<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="IssuesReturnLineList.aspx.cs" Inherits="EDMs.Web.Controls.Material.IssuesReturnLineList" EnableViewState="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <style type="text/css">
        ...
        #ctl00_ContentPlaceHolder2_ctl00_ContentPlaceHolder2_grdIssueslinePanel {
            height: 100% !important;
        }

        #ctl00_ContentPlaceHolder2_grdIssuesline_GridData {
            height: 100% !important;
        }
    ...
    <div style=" width: 100%; height: 100%; background-color: #f0f0f0 ">
        <telerik:RadSplitter RenderMode="Lightweight" ID="MainSplitter" runat="server" Height="100%" Width="100%" Orientation="Horizontal" Skin="Silk">
                ...
                <telerik:RadToolBar RenderMode="Lightweight" runat="server" ID="ToolBarWO" EnableRoundedCorners="true" EnableShadows="true" Skin="MetroTouch" Height="40">
                    <Items>
                        <telerik:RadToolBarButton Text="Left" Group="Align">
                            <ItemTemplate>
                                <span style="color: dodgerblue; font-size: 16px; font-weight: normal; font-family: helvetica, arial, verdana, sans-serif;">Xuất/Trả vật tư
                                </span>
                            ...
                            <ItemTemplate>
                                 <telerik:RadDropDownList runat="server" ID="ddlKieuGiaoDich" Width="150" OnSelectedIndexChanged="ddlKieuGiaoDich_OnSelectedIndexChanged" Skin="MetroTouch" AutoPostBack="True">
                                     <Items>
                                         ...
                                         <telerik:DropDownListItem runat="server" Text="Xuất kho" Value="1"/>
                                         <telerik:DropDownListItem runat="server" Text="Trả về" Value="2"/>
                                     </Items>
            ...
            <telerik:RadPane ID="Radpane2" runat="server" Width="100%" ShowContentDuringLoad="False">
                <telerik:RadGrid ID="grdIssuesline" runat="server" AllowPaging="True"
                    ...
                    OnNeedDataSource="grdIssuesline_OnNeedDataSource" 
                    >
                    <MasterTableView Width="100%" TableLayout="Auto" CssClass="rgMasterTable" >
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn DataField="MucSoYCMuaSamDonHang" HeaderText="Số yêu cầu mua sắm" UniqueName="MucSoYCMuaSamDonHang" ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" >
                                <HeaderStyle HorizontalAlign="Center" Width="120" />
                                <ItemStyle HorizontalAlign="Left" />
                            </telerik:GridBoundColumn>
        ...
        <telerik:RadAjaxManager runat="Server" ID="ajaxCustomer" >
            ...
            <AjaxSettings>
                ...
                <telerik:AjaxSetting AjaxControlID="ddlKieuGiaoDich">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="grdIssuesline" LoadingPanelID="RadAjaxLoadingPanel2"/>
                    </UpdatedControls>
                </telerik:AjaxSetting>
                
                <telerik:AjaxSetting AjaxControlID="grdIssuesline">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="grdIssuesline" LoadingPanelID="RadAjaxLoadingPanel2"/>
                    </UpdatedControls>
                </telerik:AjaxSetting>
        ...
        <script type="text/javascript">
            ...
            function ViewToolBar_OnClientButtonClicking(sender, args) {
                ...
                if (strValue == "SplitView") {
                    ...
                    var grid = $find("<%=grdIssuesline.ClientID %>");
