<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PartDetail.aspx.cs" Inherits="EDMs.Web.Controls.Material.PartDetail" EnableViewState="true" %>
    ...
    <div style=" width: 100%; height: 100%; background-color: #f0f0f0 ">
        <telerik:RadSplitter RenderMode="Lightweight" ID="MainSplitter" runat="server" Height="100%" Width="100%" Orientation="Horizontal" Skin="Silk">
            <telerik:RadPane ID="Radpane1" runat="server" Width="100%" Height="40" ShowContentDuringLoad="False">
                ...
                <telerik:RadToolBar RenderMode="Lightweight" runat="server" ID="ViewToolBar" EnableRoundedCorners="true" EnableShadows="true" Skin="MetroTouch" Height="40" Width="115" dir="rtl" OnClientButtonClicking="ViewToolBar_OnClientButtonClicking">
                    <Items>
                            ...
                            <telerik:RadPageView runat="server" ID="RadPageView2" >
                                ...
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <telerik:RadCheckBox ID="cbThietBi" runat="server" Skin="MetroTouch" Enabled="False"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <telerik:RadTextBox ID="txtDonViTinh" runat="server" Skin="MetroTouch" Width="150" ReadOnly="True"/>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <telerik:RadTextBox ID="txtCongCu" runat="server" Skin="MetroTouch" Width="150" ReadOnly="True"/>
                                        </td>
                                        <td align="right" style="width: 150px; padding-right: 2px">Part number:</td>
                                        <td>
                                            <telerik:RadTextBox ID="txtPartNumber" runat="server" Skin="MetroTouch" Width="150" ReadOnly="True"/>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <telerik:RadTextBox ID="txtMaThuehangHoa" runat="server" Skin="MetroTouch" Width="150" ReadOnly="True"/>
                                        </td>
                                        <td align="right" style="width: 150px; padding-right: 2px">Phương thức theo dõi:</td>
                                        <td>
                                            <telerik:RadTextBox ID="txtPhuongThucTheoDoi" runat="server" Skin="MetroTouch" Width="200" ReadOnly="True"/>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <telerik:RadCheckBox ID="cbKiemTraNhap" runat="server" Skin="MetroTouch" Enabled="False"/>
                                        </td>
                                        <td align="right" style="width: 150px; padding-right: 2px">Số ngày bảo hành:</td>
                                        <td>
                                            <telerik:RadTextBox ID="txtSoNgayBaoHanh" runat="server" Skin="MetroTouch" Width="150" ReadOnly="True"/>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <telerik:RadTextBox ID="txtDonGiaTieuChuan" runat="server" Skin="MetroTouch" Width="150" ReadOnly="True"/>
                                        </td>
                                        <td align="right" style="width: 150px; padding-right: 2px">Đơn giá cơ sở:</td>
                                        <td>
                                            <telerik:RadTextBox ID="txtDonGiaCoSo" runat="server" Skin="MetroTouch" Width="150" ReadOnly="True"/>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <telerik:RadTextBox ID="txtDonGiaMuaCuoi" runat="server" Skin="MetroTouch" Width="150" ReadOnly="True"/>
                                        </td>
                                        <td align="right" style="width: 150px; padding-right: 2px">Đơn giá trung bình:</td>
                                        <td>
                                            <telerik:RadTextBox ID="txtDonGiaTrungBinh" runat="server" Skin="MetroTouch" Width="150" ReadOnly="True"/>
                                        </td>
                                    </tr>
                                </table>
                            </telerik:RadPageView>
