...
namespace EDMs.Web.Controls.Scope
{
    ...
    /// Class customer
    /// </summary>
    public partial class DocumentStatusList : Page
    {
        private readonly PermissionService permissionService = new PermissionService();

        private readonly StatusService documentStatusService = new StatusService();
        ...
        {
            var DocumentStatusList = this.documentStatusService.GetAll();
            this.grdDocument.DataSource = DocumentStatusList;
        }
        ...
        protected void grdDocument_DeleteCommand(object sender, GridCommandEventArgs e)
        {
            ...
            this.documentStatusService.Delete(disId);
