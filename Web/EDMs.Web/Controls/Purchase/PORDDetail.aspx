<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PORDDetail.aspx.cs" Inherits="EDMs.Web.PORDDetail" EnableViewState="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <style type="text/css">
        ...
        #ctl00_ContentPlaceHolder2_txtTrangThai {
            font-weight: bold;
        }
        </style>
    ...
    <div style=" width: 100%; height: 100%; background-color: #f0f0f0 ">
                ...
                <telerik:RadToolBar RenderMode="Lightweight" runat="server" ID="ToolBarObject" EnableRoundedCorners="true" EnableShadows="true" Skin="MetroTouch" Height="40">
                    <Items>
                        <telerik:RadToolBarButton Text="Left" Group="Align">
                            <ItemTemplate>
                                <span style="color: dodgerblue;font-size: 16px;font-weight: normal;font-family: helvetica, arial, verdana, sans-serif;">Đơn hàng: </span>
                        ...
                        <telerik:RadSplitter RenderMode="Lightweight" ID="LeftSplitter" runat="server" Height="100%" Width="100%" Orientation="Horizontal" Skin="Silk">
                            <telerik:RadPane ID="Radpane3" runat="server" Width="100%" Height="27">
                                <telerik:RadTextBox RenderMode="Lightweight" Width="100%" ID="txtSearch" runat="server"
                                                    EmptyMessage="Search within All POs" InvalidStyleDuration="100">
                                </telerik:RadTextBox>
                            ...
                            <telerik:RadPane ID="Radpane4" runat="server" Width="100%" >
                                <telerik:RadListBox RenderMode="Lightweight" runat="server" ID="lbPORD" Height="100%" Width="100%" LoadingPanelID="<%# RadAjaxLoadingPanel2.ClientID %>" EnableLoadOnDemand="False" Skin="MetroTouch" OnSelectedIndexChanged="lbPORD_OnSelectedIndexChanged" AutoPostBack="True">
                                    <ItemTemplate>
                                        ...
                                        <table>
                                            ...
                                            <tr>
                                                <td align="right"><span class="ObjectDetail">Đưa về kho:&nbsp;</span></td>
                        ...
                        <telerik:RadMultiPage runat="server" ID="MultiPageObject" SelectedIndex="0">
                            <telerik:RadPageView runat="server" ID="RadPageView2" >
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td align="right" style="width: 150px; padding-right: 2px">Người đặt hàng:</td>
                                        <td>
                                            <telerik:RadTextBox ID="txtNguoiDatHang" runat="server" Skin="MetroTouch" Width="150"/>
                                        </td>
                                        <td align="right" style="width: 150px; padding-right: 2px">Số gói theo dõi:</td>
                                        <td>
                                            <telerik:RadTextBox ID="txtSoGoiTheoDoi" runat="server" Skin="MetroTouch" Width="150"/>
                                        </td>
                                    </tr>
                                    
                                    <tr>
                                        <td align="right" style="width: 150px; padding-right: 2px">Thời gian chờ:</td>
                                        <td>
                                            <telerik:RadTextBox ID="txtThoiGianCho" runat="server" Skin="MetroTouch" Width="150"/>
                                        </td>
                                        <td align="right" style="width: 150px; padding-right: 2px">Địa chỉ giao nhận:</td>
                                        <td>
                                            <telerik:RadTextBox ID="txtDiaChiGiaoNhan" runat="server" Skin="MetroTouch" Width="150"/>
                                        </td>
                                    </tr>
                                    
                                    <tr>
                                        <td align="right" style="width: 150px; padding-right: 2px">Tổng giá trị:</td>
                                        <td>
                                            <telerik:RadTextBox ID="txtTongGiaTri" runat="server" Skin="MetroTouch" Width="150"/>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <telerik:RadTextBox ID="txtNhaCungCap" runat="server" Skin="MetroTouch" Width="150"/>
                                        </td>
                                        <td align="right" style="width: 150px; padding-right: 2px">Tiền tệ:</td>
                                        <td>
                                            <telerik:RadTextBox ID="txtTienTe" runat="server" Skin="MetroTouch" Width="150"/>
                                        </td>
                                    </tr>

                                    <tr>
                                        <td align="right" style="width: 150px; padding-right: 2px">Tỷ giá:</td>
                                        <td>
                                            <telerik:RadTextBox ID="txtTyGia" runat="server" Skin="MetroTouch" Width="150"/>
                                        </td>
                            ...
                            <telerik:RadPageView runat="server" ID="RadPageView1">
                                <telerik:RadSplitter RenderMode="Lightweight" ID="REQ_linesSplitter" runat="server" Height="100%" Width="100%" Orientation="Horizontal" Skin="Silk">
                                    <telerik:RadPane ID="REQ_linesPanel" runat="server" Width="100%" Height="300">
                                        <telerik:RadGrid ID="grdPORDLines" runat="server" AllowPaging="False"
                                            AutoGenerateColumns="False" CellPadding="0" CellSpacing="0"
                                            GridLines="None" Height="100%" Skin="Metro"
                                            OnNeedDataSource="grdPORDLines_OnNeedDataSource" 
                                            >
                                            <MasterTableView Width="100%" TableLayout="Auto" CssClass="rgMasterTable" >
                                                ...
                                                <Columns>
                                                    ...
                                                    <telerik:GridBoundColumn DataField="GiamGia" HeaderText="Giảm giá" UniqueName="GiamGia">
                                                        <HeaderStyle HorizontalAlign="Center" Width="120" />
                                                        <ItemStyle HorizontalAlign="Right" />
                                                    </telerik:GridBoundColumn>
                                                    
                                                    <telerik:GridBoundColumn DataField="TongThue" HeaderText="Tổng thuế" UniqueName="TongThue">
                                                        <HeaderStyle HorizontalAlign="Center" Width="120" />
                                                        <ItemStyle HorizontalAlign="Right" />
                                                    </telerik:GridBoundColumn>
        ...
        <telerik:RadAjaxManager runat="Server" ID="ajaxCustomer" OnAjaxRequest="RadAjaxManager1_AjaxRequest">
            ...
            <AjaxSettings>
                ...
                <telerik:AjaxSetting AjaxControlID="lbPORD">
                    <UpdatedControls>
                ...
                <telerik:AjaxSetting AjaxControlID="btnSearch">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="lbPORD" LoadingPanelID="RadAjaxLoadingPanel2"/>
                    </UpdatedControls>
                </telerik:AjaxSetting>
        ...
        <script type="text/javascript">
            ...
            function ViewToolBar_OnClientButtonClicking(sender, args) {
                ...
                if (strValue == "ExpandLeft") {
                    ...
                    window.location.href = "PORDList.aspx";
                }
            }
        </script>
