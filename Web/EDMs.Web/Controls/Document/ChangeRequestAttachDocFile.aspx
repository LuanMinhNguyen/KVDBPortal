<%@ Page Language="C#" Debug="true" AutoEventWireup="true" CodeBehind="ChangeRequestAttachDocFile.aspx.cs" Inherits="EDMs.Web.Controls.Document.ChangeRequestAttachDocFile" %>
        ...
        <div style="width: 100%; height:100vh;" runat="server" ID="divContent" >
            ...
            <telerik:RadSplitter ID="RadSplitter4" runat="server" Orientation="Vertical" Width="100%" Height="100%" Skin="Windows7">
                <telerik:RadPane ID="RadPane2" runat="server" Scrollable="true" Scrolling="Y" Width="400" Height="100%">
                    ...
                    <dl class="accordion">
                        <dt style="width: 100%;">
                            <span>SELECT PROJECT'S DOCUMENT FILES</span>
                        </dt>
                    </dl>
                    <div class="demo-container size-narrow">
                        <telerik:RadAsyncUpload Skin="Silk" RenderMode="Lightweight" runat="server" ID="radUploadDoc" MultipleFileSelection="Automatic"/>
                    </div>
    ...
    <telerik:RadWindowManager ID="RadWindowManager1" runat="server" EnableShadow="true" Skin="Windows7">
        ...
        <telerik:RadScriptBlock runat="server">
            <script type="text/javascript">
                ...
                owd.Show();
                owd.setUrl("ChangeRequestAttachDocFileEditForm.aspx?objId=" + objId, "CustomerDialog");
                }
