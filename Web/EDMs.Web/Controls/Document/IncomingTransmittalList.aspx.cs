...
namespace EDMs.Web.Controls.Document
{
    ...
    /// Class customer
    /// </summary>
    public partial class IncomingTransmittalList : Page
    {
        /// <summary>
        ...
        /// <summary>
        /// The IncomingTransmittal service.
        /// </summary>
        private readonly IncomingTransmittalService IncomingTransmittalService = new IncomingTransmittalService();
        ...
        {
            var listIncomingTrans = UserSession.Current.User.Role.IsAdmin.GetValueOrDefault() ? 
                                this.IncomingTransmittalService.GetAll() : 
                                this.IncomingTransmittalService.GetAllByOwner(UserSession.Current.User.Id);

            this.grdDocument.DataSource = listIncomingTrans;
        ...
        protected void grdDocument_DeleteCommand(object sender, GridCommandEventArgs e)
        {
            ...
            this.IncomingTransmittalService.Delete(tranId);
