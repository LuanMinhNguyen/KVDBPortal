...
namespace EDMs.Web.Controls.Document
{
    ...
    /// The customer edit form.
    /// </summary>
    public partial class DocumentListProjectInfoEditForm_ENG : Page
    {
        ...
        /// </summary>
        public DocumentListProjectInfoEditForm_ENG()
        {
        ...
        private void LoadComboData(ProjectCode projectObj)
        {
            ...
            var kksList = this.kksCodeService.GetAll();
            this.ddlKKS.DataSource = kksList.OrderBy(t => t.Code);
            ...
            this.ddlDiscipline.DataSource = disciplineList.OrderBy(t => t.Code);
        ...
        {
            obj.CategoryId = 1;
            obj.CategoryName = "1. Engineering Document";
            ...
            obj.DocTypeCode = this.ddlDocType.SelectedItem != null ?
                                        ...
                                        : string.Empty;
            obj.KKSId = this.ddlKKS.SelectedItem != null ?
                                        Convert.ToInt32(this.ddlKKS.SelectedValue)
                                        : 0;
            obj.KKSCode = this.ddlKKS.SelectedItem != null ?
                                        this.ddlKKS.SelectedItem.Text.Split(',')[0]
                                        : string.Empty;
            obj.TrainNo = this.txtTrainNo.Text.Trim();
            obj.DisciplineId = this.ddlDiscipline.SelectedItem != null ?
                                        Convert.ToInt32(this.ddlDiscipline.SelectedValue)
                                        : 0;
            obj.DisciplineCode = this.ddlDiscipline.SelectedItem != null ?
                                        this.ddlDiscipline.SelectedItem.Text.Split(',')[0]
                                        : string.Empty;
            obj.SheetNo = this.txtSheetNo.Text.Trim();
            ...
            {
                obj.Sequence = Convert.ToInt32(this.txtSequence.Text);
                obj.SequenceText = this.txtSequence.Text.Trim();
        ...
        private void LoadDocInfo(PECC2Documents obj, ProjectCode projectObj)
        {
            ...
            this.ddlDiscipline.SelectedValue = obj.DisciplineId.ToString();
            this.txtSheetNo.Text = obj.SheetNo;
            ...
            this.txtSequence.Text = obj.SequenceText;
