<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContractorTransmittalAttachDocFileReject.aspx.cs" Inherits="EDMs.Web.Controls.Document.ContractorTransmittalAttachDocFileReject" %>
                ...
                <li style="width: 600px;">
                    <div>
                        <label style="width: 125px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
                            <span style="color: #2E5689; text-align: right; ">Reject Reason
                            </span>
                        </label>
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem" runat="server" id="divFileName">
                            <asp:TextBox ID="txtReason" runat="server" Style="width: 400px;" CssClass="min25Percent" TextMode="MultiLine" Rows="5"/>
                        </div>
                    </div>
