...
namespace EDMs.Web.Controls.Document
{
    ...
    /// The customer edit form.
    /// </summary>
    public partial class PECC2AttachDocument : Page
    {
        ...
        protected void btnExportCRS_OnClick(object sender, EventArgs e)
        {
            if (!string.IsNullOrEmpty(Request.QueryString["docId"]))
            {
                ...
                if (consolidateDocFile != null)
                {
                    ...
                    var docObj = this._PECC2DocumentService.GetById(consolidateDocFile.ProjectDocumentId.GetValueOrDefault());
                    if (docObj != null)
                    {
