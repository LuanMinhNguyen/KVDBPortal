<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChangeRequestAttachDocument.aspx.cs" Inherits="EDMs.Web.Controls.Document.ChangeRequestAttachDocument" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <dl class="accordion">
            <dt style="width: 100%;">
                <span>PECC2's Attach Files</span>
            </dt>
        </dl>

        <telerik:RadGrid ID="grdPECC2AttachFile" runat="server" AllowPaging="True"
            AutoGenerateColumns="False" CellPadding="0" CellSpacing="0"
            GridLines="None" Skin="Windows7" Height="170"
            OnNeedDataSource="grdPECC2AttachFile_NeedDataSource" 
        ...
        <dl class="accordion">
            <dt style="width: 100%;">
                <span>Contractor's Attach Files</span>
            </dt>
        </dl>

        <div style="width: 100%" runat="server" id="divUpload">
            <ul style="list-style-type: none" Runat="server" ID="UploadControl">
                <li style="width: 100%;">
                    <div>
                ...
                <li style="width: 100%;">
                    <div>
                        ...
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                            <asp:RadioButton runat="server" GroupName="AttachType" ID="cbChangeRequestForm" Text="Change Request Form" Checked="True"/><br/>
                            <asp:RadioButton runat="server" GroupName="AttachType" ID="cbCRSResponse" Text="CRS Response File" />
                        </div>
                    </div>
                    <div style="clear: both; font-size: 0;"></div>
                </li>
                ...
                <li style="width: 100%; text-align: center; padding-top: 10px">
                    ...
                    <telerik:RadButton ID="btnExportChangeRequestForm" runat="server" Text="Export Change Request Form" OnClick="btnExportChangeRequestForm_OnClick" Width="220px" style="text-align: center">
