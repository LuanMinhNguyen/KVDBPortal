<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChangeRequestEditForm.aspx.cs" Inherits="EDMs.Web.Controls.Document.ChangeRequestEditForm" %>
    ...
    <form id="form1" runat="server">
        ...
        <div style="width: 100%; height: 100%" runat="server" ID="divContent">
                ...
                <li style="width: 600px;">
                    <div>
                        ...
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                            <asp:TextBox ID="txtChangeRequestNo"  runat="server" Style="width: 400px;" CssClass="min25Percent qlcbFormRequired"/>
                        </div>
                    </div>
            ...
            <li style="width: 600px;">
                <div>
                    <label style="width: 130px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
                        <span style="color: #2E5689; text-align: right; ">Ref. Change Request
                        </span>
                    </label>
                    <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                        <asp:DropDownList ID="ddlRefChangeRequest" runat="server" CssClass="min25Percent" Width="416px"/>
                    ...
                    <div>
                        <label style="width: 130px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
                           ...
                           <asp:DropDownList ID="ddlType" runat="server" CssClass="min25Percent qlcbFormRequired" Width="416px"
                               OnSelectedIndexChanged="RegenChangeRequestNo" AutoPostBack="True"/>
                        </div>
                    ...
                    <div>
                        ...
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                            <telerik:radnumerictextbox type="Number" id="txtYear" runat="server" Style=" min-width: 0px !important; border-color: #8E8E8E #B8B8B8 #B8B8B8 #46A3D3;" Width="70px" CssClass="min25Percent qlcbFormRequired"
                                OnTextChanged="txtYear_OnTextChanged" AutoPostBack="True">
                ...
                <li style="width: 600px;">
                    <div>
                        ...
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                             <asp:TextBox ID="txtSequentialNumber"  runat="server" Style="width: 400px;" CssClass="min25Percent"
                                 OnTextChanged="txtSequentialNumber_OnTextChanged" AutoPostBack="True"/>
                        </div>
                    </div>
                    <div style="clear: both; font-size: 0;"></div>
                </li>
                ...
                <dl class="accordion">
                  ...
                  <li style="width: 600px;">
                    <div>
                        ...
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                            <asp:TextBox ID="txtReasonForChange"  runat="server" Style="width: 400px;" CssClass="min25Percent" TextMode="MultiLine" Rows="6"/>
                        </div>
                    </div>
                    <div style="clear: both; font-size: 0;"></div>
                </li>
                ...
                <li style="width: 600px;">
                    <div>
                        ...
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                            <asp:TextBox ID="txtExistingCondition"  runat="server" Style="width: 400px;" CssClass="min25Percent" TextMode="MultiLine" Rows="6"/>
                        </div>
                    </div>
                    <div style="clear: both; font-size: 0;"></div>
                </li>
            ...
            <li style="width: 600px;">
                <div>
                    ...
                    <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                        <asp:TextBox ID="txtDescription"  runat="server" Style="width: 400px;" CssClass="min25Percent" TextMode="MultiLine" Rows="6"/>
                    </div>
                </div>
                <div style="clear: both; font-size: 0;"></div>
            </li>
                ...
                <li style="width: 600px;" runat="server" id="divClosedDate">
                    <div>
                        <label style="width: 130px; float: left; padding-top: 3px; padding-right: 10px; text-align: right;">
                ...
                <li style="width: 600px;">
                    <div>
                        <label style="width: 130px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
                            ...
                            <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                           <asp:DropDownList ID="ddlChangeGradeCode" runat="server" CssClass="min25Percent qlcbFormRequired" Width="416px"/>
                        </div>
                ...
                <li style="width: 600px;">
                    <div>
                        <label style="width: 130px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
                            <span style="color: #2E5689; text-align: right; ">Referenced/Revised Document Number
                            </span>
                        </label>
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                            <asp:Panel ID="panelSearchRefDocNo" runat="server" DefaultButton="btnSearchRefDocNo">
                                <telerik:RadTextBox runat="server" ID="txtSearchRefDocNo" Width="396" CssClass="min25Percent" EmptyMessage="Search Reference Document Number" style="border-color: #8E8E8E #B8B8B8 #B8B8B8 #46A3D3 !important;" /> 
                ...
                <li style="width: 600px;" runat="server" id="divReviewResult">
                    <div>
                        <label style="width: 130px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
                            <span style="color: #2E5689; text-align: right; ">Review Result
                            </span>
                        </label>
                            <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                           <asp:DropDownList ID="ddlReviewResult" runat="server" CssClass="min25Percent" Width="416px"/>
                        </div>
                ...
                <li style="width: 600px;display: none">
                    <div>
                        <label style="width: 130px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
                            <span style="color: #2E5689; text-align: right; ">PECC2 Review Result
                            </span>
                        </label>
                            <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                           <asp:DropDownList ID="ddlPECC2ReviewResult" runat="server" CssClass="min25Percent" Width="416px"/>
                        </div>
                ...
                <li style="width: 600px;display: none">
                    <div>
                        <label style="width: 130px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
                            <span style="color: #2E5689; text-align: right; ">Owner Review Result
                            </span>
                        </label>
                            <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                           <asp:DropDownList ID="ddlOwnerReviewResult" runat="server" CssClass="min25Percent" Width="416px"/>
                        </div>
                ...
                <li style="width: 600px; display: none">
                    <div>
                        <label style="width: 130px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
                            <span style="color: #2E5689; text-align: right; ">Document To Be Revised
                            </span>
                        </label>
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                            <asp:Panel ID="panelSearchDocRevised" runat="server" DefaultButton="btnSearchDocRevised">
                                <telerik:RadTextBox runat="server" ID="txtSearchDocRevised" Width="396" CssClass="min25Percent" EmptyMessage="Search Document To Be Revised" style="border-color: #8E8E8E #B8B8B8 #B8B8B8 #46A3D3 !important;"/> 
                                <asp:ImageButton ID="btnSearchDocRevised" runat="server" ImageUrl="../../Images/search.png" style="margin-bottom: -5px !important; margin-left: -2px !important;" OnClick="btnSearchDocRevised_OnClick"/>
                                <telerik:RadTreeView RenderMode="Lightweight" ID="rtvDocToBeRevised" runat="server" CheckBoxes="True" TriStateCheckBoxes="true" CheckChildNodes="true" Width="400" Height="120" OnNodeCheck="rtvDocToBeRevised_OnNodeCheck" Skin="Windows7"/>
                            </asp:Panel>
                        </div>
