<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AttachResponse.aspx.cs" Inherits="EDMs.Web.Controls.Document.AttachResponse" %>
                ...
                <%--<li style="width: 100%;" Runat="server" ID="Li1">
                    <div>
                        <label style="width: 200px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
                            <span style="color: #2E5689; text-align: right; ">Final Code
                            </span>
                        </label>
