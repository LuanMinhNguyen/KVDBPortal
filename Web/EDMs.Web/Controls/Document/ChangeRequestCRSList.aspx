<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChangeRequestCRSList.aspx.cs" Inherits="EDMs.Web.Controls.Document.ChangeRequestCRSList" %>
        ...
        <div style="width: 100%">
            <ul style="list-style-type: none">
                ...
                <li style="width: 100%; text-align: center; padding-top: 10px">
                    ...
                    <br />
                    <br />
                    <telerik:RadButton ID="btnExportCRS" runat="server" Text="Generate CRS" OnClick="btnExportCRS_OnClick" Width="120px" style="text-align: center">
