...
namespace EDMs.Web.Controls.Document
{
    ...
    /// The customer edit form.
    /// </summary>
    public partial class InternalDocumentRevisionHistory : Page
    {
        /// <summary>
        ...
        /// </summary>
        public InternalDocumentRevisionHistory()
        {
        ...
        protected void grdDocument_DataBound(object sender, EventArgs e)
        {
            ...
            {
                var docId = Convert.ToInt32(Request.QueryString["docId"]);
                var objDoc = this.documentNewService.GetById(docId);
                if (objDoc != null)
                {
                    var deparmentId = isViewByGroup ? UserSession.Current.RoleId : 0;
                    foreach (var docPropertiesView in this.docPropertiesViewService.GetAllSpecial(objDoc.CategoryId.GetValueOrDefault(), deparmentId))
                    {
