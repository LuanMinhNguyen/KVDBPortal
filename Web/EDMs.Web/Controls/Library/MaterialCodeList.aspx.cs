...
namespace EDMs.Web.Controls.Library
{
    ...
    /// Class customer
    /// </summary>
    public partial class MaterialCodeList : Page
    {
        ...
        protected void RadAjaxManager1_AjaxRequest(object sender, AjaxRequestEventArgs e)
        {
            ...
            {
                this.ExportMaterialCode();
            }
        }

        private void ExportMaterialCode()
        {
            ...
            var materialList = this.materialService.GetAll().ToList();
            ...
            foreach (var materialObj in materialList)
            {
                var dataRow = dtFull.NewRow();
                dataRow["ID"] = materialObj.ID;
                dataRow["Code"] = materialObj.Code;
                dataRow["Description"] = materialObj.Description;
            ...
            dataSheet.Cells["C1"].PutValue("MATERIAL CODE");
            var filename = "MaterialCode.xlsx";
        ...
        {
            var drawingList = this.materialService.GetAll();
        ...
        protected void grdDocument_DeleteCommand(object sender, GridCommandEventArgs e)
        {
            ...
            var materialId = Convert.ToInt32(item.GetDataKeyValue("ID").ToString());
