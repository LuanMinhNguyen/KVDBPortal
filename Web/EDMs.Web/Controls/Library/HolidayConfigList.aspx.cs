...
namespace EDMs.Web.Controls.Library
{
    ...
    /// Class customer
    /// </summary>
    public partial class HolidayConfigList : Page
    {
        private readonly PermissionService permissionService = new PermissionService();

        private readonly HolidayConfigService holidayConfigService = new HolidayConfigService();

        private readonly WaitingSyncDataService waitingSyncDataService = new WaitingSyncDataService();
        ...
        {
            var DocumentHolidayConfigList = this.holidayConfigService.GetAll();
            this.grdDocument.DataSource = DocumentHolidayConfigList;
        }
        ...
        protected void grdDocument_DeleteCommand(object sender, GridCommandEventArgs e)
        {
            ...
            this.holidayConfigService.Delete(objId);
            this.grdDocument.Rebind();
        }
