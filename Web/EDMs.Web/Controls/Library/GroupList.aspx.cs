...
namespace EDMs.Web.Controls.Library
{
    ...
    public partial class GroupList : Page
    {
        ...
        private void ExportGroup()
        {
            ...
            var GroupCodeList = this.GroupCodeService.GetAll().ToList();
            ...
            foreach (var GroupObj in GroupCodeList)
            {
                var dataRow = dtFull.NewRow();
                dataRow["ID"] = GroupObj.ID;
                dataRow["Code"] = GroupObj.Code;
                dataRow["Description"] = GroupObj.Description;
            ...
            dataSheet.Cells["C1"].PutValue("GroupCode CODE");
        ...
        {
            var projectList = this.GroupCodeService.GetAll();
        ...
        protected void grdDocument_DeleteCommand(object sender, GridCommandEventArgs e)
        {
            ...
            this.GroupCodeService.Delete(disId);
