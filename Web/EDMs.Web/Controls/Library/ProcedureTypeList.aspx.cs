...
namespace EDMs.Web.Controls.Library
{
    ...
    /// Class customer
    /// </summary>
    public partial class ProcedureTypeList : Page
    {
        private readonly PermissionService permissionService = new PermissionService();

        private readonly ProcedureTypeService ProcedureTypeService = new ProcedureTypeService();
        ...
        {
            var DocumentProcedureTypeList = this.ProcedureTypeService.GetAll();
            this.grdDocument.DataSource = DocumentProcedureTypeList;
        }
        ...
        protected void grdDocument_DeleteCommand(object sender, GridCommandEventArgs e)
        {
            ...
            this.ProcedureTypeService.Delete(disId);
