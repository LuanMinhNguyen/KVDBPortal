<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TagTypeEditForm.aspx.cs" Inherits="EDMs.Web.Controls.Library.TagTypeEditForm" %>
                    ...
                    <div>
                        ...
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem" runat="server" id="div3">
                            <telerik:RadComboBox ID="ddlParent" runat="server" Skin="Windows7" 
                                ...
                                <ItemTemplate>
                                    <div id="div1">
                                        <telerik:RadTreeView runat="server" ID="rtvTagType" Skin="Windows7" OnClientNodeClicking="nodeClicking">
                                            <DataBindings>
