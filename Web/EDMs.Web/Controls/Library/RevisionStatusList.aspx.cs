...
namespace EDMs.Web.Controls.Library
{
    ...
    /// Class customer
    /// </summary>
    public partial class RevisionStatusList : Page
    {
        private readonly PermissionService permissionService = new PermissionService();

        private readonly RevisionStatuService _RevisionStatusSrvice = new RevisionStatuService();
        ...
        {
            this.grdDocument.DataSource = this._RevisionStatusSrvice.GetAll();
        ...
        protected void RadAjaxManager1_AjaxRequest(object sender, AjaxRequestEventArgs e)
        {
            ...
            }else if(e.Argument== "ExportTemplate")
            {
                ...
                workbook.Open(filePath + @"Template\TemplateDocumentClass.xls");
                var sheets = workbook.Worksheets;
                var filename =  "RevisionStatus_MasterListTemplate"+ DateTime.Now.ToString("ddmmyyy")+".xls";
        ...
        protected void grdDocument_DeleteCommand(object sender, GridCommandEventArgs e)
        {
            ...
            this._RevisionStatusSrvice.Delete(disId);
