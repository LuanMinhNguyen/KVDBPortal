<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AreaEditForm.aspx.cs" Inherits="EDMs.Web.Controls.Library.AreaEditForm" %>
                ...
                <li style="width:500px;">
                    <div>
                       <label style="width: 125px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
                        ...
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                            <asp:DropDownList ID="ddlPlant" runat="server" CssClass="min25Percent" Width="300px"/>
                        </div>
                    </div>
                    <div style="clear:both; font-size:0;"></div>
                </li>
