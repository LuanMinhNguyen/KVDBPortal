...
namespace EDMs.Web.Controls.Library
{
    ...
    /// The customer edit form.
    /// </summary>
    public partial class KKSEditForm : Page
    {
        /// <summary>
        /// The KKS service.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KKSEditForm"/> class.
        /// </summary>
        public KKSEditForm()
        {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!this.IsPostBack)
            {
                if (!string.IsNullOrEmpty(this.Request.QueryString["objId"]))
                {
                    ...
                    var objDis = this.KKSIdentificationCodeService.GetById(Convert.ToInt32(this.Request.QueryString["objId"]));
                    if (objDis != null)
                    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            if (this.Page.IsValid)
            {
                if (!string.IsNullOrEmpty(this.Request.QueryString["objId"]))
                {
                    ...
                    var objDis = this.KKSIdentificationCodeService.GetById(objId);
                    if (objDis != null)
                    {
                        ...
                        this.KKSIdentificationCodeService.Update(objDis);
                        
                    }
                }
                else
                {
                    var objDis = new KKSIdentificationCode()
                    {
                    ...
                    this.KKSIdentificationCodeService.Insert(objDis);
        ...
        protected void ServerValidationFileNameIsExist(object source, ServerValidateEventArgs args)
        {
            ...
            {
                this.fileNameValidator.ErrorMessage = "Please enter KKS Code.";
