...
namespace EDMs.Web.Controls.Library
{
    ...
    /// Class customer
    /// </summary>
    public partial class ChangeGradeCodeList : Page
    {
        private readonly PermissionService permissionService = new PermissionService();

        private readonly ChangeGradeCodeService ChangeGradeCodeCodeService = new ChangeGradeCodeService();
        ...
        protected void RadAjaxManager1_AjaxRequest(object sender, AjaxRequestEventArgs e)
        {
            ...
            {
                this.ExportChangeGradeCode();
            }
        }

        private void ExportChangeGradeCode()
        {
            ...
            var ChangeGradeCodeCodeList = this.ChangeGradeCodeCodeService.GetAll().ToList();
            ...
            foreach (var ChangeGradeCodeObj in ChangeGradeCodeCodeList)
            {
                var dataRow = dtFull.NewRow();
                dataRow["ID"] = ChangeGradeCodeObj.ID;
                dataRow["Code"] = ChangeGradeCodeObj.Code;
                dataRow["Description"] = ChangeGradeCodeObj.Description;
            ...
            dataSheet.Cells["C1"].PutValue("ChangeGradeCodeCode CODE");
            var filename = "ChangeGradeCode.xlsx";
        ...
        {
            var projectList = this.ChangeGradeCodeCodeService.GetAll();
        ...
        protected void grdDocument_DeleteCommand(object sender, GridCommandEventArgs e)
        {
            ...
            this.ChangeGradeCodeCodeService.Delete(disId);
        ...
        private void LoadScopePanel()
        {
            ...
            if (permissions.Any())
            {
                ...
                foreach (RadPanelItem item in this.radPbScope.Items[0].Items)
                {
                    item.ImageUrl = permissions.FirstOrDefault(t => t.Id == Convert.ToInt32(item.Value)).Menu.Icon;
                    item.NavigateUrl = permissions.FirstOrDefault(t => t.Id == Convert.ToInt32(item.Value)).Menu.Url;
                    if (item.Text == "Change Grade Code")
                    {
                        item.Selected = true;
                    }
                }
