<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="OptionalTypeDetailList.aspx.cs" Inherits="EDMs.Web.Controls.Library.OptionalTypeDetailList" EnableViewState="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
            ...
            <telerik:RadToolBar ID="CustomerMenu" runat="server" Width="100%" OnClientButtonClicking="OnClientButtonClicking">
                <Items>
                    <telerik:RadToolBarDropDown runat="server" Text="New" ImageUrl="~/Images/addNew.png">
                        <Buttons>
                            <telerik:RadToolBarButton runat="server" Text="Optional Type Detail" Value="1" ImageUrl="~/Images/object.png"/>
                        </Buttons>
                    </telerik:RadToolBarDropDown>
                    <telerik:RadToolBarButton runat="server" IsSeparator="true">
                    </telerik:RadToolBarButton>
                    
                    <telerik:RadToolBarButton Value="FilterCondition" >
                        <ItemTemplate>
                            <div>
                                <asp:Label ID="Label2" runat="server" Text="Filter by:  Category  " />
                                <telerik:RadComboBox ID="ddlCategory" Skin="Windows7" runat="server" Width="250px"
                                    OnSelectedIndexChanged="ddlCategory_SelectedIndexChanged" AutoPostBack="True"
                                    AllowCustomText="True" MarkFirstMatch="True" />
                                
                                <asp:Label ID="lblPlant" runat="server" Text="  | Optional type  " />
                                <telerik:RadComboBox ID="ddlOptionalType" Skin="Windows7" runat="server" Width="250px"
                                    OnSelectedIndexChanged="ddlOptionalType_SelectedIndexChanged" AutoPostBack="True"
                                    AllowCustomText="True" MarkFirstMatch="True" />
                            </div>
                        </ItemTemplate>
                    </telerik:RadToolBarButton>
                                ...
                                <telerik:RadTreeView ID="rtvOptionalTypeDetail" runat="server" Width="100%" Height="100%" ShowLineImages="False"
                                        ...
                                        <ContextMenus>
                                            <telerik:RadTreeViewContextMenu ID="MainContextMenu" runat="server">
                                                <Items>
                                                    <telerik:RadMenuItem Value="Add" Text="Add new" ImageUrl="~/Images/addNew.png"/>
        ...
        <telerik:RadAjaxManager runat="Server" ID="ajaxCustomer" OnAjaxRequest="RadAjaxManager1_AjaxRequest">
            <AjaxSettings>
                ...
                <telerik:AjaxSetting AjaxControlID="ajaxCustomer">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="rtvOptionalTypeDetail" LoadingPanelID="RadAjaxLoadingPanel2" UpdatePanelRenderMode="Block" UpdatePanelHeight="100%"></telerik:AjaxUpdatedControl>
                    </UpdatedControls>
                </telerik:AjaxSetting>
    ...
    <telerik:RadWindowManager ID="RadWindowManager1" runat="server" EnableShadow="true" >
        <Windows>
            <telerik:RadWindow ID="CustomerDialog" runat="server" Title="Optional Type Detail Information"
                VisibleStatusbar="false" Height="550" Width="610" MinHeight="550" MinWidth="610" MaxWidth="610"
        ...
        <script type="text/javascript">
            ...
            function onClientContextMenuItemClicking(sender, args) {
                ...
                switch (menuItem.get_value()) {
                    ...
                    owd.Show();
                    owd.setUrl("OptionalTypeDetailEditForm.aspx?action=add&parentId=" + treeNode.get_value(), "CustomerDialog");
                    break;
                    case "Edit":
                        var owd = $find("<%=CustomerDialog.ClientID %>");
                        owd.Show();
                        owd.setUrl("OptionalTypeDetailEditForm.aspx?Id=" + treeNode.get_value(), "CustomerDialog");
                        break;
                    case "Delete":
            ...
            function rtvExplore_OnNodeExpandedCollapsed(sender, eventArgs) {
                ...
                Set_Cookie("expandedNodesOptionalTypeDetail", selectedNodes, 30);
            }
            ...
            function ShowEditForm(id) {
                var owd = $find("<%=CustomerDialog.ClientID %>");
                owd.Show();
                owd.setUrl("OptionalTypeDetailEditForm.aspx?Id=" + id, "CustomerDialog");
            }
            ...
            function OnClientButtonClicking(sender, args) {
                ...
                if (strText.toLowerCase() == "optional type detail") {
                    var owd = $find("<%=CustomerDialog.ClientID %>");
                    owd.Show();
                    owd.setUrl("OptionalTypeDetailEditForm.aspx", "CustomerDialog");
