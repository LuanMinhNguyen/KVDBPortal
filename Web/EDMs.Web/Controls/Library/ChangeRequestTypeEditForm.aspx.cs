...
namespace EDMs.Web.Controls.Library
{
    ...
    /// The customer edit form.
    /// </summary>
    public partial class ChangeRequestTypeEditForm : Page
    {
        /// <summary>
        /// The ChangeRequestType service.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ChangeRequestTypeEditForm"/> class.
        /// </summary>
        public ChangeRequestTypeEditForm()
        {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!this.IsPostBack)
            {
                if (!string.IsNullOrEmpty(this.Request.QueryString["objId"]))
                {
                    ...
                    var objDis = this.ChangeRequestTypeService.GetById(Convert.ToInt32(this.Request.QueryString["objId"]));
                    if (objDis != null)
                    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            if (this.Page.IsValid)
            {
                if (!string.IsNullOrEmpty(this.Request.QueryString["objId"]))
                {
                    ...
                    var objDis = this.ChangeRequestTypeService.GetById(objId);
                    if (objDis != null)
                    {
                        ...
                        this.ChangeRequestTypeService.Update(objDis);
                        
                    }
                }
                else
                {
                    var objDis = new ChangeRequestType()
                    {
                    ...
                    this.ChangeRequestTypeService.Insert(objDis);
        ...
        protected void ServerValidationFileNameIsExist(object source, ServerValidateEventArgs args)
        {
            ...
            {
                this.fileNameValidator.ErrorMessage = "Please enter ChangeRequestType Code.";
