...
namespace EDMs.Web.Controls.Library
{
    ...
    /// The customer edit form.
    /// </summary>
    public partial class ChangeRequestReviewResultCodeEditForm : Page
    {
        /// <summary>
        /// The ChangeRequestReviewResultCode service.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ChangeRequestReviewResultCodeEditForm"/> class.
        /// </summary>
        public ChangeRequestReviewResultCodeEditForm()
        {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!this.IsPostBack)
            {
                if (!string.IsNullOrEmpty(this.Request.QueryString["objId"]))
                {
                    ...
                    var objDis = this.ChangeRequestReviewResultCodeService.GetById(Convert.ToInt32(this.Request.QueryString["objId"]));
                    if (objDis != null)
                    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            if (this.Page.IsValid)
            {
                if (!string.IsNullOrEmpty(this.Request.QueryString["objId"]))
                {
                    ...
                    var objDis = this.ChangeRequestReviewResultCodeService.GetById(objId);
                    if (objDis != null)
                    {
                        ...
                        this.ChangeRequestReviewResultCodeService.Update(objDis);
                        
                    }
                }
                else
                {
                    var objDis = new ChangeRequestReviewResultCode()
                    {
                    ...
                    this.ChangeRequestReviewResultCodeService.Insert(objDis);
        ...
        protected void ServerValidationFileNameIsExist(object source, ServerValidateEventArgs args)
        {
            ...
            {
                this.fileNameValidator.ErrorMessage = "Please enter Change Request Review Result Code.";
