<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DocumentCodeEditForm.aspx.cs" Inherits="EDMs.Web.Controls.Library.DocumentCodeEditForm" %>
            ...
            <ul style="list-style-type: none">
                ...
                <li style="width: 500px; display:none">
                    <div>
                        ...
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                            <asp:CheckBox runat="server" ID="cbIsFinal" Text="Is Final"/>
                        </div>
                    </div>
                    <div style="clear: both; font-size: 0;"></div>
                </li>
                ...
                <li style="width: 500px;">
                    <div>
                        ...
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                            <asp:DropDownList ID="ddlType" runat="server" CssClass="min25Percent" Width="315px">
                                <Items>
                                    <asp:ListItem Text="Action Code" Value="1"></asp:ListItem>
                                    <asp:ListItem Text="Review Status" Value="2"></asp:ListItem>
                                </Items>
                            </asp:DropDownList>
                        </div>
                    </div>
