<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MaterialCodeList.aspx.cs" Inherits="EDMs.Web.Controls.Library.MaterialCodeList" EnableViewState="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
            ...
            <telerik:RadToolBar ID="CustomerMenu" runat="server" Width="100%" OnClientButtonClicking="OnClientButtonClicking">
                <Items>
                    <telerik:RadToolBarDropDown runat="server" Text="New" ImageUrl="~/Images/addNew.png">
                        <Buttons>
                            <telerik:RadToolBarButton runat="server" Text="Material" Value="1" ImageUrl="~/Images/material.png" />
                        </Buttons>
    ...
    <telerik:RadWindowManager ID="RadWindowManager1" runat="server" EnableShadow="true">
        <Windows>
            <telerik:RadWindow ID="CustomerDialog" runat="server" Title="Material Code Information"
                VisibleStatusbar="false" Height="500" Width="650"
                Left="150px" ReloadOnShow="true" ShowContentDuringLoad="false" Modal="true">
            </telerik:RadWindow>

            <telerik:RadWindow ID="NewDialog" runat="server" Title="Material Code Information"
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            ...
            function ShowEditForm(id) {
                ...
                owd.Show();
                owd.setUrl("MaterialEditForm.aspx?materialId=" + id, "CustomerDialog");
            }
            ...
            function OnClientButtonClicking(sender, args) {
                ...
                if (strText.toLowerCase() == "material") {
                    ...
                    owd.setSize(650, document.documentElement.offsetHeight);
                    owd.Show();
                    owd.setUrl("MaterialEditForm.aspx", "NewDialog");
                }
                ...
                if (strText.toLowerCase() == "import data file") {
                    ...
                    owd.Show();
                    owd.setUrl("ImportMaterialCode.aspx", "ImportTemplate");
                }
            }
