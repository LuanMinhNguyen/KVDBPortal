...
namespace EDMs.Web.Controls.Library
{
    ...
    /// Class customer
    /// </summary>
    public partial class OptionalTypeList : Page
    {
        ...
        protected void LoadDocuments(bool isbind = false)
        {
            ...
            this.grdDocument.DataSource = this.OptionalTypeService.GetAll();
        ...
        protected void grdDocument_DeleteCommand(object sender, GridCommandEventArgs e)
        {
            ...
            this.OptionalTypeService.Delete(disId);
