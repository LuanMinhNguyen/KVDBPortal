<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TitleEditForm.aspx.cs" Inherits="EDMs.Web.Controls.Scope.TitleEditForm" %>
                ...
                <li style="width: 500px;">
                    <div>
                        ...
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem" runat="server" id="div3">
                            <asp:DropDownList ID="ddlLocation" runat="server" CssClass="min25Percent qlcbFormRequired" Width="316px" style="max-width: 5006px">
                                <Items>
