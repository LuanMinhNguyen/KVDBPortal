...
namespace EDMs.Web.Controls.Library
{
    ...
    /// Class customer
    /// </summary>
    public partial class WellList : Page
    {
        ...
        /// </summary>
        private readonly WellService WellService = new WellService();
        ...
        {
            this.grdDocument.DataSource = this.WellService.GetAll();
