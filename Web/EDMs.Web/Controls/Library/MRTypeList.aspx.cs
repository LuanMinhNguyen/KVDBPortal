...
namespace EDMs.Web.Controls.Library
{
    ...
    /// Class customer
    /// </summary>
    public partial class MRTypeList : Page
    {
        private readonly PermissionService permissionService = new PermissionService();

        private readonly MRTypeService mrTypeService = new MRTypeService();
        ...
        {
            var DocumentMRTypeList = this.mrTypeService.GetAll();
            this.grdDocument.DataSource = DocumentMRTypeList;
        }
        ...
        protected void grdDocument_DeleteCommand(object sender, GridCommandEventArgs e)
        {
            ...
            this.mrTypeService.Delete(disId);
