...
namespace EDMs.Web.Controls.Library
{
    ...
    /// Class customer
    /// </summary>
    public partial class ConfidentialityList : Page
    {
        ...
        protected void RadAjaxManager1_AjaxRequest(object sender, AjaxRequestEventArgs e)
        {
            ...
            {
                this.ExportConfidentialityCode();
            }
        }

        private void ExportConfidentialityCode()
        {
            ...
            var confidentialityList = this.confidentialityService.GetAll(UserSession.Current.User.ConfidentialId.GetValueOrDefault()).ToList();
            ...
            foreach (var confidentialityObj in confidentialityList)
            {
                var dataRow = dtFull.NewRow();
                dataRow["ID"] = confidentialityObj.ID;
                dataRow["Code"] = confidentialityObj.Code;
                dataRow["Description"] = confidentialityObj.Description;
            ...
            dataSheet.Cells["C1"].PutValue("CONFIDENTIALITY");
            var filename = "Confidentiality.xlsx";
        ...
        {
            var confidentialityList = this.confidentialityService.GetAll(UserSession.Current.User.ConfidentialId.GetValueOrDefault());
            this.grdDocument.DataSource = confidentialityList;
        }
        ...
        protected void grdDocument_DeleteCommand(object sender, GridCommandEventArgs e)
        {
            ...
            var confidentialityId = Convert.ToInt32(item.GetDataKeyValue("ID").ToString());
            this.confidentialityService.Delete(confidentialityId);
