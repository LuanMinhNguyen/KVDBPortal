<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MRCheckListEditForm.aspx.cs" Inherits="EDMs.Web.Controls.Library.MRCheckListEditForm" %>
            ...
            <ul style="list-style-type: none">
                ...
                <li style="width: 600px; display: none">
                    <div>
                        ...
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                            <telerik:radnumerictextbox type="Percent" id="txtPercentCompleteDefault" runat="server" Style=" min-width: 0px !important; border-color: #8E8E8E #B8B8B8 #B8B8B8 #46A3D3;" Width="80px" CssClass="min25Percent">
                ...
                <li style="width: 600px;">
                    <div>
                        ...
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                            <asp:TextBox ID="txtDescription" runat="server" Style="width: 400px;" CssClass="min25Percent" TextMode="MultiLine" Rows="8"/>
                        </div>
                    </div>
                    <div style="clear: both; font-size: 0;"></div>
                </li>
