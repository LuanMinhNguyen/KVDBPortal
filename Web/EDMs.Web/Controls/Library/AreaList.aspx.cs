...
namespace EDMs.Web.Controls.Library
{
    ...
    public partial class AreaList : Page
    {
        ...
        {
            this.grdDocument.DataSource = this.areaService_.GetAll();
        ...
        protected void RadAjaxManager1_AjaxRequest(object sender, AjaxRequestEventArgs e)
        {
            ...
            }else if(e.Argument== "ExportTemplate")
            {
                ...
                workbook.Open(filePath + @"Template\TemplateArea.xls");
                var sheets = workbook.Worksheets;
                var readMeSheet = sheets[1];
                var dataSheet = sheets[0];

                var PlantList = this.plantService_.GetAll();
                ...
                var filename =  "Area_MasterListTemplate"+ DateTime.Now.ToString("ddmmyyy")+".xls";
