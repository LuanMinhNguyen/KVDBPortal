<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrganizationCodeImportFileTemplate.aspx.cs" Inherits="EDMs.Web.Controls.Library.OrganizationCodeImportFileTemplate" %>
                ...
                <li style="width:100%;" Runat="server" ID="UploadControl">
                    <div>
                        <label style="width: 125px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
                            <span style="color: #2E5689; text-align: right; ">Template file
                            </span>
                        </label>
...
>
        ...
        <telerik:RadAjaxManager runat="Server" ID="ajaxDocument">
            <AjaxSettings> 
                ...
                <telerik:AjaxSetting  AjaxControlID="ddlGroupFrom">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="ddlFromList" LoadingPanelID="RadAjaxLoadingPanel2"></telerik:AjaxUpdatedControl>
                        </UpdatedControls>
                </telerik:AjaxSetting>
                <telerik:AjaxSetting AjaxControlID="ddlGroupTo">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="ddlToList" LoadingPanelID="RadAjaxLoadingPanel2"></telerik:AjaxUpdatedControl>
                    </UpdatedControls>
                </telerik:AjaxSetting>
