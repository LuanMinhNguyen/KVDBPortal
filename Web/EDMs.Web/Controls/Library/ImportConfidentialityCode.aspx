<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ImportConfidentialityCode.aspx.cs" Inherits="EDMs.Web.Controls.Library.ImportConfidentialityCode" %>
            ...
            <ul style="list-style-type: none">
                ...
                <li style="width: 400px;" Runat="server" id="blockError" Visible="False">
                    <div>
                        ...
                        <div style="float: left; padding-top: 5px; " class="qlcbFormItem">
                            <asp:Label runat="server" ID="lblError" Width="300px" ForeColor="Red"></asp:Label>
                        </div>
                    </div>
                    <div style="clear: both; font-size: 0;"></div>
                </li>
