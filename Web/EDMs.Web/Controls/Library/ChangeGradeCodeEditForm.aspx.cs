...
namespace EDMs.Web.Controls.Library
{
    ...
    /// The customer edit form.
    /// </summary>
    public partial class ChangeGradeCodeEditForm : Page
    {
        /// <summary>
        /// The ChangeGradeCode service.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ChangeGradeCodeEditForm"/> class.
        /// </summary>
        public ChangeGradeCodeEditForm()
        {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!this.IsPostBack)
            {
                if (!string.IsNullOrEmpty(this.Request.QueryString["objId"]))
                {
                    ...
                    var objDis = this.ChangeGradeCodeService.GetById(Convert.ToInt32(this.Request.QueryString["objId"]));
                    if (objDis != null)
                    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            if (this.Page.IsValid)
            {
                if (!string.IsNullOrEmpty(this.Request.QueryString["objId"]))
                {
                    ...
                    var objDis = this.ChangeGradeCodeService.GetById(objId);
                    if (objDis != null)
                    {
                        ...
                        this.ChangeGradeCodeService.Update(objDis);
                        
                    }
                }
                else
                {
                    var objDis = new ChangeGradeCode()
                    {
                    ...
                    this.ChangeGradeCodeService.Insert(objDis);
        ...
        protected void ServerValidationFileNameIsExist(object source, ServerValidateEventArgs args)
        {
            ...
            {
                this.fileNameValidator.ErrorMessage = "Please enter Change Grade Code.";
