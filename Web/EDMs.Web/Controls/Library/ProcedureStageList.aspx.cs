...
namespace EDMs.Web.Controls.Library
{
    ...
    /// Class customer
    /// </summary>
    public partial class ProcedureStageList : Page
    {
        private readonly PermissionService permissionService = new PermissionService();

        private readonly ProcedureStageService ProcedureStageService = new ProcedureStageService();
        ...
        {
            var DocumentProcedureStageList = this.ProcedureStageService.GetAll();
            this.grdDocument.DataSource = DocumentProcedureStageList;
        }
        ...
        protected void grdDocument_DeleteCommand(object sender, GridCommandEventArgs e)
        {
            ...
            this.ProcedureStageService.Delete(disId);
