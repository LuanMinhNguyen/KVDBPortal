<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SystemDocEditForm.aspx.cs" Inherits="EDMs.Web.Controls.Library.SystemDocEditForm" %>
                    ...
                    <div>
                        ...
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem" runat="server" id="div3">
                            <telerik:RadComboBox ID="ddlParent" runat="server" Skin="Windows7" 
                                ...
                                <ItemTemplate>
                                    <div id="div1">
                                        <telerik:RadTreeView runat="server" ID="rtvSystemDoc" Skin="Windows7" OnClientNodeClicking="nodeClicking">
                                            <DataBindings>
