...
namespace EDMs.Web.Controls.Library
{
    ...
    /// Class customer
    /// </summary>
    public partial class TagTypeList : Page
    {
        /// <summary>
        /// The unread pattern.
        /// </summary>
        ...
        /// </summary>
        private readonly TagTypeService TagTypeService = new TagTypeService();
        ...
        protected void RadAjaxManager1_AjaxRequest(object sender, AjaxRequestEventArgs e)
        {
            if (e.Argument.Contains("Delete_"))
            {
                ...
                this.TagTypeService.Delete(docTypeId);
        ...
        /// The e.
        /// </param>
        protected void rtvTagType_OnNodeDataBound(object sender, RadTreeNodeEventArgs e)
        {
        ...
        private void RestoreExpandStateTreeView()
        {
            ...
            HttpCookie cookie = this.Request.Cookies["expandedNodesTagType"];
            if (cookie != null)
            {
                var expandedNodeValues = cookie.Value.Split('*');
                foreach (var nodeValue in expandedNodeValues)
                {
                    RadTreeNode expandedNode = this.rtvTagType.FindNodeByValue(HttpUtility.UrlDecode(nodeValue));
        ...
        private void LoadTagTypeTree()
        {
            var listTagType = this.TagTypeService.GetAll();

            this.rtvTagType.DataSource = listTagType;
            this.rtvTagType.DataFieldParentID = "ParentId";
            this.rtvTagType.DataTextField = "Name";
            this.rtvTagType.DataValueField = "ID";
            this.rtvTagType.DataFieldID = "ID";
            this.rtvTagType.DataBind();
