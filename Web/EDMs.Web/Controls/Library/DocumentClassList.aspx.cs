...
namespace EDMs.Web.Controls.Library
{
    ...
    /// Class customer
    /// </summary>
    public partial class DocumentClassList : Page
    {
        ...
        {
            this.grdDocument.DataSource = this._DocumentClassService.GetAll();
        ...
        protected void RadAjaxManager1_AjaxRequest(object sender, AjaxRequestEventArgs e)
        {
            ...
            }else if(e.Argument== "ExportTemplate")
            {
                ...
                var filename =  "DocumenClass_MasterListTemplate"+ DateTime.Now.ToString("ddmmyyy")+".xls";
        ...
        protected void grdDocument_DeleteCommand(object sender, GridCommandEventArgs e)
        {
            ...
            this._DocumentClassService.Delete(disId);
