...
namespace EDMs.Web.Controls.Library
{
    ...
    /// Class customer
    /// </summary>
    public partial class UnitList : Page
    {
        ...
        {
            this.grdDocument.DataSource = this._UnitService.GetAll();
        ...
        protected void RadAjaxManager1_AjaxRequest(object sender, AjaxRequestEventArgs e)
        {
            ...
            }else if(e.Argument== "ExportTemplate")
            {
                ...
                workbook.Open(filePath + @"Template\TemplateUnit.xls");
                var sheets = workbook.Worksheets;
                var readMeSheet = sheets[1];
                var dataSheet = sheets[0];

                var PlantList = this.areaService_.GetAll();
                ...
                var filename =  "Unit_MasterListTemplate"+ DateTime.Now.ToString("ddmmyyyy")+".xls";
        ...
        protected void grdDocument_DeleteCommand(object sender, GridCommandEventArgs e)
        {
            ...
            this.areaService_.Delete(disId);
