<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DepartmentEditForm.aspx.cs" Inherits="EDMs.Web.Controls.Library.DepartmentEditForm" %>
                ...
                <li style="width: 500px;">
                    <div>
                        ...
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem" runat="server" id="div1">
                            <asp:DropDownList ID="ddlLocation" runat="server" CssClass="min25Percent" Width="316px" style="max-width: 316px">
                                <Items>
