<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RevisionEditForm.aspx.cs" Inherits="EDMs.Web.Controls.Library.RevisionEditForm" %>
            ...
            <ul style="list-style-type: none">
                ...
                <li style="width: 500px;">
                    <div>
                        ...
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                            <asp:CheckBox runat="server" Text="First Revision" ID="cbFirstRevision"/>
                        </div>
                    </div>
                    <div style="clear: both; font-size: 0;"></div>
                </li>
