...
namespace EDMs.Web.Controls.Library
{
    ...
    /// Class customer
    /// </summary>
    public partial class DrawingCodeList : Page
    {
        ...
        protected void RadAjaxManager1_AjaxRequest(object sender, AjaxRequestEventArgs e)
        {
            ...
            {
                this.ExportDrawingCode();
            }
        }

        private void ExportDrawingCode()
        {
            ...
            var drawingList = this.drawingService.GetAll().ToList();
            ...
            foreach (var drawingObj in drawingList)
            {
                var dataRow = dtFull.NewRow();
                dataRow["ID"] = drawingObj.ID;
                dataRow["Code"] = drawingObj.Code;
                dataRow["Description"] = drawingObj.Description;
            ...
            dataSheet.Cells["C1"].PutValue("DRAWING CODE");
            var filename = "DrawingCode.xlsx";
        ...
        {
            var drawingList = this.drawingService.GetAll();
        ...
        protected void grdDocument_DeleteCommand(object sender, GridCommandEventArgs e)
        {
            ...
            var drawingId = Convert.ToInt32(item.GetDataKeyValue("ID").ToString());
            this.drawingService.Delete(drawingId);
