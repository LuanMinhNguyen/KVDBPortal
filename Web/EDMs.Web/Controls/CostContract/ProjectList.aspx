<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ProjectList.aspx.cs" Inherits="EDMs.Web.Controls.CostContract.ProjectList" EnableViewState="true" %>
                                ...
                                <telerik:RadGrid ID="grdDocument" runat="server" AllowPaging="True"
                                    ...
                                    <MasterTableView ClientDataKeyNames="ID" DataKeyNames="ID" Width="100%" TableLayout="Auto" CssClass="rgMasterTable">
                                        ...
                                        AllowFiltering="false">
                                            ...
                                            <telerik:GridTemplateColumn HeaderText="Auto Calculate Actual Progress" UniqueName="IsAuto" AllowFiltering="false">
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            ...
            function ShowEditForm(id) {
                ...
                owd.Show();
                owd.setUrl("ProjectEditForm.aspx?disId=" + id, "CustomerDialog");
            }
