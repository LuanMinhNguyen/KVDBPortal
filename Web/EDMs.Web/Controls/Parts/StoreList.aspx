<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="StoreList.aspx.cs" Inherits="EDMs.Web.Controls.Store.StoreList" %>
                ...
                <telerik:RadGrid ID="grdData" runat="server" AllowPaging="True"
                    ...
                    <MasterTableView Width="100%" TableLayout="Auto" CssClass="rgMasterTable" CommandItemDisplay="Top">
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn DataField="TenKho" HeaderText="Chi tiết" UniqueName="TenKho"
                                ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                <HeaderStyle HorizontalAlign="Center" Width="200" />
                                <ItemStyle HorizontalAlign="Left" />
                            </telerik:GridBoundColumn>

                            <telerik:GridBoundColumn DataField="Nhom" HeaderText="Nhóm" UniqueName="Nhom"
                                ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                <HeaderStyle HorizontalAlign="Center" Width="80" />
                                <ItemStyle HorizontalAlign="Left" />
                            </telerik:GridBoundColumn>
                            ...
                            <telerik:GridBoundColumn DataField="KhoCha" HeaderText="Kho cha" UniqueName="KhoCha"
                                ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                <HeaderStyle HorizontalAlign="Center" Width="70" />
                                <ItemStyle HorizontalAlign="Left" />
                            </telerik:GridBoundColumn>
