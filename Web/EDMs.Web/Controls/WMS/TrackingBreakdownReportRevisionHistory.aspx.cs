...
namespace EDMs.Web.Controls.WMS
{
    ...
    /// The customer edit form.
    /// </summary>
    public partial class TrackingBreakdownReportRevisionHistory : Page
    {
        private readonly TrackingBreakdownReportService mcService;

        private readonly TrackingBreakdownReportAttachFileService mcAttachFileService;


        /// <summary>
        /// Initializes a new instance of the <see cref="TrackingBreakdownReportRevisionHistory"/> class.
        /// </summary>
        public TrackingBreakdownReportRevisionHistory()
        {
            this.mcAttachFileService = new TrackingBreakdownReportAttachFileService();
            this.mcService = new TrackingBreakdownReportService();
        ...
        protected void grdDocument_OnNeedDataSource(object source, GridNeedDataSourceEventArgs e)
        {
            if(Request.QueryString["objId"] != null)
            {
                ...
                if (obj != null)
                {
                    var revList = this.mcService.GetAllBreakdownReportRev(obj.ParentId == null ? obj.ID : obj.ParentId.Value);
