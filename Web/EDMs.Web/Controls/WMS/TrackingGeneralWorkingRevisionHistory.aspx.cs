...
namespace EDMs.Web.Controls.WMS
{
    ...
    /// The customer edit form.
    /// </summary>
    public partial class TrackingGeneralWorkingRevisionHistory : Page
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackingGeneralWorkingRevisionHistory"/> class.
        /// </summary>
        public TrackingGeneralWorkingRevisionHistory()
        {
        ...
        protected void grdDocument_OnNeedDataSource(object source, GridNeedDataSourceEventArgs e)
        {
            if(Request.QueryString["objId"] != null)
            {
                ...
                if (obj != null)
                {
                    var revList = this.mcService.GetAllGeneralWorkingRev(obj.ParentId == null ? obj.ID : obj.ParentId.Value);
