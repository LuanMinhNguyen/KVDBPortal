...
namespace EDMs.Web.Controls.WMS
{
    ...
    /// The customer edit form.
    /// </summary>
    public partial class TrackingMOCRevisionHistory : Page
    {
        protected const string ServiceName = "EDMSFolderWatcher";

        private readonly TrackingMOCService mcService;

        private readonly TrackingMOCAttachFileService mcAttachFileService;


        /// <summary>
        /// Initializes a new instance of the <see cref="TrackingMOCRevisionHistory"/> class.
        /// </summary>
        public TrackingMOCRevisionHistory()
        {
            this.mcAttachFileService = new TrackingMOCAttachFileService();
            this.mcService = new TrackingMOCService();
        ...
        protected void grdDocument_OnNeedDataSource(object source, GridNeedDataSourceEventArgs e)
        {
            if(Request.QueryString["objId"] != null)
            {
                ...
                if (obj != null)
                {
                    var revList = this.mcService.GetAllMOCRev(obj.ParentId == null ? obj.ID : obj.ParentId.Value);
