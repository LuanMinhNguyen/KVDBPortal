...
namespace EDMs.Web.Controls.WMS
{
    ...
    /// The customer edit form.
    /// </summary>
    public partial class TrackingMorningCallRevisionHistory : Page
    {
        ...
        /// </summary>
        public TrackingMorningCallRevisionHistory()
        {
        ...
        protected void grdDocument_OnNeedDataSource(object source, GridNeedDataSourceEventArgs e)
        {
            if(Request.QueryString["objId"] != null)
            {
                ...
                if (obj != null)
                {
                    var revList = this.mcService.GetAllMCRev(obj.ParentId == null ? obj.ID : obj.ParentId.Value);
