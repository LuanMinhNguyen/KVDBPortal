...
namespace EDMs.Web.Controls.WMS
{
    ...
    /// The customer edit form.
    /// </summary>
    public partial class TrackingWCRRevisionHistory : Page
    {
        protected const string ServiceName = "EDMSFolderWatcher";

        private readonly TrackingWCRService mcService;

        private readonly TrackingWCRAttachFileService mcAttachFileService;


        /// <summary>
        /// Initializes a new instance of the <see cref="RevisionHistory"/> class.
        /// </summary>
        public TrackingWCRRevisionHistory()
        {
            this.mcAttachFileService = new TrackingWCRAttachFileService();
            this.mcService = new TrackingWCRService();
        ...
        protected void grdDocument_OnNeedDataSource(object source, GridNeedDataSourceEventArgs e)
        {
            if(Request.QueryString["objId"] != null)
            {
                ...
                if (obj != null)
                {
                    var revList = this.mcService.GetAllWCRRev(obj.ParentId == null ? obj.ID : obj.ParentId.Value);
