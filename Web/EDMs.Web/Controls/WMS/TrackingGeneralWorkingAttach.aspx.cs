...
namespace EDMs.Web.Controls.WMS
{
    ...
    /// The customer edit form.
    /// </summary>
    public partial class TrackingGeneralWorkingAttach : Page
    {
        private readonly TrackingGeneralWorkingAttachFileService trackingGeneralWorkingAttachFileService;
        ...
        /// </summary>
        public TrackingGeneralWorkingAttach()
        {
        ...
        protected void btnSaveAttachFile_Click(object sender, EventArgs e)
        {
            ...
            foreach (UploadedFile docFile in docuploader.UploadedFiles)
            {
                ...
                var attachFile = new TrackingGeneralWorkingAttachFile()
                {
                    ID = Guid.NewGuid(),
                    GeneralWorkingId = objId,
                ...
                this.trackingGeneralWorkingAttachFileService.Insert(attachFile);
            }
        ...
        protected void grdAttachFile_DeleteCommand(object sender, GridCommandEventArgs e)
        {
            ...
            this.trackingGeneralWorkingAttachFileService.Delete(objId);
            this.grdAttachFile.Rebind();
        }
        ...
        {
            var objId = new Guid(this.Request.QueryString["objId"]);
            var attachList = this.trackingGeneralWorkingAttachFileService.GetAllObjId(objId);
