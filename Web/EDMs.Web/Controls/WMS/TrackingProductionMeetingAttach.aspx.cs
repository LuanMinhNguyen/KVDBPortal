...
namespace EDMs.Web.Controls.WMS
{
    ...
    /// The customer edit form.
    /// </summary>
    public partial class TrackingProductionMeetingAttach : Page
    {
        private readonly TrackingProductionMeetingAttachFileService trackingProductionMeetingAttachFileService;
        ...
        /// </summary>
        public TrackingProductionMeetingAttach()
        {
            this.trackingProductionMeetingAttachFileService = new TrackingProductionMeetingAttachFileService();
        ...
        {
            this.divUploadControl.Visible = Convert.ToBoolean(this.IsUpdate.Value);
        ...
        protected void btnSaveAttachFile_Click(object sender, EventArgs e)
        {
            ...
            foreach (UploadedFile docFile in docuploader.UploadedFiles)
            {
                ...
                var attachFile = new TrackingProductionMeetingAttachFile()
                {
                    ID = Guid.NewGuid(),
                    ProductionMeetingId = objId,
                ...
                this.trackingProductionMeetingAttachFileService.Insert(attachFile);
            }
        ...
        protected void grdAttachFile_DeleteCommand(object sender, GridCommandEventArgs e)
        {
            ...
            this.trackingProductionMeetingAttachFileService.Delete(objId);
            this.grdAttachFile.Rebind();
        }
        ...
        {
            var objId = new Guid(this.Request.QueryString["objId"]);
            var attachList = this.trackingProductionMeetingAttachFileService.GetAllObjId(objId);
