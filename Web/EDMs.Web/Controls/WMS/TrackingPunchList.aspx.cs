...
namespace EDMs.Web.Controls.WMS
{
    ...
    /// Class customer
    /// </summary>
    public partial class TrackingPunchList : Page
    {
        private readonly TrackingPunchService trackingPunchService = new TrackingPunchService();
        ...
        protected void grdDocument_OnNeedDataSource(object source, GridNeedDataSourceEventArgs e)
        {
            if (this.ddlProject.SelectedItem!= null)
            {
                if (this.IsView.Value == "True")
                {
                    ...
                    var projectId = Convert.ToInt32(this.ddlProject.SelectedValue);
                    var objList = this.trackingPunchService.GetAllRevTrackingPunchOfProject(projectId,
                        txtSearchAllField.Text);
                    //switch (ddlStatus.SelectedValue)
                    //{
                    //    case "1":
                    //        objList = this.trackingPunchService.GetAllRevTrackingPunchOfProject(projectId, txtSearchAllField.Text)
                    ...
                    //        break;
                    //    case "2":
                    //        objList = this.trackingPunchService.GetAllTrackingPunchOfProject(projectId, txtSearchAllField.Text)
                    //                                    .Where(t => (txtDeadlineFrom.SelectedDate == null || t.Deadline >= txtDeadlineFrom.SelectedDate)
                    //                                            && (txtDeadlineTo.SelectedDate == null || t.Deadline < txtDeadlineTo.SelectedDate.Value.AddDays(1)))
                    //                                    .ToList();
                    //        break;
                    //    case "3":
                    //        objList = this.trackingPunchService.GetAllComingDueTrackingPunchOfProject(projectId, txtSearchAllField.Text)
                    //                                    .Where(t => (txtDeadlineFrom.SelectedDate == null || t.Deadline >= txtDeadlineFrom.SelectedDate)
                    //                                            && (txtDeadlineTo.SelectedDate == null || t.Deadline < txtDeadlineTo.SelectedDate.Value.AddDays(1)))
                    //                                    .ToList();
                    //        break;
                    //    case "4":
                    //        objList = this.trackingPunchService.GetAllOverDueTrackingPunchOfProject(projectId, txtSearchAllField.Text)
                    //                                    .Where(t => (txtDeadlineFrom.SelectedDate == null || t.Deadline >= txtDeadlineFrom.SelectedDate)
                    //                                            && (txtDeadlineTo.SelectedDate == null || t.Deadline < txtDeadlineTo.SelectedDate.Value.AddDays(1)))
                    //                                    .ToList();
                    //        break;
                    //    case "5":
                    //        objList = this.trackingPunchService.GetAllCompleteTrackingPunchOfProject(projectId, txtSearchAllField.Text)
                    //                                    .Where(t => (txtDeadlineFrom.SelectedDate == null || t.Deadline >= txtDeadlineFrom.SelectedDate)
                    //                                            && (txtDeadlineTo.SelectedDate == null || t.Deadline < txtDeadlineTo.SelectedDate.Value.AddDays(1)))
                    //                                    .ToList();
                    //        break;
                    //    case "6":
                    //        objList = this.trackingPunchService.GetAllInCompleteTrackingPunchOfProject(projectId, txtSearchAllField.Text)
                    //                                    .Where(t => (txtDeadlineFrom.SelectedDate == null || t.Deadline >= txtDeadlineFrom.SelectedDate)
                    //                                            && (txtDeadlineTo.SelectedDate == null || t.Deadline < txtDeadlineTo.SelectedDate.Value.AddDays(1)))
                    //                                    .ToList();
                    //        break;
                ...
                {
                    this.grdDocument.DataSource = new List<TrackingPunch>();
                }
            }
            else
            {
        ...
        protected void grdDocument_DeleteCommand(object sender, GridCommandEventArgs e)
        {
            ...
            this.trackingPunchService.Delete(objId);
