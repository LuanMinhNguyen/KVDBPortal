...
namespace EDMs.Web.Controls.WMS
{
    ...
    /// The customer edit form.
    /// </summary>
    public partial class TrackingPunchAttach : Page
    {
        private readonly TrackingPunchAttachFileService trackingPunchAttachFileService;
        ...
        protected void btnSaveAttachFile_Click(object sender, EventArgs e)
        {
            ...
            foreach (UploadedFile docFile in docuploader.UploadedFiles)
            {
                ...
                var attachFile = new TrackingPunchAttachFile()
                {
                    ID = Guid.NewGuid(),
                    PunchId = objId,
                ...
                this.trackingPunchAttachFileService.Insert(attachFile);
            }
        ...
        protected void grdAttachFile_DeleteCommand(object sender, GridCommandEventArgs e)
        {
            ...
            this.trackingPunchAttachFileService.Delete(objId);
            this.grdAttachFile.Rebind();
        }
        ...
        {
            var objId = new Guid(this.Request.QueryString["objId"]);
            var attachList = this.trackingPunchAttachFileService.GetAllObjId(objId);
