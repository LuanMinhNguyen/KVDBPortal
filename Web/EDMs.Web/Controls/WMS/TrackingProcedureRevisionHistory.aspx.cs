...
namespace EDMs.Web.Controls.WMS
{
    ...
    /// The customer edit form.
    /// </summary>
    public partial class TrackingProcedureRevisionHistory : Page
    {
        protected const string ServiceName = "EDMSFolderWatcher";

        private readonly TrackingProcedureService mcService;

        private readonly TrackingProcedureAttachFileService mcAttachFileService;


        /// <summary>
        /// Initializes a new instance of the <see cref="TrackingProcedureRevisionHistory"/> class.
        /// </summary>
        public TrackingProcedureRevisionHistory()
        {
            this.mcAttachFileService = new TrackingProcedureAttachFileService();
            this.mcService = new TrackingProcedureService();
        ...
        protected void grdDocument_OnNeedDataSource(object source, GridNeedDataSourceEventArgs e)
        {
            if(Request.QueryString["objId"] != null)
            {
                ...
                if (obj != null)
                {
                    var revList = this.mcService.GetAllProcedureRev(obj.ParentId == null ? obj.ID : obj.ParentId.Value);
