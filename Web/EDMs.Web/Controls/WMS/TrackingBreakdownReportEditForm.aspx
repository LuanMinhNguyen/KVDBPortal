<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TrackingBreakdownReportEditForm.aspx.cs" Inherits="EDMs.Web.Controls.WMS.TrackingBreakdownReportEditForm" %>
            ...
            <ul style="list-style-type: none">
                ...
                <li style="width: 750px;">
                    <div>
                        ...
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                            <asp:TextBox ID="txtComment" runat="server" Style="width: 500px;" CssClass="min25Percent" TextMode="MultiLine" Rows="3"/>
                        </div>
                    </div>
                    <div style="clear: both; font-size: 0;"></div>
                </li>
