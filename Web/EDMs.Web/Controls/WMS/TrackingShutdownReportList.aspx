<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TrackingShutdownReportList.aspx.cs" Inherits="EDMs.Web.Controls.WMS.TrackingShutdownReportList" EnableViewState="true" %>
    ...
    <div style="width: 98%; padding-top: 10px; padding-left: 5px">
        ...
        <telerik:RadTreeView ID="rtvDiscipline" runat="server" 
            ...
            <Nodes>
                ...
                <telerik:RadTreeNode runat="server" Text="Tracking List Of Shutdown Report" ImageUrl="~/Images/trackinglist.png" Value="ShutdownReport" NavigateUrl="TrackingShutdownReportList.aspx" Selected="True"/>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
            ...
            <telerik:RadToolBar ID="CustomerMenu" runat="server" Width="100%" OnClientButtonClicking="OnClientButtonClicking">
                <Items>
                    <telerik:RadToolBarDropDown runat="server" Text="New" ImageUrl="~/Images/addNew.png" Visible="False">
                        <Buttons>
                            <telerik:RadToolBarButton runat="server" Text="Shutdown Report" Value="1" ImageUrl="~/Images/trackinglist.png"/>
                        </Buttons>
                        ...
                        <ItemTemplate>
                            ...
                            <asp:DropDownList ID="ddlStatus" runat="server" CssClass="min25Percent" Width="200px" style="max-width: 316px"
                                ...
                                <Items>
                                    ...
                                    <%--<asp:ListItem Value="2" Text="All Latest Shutdown Report" Selected="True"></asp:ListItem>--%>
                                    <asp:ListItem Value="3" Text="Coming Due Shutdown Report" style="background-color: yellow"></asp:ListItem>
    ...
    <telerik:RadWindowManager ID="RadWindowManager1" runat="server" EnableShadow="true" >
        <Windows>
            <telerik:RadWindow ID="CreateNewWD" runat="server" Title="Create New Shutdown Report"
                VisibleStatusbar="False" Height="700" Width="850" 
                Left="150px" ReloadOnShow="true" ShowContentDuringLoad="false" Modal="true">
            </telerik:RadWindow>
            
            <telerik:RadWindow ID="UpdateWD" runat="server" Title="Update Shutdown Report"
                VisibleStatusbar="False" Height="700" Width="850" 
                Left="150px" ReloadOnShow="true" ShowContentDuringLoad="false" Modal="true">
            </telerik:RadWindow>
            ...
            <telerik:RadWindow ID="RevisionHistory" runat="server" Title="Shutdown Report Revision History"
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            ...
            function ShowEditForm(id) {
                ...
                owd.Show();
                owd.setUrl("TrackingShutdownReportEditForm.aspx?objId=" + id + "&projId=" + projectId, "UpdateWD");
            }
            ...
            function ShowAttachment(id) {
                ...
                owd.Show();
                owd.setUrl("TrackingShutdownReportAttach.aspx?objId=" + id, "AttachDoc");
            }
            ...
            function ShowHistory(id) {
                ...
                owd.Show();
                owd.maximize();
                owd.setUrl("TrackingShutdownReportRevisionHistory.aspx?objId=" + id, "RevisionHistory");
            }
            ...
            function OnClientButtonClicking(sender, args) {
                ...
                if (strText == "Shutdown Report") {
                    ...
                    owd.setSize(850, document.documentElement.offsetHeight);
                    owd.Show();
                    owd.setUrl("TrackingShutdownReportEditForm.aspx?projId=" + projectId, "CreateNewWD");
                }
            }
            ...
            function gridMenuClicking(sender, args) {
                ...
                case "MRDetail":
                    ...
                    owd.setSize(850, document.documentElement.offsetHeight);
                    owd.Show();
                    owd.setUrl("TrackingShutdownReportDetail.aspx?objId=" + docId, "ShutdownReportDetailDialog");
                    break;
                case "WFHistory":
                    var owd = $find("<%=WFProcessHistory.ClientID %>");
                    owd.Show();
                    owd.maximize();
                    owd.setUrl("../../Controls/Workflow/WorkflowProcessHistory.aspx?objId=" + docId + "&objType=ShutdownReport",
                        "WFProcessHistory");
                    break;
                case "AttachDocument":
                    var owd = $find("<%=AttachDoc.ClientID %>");
                    ...
                    owd.setUrl("TrackingShutdownReportAttach.aspx?objId=" + docId, "AttachDoc");
                    break;
                case "EditProperties":
                    var projectId = document.getElementById("<%= lblProjectId.ClientID %>").value;
                    var owd = $find("<%=CustomerDialog.ClientID %>");
                    owd.setSize(850, document.documentElement.offsetHeight);
                    owd.Show();
                    owd.setUrl("TrackingShutdownReportEditForm.aspx?objId=" + docId + "&projId=" + projectId,
                        "CustomerDialog");
                    break;
