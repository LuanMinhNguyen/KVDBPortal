...
namespace EDMs.Web.Controls.WMS
{
    ...
    /// The customer edit form.
    /// </summary>
    public partial class TrackingSailRevisionHistory : Page
    {
        protected const string ServiceName = "EDMSFolderWatcher";

        private readonly TrackingSailService mcService;

        private readonly TrackingSailAttachFileService mcAttachFileService;


        /// <summary>
        /// Initializes a new instance of the <see cref="TrackingSailRevisionHistory"/> class.
        /// </summary>
        public TrackingSailRevisionHistory()
        {
            this.mcAttachFileService = new TrackingSailAttachFileService();
            this.mcService = new TrackingSailService();
        ...
        protected void grdDocument_OnNeedDataSource(object source, GridNeedDataSourceEventArgs e)
        {
            if(Request.QueryString["objId"] != null)
            {
                ...
                if (obj != null)
                {
                    var revList = this.mcService.GetAllSailRev(obj.ParentId == null ? obj.ID : obj.ParentId.Value);
