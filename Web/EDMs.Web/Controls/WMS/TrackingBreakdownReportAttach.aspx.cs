...
namespace EDMs.Web.Controls.WMS
{
    ...
    /// The customer edit form.
    /// </summary>
    public partial class TrackingBreakdownReportAttach : Page
    {
        private readonly TrackingBreakdownReportAttachFileService trackingBreakdownReportAttachFileService;
        ...
        /// </summary>
        public TrackingBreakdownReportAttach()
        {
        ...
        protected void btnSaveAttachFile_Click(object sender, EventArgs e)
        {
            ...
            foreach (UploadedFile docFile in docuploader.UploadedFiles)
            {
                ...
                this.trackingBreakdownReportAttachFileService.Insert(attachFile);
            }
        ...
        protected void grdAttachFile_DeleteCommand(object sender, GridCommandEventArgs e)
        {
            ...
            this.trackingBreakdownReportAttachFileService.Delete(objId);
            this.grdAttachFile.Rebind();
        }
        ...
        {
            var objId = new Guid(this.Request.QueryString["objId"]);
            var attachList = this.trackingBreakdownReportAttachFileService.GetAllObjId(objId);
