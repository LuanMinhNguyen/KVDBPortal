<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="IncommingTrans.aspx.cs" Inherits="EDMs.Web.Controls.Report.IncommingTrans" EnableViewState="true" %>
                        ...
                        <telerik:RadPane ID="Radpane6" runat="server" Scrolling="None">
                            <telerik:RadGrid  ID="grdDocument" runat="server" AllowPaging="True"
                                ...
                                <MasterTableView AllowMultiColumnSorting="false"
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Revisoion" DataField="DocRev" UniqueName="DocRev"
