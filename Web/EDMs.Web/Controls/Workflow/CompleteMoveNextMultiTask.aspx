<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompleteMoveNextMultiTask.aspx.cs" Inherits="EDMs.Web.Controls.Workflow.CompleteMoveNextMultiTask" %>
    ...
    <form id="form1" runat="server">
        ...
        <div style="width: 100%" runat="server" ID="divContent">
            <ul style="list-style-type: none">
                ...
                <li style="width: 500px;" runat="server" ID="DurationControl">
                    <div>
                        <label style="width: 75px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
                ...
                <li style="width: 600px; display: none" runat="server" ID="DevCommentCode">
                    <div>
                        <label style="width: 75px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
