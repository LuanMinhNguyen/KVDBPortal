...
namespace EDMs.Web.Controls.PPM
{
    ...
    /// Class customer
    /// </summary>
    public partial class WOPartPlanList : Page
    {
        /// <summary>
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                var txtStartDate = this.ViewToolBar.Items[4].FindControl("txtStartDate") as RadDatePicker;
                var txtEndDate = this.ViewToolBar.Items[4].FindControl("txtEndDate") as RadDatePicker;
        ...
        protected void grdData_OnNeedDataSource(object sender, GridNeedDataSourceEventArgs e)
        {
            ...
            DataSet ds;
            var objectList = new List<WOPartPlanDto>();
            ds = this.eamService.GetDataSet("get_WO_Plan_Parts_List_r2", new[] { userParam, startDateParam, endDateParam});
            if (ds != null)
            {
                objectList = this.eamService.CreateListFromTable<WOPartPlanDto>(ds.Tables[0]);
            }
