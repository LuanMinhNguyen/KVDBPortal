<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="WOResultDetail.aspx.cs" Inherits="EDMs.Web.WOResultDetail" EnableViewState="true" %>
                ...
                <telerik:RadToolBar RenderMode="Lightweight" runat="server" ID="ToolBarWO" EnableRoundedCorners="true" EnableShadows="true" Skin="MetroTouch" Height="40">
                    <Items>
                        <telerik:RadToolBarButton Text="Left" Group="Align">
                            <ItemTemplate>
                                <span style=" color: dodgerblue; font-size: 16px; font-weight: normal; font-family: helvetica, arial, verdana, sans-serif; ">Kết quả Phiếu CV: </span>
        ...
        <script type="text/javascript">
            ...
            function ViewToolBar_OnClientButtonClicking(sender, args) {
                ...
                if (strValue == "ExpandLeft") {
                    ...
                    window.location.href = "WOResultList.aspx";
                }
            }
        </script>
