...
namespace EDMs.Web.Controls.Security
{
    ...
    public partial class ExportHistory : Page
    {
        ...
        private readonly MaterialRequisitionCommentService mrComment = new MaterialRequisitionCommentService();
        ...
        private readonly ExportDataChangeHistoryService exportDataChangeHistoryService = new ExportDataChangeHistoryService();
        ...
        {
            var dataList = this.exportDataChangeHistoryService.GetAll();
        ...
        private void LoadSystemPanel()
        {
            ...
            if (permissions.Any())
            {
                ...
                foreach (RadPanelItem item in this.radPbSystem.Items[0].Items)
                {
                    ...
                    if (item.Text == "Export Data Changed History")
                    {
                        item.Selected = true;
                    }
                }
