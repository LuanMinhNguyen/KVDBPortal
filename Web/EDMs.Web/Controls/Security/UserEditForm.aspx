        ...
        <div style="width: 100%" runat="server" ID="divContent">
            ...
            <li style="width: 600px; display: none">
                <div>
                    ...
                    <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                        <asp:RadioButton runat="server" ID="cbYTHC" Text="Y tá hành chính" GroupName="YT"/>
                        <asp:RadioButton runat="server" ID="cbYTP" Text="Y tá phó" GroupName="YT"/>
                    </div>
                </div>
                <div style="clear: both; font-size: 0;"></div>
            </li>
            ...
            <li style="width: 600px; display: none">
                <div>
                    ...
                    <div style="float: left; padding-top: 5px;" >
                        <asp:DropDownList ID="ddlYTP" runat="server" CssClass="min25Percent qlcbFormRequired" Style="width: 315px; max-width: 315px" Visible="False"/>
                        
                        <telerik:RadComboBox RenderMode="Lightweight" ID="ddlMYTP" runat="server" CheckBoxes="true" 
