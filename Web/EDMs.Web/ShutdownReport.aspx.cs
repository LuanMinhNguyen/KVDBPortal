...
namespace EDMs.Web
{
    ...
    /// Class customer
    /// </summary>
    public partial class ShutdownReport : Page
    {
        ...
        private readonly TrackingShutdownReportService ShutdownReportService = new TrackingShutdownReportService();
                ...
                if (this.IsView.Value == "True")
                {
                    ...
                    switch (ddlStatus.SelectedValue)
                    {
                        case "1":
                            ...
                            //            ? this.ShutdownReportService.GetAll(projectId, txtSearchAllField.Text.Trim()).Where(t => t.DeparmentId == deptId).ToList()
                            //            : this.ShutdownReportService.GetAll(projectId, txtSearchAllField.Text.Trim());

                            objList = this.ShutdownReportService.GetAll(projectId, txtSearchAllField.Text.Trim());
                            break;
                        case "4":
                            var overDueTask =
                                this.objAssignedUserService.GetAllOverDueTask("Shutdown Report")
                                    .Select(t => t.ObjectID)
                                    .ToList();
                            //objList = this.rtvDiscipline.SelectedNode != null
                        ...
                        case "5":
                            ...
                            objList = this.ShutdownReportService.GetAllCompletedShutdownReport(projectId,
                        ...
                        case "6":
                            ...
                            objList = this.ShutdownReportService.GetAllIncompleteShutdownReport(projectId,
                                txtSearchAllField.Text.Trim());
                            break;
                        ...
                        case "7":
                            ...
                            objList = this.ShutdownReportService.GetAllCompletedShutdownReportWaitingPrint(projectId,
                                txtSearchAllField.Text.Trim());
                            break;
                    }
