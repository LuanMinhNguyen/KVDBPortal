...
namespace EDMs.Web
{
    ...
    /// Class customer
    /// </summary>
    public partial class EAM_WOCompletedList : Page
    {
        /// <summary>
        ...
        private void GetWODataList()
        {
            ...
            DataSet ds;
            var WOList = new List<WOCompletedDto>();
            ds = this.eamService.GetDataSet("get_WO_Completed_List", new[] { userParam });
            if (ds != null)
            {
                WOList = this.eamService.CreateListFromTable<WOCompletedDto>(ds.Tables[0]);
        ...
        {
            var WOList = Session["WOList"] as List<WOCompletedDto>;
            this.BindWOData(WOList);
            
        }

        private void BindWOData(List<WOCompletedDto> WOList)
        {
        ...
        private void FillWODetail(WOCompletedDto item)
        {
