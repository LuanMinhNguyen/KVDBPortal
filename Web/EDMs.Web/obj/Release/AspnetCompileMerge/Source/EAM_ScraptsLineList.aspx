<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EAM_ScraptsLineList.aspx.cs" Inherits="EDMs.Web.EAM_ScraptsLineList" EnableViewState="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <style type="text/css">
        ...
        #ctl00_ContentPlaceHolder2_ctl00_ContentPlaceHolder2_grdScraptsLinePanel {
            height: 100% !important;
        }

        #ctl00_ContentPlaceHolder2_grdScraptsLine_GridData {
            height: 100% !important;
        }
                ...
                <telerik:RadToolBar RenderMode="Lightweight" runat="server" ID="ToolBarWO" EnableRoundedCorners="true" EnableShadows="true" Skin="MetroTouch" Height="40">
                    <Items>
                        <telerik:RadToolBarButton Text="Left" Group="Align">
                            <ItemTemplate>
                                <span style="color: dodgerblue;font-size: 16px;font-weight: normal;font-family: helvetica, arial, verdana, sans-serif;">Danh mục trả hàng phế liệu 
                                </span>
