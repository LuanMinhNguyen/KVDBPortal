<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DQRETransmittalFromToDoList.aspx.cs" Inherits="EDMs.Web.Controls.Document.DQRETransmittalFromToDoList" %>
            ...
            <telerik:RadGrid AllowCustomPaging="False" AllowPaging="False" AllowSorting="True" 
                ...
                <MasterTableView AllowMultiColumnSorting="false"
                    ...
                    <telerik:GridTemplateColumn HeaderText="Revision" UniqueName="Revision"
                        ...
                        <telerik:GridTemplateColumn HeaderText="Original Document No." UniqueName="OriginalDocumentNumber" DataField="OriginalDocumentNumber"
                        ShowFilterIcon="False" FilterControlWidth="97%" 
                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                        <HeaderStyle HorizontalAlign="Center" Width="160" />
                        <ItemStyle HorizontalAlign="Left" Width="160" />
