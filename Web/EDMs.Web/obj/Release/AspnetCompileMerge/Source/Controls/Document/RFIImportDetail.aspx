<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RFIImportDetail.aspx.cs" Inherits="EDMs.Web.Controls.Document.RFIImportDetail" %>
    ...
    <form id="form1" runat="server">
        ...
        <div style="width: 100%">
            <ul style="list-style-type: none">
                <li style="width: 350px;" Runat="server" ID="UploadControl">
                    <div>
         ...
         <div style="width: 100%">
            <ul style="list-style-type: none">
                <li style="width: 350px; padding-top: 10px; padding-bottom: 3px; text-align: center">
                    <telerik:RadButton ID="btnSave" runat="server" Text="Save" OnClick="btnSave_Click" Width="70px" style="text-align: center" SingleClick="true" SingleClickText="Processing..."
>
