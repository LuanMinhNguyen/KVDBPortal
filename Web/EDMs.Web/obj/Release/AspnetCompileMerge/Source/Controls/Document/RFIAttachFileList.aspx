<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RFIAttachFileList.aspx.cs" Inherits="EDMs.Web.Controls.Document.RFIAttachFileList" %>
        ...
        <div style="width: 100%">
            <ul style="list-style-type: none">
                ...
                <li style="width: 100%; text-align: center">
                    <div>
                        <label style="width: 270px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
                            <span style="color: #2E5689; text-align: right; ">
                            </span>
                        </label>
                         <div style="float: left; padding-top: 5px; ">
                   <telerik:RadButton ID="btnSave" runat="server" Text="Save" OnClick="btnSave_Click" Width="70px" style="text-align: center; float:left;">
                        <Icon PrimaryIconUrl="../../Images/save.png" PrimaryIconLeft="4" PrimaryIconTop="4" PrimaryIconWidth="16" PrimaryIconHeight="16"></Icon>  </telerik:RadButton> </div>
                    <div style="clear: both; font-size: 0;"></div></div>
                </li>
            </ul>
        </div>
