<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContractorTransmittalAttachChangeRequestFileEditForm.aspx.cs" Inherits="EDMs.Web.Controls.Document.ContractorTransmittalAttachChangeRequestFileEditForm" %>
            ...
            <ul style="list-style-type: none">
                ...
                <li style="width: 600px;">
                    <div>
                        ...
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                            <asp:DropDownList ID="ddlChangeRequestType" runat="server" CssClass="min25Percent" Width="416px" Enabled="False"/>
                        </div>
                    </div>
                    <div style="clear: both; font-size: 0;"></div>
                </li>
