<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PECC2TransETRMAttach.aspx.cs" Inherits="EDMs.Web.Controls.Document.PECC2TransETRMAttach" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div  runat="server" id="divContractorTransAttachFile">
        <dl class="accordion">
            <dt style="width: 100%;">
                <span>CONTRACTOR'S TRANSMITTAL ATTACH FILES</span>
            </dt>
        </dl>

        <telerik:RadGrid ID="grdContractorTransAttachFile" runat="server" AllowPaging="False"
            AutoGenerateColumns="False" CellPadding="0" CellSpacing="0"
            GridLines="None" Skin="Windows7" Height="220"
            OnNeedDataSource="grdContractorTransAttachFile_OnNeedDataSource" 
        ...
        <dl class="accordion">
            <dt style="width: 100%;">
                <span>PECC2'S TRANSMITTAL ATTACH FILES</span>
            </dt>
        </dl>
            ...
            <ul style="list-style-type: none">
                ...
                <li style="width: 100%;">
                    <div>
                        ...
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                           <asp:RadioButton runat="server" GroupName="AttachType" ID="cbETRM"
                                 Text="Transmittal Cover Sheet"  Checked="True"/><br/>
                            <asp:RadioButton runat="server" GroupName="AttachType" ID="cbCRS" Text="CRS Response File" /><br/>
                            <asp:RadioButton runat="server" GroupName="AttachType" ID="cbOther" Text="Other File" />
                        </div>
                    </div>
                    <div style="clear: both; font-size: 0;"></div>
                </li>
        ...
        <telerik:RadScriptBlock runat="server">
            <script type="text/javascript">
                ...
                function ConfirmReplaceFileeTRM() {
                    ...
                    if (document.getElementById("IsHasAttachFileeTRM").value == "true" && radios == true) {
