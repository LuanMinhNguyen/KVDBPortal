<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContractorEditForm.aspx.cs" Inherits="EDMs.Web.Controls.Scope.ContractorEditForm" %>
        ...
        <div style="width: 100%" runat="server" ID="divContent">
            <ul style="list-style-type: none">
                ...
                <li style="width: 500px;">
                    <div>
                        <label style="width: 125px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
                            <span style="color: #2E5689; text-align: right; ">Contractor Type
                            </span>
                        </label>
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                            <asp:DropDownList ID="ddlType" runat="server" CssClass="min25Percent qlcbFormRequired" Width="315px">
                                <Items>
                                    <asp:ListItem Value="1" Text="Design Contractor"></asp:ListItem>
                                    <asp:ListItem Value="2" Text="Review Contractor"></asp:ListItem>
                                    <asp:ListItem Value="4" Text="Internal Review"></asp:ListItem>
                                    <asp:ListItem Value="3" Text="International Certification Contractor"></asp:ListItem>
