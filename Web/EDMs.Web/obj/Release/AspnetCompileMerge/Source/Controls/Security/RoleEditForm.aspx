<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoleEditForm.aspx.cs" Inherits="EDMs.Web.Controls.Security.RoleEditForm" %>
    ...
    <form id="frmRoleEdit" runat="server">
        ...
        <div style="width: 100%" runat="server" ID="divContent">
            <ul style="list-style-type: none">
                 ...
                 <li style="width: 500px;" runat="server" ID="IndexContractor">
                    <div>
