<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ImportHistory.aspx.cs" Inherits="EDMs.Web.Controls.Security.ImportHistory" EnableViewState="true" %>
                     ...
                     <telerik:RadSplitter ID="Radsplitter10" runat="server" Orientation="Vertical">
                         <telerik:RadPane ID="Radpane6" runat="server" Scrolling="None">
                                <telerik:RadGrid ID="grdDocument" runat="server" AllowPaging="True"
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Import Data File Complete" UniqueName="IsComplete" AllowFiltering="False">
