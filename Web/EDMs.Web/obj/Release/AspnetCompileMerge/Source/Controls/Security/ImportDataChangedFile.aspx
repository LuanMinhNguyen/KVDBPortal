<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ImportDataChangedFile.aspx.cs" Inherits="EDMs.Web.Controls.Security.ImportDataChangedFile" %>
            ...
            <ul style="list-style-type: none">
                <li style="width: 600px;" Runat="server" ID="UploadControl">
                    <div>
                        <label style="width: 140px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
                            <span style="color: #2E5689; text-align: right; ">Upload Data Changed File
                            </span>
                        </label>
                        <div style="float: left; padding-top: 5px; " class="qlcbFormItem">
                            <telerik:RadAsyncUpload runat="server" ID="docuploader"
                                ...
                                EnableInlineProgress="true" Width="400px"
                ...
                <li style="width: 600px;">
                    <div>
                        ...
                        <div style="float: left; padding-top: 5px; " class="qlcbFormItem">
                            <asp:CheckBox ID="cbCheckValidFile" runat="server" Checked="true" Text="Check Data Changed File is valid?"/>
                        </div>
                    </div>
                    <div style="clear: both; font-size: 0;"></div>
                </li>
                
                <li style="width: 600px;" Runat="server" ID="blockError" Visible="False">
                    <div>
                        <label style="width: 140px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
                        ...
                        <div style="float: left; padding-top: 5px; " class="qlcbFormItem">
                            <asp:Label runat="server" ID="lblError" Width="350px"></asp:Label>
                        </div>
                    </div>
                    <div style="clear: both; font-size: 0;"></div>
                </li>
