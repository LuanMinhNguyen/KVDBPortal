<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ConfigDocPropertiesView.aspx.cs" Inherits="EDMs.Web.Controls.Security.ConfigDocPropertiesView" EnableViewState="true" %>
        ...
        <span>Config document properties view</span>
                               ...
                               <div style="width: 100%" runat="server" ID="divContent">
                                    <ul style="list-style-type: none">
                                        ...
                                        <li style="width: 600px;" runat="server" ID="divDepartment">
                                            <div>
                                                <label style="width: 150px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
                                        ...
                                        <li style="width: 600px;">
                                            <div>
                                                <label style="width: 150px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
                                                    <span style="color: #2E5689; text-align: right; ">Document properties
                                                    </span>
                                                </label>
                                                <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
