<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TrackingProcedureList.aspx.cs" Inherits="EDMs.Web.Controls.WMS.TrackingProcedureList" EnableViewState="true" %>
    ...
    <div style="width: 98%; padding-top: 10px; padding-left: 5px">
        ...
        <telerik:RadTreeView ID="rtvDiscipline" runat="server" 
            ...
            <Nodes>
                ...
                <telerik:RadTreeNode runat="server" Text="Tracking List Of Procedure" ImageUrl="~/Images/trackinglist.png" Value="Procedure" NavigateUrl="TrackingProcedureList.aspx" Selected="True"/>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
            ...
            <telerik:RadToolBar ID="CustomerMenu" runat="server" Width="100%" OnClientButtonClicking="OnClientButtonClicking">
                <Items>
                    <telerik:RadToolBarDropDown runat="server" Text="New" ImageUrl="~/Images/addNew.png">
                        <Buttons>
                            <telerik:RadToolBarButton runat="server" Text="Procedure" Value="1" ImageUrl="~/Images/trackinglist.png"/>
                        </Buttons>
                    ...
                    <telerik:RadToolBarButton runat="server" Value="ShowAll">
                        <ItemTemplate>
                            ...
                            <asp:DropDownList ID="ddlStatus" runat="server" CssClass="min25Percent" Width="200px" style="max-width: 316px"
                                ...
                                <Items>
                                    <asp:ListItem Value="1" Text="All Procedure"></asp:ListItem>
                                    <asp:ListItem Value="2" Text="All Latest Procedure" Selected="True"></asp:ListItem>
                                    <asp:ListItem Value="3" Text="Coming Due Procedure" style="background-color: yellow"></asp:ListItem>
                                    <asp:ListItem Value="4" Text="Overdue Procedure" style="background-color: red"></asp:ListItem>
                                    <asp:ListItem Value="5" Text="Completed Procedure" style="background-color: greenyellow"></asp:ListItem>
                                    <asp:ListItem Value="6" Text="Incompleted Procedure" style="background-color: coral"></asp:ListItem>
                                </Items>
                            </asp:DropDownList>&nbsp;&nbsp;|&nbsp;&nbsp;
                            <b>Deadline</b> From 
                                    ...
                                    <MasterTableView ClientDataKeyNames="ID" DataKeyNames="ID" Width="100%" TableLayout="Auto" CssClass="rgMasterTable" CommandItemDisplay="Top" EditMode="InPlace">
                                        <GroupByExpressions>
                                            <telerik:GridGroupByExpression>
                                                <SelectFields>
                                                    <telerik:GridGroupByField FieldAlias="TypeName" HeaderText="Procedure Type" FieldName="TypeName" FormatString="{0:D}"
                                        ...
                                        <Columns>
                                            ...
                                            <telerik:GridTemplateColumn  DataField="Checker" HeaderText="Checker Name" UniqueName="Checker" 
                                                AllowFiltering="false">
                                                <HeaderStyle HorizontalAlign="Center" Width="200" />
                                                <ItemStyle HorizontalAlign="Left"  />
                                                <ItemTemplate>
    ...
    <telerik:RadWindowManager ID="RadWindowManager1" runat="server" EnableShadow="true" >
        <Windows>
            <telerik:RadWindow ID="CreateNewWD" runat="server" Title="Create New Procedure"
                VisibleStatusbar="False" Height="700" Width="900" 
                Left="150px" ReloadOnShow="true" ShowContentDuringLoad="false" Modal="true">
            </telerik:RadWindow>
            
            <telerik:RadWindow ID="UpdateWD" runat="server" Title="Update Procedure"
                VisibleStatusbar="False" Height="700" Width="900" 
                Left="150px" ReloadOnShow="true" ShowContentDuringLoad="false" Modal="true">
            </telerik:RadWindow>
            ...
            <telerik:RadWindow ID="RevisionHistory" runat="server" Title="Procedure Revision History"
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            ...
            function ShowEditForm(id) {
                ...
                owd.Show();
                owd.setUrl("TrackingProcedureEditForm.aspx?objId=" + id + "&projId=" + projectId, "UpdateWD");
            }
            ...
            function ShowAttachment(id) {
                ...
                owd.Show();
                owd.setUrl("TrackingProcedureAttach.aspx?objId=" + id, "AttachDoc");
            }
            ...
            function ShowHistory(id) {
                ...
                owd.Show();
                owd.maximize();
                owd.setUrl("TrackingProcedureRevisionHistory.aspx?objId=" + id, "RevisionHistory");
            }
            ...
            function OnClientButtonClicking(sender, args) {
                ...
                if (strText == "Procedure") {
                    var projectId = document.getElementById("<%= lblProjectId.ClientID %>").value;
                    var owd = $find("<%=CreateNewWD.ClientID %>");
                    owd.setSize(950, document.documentElement.offsetHeight);
                    owd.Show();
                    owd.setUrl("TrackingProcedureEditForm.aspx?projId=" + projectId, "CreateNewWD");
                }
            }
