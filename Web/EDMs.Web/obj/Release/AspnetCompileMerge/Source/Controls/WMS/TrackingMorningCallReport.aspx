<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TrackingMorningCallReport.aspx.cs" Inherits="EDMs.Web.Controls.WMS.TrackingMorningCallReport" %>
                    ...
                    <HeaderStyle Font-Bold="True" HorizontalAlign="Center" VerticalAlign="Middle" />
                        ...
                        <Columns>
                            ...
                            <telerik:GridDateTimeColumn HeaderText="Date Raised" UniqueName="DateRaised" DataField="DateRaised"
                                        DataFormatString="{0:dd/MM/yyyy}" FilterControlWidth="100" AutoPostBackOnFilter="true">
                                    <HeaderStyle HorizontalAlign="Center" Width="130" />
                                    <ItemStyle HorizontalAlign="Center"/>
                                </telerik:GridDateTimeColumn>

                                <telerik:GridTemplateColumn DataField="EquipmentName"  UniqueName="EquipmentName" HeaderText="Names of Equipment/System/Matter"
                                    ...
                                    <ItemStyle HorizontalAlign="Left"/>
                                    <ItemTemplate>
                                        <%# Eval("EquipmentName").ToString().Replace(Environment.NewLine, "<br/>") %>
                                    </ItemTemplate>
                                </telerik:GridTemplateColumn>
                                ...
                                <telerik:GridTemplateColumn  DataField="ActionPlanDescription" HeaderText="Description of Action Plan" UniqueName="ActionPlanDescription" 
                                    ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" ColumnGroupName="ActionPlan">
                            ...
                            <telerik:GridBoundColumn DataField="DeadlineHistory" HeaderText="Deadline History" UniqueName="DeadlineHistory" 
                                    ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                    <HeaderStyle HorizontalAlign="Center" Width="80"/>
                                    <ItemStyle HorizontalAlign="Center"/>
                                </telerik:GridBoundColumn>
