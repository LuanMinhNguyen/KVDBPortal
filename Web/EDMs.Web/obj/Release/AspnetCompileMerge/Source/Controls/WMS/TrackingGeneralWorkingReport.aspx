<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TrackingGeneralWorkingReport.aspx.cs" Inherits="EDMs.Web.Controls.WMS.TrackingGeneralWorkingReport" %>
                ...
                <MasterTableView AllowMultiColumnSorting="false" 
                    ...
                    <HeaderStyle Font-Bold="True" HorizontalAlign="Center" VerticalAlign="Middle" />
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn DataField="Code" HeaderText="Code" UniqueName="Code" ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                            ...
                            <telerik:GridTemplateColumn UniqueName="AssignUserName" HeaderText="User" ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                            ...
                            <telerik:GridTemplateColumn UniqueName="BackupUserName" HeaderText="Backup User" ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                <HeaderStyle Width="200" HorizontalAlign="Center" />
                                <ItemStyle HorizontalAlign="Left"/>
                                <ItemTemplate>
                            ...
                            <telerik:GridTemplateColumn UniqueName="VerifyUserName" HeaderText="Auditor" ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                <HeaderStyle Width="200" HorizontalAlign="Center" />
                                <ItemStyle HorizontalAlign="Left"/>
                                <ItemTemplate>
                            ...
                            <telerik:GridBoundColumn DataField="StartDate1" HeaderText="Start Date" UniqueName="StartDate1" ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                <HeaderStyle HorizontalAlign="Center" Width="80"/>
                                <ItemStyle HorizontalAlign="Center"/>
                            </telerik:GridBoundColumn>
                                            
                            <telerik:GridBoundColumn DataField="Deadline1" HeaderText="Deadline" UniqueName="Deadline1" ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                <HeaderStyle HorizontalAlign="Center" Width="80"/>
                                <ItemStyle HorizontalAlign="Center"/>
                            </telerik:GridBoundColumn>
