<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TrackingProductionMeetingReport.aspx.cs" Inherits="EDMs.Web.Controls.WMS.TrackingProductionMeetingReport" %>
                ...
                <MasterTableView AllowMultiColumnSorting="false" 
                    ...
                    <HeaderStyle Font-Bold="True" HorizontalAlign="Center" VerticalAlign="Middle" />
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn DataField="WorkGroup" HeaderText="Work Group" UniqueName="WorkGroup" ShowFilterIcon="False" FilterControlWidth="97%" 
                            ...
                            <telerik:GridBoundColumn DataField="DeparmentName" HeaderText="Department" UniqueName="DeparmentName" ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                <HeaderStyle HorizontalAlign="Center" Width="80"/>
                                <ItemStyle HorizontalAlign="Center"/>
                            </telerik:GridBoundColumn>

                            <telerik:GridTemplateColumn DataField="ManagerName" UniqueName="ManagerName" HeaderText="Manager" ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                            ...
                            <telerik:GridTemplateColumn DataField="PICName" UniqueName="PICName" HeaderText="PIC" ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                <HeaderStyle Width="200" HorizontalAlign="Center" />
                                <ItemStyle HorizontalAlign="Left"/>
                                <ItemTemplate>
                            ...
                            <telerik:GridBoundColumn DataField="StatusName" HeaderText="StatusName" UniqueName="StatusName" AllowFiltering="False   ">
                                <HeaderStyle HorizontalAlign="Center" Width="80"/>
                                <ItemStyle HorizontalAlign="Center"/>
                            </telerik:GridBoundColumn>
                        </Columns>
