<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShipmentEditForm.aspx.cs" Inherits="EDMs.Web.Controls.CostContract.ShipmentEditForm" %>
		...
		<div style="width: 100%; height: 100%" runat="server" ID="divContent">
			<ul style="list-style-type: none">
				...
				<li style="width: 500px;">
					<div>
						<label style="width: 140px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
							<span style="color: #2E5689; text-align: right; ">Shipment Number
							</span>
						</label>
						<div style="float: left; padding-top: 5px;" class="qlcbFormItem">
			   ...
			   <%-- <li style="width: 500px;">
				...
				<li style="width: 500px;">
					<div>
						<label style="width: 140px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
							<span style="color: #2E5689; text-align: right; ">Shipment Type
							</span>
						</label>
						<div style="float: left; padding-top: 5px;" class="qlcbFormItem">
							<asp:DropDownList ID="ddlShipmentType" runat="server" CssClass="min25Percent" Width="315px">
								<Items>
				  ...
				  <li style="width: 500px;">
					<div>
						<label style="width: 140px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
							<span style="color: #2E5689; text-align: right; ">Shipment Status
							</span>
						</label>
						<div style="float: left; padding-top: 5px;" class="qlcbFormItem">
							<asp:DropDownList ID="ddlShipmentStatus" runat="server" CssClass="min25Percent" Width="315px">
								<Items>
									<asp:ListItem Value="0" Text=""></asp:ListItem>
									<asp:ListItem Value="1" Text="Status 1"></asp:ListItem>
									<asp:ListItem Value="2" Text="Status 2"></asp:ListItem>
								</Items> 
							</asp:DropDownList>
						</div>
					</div>
