<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ProcessingDocument.aspx.cs" Inherits="EDMs.Web.Controls.Report.ProcessingDocument" EnableViewState="true" %>
                                ...
                                <MasterTableView AllowMultiColumnSorting="false"
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="No." Groupable="False" AllowFiltering="false">
                                         ...
                                         <telerik:GridTemplateColumn HeaderText="Transmittal Number" UniqueName="TransmittalNumber"
                                        DataField="TransmittalNumber" ShowFilterIcon="True" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        <HeaderStyle HorizontalAlign="Center" Width="150" />
                                        <ItemStyle HorizontalAlign="Left" Width="150" />
                                        <ItemTemplate>
                                            <asp:Label ID="transmittal" runat="server" Text='<%# Eval("TransmittalNumber") %>' style="cursor: pointer"/> 
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Revision" DataField="DocRev" UniqueName="DocRev"
                                        ...
                                        <ItemTemplate>
                                           ...
                                           <telerik:GridTemplateColumn HeaderText="CLass" DataField="CLassCode" UniqueName="CLassCode"
                                        ShowFilterIcon="False" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        ...
                                        <ItemTemplate>
                                           ...
                                           <telerik:GridTemplateColumn HeaderText="Revision Status" DataField="StatusCode" UniqueName="StatusCode"
                                        ShowFilterIcon="False" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        ...
                                        <ItemTemplate>
                                           ...
                                           <telerik:GridTemplateColumn HeaderText="Document Description / Title" DataField="Title" UniqueName="Title"
                                        ShowFilterIcon="False" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        ...
                                        <ItemTemplate>
                                           ...
                                           <telerik:GridTemplateColumn HeaderText="Unit" DataField="UnitCode" UniqueName="UnitCode"
                                        ShowFilterIcon="False" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        <HeaderStyle HorizontalAlign="Center" Width="80" />
                                        <ItemStyle HorizontalAlign="Left" Width="80" />
                                     ...
                                     <telerik:GridTemplateColumn HeaderText="Discipline" DataField="DisciplineCode" UniqueName="DisciplineCode"
                                        ShowFilterIcon="False" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        <HeaderStyle HorizontalAlign="Center" Width="80" />
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Lead" DataField="LeadReview" UniqueName="LeadReview"
                                        ShowFilterIcon="False" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        <HeaderStyle HorizontalAlign="Center" Width="80" />
                                        <ItemStyle HorizontalAlign="Center" Width="80" />
                                   ...
                                   <telerik:GridDateTimeColumn HeaderText="Date Issues" UniqueName="TransInDate" DataField="TransInDate"
                                            DataFormatString="{0:dd/MM/yyyy}" SortExpression="TransInDate"  PickerType="DatePicker" AutoPostBackOnFilter="true" 
                                    ...
                                    <telerik:GridDateTimeColumn HeaderText="Due Date" UniqueName="TrasInDueDate" DataField="TrasInDueDate"
                                            DataFormatString="{0:dd/MM/yyyy}" SortExpression="TrasInDueDate"  PickerType="DatePicker" AutoPostBackOnFilter="true" 
                                                EnableRangeFiltering="true" FilterControlWidth="95" ShowFilterIcon="true" CurrentFilterFunction="Between">
                                                <HeaderStyle HorizontalAlign="Center" Width="280" />
                                        <ItemStyle HorizontalAlign="Center"/>
                                    </telerik:GridDateTimeColumn>  
                                           <telerik:GridTemplateColumn HeaderText="Answer the contractor" DataField="DocumentCode" UniqueName="DocumentCode"
                                        ShowFilterIcon="False" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        <HeaderStyle HorizontalAlign="Center" Width="80" />
                                        <ItemStyle HorizontalAlign="Left" Width="80" />
                                        ...
                                        <ItemTemplate>
                                           ...
                                           <telerik:GridTemplateColumn HeaderText="Current Workflow Step" DataField="WFStep" UniqueName="WFStep"
                                        ShowFilterIcon="False" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        <HeaderStyle HorizontalAlign="Center" Width="120" />
                                        <ItemStyle HorizontalAlign="Left" Width="120" />
                                     ...
                                     <telerik:GridTemplateColumn HeaderText="Current Users In Step" DataField="UserInStep" UniqueName="UserInStep"
                                        ShowFilterIcon="False" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        <HeaderStyle HorizontalAlign="Center" Width="120" />
                                        <ItemStyle HorizontalAlign="Left" Width="120" />
