<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AssignToAnotherUser.aspx.cs" Inherits="EDMs.Web.Controls.Workflow.AssignToAnotherUser" %>
            ...
            <ul style="list-style-type: none">
                ...
                <li style="width: 600px;">
                    <div>
                        ...
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                            <asp:DropDownList ID="ddlRole" runat="server" CssClass="min25Percent qlcbFormRequired" Width="405px"
                                OnSelectedIndexChanged="ddlRole_OnSelectedIndexChanged" AutoPostBack="True"/>
                        </div>
                    </div>
                    <div style="clear: both; font-size: 0;"></div>
                </li>
                ...
                <li style="width: 600px;">
                    <div>
                        <label style="width: 125px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
                            <span style="color: #2E5689; text-align: right; ">Re-assign To User
                            </span>
                        </label>
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                            <telerik:RadTreeView RenderMode="Lightweight" ID="rtvUser" runat="server"  CheckBoxes="True" TriStateCheckBoxes="true" CheckChildNodes="true" Width="390" Height="300" Skin="Windows7"/>
                        </div>
                    </div>
                    <div style="clear: both; font-size: 0;"></div>
                </li>
            ...
            <AjaxSettings> 
                ...
                <telerik:AjaxSetting AjaxControlID="ddlWorkflow">
                    <UpdatedControls>
                        ...
                        <telerik:AjaxUpdatedControl ControlID="rtvUser"/>
                    </UpdatedControls>
                </telerik:AjaxSetting>
