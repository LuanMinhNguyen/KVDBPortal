<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="WorkflowList.aspx.cs" Inherits="EDMs.Web.Controls.Workflow.WorkflowList" EnableViewState="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
            ...
            <telerik:RadToolBar ID="CustomerMenu" runat="server" Width="100%" OnClientButtonClicking="OnClientButtonClicking">
                <Items>
                    <telerik:RadToolBarDropDown runat="server" Text="New" ImageUrl="~/Images/addNew.png">
                        <Buttons>
                            <telerik:RadToolBarButton runat="server" Text="Workflow" Value="1" ImageUrl="~/Images/workflow2.png"/>
                        </Buttons>
                                ...
                                <telerik:RadGrid ID="grdDocument" runat="server" AllowPaging="True"
                                    ...
                                    <MasterTableView ClientDataKeyNames="ID" DataKeyNames="ID" Width="100%" TableLayout="Auto" CssClass="rgMasterTable">
                                        ...
                                        <Columns>
                                            ...
                                            <telerik:GridBoundColumn DataField="ObjectTypeName" HeaderText="Object Type" UniqueName="ObjectTypeName">
                                            ...
                                            <telerik:GridTemplateColumn HeaderText="Discipline Internal Workflow" UniqueName="IsInternalWorkflow" AllowFiltering="False" Display="False">
                                                    <HeaderStyle Width="100" HorizontalAlign="Center"></HeaderStyle>
                                                <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                <ItemTemplate>
                                                    <asp:Image ID="imgInternalWorkflow" runat="server" 
                                                        Visible='<%# Convert.ToBoolean(DataBinder.Eval(Container.DataItem, "IsInternalWorkflow"))%>'
    ...
    <telerik:RadWindowManager ID="RadWindowManager1" runat="server" EnableShadow="true" >
        <Windows>
            <telerik:RadWindow ID="CustomerDialog" runat="server" Title="Workflow Information"
                VisibleStatusbar="false" Height="450" Width="610" 
                Left="150px" ReloadOnShow="true" ShowContentDuringLoad="false" Modal="true">
            </telerik:RadWindow>
            
            <telerik:RadWindow ID="WorkflowStepDefinition" runat="server" Title="Workflow Step Definition"
                VisibleStatusbar="False" Height="650" Width="650" 
                Left="150px" ReloadOnShow="true" ShowContentDuringLoad="false" Modal="true">
            </telerik:RadWindow>
            
            <telerik:RadWindow ID="WorkflowDetail" runat="server" Title="Workflow Details"
                VisibleStatusbar="false" Height="450" Width="1000" 
                Left="150px" ReloadOnShow="true" ShowContentDuringLoad="false" Modal="true">
            </telerik:RadWindow>
        </Windows>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            ...
            function ShowStep(id) {
                var owd = $find("<%=WorkflowStepDefinition.ClientID %>");
                owd.setSize(730, document.documentElement.offsetHeight);

                owd.Show();
                owd.setUrl("WorkflowStepDefinition.aspx?wfid=" + id, "WorkflowStepDefinition");
            }

            function ShowWorkflowDetail(id) {
                var owd = $find("<%=WorkflowDetail.ClientID %>");
                owd.Show();
                owd.maximize(true);
                owd.setUrl("WorkflowDetailPage.aspx?wfid=" + id, "WorkflowDetail");
            }

            function ShowEditForm(id) {
                var owd = $find("<%=CustomerDialog.ClientID %>");
                owd.setSize(630, document.documentElement.offsetHeight);
                owd.Show();
                owd.setUrl("WorkflowEditForm.aspx?disId=" + id, "CustomerDialog");
            }
            ...
            function OnClientButtonClicking(sender, args) {
                ...
                if (strText.toLowerCase() == "workflow") {
                    var owd = $find("<%=CustomerDialog.ClientID %>");
                    owd.Show();
                    owd.setUrl("WorkflowEditForm.aspx", "CustomerDialog");
                }
            }
