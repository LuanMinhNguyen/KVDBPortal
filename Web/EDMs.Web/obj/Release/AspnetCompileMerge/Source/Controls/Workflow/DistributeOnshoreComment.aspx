<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DistributeOnshoreComment.aspx.cs" Inherits="EDMs.Web.Controls.Workflow.DistributeOnshoreComment" %>
                ...
                <li style="width: 500px;">
                    <div>
                        ...
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                            <asp:DropDownList ID="ddlUser" runat="server" CssClass="min25Percent qlcbFormRequired" Width="415px"
                                />
                        </div>
                    </div>
