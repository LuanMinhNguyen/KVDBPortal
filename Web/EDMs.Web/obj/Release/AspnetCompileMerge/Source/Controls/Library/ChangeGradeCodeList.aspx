<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ChangeGradeCodeList.aspx.cs" Inherits="EDMs.Web.Controls.Library.ChangeGradeCodeList" EnableViewState="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
            ...
            <telerik:RadToolBar ID="CustomerMenu" runat="server" Width="100%" OnClientButtonClicking="OnClientButtonClicking">
                <Items>
                    <telerik:RadToolBarDropDown runat="server" Text="New" ImageUrl="~/Images/addNew.png">
                        <Buttons>
                            <telerik:RadToolBarButton runat="server" Text="Change Grade Code" Value="1" ImageUrl="~/Images/index.png" />
                        </Buttons>
    ...
    <telerik:RadWindowManager ID="RadWindowManager1" runat="server" EnableShadow="true">
        <Windows>
            <telerik:RadWindow ID="CustomerDialog" runat="server" Title="Change Grade Code Information"
                VisibleStatusbar="false" Height="100%" Width="650" IconUrl="~/Images/index.png"
                Left="150px" ReloadOnShow="true" ShowContentDuringLoad="false" Modal="true">
            </telerik:RadWindow>

            <telerik:RadWindow ID="NewDialog" runat="server" Title="Change Grade Code Information"
                VisibleStatusbar="false" Height="100%" Width="650" IconUrl="~/Images/index.png"
                Left="150px" ReloadOnShow="true" ShowContentDuringLoad="false" Modal="true">
            </telerik:RadWindow>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            ...
            function ShowEditForm(id) {
                ...
                owd.Show();
                owd.setUrl("ChangeGradeCodeEditForm.aspx?objId=" + id, "CustomerDialog");
            }
            ...
            function OnClientButtonClicking(sender, args) {
                ...
                if (strText == "Change Grade Code") {
                    var owd = $find("<%=NewDialog.ClientID %>");
                    owd.setSize(650, document.documentElement.offsetHeight);
                    owd.Show();
                    owd.setUrl("ChangeGradeCodeEditForm.aspx", "NewDialog");
                }
                ...
                if (strText.toLowerCase() == "import data file") {
                    ...
                    owd.Show();
                    owd.setUrl("ImportChangeGradeCode.aspx", "ImportTemplate");
                }
            }
