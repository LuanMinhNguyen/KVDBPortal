                                ...
                                <telerik:RadGrid ID="grdDocument" runat="server" AllowPaging="True"
                                    ...
                                    <MasterTableView ClientDataKeyNames="ID" DataKeyNames="ID" Width="100%" TableLayout="Auto" CssClass="rgMasterTable">
                                        ...
                                        <Columns>
                                            ...
                                            <%--3--%>
                                            <telerik:GridTemplateColumn UniqueName="Name" HeaderText="Name" ShowFilterIcon="False" FilterControlWidth="99%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" DataField="Name">
                                            ...
                                            <telerik:GridBoundColumn DataField="ProjectName" HeaderText="Project Name" UniqueName="ProjectName" AllowFiltering="False">
                                    ...
                                    <telerik:GridBoundColumn DataField="Description" HeaderText="Description" UniqueName="Description" ShowFilterIcon="False" FilterControlWidth="99%" 
