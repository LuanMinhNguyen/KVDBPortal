<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ProjectCodeList.aspx.cs" Inherits="EDMs.Web.Controls.Library.ProjectCodeList" EnableViewState="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <telerik:RadWindowManager ID="RadWindowManager1" runat="server" EnableShadow="true">
        <Windows>
            <telerik:RadWindow ID="CustomerDialog" runat="server" Title="Project Code Information"
                VisibleStatusbar="false" Height="500" Width="650"
                Left="150px" ReloadOnShow="true" ShowContentDuringLoad="false" Modal="true">
            </telerik:RadWindow>

            <telerik:RadWindow ID="NewDialog" runat="server" Title="Project Code Information"
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            ...
            function ShowEditForm(id) {
                ...
                owd.Show();
                owd.setUrl("ProjectCodeEditForm.aspx?disId=" + id, "CustomerDialog");
            }
            ...
            function OnClientButtonClicking(sender, args) {
                ...
                if (strText.toLowerCase() == "project") {
                    ...
                    owd.setSize(650, document.documentElement.offsetHeight);
                    owd.Show();
                    owd.setUrl("ProjectCodeEditForm.aspx", "NewDialog");
                }
                ...
                if (strText.toLowerCase() == "import data file") {
                    ...
                    owd.Show();
                    owd.setUrl("ImportProjectCode.aspx", "ImportTemplate");
                }
            }
