<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SystemDocList.aspx.cs" Inherits="EDMs.Web.Controls.Library.SystemDocList" EnableViewState="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
            ...
            <telerik:RadToolBar ID="CustomerMenu" runat="server" Width="100%" OnClientButtonClicking="OnClientButtonClicking">
                <Items>
                    <telerik:RadToolBarDropDown runat="server" Text="New" ImageUrl="~/Images/addNew.png">
                        <Buttons>
                            <telerik:RadToolBarButton runat="server" Text="System" Value="1" ImageUrl="~/Images/system.png"/>
                        </Buttons>
                ...
                <telerik:RadPane ID="Radpane4" runat="server" Scrolling="None" >
                     ...
                     <telerik:RadSplitter ID="Radsplitter10" runat="server" Orientation="Vertical">
                         <telerik:RadPane ID="Radpane6" runat="server" Scrolling="None">
                                <telerik:RadTreeView ID="rtvSystemDoc" runat="server" Width="100%" Height="100%" ShowLineImages="False"
                                        OnNodeDataBound="rtvSystemDoc_OnNodeDataBound"
        ...
        <telerik:RadAjaxManager runat="Server" ID="ajaxCustomer" OnAjaxRequest="RadAjaxManager1_AjaxRequest">
            <AjaxSettings>
                ...
                <telerik:AjaxSetting AjaxControlID="ajaxCustomer">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="rtvSystemDoc" LoadingPanelID="RadAjaxLoadingPanel2" UpdatePanelRenderMode="Block" UpdatePanelHeight="100%"></telerik:AjaxUpdatedControl>
                    </UpdatedControls>
                </telerik:AjaxSetting>
                ...
                <telerik:AjaxSetting AjaxControlID="rtvSystemDoc">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="rtvSystemDoc" LoadingPanelID="RadAjaxLoadingPanel2" UpdatePanelRenderMode="Block" UpdatePanelHeight="100%"></telerik:AjaxUpdatedControl>
                    </UpdatedControls>
                </telerik:AjaxSetting>
    ...
    <telerik:RadWindowManager ID="RadWindowManager1" runat="server" EnableShadow="true" >
        <Windows>
            <telerik:RadWindow ID="CustomerDialog" runat="server" Title="System Information"
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            ...
            function onClientContextMenuItemClicking(sender, args) {
                ...
                switch (menuItem.get_value()) {
                    case "Edit":
                        ...
                        owd.Show();
                        owd.setUrl("SystemDocEditForm.aspx?doctypeId=" + treeNode.get_value(), "CustomerDialog");
                        break;
                    case "Delete":
                        var result = confirm("Are you sure you want to delete the system: " + treeNode.get_text());
                        if (result) {
            ...
            function ShowEditForm(id) {
                var owd = $find("<%=CustomerDialog.ClientID %>");
                owd.Show();
                owd.setUrl("SystemDocEditForm.aspx?doctypeId=" + id, "CustomerDialog");
            }
            ...
            function OnClientButtonClicking(sender, args) {
                ...
                if (strText.toLowerCase() == "system") {
                    var owd = $find("<%=CustomerDialog.ClientID %>");
                    owd.Show();
                    owd.setUrl("SystemDocEditForm.aspx", "CustomerDialog");
