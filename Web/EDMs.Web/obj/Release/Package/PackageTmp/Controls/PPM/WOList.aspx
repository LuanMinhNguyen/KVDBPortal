<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="WOList.aspx.cs" Inherits="EDMs.Web.Controls.PPM.WOList" %>
            ...
            <telerik:RadPane ID="Radpane2" runat="server" Width="100%" ShowContentDuringLoad="False">
                <telerik:RadGrid ID="grdData" runat="server" AllowPaging="True"
                    ...
                    <MasterTableView Width="100%" TableLayout="Auto" CssClass="rgMasterTable" CommandItemDisplay="Top">
                        ...
                        <Columns>
                            <telerik:GridBoundColumn DataField="DoUuTien" UniqueName="DoUuTien" Display="false"></telerik:GridBoundColumn>
                            ...
                            <telerik:GridBoundColumn DataField="TenCongViec" HeaderText="Chi tiết" UniqueName="TenCongViec"
                                ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                            ...
                            <telerik:GridBoundColumn DataField="LoaiBaoDuong" HeaderText="Loại bảo dưỡng" UniqueName="LoaiBaoDuong"
                                ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                <HeaderStyle HorizontalAlign="Center" Width="150" />
                                <ItemStyle HorizontalAlign="Left" />
                            </telerik:GridBoundColumn>

                            <telerik:GridTemplateColumn HeaderText="Độ ưu tiên" UniqueName="lbDoUuTien"
                                ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                <HeaderStyle HorizontalAlign="Center" Width="100" />
                                <ItemStyle HorizontalAlign="Left" />
                                <ItemTemplate>
                                    <asp:Label runat="server" ID="lbDoUuTien"></asp:Label>
                                </ItemTemplate>
                            ...
                            <telerik:GridBoundColumn DataField="NgayBatDauKeHoach" HeaderText="Ngày bắt đầu kế hoạch" UniqueName="NgayBatDauKeHoach"
                                ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                <HeaderStyle HorizontalAlign="Center" Width="150" />
                                <ItemStyle HorizontalAlign="Left" />
                            </telerik:GridBoundColumn>

                            <telerik:GridBoundColumn DataField="NgayKetThucKeHoach" HeaderText="Ngày kết thúc kế hoạch" UniqueName="NgayKetThucKeHoach"
                                ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                <HeaderStyle HorizontalAlign="Center" Width="150" />
                                <ItemStyle HorizontalAlign="Left" />
                            </telerik:GridBoundColumn>

                            <telerik:GridBoundColumn DataField="NgayBatDauThucTe" HeaderText="Ngày bắt đầu thực tế" UniqueName="NgayBatDauThucTe"
                                ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                <HeaderStyle HorizontalAlign="Center" Width="150" />
                                <ItemStyle HorizontalAlign="Left" />
                            </telerik:GridBoundColumn>

                            <telerik:GridBoundColumn DataField="NgayKetThucTe" HeaderText="Ngày kết thúc thực tế" UniqueName="NgayKetThucTe"
                                ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                <HeaderStyle HorizontalAlign="Center" Width="150" />
                                <ItemStyle HorizontalAlign="Left" />
                            </telerik:GridBoundColumn>
        ...
        <script type="text/javascript">
            ...
            function ViewToolBar_OnClientButtonClicking(sender, args) {
                ...
                if (strValue == "SplitView") {
                    window.location.href = "WODetail.aspx";
                }
            }
        </script>
