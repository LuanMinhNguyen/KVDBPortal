<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="WOCompletedDetail.aspx.cs" Inherits="EDMs.Web.WOCompletedDetail" EnableViewState="true" %>
                ...
                <telerik:RadToolBar RenderMode="Lightweight" runat="server" ID="ToolBarWO" EnableRoundedCorners="true" EnableShadows="true" Skin="MetroTouch" Height="40">
                    <Items>
                        <telerik:RadToolBarButton Text="Left" Group="Align">
                            <ItemTemplate>
                                <span style=" color: dodgerblue; font-size: 16px; font-weight: normal; font-family: helvetica, arial, verdana, sans-serif; ">Xác nhận hoàn thành Phiếu CV: </span>
                ...
                <telerik:RadSplitter RenderMode="Lightweight" ID="SubSplitter" runat="server" Height="100%" Width="100%" Skin="Silk">
                    <telerik:RadPane ID="PanelWOList" runat="server" Width="400" MinWidth="300">
                        <telerik:RadSplitter RenderMode="Lightweight" ID="LeftSplitter" runat="server" Height="100%" Width="100%" Orientation="Horizontal" Skin="Silk">
                            <telerik:RadPane ID="Radpane3" runat="server" Width="100%" Height="63">
                                Từ ngày: <telerik:RadDatePicker ID="txtStartDate" runat="server" Skin="MetroTouch" Width="146">
                                    <DateInput DateFormat="dd-MMM-yy"/>
                                </telerik:RadDatePicker>
                                Đến ngày: <telerik:RadDatePicker ID="txtEndDate" runat="server" Skin="MetroTouch" Width="146">
                                    <DateInput DateFormat="dd-MMM-yy"/>
                                </telerik:RadDatePicker> 
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td><span class="WODetail"><%# DataBinder.Eval(Container, "Attributes['TrangThaiCongViec']") %></span></td>
                                            </tr>
                                            <tr>
                        ...
                        <telerik:RadMultiPage runat="server" ID="MultiPageWO" SelectedIndex="0">
                            ...
                            <telerik:RadPageView runat="server" ID="RadPageView3">
                                <telerik:RadGrid ID="grdWOActivities" runat="server" AllowPaging="False"
                                    ...
                                    OnNeedDataSource="grdWOActivities_OnNeedDataSourceedDataSource" 
                                    >
                                ...
                                <telerik:RadSplitter RenderMode="Lightweight" ID="PMScheduleSplitter" runat="server" Height="100%" Width="100%" Orientation="Horizontal" Skin="Silk">
                                    <telerik:RadPane ID="PMSchedulePanel" runat="server" Width="100%" Height="300">
                                        <telerik:RadGrid ID="grdPart" runat="server" AllowPaging="False"
                                            AutoGenerateColumns="False" CellPadding="0" CellSpacing="0"
                                            GridLines="None" Height="100%" Skin="Metro"
                                            OnNeedDataSource="grdPart_OnNeedDataSourcetaSource" 
                                            >
                                            <MasterTableView Width="100%" TableLayout="Auto" CssClass="rgMasterTable" >
        ...
        <script type="text/javascript">
            ...
            function ViewToolBar_OnClientButtonClicking(sender, args) {
                ...
                if (strValue == "ExpandLeft") {
                    ...
                    window.location.href = "WOCompletedList.aspx";
                }
            }
        </script>
