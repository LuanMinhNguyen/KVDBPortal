<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DocumentList.aspx.cs" Inherits="EDMs.Web.Controls.Document.DocumentList" %>
                ...
                <telerik:RadGrid ID="grdData" runat="server" AllowPaging="True"
                    ...
                    <MasterTableView Width="100%" TableLayout="Auto" CssClass="rgMasterTable" CommandItemDisplay="Top">
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn DataField="TaiLieu" HeaderText="Mã tài liệu" UniqueName="TaiLieu"
                                ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                <HeaderStyle HorizontalAlign="Center" Width="80" />
                                <ItemStyle HorizontalAlign="Left" />
                            </telerik:GridBoundColumn>

                            <telerik:GridBoundColumn DataField="TenTaiLieu" HeaderText="Chi tiết" UniqueName="TenTaiLieu"
                                ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                            ...
                            <telerik:GridBoundColumn DataField="SoPhienBan" HeaderText="Số phiên bản" UniqueName="SoPhienBan"
                                ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                <HeaderStyle HorizontalAlign="Center" Width="80" />
                                <ItemStyle HorizontalAlign="Left" />
                            </telerik:GridBoundColumn>

                            <telerik:GridBoundColumn DataField="NgayCapNhatPhienBan" HeaderText="Ngày cập nhật phiên bản" UniqueName="NgayCapNhatPhienBan"
                                ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                <HeaderStyle HorizontalAlign="Center" Width="80" />
                                <ItemStyle HorizontalAlign="Left" />
                            </telerik:GridBoundColumn>

                            <telerik:GridBoundColumn DataField="DuongDan" HeaderText="Đường dẫn" UniqueName="DuongDan"
                                ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                <HeaderStyle HorizontalAlign="Center" Width="80" />
                                <ItemStyle HorizontalAlign="Left" />
                            </telerik:GridBoundColumn>
                            ...
                            <telerik:GridBoundColumn DataField="TenGoc" HeaderText="Tên gốc" UniqueName="TenGoc"
                                ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                <HeaderStyle HorizontalAlign="Center" Width="80" />
                                <ItemStyle HorizontalAlign="Left" />
                            </telerik:GridBoundColumn>

                            <telerik:GridBoundColumn DataField="NgayTaiLen" HeaderText="Ngày tải lên" UniqueName="NgayTaiLen"
                                ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                <HeaderStyle HorizontalAlign="Center" Width="80" />
                                <ItemStyle HorizontalAlign="Left" />
                            </telerik:GridBoundColumn>
        ...
        <script type="text/javascript">
            ...
            function ViewToolBar_OnClientButtonClicking(sender, args) {
                ...
                if (strValue == "SplitView") {
                    window.location.href = "DocumentDetail.aspx";
                }
            }
        </script>
