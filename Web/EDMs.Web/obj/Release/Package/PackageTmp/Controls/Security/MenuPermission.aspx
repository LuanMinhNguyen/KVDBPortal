<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" 
    CodeBehind="MenuPermission.aspx.cs" Inherits="EDMs.Web.Controls.Security.MenuPermission" EnableViewState="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <style type="text/css">
        ...
        #ctl00_ContentPlaceHolder2_RadPageView5
        {
         ...
         #ctl00_ContentPlaceHolder2_radPbGroup{
             width: 100% !important;
         }
         .RadPanelBar {
             width: 100% !important;
    ...
    <telerik:RadSplitter ID="RadSplitter4" runat="server" Orientation="Horizontal" Width="100%" Skin="Metro">
        <telerik:RadPane ID="RadPane3" runat="server" Height="30px" Scrollable="false" Scrolling="None">
            <telerik:RadToolBar ID="CustomerMenu" runat="server" Width="100%" OnButtonClick="CustomerMenu_ButtonClick" Skin="Metro">
                <Items>
                ...
                <telerik:RadPane ID="Radpane4" runat="server" Scrolling="None" >
                     <telerik:RadSplitter ID="Radsplitter10" runat="server" Orientation="Vertical" Width="">
                         <telerik:RadPane ID="Radpane6" runat="server" Scrolling="Both" Width="460">
                                <telerik:RadPanelBar ID="radPbGroup" runat="server" OnItemClick="radPbGroup_ItemClick" Width="360" style="min-width: 436px" Skin="Metro" />
                        </telerik:RadPane>
                         
                         <telerik:RadPane ID="Radpane1" runat="server" Scrolling="None" >
                             <telerik:RadTreeView
                                ID="treePemissionMenus" Skin="Metro"
                                runat="server"
                                Height="100%"
                                Width="100%"
                                CheckBoxes="True"
