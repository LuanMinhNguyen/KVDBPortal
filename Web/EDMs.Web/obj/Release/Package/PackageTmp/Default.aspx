...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <style type="text/css">
        ...
        #ctl00_ContentPlaceHolder2_Gauge6 {
            margin-bottom: -40px;
        }
        ...
        /*#RAD_SPLITTER_PANE_CONTENT_ctl00_ContentPlaceHolder2_RadPane4 {
            width: 98% !important;
        }*/
        ...
        #ctl00_ContentPlaceHolder2_ctl00_ContentPlaceHolder2_Gauge1Panel {
            margin-top: -30px !important
        }

        #ctl00_ContentPlaceHolder2_ctl00_ContentPlaceHolder2_Gauge2Panel {
            margin-top: -30px !important
        }

        #ctl00_ContentPlaceHolder2_ctl00_ContentPlaceHolder2_Gauge3Panel {
            margin-top: -30px !important
        }

        #ctl00_ContentPlaceHolder2_ctl00_ContentPlaceHolder2_Gauge4Panel {
            margin-top: -30px !important
        }

        #ctl00_ContentPlaceHolder2_ctl00_ContentPlaceHolder2_Gauge5Panel {
            margin-top: -30px !important
        }

        #ctl00_ContentPlaceHolder2_ctl00_ContentPlaceHolder2_Gauge6Panel {
            margin-top: -30px !important
        }
    </style>
    ...
    <div style=" width: 100%; height: 100%; background-color: #f0f0f0">
        <telerik:RadSplitter RenderMode="Lightweight" ID="MainSplitter" runat="server" Height="100%" Width="100%">
            <telerik:RadPane ID="RadPane1" runat="server" Width="450" Locked="True" CssClass="dashboard">
                <div style="display: none">
                    ...
                    <div style="margin-top: 10px;height: 50px"><div class="divLabel">Thư mục:</div> 
                        <telerik:RadComboBox ID="ddlFolder" runat="server" Width="442" Skin="MetroTouch" OnSelectedIndexChanged="ddlFolder_OnSelectedIndexChanged" AutoPostBack="True">
                            <Items>
            ...
            <telerik:RadPane ID="RadPane3" runat="server" Scrolling="Both" Height="100%">
                <telerik:RadSplitter RenderMode="Lightweight" ID="Radsplitter3" runat="server" Height="100%" Orientation="Horizontal">
                    <telerik:RadPane ID="RadPane2" runat="server" Height="40%" CssClass="dashboard1">
                        <div style="width: 98%; display: none">
                            <div style="border-color: #d8d8d8;border-bottom-width: 1px !important;height: 35px; border-style: solid;border-width: 0px">
                            ...
                            <div style="width: 100%; height: 100%">
                                <div style="display: inline; float: left; width: 40%; height: 100%" >
                                    <telerik:RadHtmlChart runat="server" ID="ColumnChart" Width="100%" Height="260" Transitions="true" Skin="MetroTouch">
                                        <PlotArea>
                                            <Series>
                                ...
                                <div style="display: inline; float: left">
                                    ...
                                    <div style="margin-top: 10px;height: 50px">
                                        <div style="display: inline; float: left; width: 120px;padding-top: 10px;padding-left: 22px;" class="divLabel">Đơn vị</div>
                                        <div style="display: inline; float: left">
                                            <telerik:RadComboBox runat="server" Width="230" Skin="MetroTouch" ID="ddlOrganization" OnSelectedIndexChanged="ddlColumnChart_OnSelectedIndexChanged" AutoPostBack="True">
                                            </telerik:RadComboBox>
                                        </div>
                                    </div>

                                    <div style="margin-top: 10px;height: 50px">
                                        <div style="display: inline; float: left; width: 120px;padding-top: 10px;padding-left: 22px;" class="divLabel">Kiểu biểu đồ</div>
                                        <div style="display: inline; float: left">
                                            <telerik:RadComboBox runat="server" Width="230" Skin="MetroTouch" ID="ddlColumnChart" OnSelectedIndexChanged="ddlColumnChart_OnSelectedIndexChanged" AutoPostBack="True">
                                                <Items>
                                    ...
                                    <div style="margin-top: 10px;height: 50px">
                                        <div style="display: inline; float: left; width: 120px;padding-top: 10px;padding-left: 22px;" class="divLabel">Bộ phận</div>
                                        <div style="display: inline; float: left">
                                            <telerik:RadComboBox runat="server" Width="230" Skin="MetroTouch" ID="ddlDepartment" OnSelectedIndexChanged="ddlColumnChart_OnSelectedIndexChanged" AutoPostBack="True">
                                            </telerik:RadComboBox>
                                        </div>
                                    </div>
                    ...
                    <telerik:RadPane ID="RadPane4" runat="server" Height="60%"  CssClass="dashboard1" >
                        <div style="width: 98%; display: none">
                            <div style="border-color: #d8d8d8;border-bottom-width: 1px !important;height: 35px; border-style: solid;border-width: 0px">
                                <div class="divTitle" style="width: 400px">Đánh giá hiệu năng</div>
                                <div class="divBtnRefresh">
                                    <asp:ImageButton runat="server" ImageUrl="Images/refresh_20.png" ID="btnRefreshKPI" OnClick="btnRefreshKPI_OnClick"/>
                                </div>
                            </div>
                        </div>
                        <table width="100%" style="display: none">
                            <tr style="height: 100px">
                                <td width="20%" align="center">
                                    <telerik:RadRadialGauge runat="server" ID="Gauge1" Width="60%">
                                        <Pointer Value="23">
                                            <Cap Size="0.1" />
                                        </Pointer>
                                    ...
                                    <asp:Label runat="server" ID="lbl1" Text="16%" CssClass="lblGauge"/>
                                    <div class="divLabel">Tỉ lệ hoàn thành công việc <br/>theo năm các bộ phận</div>
                                </td>
                                
                                <td width="20%" align="center"> 
                                    <telerik:RadRadialGauge runat="server" ID="Gauge2" Width="60%">
                                        <Pointer Value="23">
                                            <Cap Size="0.1" />
                                        </Pointer>
                                        <Scale Min="0" Max="100" MajorUnit="25">
                                    ...
                                    <asp:Label runat="server" ID="lbl2" Text="16%" CssClass="lblGauge"/>
                                    <div class="divLabel">Tỉ lệ hoàn thành công việc <br/>theo quý các bộ phận</div>
                                </td>
                                
                                <td width="20%" align="center">
                                    <telerik:RadRadialGauge runat="server" ID="Gauge3" Width="60%">
                                        <Pointer Value="23">
                                            <Cap Size="0.1" />
                                        </Pointer>
                                        <Scale Min="0" Max="100" MajorUnit="25">
                                    ...
                                    <asp:Label runat="server" ID="lbl3" Text="16%" CssClass="lblGauge"/>
                                    <div class="divLabel">Tỉ lệ hoàn thành công việc <br/>theo tháng các bộ phận </div>
                                </td>
                                <td width="40%" rowspan="2" valign="top">
                                    <div style="display: inline; float: left">
                                        ...
                                        <div style="margin-top: 10px;height: 50px">
                                            <div style="margin-top: 10px;height: 50px">
                                                <div style="display: inline; float: left; width: 120px;padding-top: 10px;padding-left: 22px;" class="divLabel">Từ ngày</div>
                                                <div style="display: inline; float: left">
                                                    <telerik:RadDatePicker ID="txtTuNgay" runat="server" Skin="MetroTouch" Width="150" OnSelectedDateChanged="txtDenNgay_OnSelectedDateChanged" AutoPostBack="True">
                                                        <DateInput DateFormat="dd-MMM-yy"/>
                                                    </telerik:RadDatePicker>
                                                </div>
                                            </div>
                                            <div style="margin-top: 10px;height: 50px">
                                                <div style="display: inline; float: left; width: 120px;padding-top: 10px;padding-left: 22px;" class="divLabel">Đến ngày</div>
                                                <div style="display: inline; float: left">
                                                    <telerik:RadDatePicker ID="txtDenNgay" runat="server" Skin="MetroTouch" Width="150" OnSelectedDateChanged="txtDenNgay_OnSelectedDateChanged" AutoPostBack="True">
                                                        <DateInput DateFormat="dd-MMM-yy"/>
                                                    </telerik:RadDatePicker>
                                                </div>
                                            </div>
                                            <div style="margin-top: 10px;height: 50px">
                                                <div style="display: inline; float: left; width: 120px;padding-top: 10px;padding-left: 22px;" class="divLabel">Đơn vị</div>
                                                <div style="display: inline; float: left">
                                                    <telerik:RadComboBox runat="server" Width="230" Skin="MetroTouch" ID="ddlKPIOrg" OnSelectedIndexChanged="ddlKPIOrg_OnSelectedIndexChanged" AutoPostBack="True">
                                                    </telerik:RadComboBox>
                                                </div>
                                            </div>
                                            ...
                                            <div style="margin-top: 10px;height: 50px">
                                                <div style="display: inline; float: left; width: 120px;padding-top: 10px;padding-left: 22px;" class="divLabel">Bộ phận</div>
                                                <div style="display: inline; float: left">
                                                    <telerik:RadComboBox runat="server" Width="230" Skin="MetroTouch" ID="ddlKPIDept" OnSelectedIndexChanged="ddlKPIOrg_OnSelectedIndexChanged" AutoPostBack="True">
                                                    </telerik:RadComboBox>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <tr>
                                <td  align="center">
                                    <telerik:RadRadialGauge runat="server" ID="Gauge4" Width="60%">
                                        <Pointer Value="23">
                                            <Cap Size="0.1" />
                                        </Pointer>
                                        <Scale Min="0" Max="100" MajorUnit="25">
                                    ...
                                    <asp:Label runat="server" ID="lbl4" Text="16%" CssClass="lblGauge"/>
                                    <div class="divLabel">Tỉ lệ hoàn thành công việc <br/>theo tuần các bộ phận</div>
                                </td>
                                <td  align="center">
                                    <telerik:RadRadialGauge runat="server" ID="Gauge5" Width="60%" >
                                        <Pointer Value="23">
                                            <Cap Size="0.1" />
                                        </Pointer>
                                        <Scale Min="0" Max="100" MajorUnit="25">
                                    ...
                                    <asp:Label runat="server" ID="lbl5" Text="16%" CssClass="lblGauge"/>
                                    <div class="divLabel">Tỉ lệ hoàn thành công việc <br/>được phân công theo nhân sự thực hiện </div>
                                </td>
                                
                                <td  align="center">
                                    <telerik:RadRadialGauge runat="server" ID="Gauge6" Width="60%" >
                                        <Pointer Value="23">
                                            <Cap Size="0.1" />
                                        </Pointer>
                                        <Scale Min="0" Max="100" MajorUnit="25">
                                    ...
                                    <asp:Label runat="server" ID="lbl6" Text="16%" CssClass="lblGauge"/>
                                    <div class="divLabel">Tỉ lệ hoàn thành công việc<br/>của các bộ phận theo khoảng thời gian </div>
                                </td>
                            </tr>
                        </table>
                    </telerik:RadPane>
        ...
        <telerik:RadAjaxManager runat="Server" ID="ajaxCustomer" OnAjaxRequest="RadAjaxManager1_AjaxRequest">
            ...
            <AjaxSettings>
                ...
                <telerik:AjaxSetting AjaxControlID="btnRefreshKPI">
                    <UpdatedControls>
                        ...
                        <telerik:AjaxUpdatedControl ControlID="Gauge6" LoadingPanelID="RadAjaxLoadingPanel2"/>
                    </UpdatedControls>
                </telerik:AjaxSetting>
                
                <telerik:AjaxSetting AjaxControlID="ddlKPIOrg">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="Gauge1" LoadingPanelID="RadAjaxLoadingPanel2"/>
                        <telerik:AjaxUpdatedControl ControlID="Gauge2" LoadingPanelID="RadAjaxLoadingPanel2"/>
                        <telerik:AjaxUpdatedControl ControlID="Gauge3" LoadingPanelID="RadAjaxLoadingPanel2"/>
                ...
                <telerik:AjaxSetting AjaxControlID="ddlKPIDept">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="Gauge1" LoadingPanelID="RadAjaxLoadingPanel2"/>
                        <telerik:AjaxUpdatedControl ControlID="Gauge2" LoadingPanelID="RadAjaxLoadingPanel2"/>
                        <telerik:AjaxUpdatedControl ControlID="Gauge3" LoadingPanelID="RadAjaxLoadingPanel2"/>
                ...
                <telerik:AjaxSetting AjaxControlID="txtTuNgay">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="Gauge6" LoadingPanelID="RadAjaxLoadingPanel2"/>
                    </UpdatedControls>
                </telerik:AjaxSetting>
                
                <telerik:AjaxSetting AjaxControlID="txtDenNgay">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="Gauge6" LoadingPanelID="RadAjaxLoadingPanel2"/>
                    </UpdatedControls>
                </telerik:AjaxSetting>
                ...
                <telerik:AjaxSetting AjaxControlID="btnRefreshKPI">
                    <UpdatedControls>
                        ...
                        <telerik:AjaxUpdatedControl ControlID="lbl6"/>
                    </UpdatedControls>
                </telerik:AjaxSetting>
