<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EAM_AssetManagementList.aspx.cs" Inherits="EDMs.Web.EAM_AssetManagementList" EnableViewState="true" %>
                ...
                <telerik:RadGrid ID="grdData" runat="server" AllowPaging="True"
                    ...
                    <MasterTableView Width="100%" TableLayout="Auto" CssClass="rgMasterTable" >
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn DataField="MA_THIET_BI" HeaderText="Mã thiết bị" UniqueName="MA_THIET_BI"
                                ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                <HeaderStyle HorizontalAlign="Center" Width="200" />
                                <ItemStyle HorizontalAlign="Left" />
                            </telerik:GridBoundColumn>
                            
                            <telerik:GridBoundColumn DataField="TEN_THIET_BI" HeaderText="Tên thiết bị" UniqueName="TEN_THIET_BI"
                                                     ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                <HeaderStyle HorizontalAlign="Center" Width="200" />
                                <ItemStyle HorizontalAlign="Left" />
                            </telerik:GridBoundColumn>
                            ...
                            <telerik:GridBoundColumn DataField="TRANG_THAI" HeaderText="Trạng thái" UniqueName="TRANG_THAI"
                                                     ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                            ...
                            <telerik:GridBoundColumn DataField="THONG_SO_KY_THUAT" HeaderText="Thông số kỹ thuật" UniqueName="THONG_SO_KY_THUAT"
                                                     ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                <HeaderStyle HorizontalAlign="Center" Width="200" />
                                <ItemStyle HorizontalAlign="Left" />
                            </telerik:GridBoundColumn>
                            
                            <telerik:GridBoundColumn DataField="NHA_CUNG_CAP" HeaderText="Nhà cung cấp" UniqueName="NHA_CUNG_CAP"
                                                     ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                <HeaderStyle HorizontalAlign="Center" Width="200" />
                                <ItemStyle HorizontalAlign="Left" />
                            </telerik:GridBoundColumn>
                            ...
                            <telerik:GridBoundColumn DataField="NHA_SAN_XUAT" HeaderText="Nhà sản xuất" UniqueName="NHA_SAN_XUAT"
                                                     ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                <HeaderStyle HorizontalAlign="Center" Width="120" />
                                <ItemStyle HorizontalAlign="Left" />
                            </telerik:GridBoundColumn>
                            ...
                            <telerik:GridBoundColumn DataField="PHAN_LOAI" HeaderText="Phân loại" UniqueName="PHAN_LOAI"
                                                     ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                <HeaderStyle HorizontalAlign="Center" Width="120" />
                                <ItemStyle HorizontalAlign="Left" />
                            </telerik:GridBoundColumn>
                            
                            <telerik:GridDateTimeColumn DataFormatString="{0:dd-MMM-yy}" HeaderText="Ngày lắp đặt" UniqueName="NGAY_LAP_DAT" ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" DataField="NGAY_LAP_DAT">
                                <HeaderStyle HorizontalAlign="Center" Width="100" />
                                <ItemStyle HorizontalAlign="Center" />
                            </telerik:GridDateTimeColumn>
                            
                            <telerik:GridTemplateColumn HeaderText="Niên hạn" DataField="NIEN_HAN" UniqueName="NIEN_HAN" ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" >
                                <HeaderStyle HorizontalAlign="Center" Width="80" />
                                <ItemStyle HorizontalAlign="Center" />
                                <ItemTemplate>
                                    <%# Eval("NIEN_HAN", "{0:dd-MMM-yy}").Replace("01-Jan-01", string.Empty) %>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>


                            <telerik:GridBoundColumn DataField="NGUOI_PHU_TRACH" HeaderText="Người phụ trách" UniqueName="NGUOI_PHU_TRACH"
                                                     ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                <HeaderStyle HorizontalAlign="Center" Width="120" />
                                <ItemStyle HorizontalAlign="Left" />
                            </telerik:GridBoundColumn>
        ...
        <script type="text/javascript">
            ...
            function ViewToolBar_OnClientButtonClicking(sender, args) {
                ...
                if (strValue == "SplitView") {
                    window.location.href = "EAM_AssetManagement.aspx";
                } else if (strValue == "ClearFilter") {
                    var grid = $find("<%=grdData.ClientID %>");
                    var masterTableView = grid.get_masterTableView();
                    masterTableView.clearFilter("MA_THIET_BI");
                    masterTableView.clearFilter("TEN_THIET_BI");
                    masterTableView.clearFilter("DON_VI");
                    masterTableView.clearFilter("BO_PHAN");
                    masterTableView.clearFilter("TRANG_THAI");
                    masterTableView.clearFilter("MODEL");
                    masterTableView.clearFilter("SERIAL");
                    masterTableView.clearFilter("THONG_SO_KY_THUAT");
                    masterTableView.clearFilter("NHA_SAN_XUAT");
                    masterTableView.clearFilter("PHAN_LOAI");
                    masterTableView.clearFilter("NGAY_LAP_DAT");
                    masterTableView.clearFilter("NIEN_HAN");
                    masterTableView.clearFilter("NGUOI_PHU_TRACH");
                }
            }
        </script>
