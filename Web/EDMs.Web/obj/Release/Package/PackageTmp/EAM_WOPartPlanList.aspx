<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EAM_WOPartPlanList.aspx.cs" Inherits="EDMs.Web.EAM_WOPartPlanList" EnableViewState="true" %>
                ...
                <telerik:RadGrid ID="grdWOPartPlan" runat="server" AllowPaging="False"
                    ...
                    <MasterTableView Width="100%" TableLayout="Auto" CssClass="rgMasterTable" >
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn DataField="thang" HeaderText="Tháng" UniqueName="thang">
                                <HeaderStyle HorizontalAlign="Center" Width="80" />
                                <ItemStyle HorizontalAlign="Right" />
                            </telerik:GridBoundColumn>
                            
                            <telerik:GridBoundColumn DataField="Nam" HeaderText="Năm" UniqueName="Nam">
                                <HeaderStyle HorizontalAlign="Center" Width="80" />
                                <ItemStyle HorizontalAlign="Right" />
                            </telerik:GridBoundColumn>
                            
                            <telerik:GridTemplateColumn HeaderText="Ngày dự kiến" UniqueName="NgayDuKien" AllowFiltering="false" >
                                <HeaderStyle HorizontalAlign="Center" Width="80" />
                                <ItemStyle HorizontalAlign="Center" />
                                <ItemTemplate>
                                    <%# Eval("NgayDuKien", "{0:dd-MMM-yy}") %>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            
                            <telerik:GridBoundColumn DataField="NguoiTao" HeaderText="Người tạo" UniqueName="NguoiTao">
                                <HeaderStyle HorizontalAlign="Center" Width="120" />
                                <ItemStyle HorizontalAlign="Left" />
                            </telerik:GridBoundColumn>
                            
                            <telerik:GridBoundColumn DataField="MaDinhMuc" HeaderText="Định mức vật tư" UniqueName="MaDinhMuc">
                                <HeaderStyle HorizontalAlign="Center" Width="120" />
                                <ItemStyle HorizontalAlign="Left" />
                            </telerik:GridBoundColumn>
