<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SIList.aspx.cs" Inherits="EDMs.Web.SIList" EnableViewState="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
            ...
            <telerik:RadToolBar ID="CustomerMenu" runat="server" Width="100%" OnClientButtonClicking="OnClientButtonClicking">
                <Items>
                    <telerik:RadToolBarDropDown runat="server" Text="Add" ImageUrl="~/Images/addNew.png">
                        <Buttons>
                            <telerik:RadToolBarButton runat="server" Text="SI" Value="1" ImageUrl="~/Images/index.png"></telerik:RadToolBarButton>
    ...
    <telerik:RadWindowManager ID="RadWindowManager1" runat="server" EnableShadow="true" >
        <Windows>
            <telerik:RadWindow ID="CustomerDialog" runat="server" Title="SI Information"
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            ...
            function ShowEditForm(objId) {
                ...
                window.Show();
                window.setUrl("Controls/Document/NCRSIEditForm.aspx?projectId=" + projectId + "&objId=" + objId +"&type=2", "CustomerDialog");
            ...
            function OnClientButtonClicking(sender, args) {
                ...
                if (strText === "SI") {
                    ...
                    window.setSize(730, document.documentElement.offsetHeight);
                    window.Show();
                    window.setUrl("Controls/Document/NCRSIEditForm.aspx?projectId=" + projectId + "&type=2", "CustomerDialog");
