<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="WR.aspx.cs" Inherits="EDMs.Web.WR" EnableViewState="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
            ...
            <telerik:RadToolBar ID="CustomerMenu" runat="server" Width="100%" OnClientButtonClicking="OnClientButtonClicking">
                <Items>
                    <telerik:RadToolBarDropDown runat="server" Text="Add" ImageUrl="~/Images/addNew.png">
                        <Buttons>
                            <telerik:RadToolBarButton runat="server" Text="Work Request" Value="1" ImageUrl="~/Images/workrequest.png"/>
                        </Buttons>
                    ...
                    <telerik:RadToolBarButton runat="server" Value="ShowAll">
                        <ItemTemplate>
                            ...
                            <asp:DropDownList ID="ddlStatus" runat="server" CssClass="rcbReadOnly" Width="230px" style="max-width: 316px"
                                ...
                                <Items>
                                    <asp:ListItem Value="1" Text="All WR"></asp:ListItem>
                                    <%--<asp:ListItem Value="2" Text="All Latest WR" Selected="True"></asp:ListItem>--%>
                                    <%--<asp:ListItem Value="3" Text="Coming Due WR" style="background-color: yellow"></asp:ListItem>--%>
                                    <asp:ListItem Value="4" Text="Overdue WR" style="background-color: red"></asp:ListItem>
                                    <asp:ListItem Value="7" Text="WR complete Workflow Process" style="background-color: greenyellow"></asp:ListItem>
                                    <asp:ListItem Value="5" Text="Completed WR" style="background-color: greenyellow"></asp:ListItem>
                                    <asp:ListItem Value="6" Text="Incompleted WR" style="background-color: coral"></asp:ListItem>
                                </Items>
                            </asp:DropDownList>
                            ...
                            <telerik:RadGrid AllowCustomPaging="False" AllowPaging="True" AllowSorting="True" 
                                ...
                                <MasterTableView AllowMultiColumnSorting="false"
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridBoundColumn DataField="PriotiyLevelId" UniqueName="PriotiyLevelId" Display="False" />
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Priority" UniqueName="PriorityLevelName"
                                        DataField="PriorityLevelName" ShowFilterIcon="False" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        <HeaderStyle HorizontalAlign="Center" Width="80" />
                                        <ItemStyle HorizontalAlign="Center"  />
                                        <ItemTemplate>
                                            <%# Eval("PriorityLevelName") %>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>

                                    <telerik:GridTemplateColumn HeaderText="WR Number" UniqueName="WRNo"
                                        DataField="WRNo" ShowFilterIcon="False" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="WR Title" UniqueName="WRTitle"
                                        DataField="WRTitle" ShowFilterIcon="False" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Originator" UniqueName="OriginatorName"
                                        DataField="OriginatorName" ShowFilterIcon="False" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        <HeaderStyle HorizontalAlign="Center" Width="100" />
                                        <ItemStyle HorizontalAlign="Center"  />
                                        <ItemTemplate>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Job Title" UniqueName="OriginatorJobTitle"
                                        DataField="OriginatorJobTitle" ShowFilterIcon="False" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        <HeaderStyle HorizontalAlign="Center" Width="100" />
                                        <ItemStyle HorizontalAlign="Left"  />
                                        <ItemTemplate>
                                            <%# Eval("OriginatorJobTitle") %>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                        
                                     <telerik:GridDateTimeColumn HeaderText="Raised Date" UniqueName="RaisedDate" DataField="RaisedDate"
                                          DataFormatString="{0:dd/MM/yyyy}" AllowFiltering="False">
                                        <HeaderStyle HorizontalAlign="Center" Width="80" />
                                        <ItemStyle HorizontalAlign="Center"/>
                                    </telerik:GridDateTimeColumn>
                                        
                                        <telerik:GridTemplateColumn HeaderText="Date Require" UniqueName="RequriedDate"
                                        DataField="RequriedDate" ShowFilterIcon="False" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        <HeaderStyle HorizontalAlign="Center" Width="80" />
                                        <ItemStyle HorizontalAlign="Center"  />
                                        <ItemTemplate>
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="Description of Request" UniqueName="Description"
                                        DataField="Description" ShowFilterIcon="False" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Summary of Scope of Services" UniqueName="ScopeOfService"
                                        DataField="ScopeOfService" ShowFilterIcon="False" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        <HeaderStyle HorizontalAlign="Center" Width="450" />
                                        <ItemStyle HorizontalAlign="Left"  />
                                        <ItemTemplate>
                                            <%# Eval("ScopeOfService").ToString().Replace(Environment.NewLine, "<br/>") %>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                        
                                        <telerik:GridTemplateColumn HeaderText="Reason to raise Work Request" UniqueName="Reason"
                                        DataField="Reason" ShowFilterIcon="False" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        <HeaderStyle HorizontalAlign="Center" Width="450" />
                                        <ItemStyle HorizontalAlign="Left"  />
                                        <ItemTemplate>
    ...
    <telerik:RadContextMenu ID="radMenu" runat="server"
        ...
        <Items>
            ...
            <telerik:RadMenuItem Text="Edit properties" ImageUrl="~/Images/edit.png" Value="EditProperties" DisabledImageUrl="~/Images/dis_edit.png"/>
            <telerik:RadMenuItem Text="WR Detail" ImageUrl="~/Images/detail.png" Value="WRDetail" DisabledImageUrl="~/Images/dis_detail.png"/>
            <telerik:RadMenuItem IsSeparator="True"/>
            ...
            <telerik:RadMenuItem IsSeparator="True"/>
            <telerik:RadMenuItem Text="Cancel WR" ImageUrl="~/Images/cancel1.png" Value="DeleteWR"/>
    ...
    <telerik:RadWindowManager ID="RadWindowManager1" runat="server" EnableShadow="true" >
        <Windows>
            <telerik:RadWindow ID="CustomerDialog" runat="server" Title="Work Request Information"
                VisibleStatusbar="false" Height="700" Width="860" 
                Left="150px" ReloadOnShow="true" ShowContentDuringLoad="false" Modal="true">
            </telerik:RadWindow>
            
            <telerik:RadWindow ID="WRDetailDialog" runat="server" Title="Work Request Details"
            ...
            <telerik:RadWindow ID="AttachWorkflow" runat="server" Title="Attach WR to Workflow"
                VisibleStatusbar="true" Height="450" Width="610" 
                Left="150px" ReloadOnShow="true" ShowContentDuringLoad="false" Modal="true">
            </telerik:RadWindow>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            ...
            function gridMenuClicking(sender, args) {
                ...
                else
                {
                    ...
                    case "WRDetail":
                        var categoryId = document.getElementById("<%= lblCategoryId.ClientID %>").value;
                        var owd = $find("<%=WRDetailDialog.ClientID %>");
                        owd.setSize(850, document.documentElement.offsetHeight);
                        owd.Show();
                        owd.maximize();
                        owd.setUrl("Controls/WMS/WRDetail.aspx?wrId=" + docId, "WRDetailDialog");
                        break;
                        case "AttachWF":
                        var projId = document.getElementById("<%= lblProjectId.ClientID %>").value;
                        var owd = $find("<%=AttachWorkflow.ClientID %>");
                        owd.Show();
                        owd.setUrl("Controls/Workflow/AttachWorkflow.aspx?objId=" + docId + "&objType=WR" + "&projId=" + projId, "AttachWorkflow");
                        break;
                        case "WFHistory":
                        var owd = $find("<%=WFProcessHistory.ClientID %>");
                        owd.Show();
                        owd.maximize();
                        owd.setUrl("Controls/Workflow/WorkflowProcessHistory.aspx?objId=" + docId + "&objType=WR", "WFProcessHistory");
                        break;
                    case "AttachDocument":
                        ...
                        owd.setUrl("Controls/WMS/WRAttach.aspx?objId=" + docId, "AttachDoc");
                        break;
                    case "CMS":
                        ...
                        case "EditProperties":
                            ...
                            owd.setSize(850, document.documentElement.offsetHeight);
                            owd.Show();
                            owd.setUrl("Controls/WMS/WREditForm.aspx?wrId=" + docId + "&projId=" + projectId, "CustomerDialog");
                        break;
                    case "Transmittals":
        ...
        <script type="text/javascript">
            ...
            function ShowEditForm(docId, projId) {
                var owd = $find("<%=CustomerDialog.ClientID %>");
                owd.Show();
                owd.setUrl("Controls/WMS/WREditForm.aspx?projId=" + projId + "&wrId=" + docId, "CustomerDialog");
            }
            ...
            function OnClientButtonClicking(sender, args) {
                ...
                if (strText == "Work Request") {
                    ...
                    owd.setSize(850, document.documentElement.offsetHeight);
                    owd.Show();
                    owd.setUrl("Controls/WMS/WREditForm.aspx?projId=" + projectId, "CustomerDialog");
                    //}
                }
