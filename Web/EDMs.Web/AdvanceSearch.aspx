<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AdvanceSearch.aspx.cs" Inherits="EDMs.Web.AdvanceSearch" EnableViewState="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="width: 98%; padding-top: 10px; padding-left: 5px">
        ...
        <div style="padding-bottom: 5px">
            <asp:Image ID="Image2" runat="server" ImageUrl="Images/typing.png" style="padding-right: 3px"/>Search All Text Field:<br />
                <asp:TextBox ID="txtSearchAllText" runat="server" Width="100%" />

        </div>
        <div style="padding-bottom: 5px">
            <asp:Image ID="Image1" runat="server" ImageUrl="Images/project.png" style="padding-right: 3px"/> Project:<br />
        ...
        <div style="padding-bottom: 5px">
            <asp:Image ID="imgCategory" runat="server" ImageUrl="Images/category1.png" style="padding-right: 3px"/> Category:<br />
             <telerik:RadComboBox ID="ddlCategory" runat="server" 
                Skin="Windows7" Width="100%" AllowCustomText="True" MarkFirstMatch="True">
                <Items>
        ...
        <div style="padding-bottom: 5px">
            <asp:Image ID="Image16" runat="server" ImageUrl="Images/incomingTrans.png" style="padding-right: 3px"/>Incoming Transmittal:<br />
                <asp:TextBox ID="txtIncomingTrans" runat="server" Width="100%" />
            <%--telerik:RadComboBox  ID="ddlIncomingTrans" runat="server" Skin="Windows7" Width="100%"  AllowCustomText="True"></telerik:RadComboBox>--%>
        </div>
           <div style="padding-bottom: 5px">
            <asp:Image ID="Image17" runat="server" ImageUrl="Images/outgoingTrans.png" style="padding-right: 3px"/>Outgoing Transmittal:<br />
                <asp:TextBox ID="txtOutgoingTrans" runat="server" Width="100%" />
            <%--telerik:RadComboBox  ID="ddlIncomingTrans" runat="server" Skin="Windows7" Width="100%"  AllowCustomText="True"></telerik:RadComboBox>--%>
        </div>  
        <div style="padding-bottom: 5px">
            <asp:Image ID="Image3" runat="server" ImageUrl="Images/docNo.png" style="padding-right: 3px"/>Document Number:<br />
                <asp:TextBox ID="txtDocNo" runat="server" Width="100%" />
        </div>
        <div style="padding-bottom: 5px">
            <asp:Image ID="Image4" runat="server" ImageUrl="Images/typing.png" style="padding-right: 3px"/>Document Title:<br />
                <asp:TextBox ID="txtDocTitle" runat="server" Width="100%" />
        </div>
        
        <div style="padding-bottom: 5px; display: none">
            <asp:Image ID="Image5" runat="server" ImageUrl="Images/revision.png" style="padding-right: 3px"/>Revision:<br />
                <asp:TextBox ID="txtRevision" runat="server" Width="100%" />
        </div>
        
        <div style="padding-bottom: 5px">
            <asp:Image ID="Image6" runat="server" ImageUrl="Images/status1.png" style="padding-right: 3px"/>Revision Status:<br />
               <%-- <asp:TextBox ID="txtRevisionStatus" runat="server" Width="100%" />--%>
             <telerik:RadComboBox  ID="ddlRevisionStatus" runat="server" Skin="Windows7" Width="100%"  AllowCustomText="True"   MarkFirstMatch="true"></telerik:RadComboBox>
        </div>
        
        <div style="padding-bottom: 5px; display: none">
            <asp:Image ID="Image7" runat="server" ImageUrl="Images/plant1.png" style="padding-right: 3px"/>Plant:<br />
               <%-- <asp:TextBox ID="txtPlant" runat="server" Width="100%" />--%>
            <telerik:RadComboBox  ID="ddlPlant" runat="server" Skin="Windows7" Width="100%"  AllowCustomText="True"    MarkFirstMatch="true"></telerik:RadComboBox>
        </div>
        
        <div style="padding-bottom: 5px">
            <asp:Image ID="Image8" runat="server" ImageUrl="Images/area1.png" style="padding-right: 3px"/>Area:<br />
               <%-- <asp:TextBox ID="txtArea" runat="server" Width="100%" />--%>
            <telerik:RadComboBox  ID="ddlArea" runat="server" Skin="Windows7" Width="100%"  AllowCustomText="True"   MarkFirstMatch="true"></telerik:RadComboBox>
        </div>
        <div style="padding-bottom: 5px">
            <asp:Image ID="Image9" runat="server" ImageUrl="Images/unit.png" style="padding-right: 3px"/>Unit:<br />
                <%--<asp:TextBox ID="txtUnit" runat="server" Width="100%" />--%>
             <telerik:RadComboBox  ID="ddlUnit" runat="server" Skin="Windows7" Width="100%"  AllowCustomText="True"   MarkFirstMatch="true"></telerik:RadComboBox>
        </div>
            
        <div style="padding-bottom: 5px">
            <asp:Image ID="Image10" runat="server" ImageUrl="Images/doctype1.png" style="padding-right: 3px"/>Document Type:<br />
                <%--<asp:TextBox ID="txtDocType" runat="server" Width="100%" />--%>
             <telerik:RadComboBox  ID="ddlDocType" runat="server" Skin="Windows7" Width="100%"  AllowCustomText="True"   MarkFirstMatch="true"></telerik:RadComboBox>
        </div>
        
        <div style="padding-bottom: 5px">
            <asp:Image ID="Image11" runat="server" ImageUrl="Images/stage.png" style="padding-right: 3px"/>Discipline:<br />
                <%--<asp:TextBox ID="txtDiscipline" runat="server" Width="100%" />--%>
            <telerik:RadComboBox  ID="ddlDiscipline" runat="server" Skin="Windows7" Width="100%"  AllowCustomText="True"   MarkFirstMatch="true"></telerik:RadComboBox>
        </div>
        
        <div style="padding-bottom: 5px; display: none">
            <asp:Image ID="Image12" runat="server" ImageUrl="Images/docCode.png" style="padding-right: 3px"/>Document Code:<br />
                <%--<asp:TextBox ID="txtDocCode" runat="server" Width="100%" />--%>
            <telerik:RadComboBox  ID="ddlDocCode" runat="server" Skin="Windows7" Width="100%"  AllowCustomText="True"   MarkFirstMatch="true"></telerik:RadComboBox>
        </div>
        
        <div style="padding-bottom: 5px; display: none">
            <asp:Image ID="Image13" runat="server" ImageUrl="Images/drawing.png" style="padding-right: 3px"/>Drawing Code:<br />
                <%--<asp:TextBox ID="txtDrawingCode" runat="server" Width="100%" />--%>
            <telerik:RadComboBox  ID="ddlDrawingCode" runat="server" Skin="Windows7" Width="100%"  AllowCustomText="True"   MarkFirstMatch="true"></telerik:RadComboBox>
        </div>
        
        <div style="padding-bottom: 5px; display: none">
            <asp:Image ID="Image14" runat="server" ImageUrl="Images/material.png" style="padding-right: 3px"/>Material Code:<br />
                <%--<asp:TextBox ID="txtMaterialCode" runat="server" Width="100%" />--%>
            <telerik:RadComboBox  ID="ddlMaterialCode" runat="server" Skin="Windows7" Width="100%"  AllowCustomText="True"   MarkFirstMatch="true"></telerik:RadComboBox>
        </div>
        
        <div style="padding-bottom: 5px; display: none">
            <asp:Image ID="Image15" runat="server" ImageUrl="Images/workCode.png" style="padding-right: 3px"/>Work Code:<br />
                <%--<asp:TextBox ID="txtWorkCode" runat="server" Width="100%" />--%>
            <telerik:RadComboBox  ID="ddlWorkCode" runat="server" Skin="Windows7" Width="100%"  AllowCustomText="True"   MarkFirstMatch="true"></telerik:RadComboBox>
        </div>
            
        <div style="width: 100%">
            <ul style="list-style-type: none">
                <li style="width: 100%; padding-top: 10px; padding-bottom: 3px; text-align: center">
                    <telerik:RadButton ID="btnSearch" runat="server" Text="Search" OnClick="btnSearch_OnClick"  Width="90px" style="text-align: center" Skin="Windows7">
                    ...
                    <telerik:RadSplitter ID="Radsplitter10" runat="server" Orientation="Vertical">
                        <telerik:RadPane ID="Radpane6" runat="server" Scrolling="None">
                            <telerik:RadGrid AllowCustomPaging="False" AllowPaging="True" AllowSorting="True" 
                                ...
                                Height="100%" ID="grdDocument"  AllowMultiRowSelection="false"
                                ...
                                <MasterTableView AllowMultiColumnSorting="false"
                                  ...
                                  <%--  <GroupByExpressions>
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridTemplateColumn AllowFiltering="False" UniqueName="EditColumn" >
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <asp:Image ID="EditLink" runat="server" ImageUrl="~/Images/info1.png" Style="cursor: pointer;" ToolTip="Document properties" />
                                                        <a/>
                                                </ItemTemplate>
                                            </telerik:GridTemplateColumn>
                                    ...
                                    <telerik:GridDateTimeColumn HeaderText="Date Created" UniqueName="CreatedDate" DataField="CreatedDate"
                                     ...
                                     <telerik:GridTemplateColumn HeaderText="Last Update By"  UniqueName="LastUpdatedByName" DataField="LastUpdatedByName" ShowFilterIcon="False" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        <HeaderStyle HorizontalAlign="Center" Width="80" />
                                        <ItemStyle HorizontalAlign="Center"  />
                                        <ItemTemplate>
        ...
        <telerik:RadAjaxManager runat="Server" ID="ajaxCustomer" OnAjaxRequest="RadAjaxManager1_AjaxRequest">
            ...
            <AjaxSettings>
                ...
                <telerik:AjaxSetting AjaxControlID="ajaxCustomer">
                  ...
                  <telerik:AjaxSetting AjaxControlID="ddlMaterialCode">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="grdDocument" LoadingPanelID="RadAjaxLoadingPanel2"/>
                    </UpdatedControls>
                </telerik:AjaxSetting>

                 <telerik:AjaxSetting AjaxControlID="ddlWorkCode">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="grdDocument" LoadingPanelID="RadAjaxLoadingPanel2"/>
                    </UpdatedControls>
                 </telerik:AjaxSetting>
                      <telerik:AjaxSetting AjaxControlID="ddlDrawingCode">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="grdDocument" LoadingPanelID="RadAjaxLoadingPanel2"/>
                    </UpdatedControls>
                 </telerik:AjaxSetting>
                           <telerik:AjaxSetting AjaxControlID="ddlDocCode">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="grdDocument" LoadingPanelID="RadAjaxLoadingPanel2"/>
                    </UpdatedControls>
                     </telerik:AjaxSetting>
                    ...
                    <telerik:AjaxSetting AjaxControlID="ddlRevisionStatus">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="grdDocument" LoadingPanelID="RadAjaxLoadingPanel2"/>
                    </UpdatedControls>
                </telerik:AjaxSetting>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            ...
            function ShowDocumentRevision(docId) {
                ...
                owd.Show();
                owd.maximize(true);
                owd.setUrl("Controls/Document/ProjectDocumentRevisionHistory.aspx?docId=" + docId, "RevisionDialog");
             }
            ...
            function AttachWorkflow(docId) {
                var owd = $find("<%=AttachWorkflow.ClientID %>");
                 ...
                 owd.Show();
                 owd.setUrl("Controls/Workflow/AttachWorkflow.aspx?objId=" + docId + "&projId=" + projId + "&type=1", "AttachWorkflow");
            }
            ...
            function OnClientButtonClicking(sender, args) {
                ...
                if (strText.toLowerCase() == "import project document register") {
                    ...
                    owd.Show();
                    owd.setUrl("Controls/Document/ImportProjectDocList.aspx", "ImportData");
                }
                ...
                if (strText.toLowerCase() == "document") {
                    ...
                    owd.setSize(730, document.documentElement.offsetHeight);
                    owd.Show();
                    owd.setUrl("Controls/Document/DocumentListProjectInfoEditForm.aspx?", "CustomerDialog");
                    //}
                }
