<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="NCRList.aspx.cs" Inherits="EDMs.Web.NCRList" EnableViewState="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
            ...
            <telerik:RadToolBar ID="CustomerMenu" runat="server" Width="100%" OnClientButtonClicking="OnClientButtonClicking">
                <Items>
                    <telerik:RadToolBarDropDown runat="server" Text="Add" ImageUrl="~/Images/addNew.png">
                        <Buttons>
                            <telerik:RadToolBarButton runat="server" Text="NCR" Value="1" ImageUrl="~/Images/index.png"></telerik:RadToolBarButton>
                            ...
                            <telerik:RadGrid AllowCustomPaging="False" AllowPaging="True" AllowSorting="True" 
                                ...
                                <MasterTableView AllowMultiColumnSorting="false"
                                  ...
                                  <%--  <GroupByExpressions>
                                    ...
                                    <telerik:GridTemplateColumn AllowFiltering="False" UniqueName="DocumentRevison" Display="False">
                                        <HeaderStyle Width="30"  />
                                        <ItemStyle HorizontalAlign="Center"/>
                                        <ItemTemplate>
                                    ...
                                    <telerik:GridTemplateColumn AllowFiltering="False" UniqueName="AttachWorkflow">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:Image ID="imgAttachWorkflow" runat="server" ImageUrl="~/Images/attachwf.png" Style="cursor: pointer;" ToolTip="Attach Document To Workflow"/>
                                                <a/>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="NCR Number" UniqueName="Number" DataField="Number"
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="NCR Subject" UniqueName="Subject" DataField="Subject"
                                        ShowFilterIcon="False" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Confidentiality" UniqueName="ConfidentialityName"
                                        ...
                                        ShowFilterIcon="False" FilterControlWidth="97%"  DataField="ProjectName"
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" >
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="Originating Organisation (OWNER)" UniqueName="OriginatingOrganisationOwnerName"
                                        ShowFilterIcon="False" FilterControlWidth="97%"  DataField="OriginatingOrganisationOwnerName"
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" >
                                        <HeaderStyle HorizontalAlign="Center" Width="200" />
                                        <ItemStyle HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <%# Eval("OriginatingOrganisationOwnerName") %>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                        
                                        <telerik:GridTemplateColumn HeaderText="Originating Organisation (PMC)" UniqueName="OriginatingOrganisationPMCName"
                                        ShowFilterIcon="False" FilterControlWidth="97%"  DataField="OriginatingOrganisationPMCName"
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" >
                                        <HeaderStyle HorizontalAlign="Center" Width="200" />
                                        <ItemStyle HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <%# Eval("OriginatingOrganisationPMCName") %>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                        
                                        <telerik:GridTemplateColumn HeaderText="Receiving Organisation (EPC)" UniqueName="ReceivingOrganisationEPCName"
                                        ShowFilterIcon="False" FilterControlWidth="97%"  DataField="ReceivingOrganisationEPCName"
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" >
                                        <HeaderStyle HorizontalAlign="Center" Width="200" />
                                        <ItemStyle HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <%# Eval("ReceivingOrganisationEPCName") %>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                        
                                        <telerik:GridTemplateColumn HeaderText="Reference Document Number" UniqueName="RefDocNo"
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="NCR Description" UniqueName="Description"
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="Action Taken" UniqueName="ActionTake"
                                        ShowFilterIcon="False" FilterControlWidth="97%"  DataField="ActionTake"
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" >
                                        <HeaderStyle HorizontalAlign="Center" Width="200" />
                                        <ItemStyle HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <%# Eval("ActionTake").ToString().Replace(Environment.NewLine, "<br/>") %>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="Issued by (OWNER)" UniqueName="IssuedByOwner" DataField="IssuedByOwner"
                                        ShowFilterIcon="False" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" >
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="Issued by (PMC)" UniqueName="IssuedByPMC" DataField="IssuedByPMC"
                                        ShowFilterIcon="False" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" >
                                        <HeaderStyle HorizontalAlign="Center" Width="120" />
                                        <ItemStyle HorizontalAlign="Left" />
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="Received by (EPC)" UniqueName="ReceivedByEPC" DataField="ReceivedByEPC"
                                        ShowFilterIcon="False" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" >
                                        <HeaderStyle HorizontalAlign="Center" Width="120" />
                                        <ItemStyle HorizontalAlign="Left" />
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="Closed by (PMB)" UniqueName="ClosedByPMB" DataField="ClosedByPMB"
                                        ShowFilterIcon="False" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" >
                                        <HeaderStyle HorizontalAlign="Center" Width="120" />
                                        <ItemStyle HorizontalAlign="Center" />
    ...
    <telerik:RadWindowManager ID="RadWindowManager1" runat="server" EnableShadow="true" >
        <Windows>
            <telerik:RadWindow ID="CustomerDialog" runat="server" Title="NCR Information"
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            ...
            function ShowEditForm(objId) {
                ...
                window.Show();
                window.setUrl("Controls/Document/NCRSIEditForm.aspx?projectId=" + projectId + "&objId=" + objId +"&type=1", "CustomerDialog");
            ...
            function OnClientButtonClicking(sender, args) {
                ...
                if (strText === "NCR") {
                    ...
                    window.setSize(730, document.documentElement.offsetHeight);
                    window.Show();
                    window.setUrl("Controls/Document/NCRSIEditForm.aspx?projectId=" + projectId + "&type=1", "CustomerDialog");
