<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EAM_TranslineList.aspx.cs" Inherits="EDMs.Web.EAM_TranslineList" EnableViewState="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <style type="text/css">
        ...
        #ctl00_ContentPlaceHolder2_ctl00_ContentPlaceHolder2_grdTranslinePanel {
            height: 100% !important;
        }

        #ctl00_ContentPlaceHolder2_grdTransline_GridData {
            height: 100% !important;
        }
                ...
                <telerik:RadToolBar RenderMode="Lightweight" runat="server" ID="ToolBarWO" EnableRoundedCorners="true" EnableShadows="true" Skin="MetroTouch" Height="40">
                    <Items>
                        <telerik:RadToolBarButton Text="Left" Group="Align">
                            <ItemTemplate>
                                <span style="color: dodgerblue;font-size: 16px;font-weight: normal;font-family: helvetica, arial, verdana, sans-serif;">Danh mục nhật ký giao dịch của vật tư</span>
                ...
                <telerik:RadGrid ID="grdTransline" runat="server" AllowPaging="False"
                    ...
                    <MasterTableView Width="100%" TableLayout="Auto" CssClass="rgMasterTable" >
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn DataField="kieuGiaoDich" HeaderText="Kiểu giao dịch" UniqueName="kieuGiaoDich">
                                <HeaderStyle HorizontalAlign="Center" Width="120" />
                                <ItemStyle HorizontalAlign="Left" />
                            </telerik:GridBoundColumn>
                            ...
                            <telerik:GridBoundColumn DataField="PhieuYCCap" HeaderText="Phiếu yêu cầu cấp" UniqueName="PhieuYCCap">
                                <HeaderStyle HorizontalAlign="Center" Width="120" />
                                <ItemStyle HorizontalAlign="Left" />
                            </telerik:GridBoundColumn>
                            ...
                            <telerik:GridBoundColumn DataField="SoDonHang" HeaderText="Số đơn hàng" UniqueName="SoDonHang">
                                <HeaderStyle HorizontalAlign="Center" Width="120" />
                                <ItemStyle HorizontalAlign="Left" />
                            </telerik:GridBoundColumn>
                            
                            
                            <telerik:GridBoundColumn DataField="MucDonHang" HeaderText="Mục đơn hàng" UniqueName="MucDonHang">
                                <HeaderStyle HorizontalAlign="Center" Width="120" />
                                <ItemStyle HorizontalAlign="Left" />
                            </telerik:GridBoundColumn>
                            
                            <telerik:GridBoundColumn DataField="SoYCMuaSam" HeaderText="Số yêu cầu mua sắm" UniqueName="SoYCMuaSam">
                                <HeaderStyle HorizontalAlign="Center" Width="120" />
                                <ItemStyle HorizontalAlign="Left" />
                            </telerik:GridBoundColumn>
                            
                            <telerik:GridBoundColumn DataField="MucYCMuaSam" HeaderText="Mục yêu cầu mua sắm" UniqueName="MucYCMuaSam">
                                <HeaderStyle HorizontalAlign="Center" Width="120" />
                                <ItemStyle HorizontalAlign="Left" />
                            </telerik:GridBoundColumn>
                        </Columns>
