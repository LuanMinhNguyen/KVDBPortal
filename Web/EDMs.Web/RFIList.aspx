<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RFIList.aspx.cs" Inherits="EDMs.Web.RFIList" EnableViewState="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
                ...
                <Items>
                    ...
                    <telerik:RadToolBarButton runat="server" IsSeparator="true"/>
                      <telerik:RadToolBarButton runat="server" Value="ShowAll">
                                <ItemTemplate>
                                    <telerik:RadButton ID="btnSearchIncoming" Text="RFI Detail" Visible="false" runat="server" NavigateUrl="~/Controls/Document/RFIDetailList.aspx" OnClientClicking="OnClientClicking"  Width="100px" style="text-align: center">
                        ...
                        <telerik:RadPane ID="Radpane6" runat="server" Scrolling="None">
                            <telerik:RadGrid AllowCustomPaging="False" AllowPaging="True" AllowSorting="True" 
                                           ...
                                           <telerik:GridTemplateColumn AllowFiltering="False" UniqueName="DeleteColumn">
                                            ...
                                            <ItemTemplate>
                                                <div>
                                                    ...
                                                    <asp:Image ID="delete" runat="server" ImageUrl="~/Images/delete.png" Style="cursor: pointer;" ToolTip="Delete RFI" Visible='<%#Convert.ToBoolean( DataBinder.Eval(Container.DataItem, "IsCanDelete"))&& !Convert.ToBoolean(Eval("IsAttachWorkflow")) %>'/>
                                                    <a/></div>
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
                              ...
                              <telerik:GridTemplateColumn AllowFiltering="False">
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <asp:Image runat="server" ImageUrl="~/Images/workflow1.png" Style="cursor: pointer;" ToolTip="RFI Detail" />
                                                        </a>
                                                </ItemTemplate>
                                            </telerik:GridTemplateColumn>
                            <telerik:GridTemplateColumn AllowFiltering="False" UniqueName="ExportExcelForm">
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:Image ID="imgExcel" runat="server" ImageUrl="~/Images/excelfile1.png" Style="cursor: pointer;" ToolTip="Export RFI Form" />
                                    <a/>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            <telerik:GridTemplateColumn AllowFiltering="False" Visible="True" UniqueName="Import">
                                            <HeaderStyle Width="30"  />
                                            <ItemStyle HorizontalAlign="Center"/>
                                            <ItemTemplate>
                                                <div>
                                                    <a href='javascript:ImportRFIDetail("<%# DataBinder.Eval(Container.DataItem, "ID") %>")' style="text-decoration: none; color:blue">
                                                    <asp:Image ID="imaexport" runat="server" ImageUrl="~/Images/export.png" Style="cursor: pointer;" ToolTip="Import RFI Detail" Visible='<%# !Convert.ToBoolean( DataBinder.Eval(Container.DataItem, "IsHasImport")) %>'/>
                                                    <a/></div>
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
                            ...
                            <telerik:GridTemplateColumn AllowFiltering="False" UniqueName="AttachWorkflow" >
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:Image ID="imgAttachWorkflow" runat="server" ImageUrl="~/Images/attachwf.png" Style="cursor: pointer;" ToolTip="Attach RFI To Workflow" Visible='<%# Convert.ToBoolean( DataBinder.Eval(Container.DataItem, "IsHasImport")) && !Convert.ToBoolean(Eval("IsAttachWorkflow"))%>'/>
                                        <a/>
                                                
                                        <asp:Image ID="imgAttachWorkflowOk" runat="server" ImageUrl="~/Images/attachwfOk.png" ToolTip="RFI Attached To Workflow" Visible='<%# Convert.ToBoolean(Eval("IsAttachWorkflow"))%>'/>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                                ...
                                <ItemTemplate>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="RFI Number" UniqueName="Number" DataField="Number"
                                     ...
                                     <telerik:GridDateTimeColumn HeaderText="Issued Date" UniqueName="IssuedDate" DataField="IssuedDate"
                                        ...
                                        ShowFilterIcon="False" FilterControlWidth="97%"  DataField="GroupName" Display="false"
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" >
                                     ...
                                     <telerik:GridTemplateColumn HeaderText="Site Manager" UniqueName="SiteManager" DataField="SiteManager"
                                        ShowFilterIcon="False" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" >
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="QA/QC Manager" UniqueName="QAQCManager" DataField="QAQCManager"
                                        ShowFilterIcon="False" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" >
                                        <HeaderStyle HorizontalAlign="Center" Width="150" />
                                        <ItemStyle HorizontalAlign="Left" />
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="Create By" UniqueName="CreatedByName"
                                        ShowFilterIcon="False" FilterControlWidth="97%"  DataField="CreatedByName"
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" >
    ...
    <telerik:RadWindowManager ID="RadWindowManager1" runat="server" EnableShadow="true" >
        <Windows>
            <telerik:RadWindow ID="CustomerDialog" runat="server" Title="RFI Information"
            ...
            <telerik:RadWindow ID="ResponseWnd" runat="server" 
             ...
             <telerik:RadWindow ID="ETRMAttachFile" runat="server" Title="RFI Attach Files"
            ...
            <telerik:RadWindow ID="RevisionDialog" runat="server" Title="RFI Detail"
               VisibleStatusbar="false" Height="700" Width="730" OnClientClose="refreshGrid"
                Left="150px" ReloadOnShow="true" ShowContentDuringLoad="false" Modal="true" >
            </telerik:RadWindow>
            ...
            <telerik:RadWindow ID="ImportData" runat="server" Title="Import RFI Detail list"
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            ...
            function gridMenuClicking(sender, args) {
                ...
                var isFullPermission = "true"; <%--document.getElementById("<%= IsFullPermission.ClientID %>").value;--%>
               ...
               switch (itemValue) {
                        ...
                        owd.Show();
                        owd.setUrl("Controls/Document/RFIDetailEditForm.aspx?rfiId=" + docId, "RevisionDialog");
                        break;
                        case "Attachfile":
                        var owd = $find("<%=AttachDoc.ClientID %>");
                        owd.setSize(730, document.documentElement.offsetHeight);
                        owd.Show();
                        owd.setUrl("Controls/Document/RFIAttachFileList.aspx?docId=" + docId + "&isFullPermission=" + isFullPermission, "AttachDoc");
                        break;
                        case "exportrfi":
                        ajaxManager.ajaxRequest("ExportRFI_"+docId);
                        break;
                }
            }
             function ShowAllAttachFile(objId) {
                ...
                owd.Show();
                owd.setUrl("Controls/Document/RFIAttachFileList.aspx?docId=" + objId, "ETRMAttachFile");
             }
            function ExportExcelForm(objId) {
                ajaxManager.ajaxRequest("ExportRFI_" + objId);
            }
            function ShowStep(objId) {
              var owd = $find("<%=RevisionDialog.ClientID %>");
                owd.Show();
                owd.maximize(true);
             owd.setUrl("Controls/Document/RFIDetailEditForm.aspx?rfiId=" + objId, "RevisionDialog");
            }
            ...
            function DeleteAttachFile(id) {
                if (confirm("Do you want delete the RFI?") == false) return;
        ...
        <script type="text/javascript">
            ...
            function AttachWorkflow(docId) {
                var owd = $find("<%=AttachWorkflow.ClientID %>");
                 ...
                 owd.Show();
                 owd.setUrl("Controls/Workflow/AttachWorkflow.aspx?objId=" + docId + "&projId=" + projId + "&type=5" + "&attachFrom=RFI&customizeWfFrom=Obj", "AttachWorkflow");
            }
            ...
            function ImportRFIDetail(Id) {
                var window = $find("<%=ImportData.ClientID %>");
                    window.Show();
                    window.setUrl("Controls/Document/RFIImportDetail.aspx?objId=" + Id, "ImportData");
            }
