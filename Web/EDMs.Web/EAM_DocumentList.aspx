<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EAM_DocumentList.aspx.cs" Inherits="EDMs.Web.EAM_DocumentList" EnableViewState="true" %>
    ...
    <div style=" width: 100%; height: 100%; background-color: #f0f0f0 ">
                        ...
                        <telerik:RadSplitter RenderMode="Lightweight" ID="LeftSplitter" runat="server" Height="100%" Width="100%" Orientation="Horizontal" Skin="Silk">
                            <telerik:RadPane ID="Radpane3" runat="server" Width="100%" Height="27">
                                <telerik:RadTextBox RenderMode="Lightweight" Width="100%" ID="txtSearch" runat="server"
                                                    EmptyMessage="Search within All Documents" InvalidStyleDuration="100">
                                </telerik:RadTextBox>
                            ...
                            <telerik:RadPane ID="Radpane4" runat="server" Width="100%" >
                                <telerik:RadListBox RenderMode="Lightweight" runat="server" ID="lbDocument" Height="100%" Width="100%" LoadingPanelID="<%# RadAjaxLoadingPanel2.ClientID %>" EnableLoadOnDemand="False" Skin="MetroTouch" OnSelectedIndexChanged="lbDocument_OnSelectedIndexChanged" AutoPostBack="True">
                                    <ItemTemplate>
                                        <span class="ObjectTitle"><%# DataBinder.Eval(Container, "Text")%></span>
                                        <table>
                                            <tr>
                                                <td align="right" style="width: 120px"><span class="ObjectDetail">Đường dẫn tệp tin:&nbsp;</span></td>
                                                <td><span class="ObjectDetail"></span></td>
                                            </tr>
                                            <tr>
                                                <td align="right" ><span class="ObjectDetail">Kiểu:&nbsp;</span></td>
                                                <td><span class="ObjectDetail"></span></td>
                                            </tr>
                                            <tr>
                                                <td align="right"><span class="ObjectDetail">Phân loại:&nbsp;</span></td>
                                                <td><span class="ObjectDetail"></span></td>
                                            </tr>
                                        </table>
                                    </ItemTemplate>
                    ...
                    <telerik:RadPane ID="PanelObjectDetail" runat="server" Scrolling="Y">
                        <telerik:RadTabStrip RenderMode="Lightweight" ID="TabObjectDetail" runat="server"  Width="100%" Height="100%" Skin="MetroTouch" MultiPageID="MultiPageObject" SelectedIndex="0" EnableDragToReorder="true">
                            <Tabs>
                                ...
                                <telerik:RadTab Text="Nơi Sử Dụng"/>
                            </Tabs>
                        </telerik:RadTabStrip>
                        ...
                        <telerik:RadMultiPage runat="server" ID="MultiPageObject" SelectedIndex="0">
                            <telerik:RadPageView runat="server" ID="RadPageView2" >
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td align="right" style="width: 150px; padding-right: 2px">Tài liệu:</td>
                                        <td>
                                            <telerik:RadTextBox ID="txtTaiLieu" runat="server" Skin="MetroTouch" Width="150"/>
                                        ...
                                        <td>
                                            <telerik:RadTextBox ID="txtTieuDe" runat="server" Skin="MetroTouch" Width="250"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right" style="width: 150px; padding-right: 2px">Ngày cập nhật:</td>
                                        <td>
                                            <telerik:RadDatePicker ID="txtNgayCapNhat" runat="server" Skin="MetroTouch" Width="150">
                                        ...
                                        <telerik:RadGrid ID="grdPORDLines" runat="server" AllowPaging="False"
                                            ...
                                            <MasterTableView Width="100%" TableLayout="Auto" CssClass="rgMasterTable" >
                                                ...
                                                <Columns>
                                                    ...
                                                    <telerik:GridBoundColumn DataField="MaTaiLieu" HeaderText="Mã tài liệu" UniqueName="MaTaiLieu">
                                                        <HeaderStyle HorizontalAlign="Center" Width="100" />
                                                        <ItemStyle HorizontalAlign="Left" />
                                                    </telerik:GridBoundColumn>
                                                    
                                                    <telerik:GridBoundColumn DataField="DAE_ENTITY" HeaderText="DAE_ENTITY" UniqueName="DAE_ENTITY">
                                                        <HeaderStyle HorizontalAlign="Center" Width="100" />
                                                        <ItemStyle HorizontalAlign="Left" />
                                                    </telerik:GridBoundColumn>
                                                    
                                                    <telerik:GridBoundColumn DataField="dae_code" HeaderText="dae_code" UniqueName="dae_code">
                                                    ...
                                                    <telerik:GridBoundColumn DataField="LoaiTaiLieu" HeaderText="Loại tài liệu" UniqueName="LoaiTaiLieu" >
                                                        <HeaderStyle HorizontalAlign="Center" Width="120" />
                                                        <ItemStyle HorizontalAlign="Left" />
                                                    </telerik:GridBoundColumn>

                                                    <telerik:GridTemplateColumn HeaderText="Ngày tạo" UniqueName="NgayTao" AllowFiltering="false" >
                                                        <HeaderStyle HorizontalAlign="Center" Width="80" />
                                                        <ItemStyle HorizontalAlign="Center" />
                                                        <ItemTemplate>
                                                            <%# Eval("NgayTao", "{0:dd-MMM-yy}") %>
                                                        </ItemTemplate>
        ...
        <telerik:RadAjaxManager runat="Server" ID="ajaxCustomer" OnAjaxRequest="RadAjaxManager1_AjaxRequest">
            ...
            <AjaxSettings>
                ...
                <telerik:AjaxSetting AjaxControlID="lbDocument">
                    <UpdatedControls>
                ...
                <telerik:AjaxSetting AjaxControlID="btnSearch">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="lbDocument" LoadingPanelID="RadAjaxLoadingPanel2"/>
                    </UpdatedControls>
                </telerik:AjaxSetting>
