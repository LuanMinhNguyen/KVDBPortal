<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" 
    CodeBehind="GroupsList.aspx.cs" Inherits="EAM.WebPortal.Control.Security.GroupsList" EnableViewState="true" %>
            ...
            <telerik:RadToolBar ID="CustomerMenu" runat="server" Width="100%" OnClientButtonClicking="OnClientButtonClicking">
                <Items>
                    <telerik:RadToolBarDropDown runat="server" Text="New" ImageUrl="~/Resources/Images/addNew.png">
                        <Buttons>
                            <telerik:RadToolBarButton runat="server" Text="Group" Value="1" ImageUrl="~/Resources/Images/group.png"/>
                        </Buttons>
                                ...
                                <MasterTableView DataKeyNames="Id" ClientDataKeyNames="Id" Width="100%" >
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridTemplateColumn>
                                            ...
                                            <ItemTemplate>
                                                <asp:ImageButton runat="server" Style="padding-left: 7px; cursor: pointer;" ID="EditLink" ImageUrl="~/Resources/Images/edit.png" />
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
                                        <telerik:GridTemplateColumn>
                                            <HeaderStyle Width="30" HorizontalAlign="Center"></HeaderStyle>
                                            ...
                                            <ItemTemplate>
                                                <!--BtnDeleteClick-->
                                                <asp:ImageButton runat="server" Style="padding-left: 7px; cursor: pointer;" ID="btnDelete" ImageUrl="~/Resources/Images/delete.png" CommandName="DeleteRoleCommand"
                                        ...
                                        <telerik:GridBoundColumn DataField="Name" HeaderText="Name" UniqueName="colName" >
                                            <HeaderStyle Width="150" HorizontalAlign="Center"></HeaderStyle>
                                            <ItemStyle HorizontalAlign="Left"></ItemStyle>
                                        </telerik:GridBoundColumn>
                                        
                                        <telerik:GridBoundColumn DataField="ContractorName" HeaderText="Member Of" UniqueName="ContractorName" Display="False">
                                        ...
                                        <telerik:GridBoundColumn DataField="Description" HeaderText="Description" UniqueName="colDescription" >
                                             <HeaderStyle Width="800" HorizontalAlign="Center"></HeaderStyle>
                                            <ItemStyle HorizontalAlign="Left"></ItemStyle>
                                        </telerik:GridBoundColumn>
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="Admin" UniqueName="RoleAdmin" Display="False">
                                            ...
                                            <ItemTemplate>
                                                <asp:Image ID="Image1" runat="server" ImageUrl="~/Resources/Images/ok.png" Visible='<%# Convert.ToBoolean(DataBinder.Eval(Container.DataItem, "IsAdmin")) %>'/>
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="Limited Data View" UniqueName="IsLimitedView" Display="False">
                                            ...
                                            <ItemStyle Width="10%" HorizontalAlign="Center"></ItemStyle>
                                            <ItemTemplate>
                                                <asp:Image ID="Image2" runat="server" ImageUrl="~/Resources/Images/ok.png" Visible='<%# Convert.ToBoolean(DataBinder.Eval(Container.DataItem, "IsLimitedView")) %>'/>
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
