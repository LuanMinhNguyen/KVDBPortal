<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" 
    CodeBehind="UsersList.aspx.cs" Inherits="EAM.WebPortal.Control.Security.UsersList" EnableViewState="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <style type="text/css">
        ...
        .exampleWrapper
        {
            width: 100%;
            height: 100%;
            /*background: transparent url(~/Resources/Images/background.png) no-repeat top left;*/
            position: relative;
        }
    ...
    <telerik:RadSplitter ID="RadSplitter4" runat="server" Orientation="Horizontal" Width="100%">
        <telerik:RadPane ID="RadPane3" runat="server" Height="30px" Scrollable="false" Scrolling="None">
            <telerik:RadToolBar ID="CustomerMenu" runat="server" Width="100%" OnClientButtonClicking="OnClientButtonClicking">
                <Items>
                    <telerik:RadToolBarDropDown runat="server" Text="New" ImageUrl="~/Resources/Images/addNew.png">
                        <Buttons>
                            <telerik:RadToolBarButton runat="server" Text="User" Value="1" ImageUrl="~/Resources/Images/user.png"/>
                        </Buttons>
                    ...
                    <telerik:RadToolBarButton ImageUrl="~/Resources/Images/search.gif" Value="search" CommandName="doSearch" />--%>
                </Items>
            </telerik:RadToolBar>
                                ...
                                <MasterTableView DataKeyNames="Id" ClientDataKeyNames="Id" Width="100%">
                                    ...
                                    <GroupByExpressions>
                                        <telerik:GridGroupByExpression>
                                            <SelectFields>
                                                <telerik:GridGroupByField FieldAlias="Group" FieldName="Role.Name" FormatString="{0:D}" HeaderValueSeparator=": "></telerik:GridGroupByField>
                                            </SelectFields>
                                            <GroupByFields>
                                                <telerik:GridGroupByField FieldName="Role.Name" SortOrder="Ascending"></telerik:GridGroupByField>
                                            </GroupByFields>
                                        </telerik:GridGroupByExpression>
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridButtonColumn UniqueName="ResetPass" CommandName="ResetPass" ConfirmText="Do you want to Reset password of this user?" ButtonType="ImageButton" ImageUrl="~/Resources/Images/reset.png">
                                        ...
                                        <telerik:GridTemplateColumn AllowFiltering="False">
                                            ...
                                            <ItemTemplate>
                                                <asp:ImageButton runat="server" Style="cursor: pointer;" 
                                                    ...
                                                    ID="EditLink" ImageUrl="~/Resources/Images/edit.png"/>
                                            </ItemTemplate>
                                        ...
                                        <telerik:GridTemplateColumn AllowFiltering="False">
                                            ...
                                            <ItemTemplate>
                                                <!--BtnDeleteClick-->
                                                <asp:ImageButton runat="server" Style=" cursor: pointer;" ID="btnDelete" CommandName="DeleteUserCommand" ImageUrl="~/Resources/Images/delete.png"
                                                    Visible='<%# Convert.ToInt32(DataBinder.Eval(Container.DataItem, "Id")) != 1%>'
                                        ...
                                        <telerik:GridBoundColumn DataField="OrgCode" HeaderText="Organization Code" UniqueName="OrgCode" FilterControlWidth="100%" ShowFilterIcon="False" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                            <HeaderStyle HorizontalAlign="Center"  Width="250" />
                                            <ItemStyle HorizontalAlign="Left" />
                                        </telerik:GridBoundColumn>
                                        
                                        <telerik:GridBoundColumn DataField="Role.Name" HeaderText="Group" UniqueName="colRoleName" FilterControlWidth="100%" ShowFilterIcon="False" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                            <HeaderStyle HorizontalAlign="Center"  Width="250" />
                                            <ItemStyle HorizontalAlign="Left" />
                                        </telerik:GridBoundColumn>
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="Dept Manager" UniqueName="IsDeptManager" AllowFiltering="False" Display="False">
                                            ...
                                            <ItemTemplate>
                                                <asp:Image ID="Image1" runat="server" ImageUrl="~/Resources/Images/ok.png" Visible='<%# Eval("IsDeptManager") %>'/>
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="Manager" UniqueName="IsDeptManager" AllowFiltering="False" Display="False">
                                            ...
                                            <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                            <ItemTemplate>
                                                <asp:Image ID="imgManager" runat="server" ImageUrl="~/Resources/Images/ok.png" Visible='<%# Eval("IsDeptManager") %>'/>
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
                                        
                                        <telerik:GridTemplateColumn HeaderText="Leader" UniqueName="IsLeader" AllowFiltering="False" Display="False">
                                                <HeaderStyle Width="80" HorizontalAlign="Center" ></HeaderStyle>
                                            <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                            <ItemTemplate>
                                                <asp:Image ID="imgLeader" runat="server" ImageUrl="~/Resources/Images/ok.png" Visible='<%# Eval("IsLeader") %>'/>
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
                                        
                                        <telerik:GridTemplateColumn HeaderText="Engineer" UniqueName="IsEngineer" AllowFiltering="False" Display="False">
                                                <HeaderStyle Width="80" HorizontalAlign="Center" ></HeaderStyle>
                                            <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                            <ItemTemplate>
                                                <asp:Image ID="imgEngineer" runat="server" ImageUrl="~/Resources/Images/ok.png" Visible='<%# Eval("IsEngineer") %>'/>
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="Is DC/ Project Director" UniqueName="IsActive" AllowFiltering="False" Display="False">
                                                <HeaderStyle Width="80" HorizontalAlign="Center" ></HeaderStyle>
                                            <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                            <ItemTemplate>
                                                <asp:Image ID="imgActive" runat="server" ImageUrl="~/Resources/Images/ok.png" Visible='<%# Eval("IsDC")== null || (bool) Eval("IsDC")==true %>'/>
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
                                    </Columns>
        ...
        <script type="text/javascript">
            ...
            function pageLoad() {
                ...
                $telerik.$(".searchtextbox")
                    .bind("keypress", function (e) {
                        searchButton.set_imageUrl("~/Resources/Images/search.gif");
            ...
            function performSearch(searchTextBox) {
                if (searchTextBox.get_value()) {
                    searchButton.set_imageUrl("~/Resources/Images/clear.gif");
