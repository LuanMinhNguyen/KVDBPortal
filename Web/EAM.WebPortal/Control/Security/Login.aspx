<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="EAM.WebPortal.Control.Security.Login" %>
...
<body style="overflow:hidden;">
    <div id="login-wrapper" class="png_bg">
        <div id="login-top">
            <img src="../../Resources/Images/logo.svg" style="height: 86px; padding-top: 100px !important; padding-left: 0px; padding-bottom: 10px"/>
        </div>
        <div id="login-content" style="padding-top: 0px">
            ...
            <telerik:RadAjaxLoadingPanel runat="server" ID="RadAjaxLoadingPanel2" />
                ...
                <span id="spanTitle">EAM Web Portal - Centers for Disease Control HCMC</span>
                </div>
