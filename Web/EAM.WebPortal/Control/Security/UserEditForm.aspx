<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserEditForm.aspx.cs" Inherits="EAM.WebPortal.Control.Security.UserEditForm" ValidateRequest ="true" %>
    ...
    <form id="frmUserEdit" runat="server">
        ...
        <div style="width: 100%" runat="server" ID="divContent">
            ...
            <li style="width: 600px;">
                <div>
                    <label style="width: 125px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
                        <span style="color: #2E5689; text-align: right; ">Organization
                        </span>
                    </label>
                    <div style="float: left; padding-top: 5px;" class="qlcbFormItem" runat="server" id="div9">
                        <telerik:RadListBox RenderMode="Lightweight" ID="lbOrg" runat="server" CheckBoxes="true" ShowCheckAll="true" Width="310" Height="150"></telerik:RadListBox>
                    </div>
                </div>
                <div style="clear: both; font-size: 0;"></div>
            </li>
            ...
            <li style="width: 600px;">
                <div>
                    <label style="width: 125px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
                        <span style="color: #2E5689; text-align: right; ">Is TTYT
                        </span>
                    </label>
                    <div style="float: left; padding-top: 5px;" class="qlcbFormItem" runat="server" id="div10">
                        <asp:CheckBox runat="server" ID="cbIsTTYT"/>
                    </div>
                </div>
                <div style="clear: both; font-size: 0;"></div>
            </li>
            ...
            <li style="width: 600px;">
                <div>
                    <label style="width: 125px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
                        <span style="color: #2E5689; text-align: right; ">Số TYT
                        </span>
                    </label>
                    <div style="float: left; padding-top: 5px;" class="qlcbFormItem" runat="server" id="div11">
                        <asp:TextBox runat="server" ID="txtSoTYT"  Style="width: 300px;" CssClass="min25Percent"></asp:TextBox>
                    </div>
                </div>
                <div style="clear: both; font-size: 0;"></div>
            </li>
