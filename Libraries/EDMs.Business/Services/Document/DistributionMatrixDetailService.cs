...
namespace EDMs.Business.Services.Document
{
    ...
    public class DistributionMatrixDetailService
    {
        ...
        public List<DistributionMatrixDetail> GetAllByDisAndDocType(int disciplineId,  int docTypeId)
        {
            return this.repo.GetAll().Where(t => t.DisciplineId == disciplineId && t.DocTypeId == docTypeId).ToList();
        }
        ...
        public List<DistributionMatrixDetail> GetAllByDM(int distributionMatrixId)
        {
            return this.repo.GetAll().Where(t => t.DistributionMatrixId == distributionMatrixId).ToList();
        }
    }
}
