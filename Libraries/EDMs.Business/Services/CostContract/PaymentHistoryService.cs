...
namespace EDMs.Business.Services.CostContract
{
    ...
    public class PaymentHistoryService
    {
        ...
        /// The repo.
        /// </summary>
        private readonly PaymentHistoryDAO repo;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentHistoryService"/> class.
        /// </summary>
        public PaymentHistoryService()
        {
            this.repo = new PaymentHistoryDAO();
            this.PermissionWorkgroupService = new PermissionWorkgroupService();
        }

        #region Get (Advances)

        public List<PaymentHistory> GetAllByContract(int contractID)
        {
        ...
        /// The <see cref="List"/>.
        /// </returns>
        public List<PaymentHistory> GetAllInPermission(int userId)
        {
        ...
        {
            return this.repo.GetAll().OrderByDescending(t => t.ActualDate).ToList();
        }
        ...
        /// <param name="bo"></param>
        /// <returns></returns>
        public int? Insert(PaymentHistory bo)
        {
        ...
        /// <param name="bo"></param>
        /// <returns></returns>
        public bool Update(PaymentHistory bo)
        {
            try
            {
        ...
        /// <param name="bo"></param>
        /// <returns></returns>
        public bool Delete(PaymentHistory bo)
        {
            try
            {
