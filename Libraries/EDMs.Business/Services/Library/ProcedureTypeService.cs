...
namespace EDMs.Business.Services.Library
{
    ...
    public class ProcedureTypeService
    {
        ...
        /// The repo.
        /// </summary>
        private readonly ProcedureTypeDAO repo;

        private readonly WaitingSyncDataService waitingSyncDataService;

        /// <summary>
        /// Initializes a new instance of the <see cref="ProcedureTypeService"/> class.
        /// </summary>
        public ProcedureTypeService()
        {
            this.waitingSyncDataService = new WaitingSyncDataService();
            this.repo = new ProcedureTypeDAO();
        }

        #region Get (Advances)
        public List<ProcedureType> GetAllProcedureTypeOfProject(int projectId)
        {
        ...
        /// <param name="bo"></param>
        /// <returns></returns>
        public int? Insert(ProcedureType bo)
        {
            ...
            if (objId != null)
            {
                var changeData = new WaitingSyncData()
                {
                    ...
                    ObjectID2 = objId,
                    ObjectName = "[Library].[ProcedureType]",
        ...
        /// <param name="bo"></param>
        /// <returns></returns>
        public bool Update(ProcedureType bo)
        {
            try
            {
        ...
        /// <param name="bo"></param>
        /// <returns></returns>
        public bool Delete(ProcedureType bo)
        {
            try
            {
