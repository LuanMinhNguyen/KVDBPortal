namespace EDMs.Business.Services.Library
{
    ...
    public class OrganizationCodeService
    {
        ...
        /// The repo.
        /// </summary>
        private readonly OrganizationCodeDAO repo;

        /// <summary>
        /// Initializes a new instance of the <see cref="OrganizationCodeService"/> class.
        /// </summary>
        public OrganizationCodeService()
        {
            this.repo = new OrganizationCodeDAO();
        }
        ...
        /// <param name="bo"></param>
        /// <returns></returns>
        public int? Insert(OrganizationCode bo)
        {
        ...
        /// <param name="bo"></param>
        /// <returns></returns>
        public bool Update(OrganizationCode bo)
        {
            try
            {
        ...
        /// <param name="bo"></param>
        /// <returns></returns>
        public bool Delete(OrganizationCode bo)
        {
            try
            {
