...
namespace EDMs.Business.Services.Library
{
    ...
    /// </summary>
    public class MRTypeService
    {
        /// <summary>
        /// The repo.
        /// </summary>
        private readonly MRTypeDAO repo;

        private readonly WaitingSyncDataService waitingSyncDataService;

        /// <summary>
        /// Initializes a new instance of the <see cref="MRTypeService"/> class.
        /// </summary>
        public MRTypeService()
        {
            this.waitingSyncDataService = new WaitingSyncDataService();
            this.repo = new MRTypeDAO();
        }

        #region Get (Advances)
        public List<MRType> GetAllMRTypeOfProject(int projectId)
        {
