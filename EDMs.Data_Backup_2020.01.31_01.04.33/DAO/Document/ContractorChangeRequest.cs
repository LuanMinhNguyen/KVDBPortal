// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ContractorChangeRequestDAO.cs" company="">
//   
// </copyright>
// <summary>
//   The category dao.
...
namespace EDMs.Data.DAO.Document
{
    ...
    /// The category dao.
    /// </summary>
    public class ContractorChangeRequestDAO : BaseDAO
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContractorChangeRequestDAO"/> class.
        /// </summary>
        public ContractorChangeRequestDAO() : base() { }
        ...
        /// </returns>
        public IQueryable<ContractorChangeRequest> GetIQueryable()
        {
            return this.EDMsDataContext.ContractorChangeRequests;
        }
        ...
        /// The <see cref="List"/>.
        /// </returns>
        public List<ContractorChangeRequest> GetAll()
        {
            return this.EDMsDataContext.ContractorChangeRequests.ToList();
        }
        ...
        /// </returns>
        public ContractorChangeRequest GetById(Guid id)
        {
            return this.EDMsDataContext.ContractorChangeRequests.FirstOrDefault(ob => ob.ID == id);
        }
        ...
        /// The <see cref="int?"/>.
        /// </returns>
        public Guid? Insert(ContractorChangeRequest ob)
        {
            try
            {
                this.EDMsDataContext.AddToContractorChangeRequests(ob);
        ...
        /// </returns>
        public bool Update(ContractorChangeRequest src)
        {
            try
            {
                ContractorChangeRequest des = (from rs in this.EDMsDataContext.ContractorChangeRequests
                                where rs.ID == src.ID
                                select rs).First();
        ...
        /// </returns>
        public bool Delete(ContractorChangeRequest src)
        {
            try
            {
