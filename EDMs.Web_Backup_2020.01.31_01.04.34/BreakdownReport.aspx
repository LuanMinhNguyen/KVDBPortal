<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BreakdownReport.aspx.cs" Inherits="EDMs.Web.BreakdownReport" EnableViewState="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
            ...
            <telerik:RadToolBar ID="CustomerMenu" runat="server" Width="100%" OnClientButtonClicking="OnClientButtonClicking">
                <Items>
                    <telerik:RadToolBarDropDown runat="server" Text="Add" ImageUrl="~/Images/addNew.png">
                        <Buttons>
                            <telerik:RadToolBarButton runat="server" Text="Breakdown Report" Value="1" ImageUrl="~/Images/break1.png"></telerik:RadToolBarButton>
                        ...
                        <ItemTemplate>
                            ...
                            <asp:DropDownList ID="ddlStatus" runat="server" CssClass="rcbReadOnly" Width="230px" style="max-width: 316px"
                                ...
                                <Items>
                                    ...
                                    <asp:ListItem Value="7" Text="Breakdown Report complete Workflow Process" style="background-color: greenyellow"></asp:ListItem>
                        ...
                        <telerik:RadPane ID="Radpane6" runat="server" Scrolling="None">
                            <telerik:RadGrid AllowCustomPaging="False" AllowPaging="True" AllowSorting="True" 
                                ...
                                <MasterTableView AllowMultiColumnSorting="false"
                                    ...
                                    <telerik:GridBoundColumn UniqueName="Code" HeaderText="Code" DataField="Code" ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                    ...
                                    <telerik:GridTemplateColumn UniqueName="BreakdownSystemName" HeaderText="Name of Breakdown Equipments/System" ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                    ...
                                    <telerik:GridBoundColumn DataField="TagNo" HeaderText="Breakdown Equipment Name or Tag No" UniqueName="TagNo" ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        <HeaderStyle HorizontalAlign="Center" Width="200" />
                                        <ItemStyle HorizontalAlign="Center"/>
                                    </telerik:GridBoundColumn>
                                            
                                    <telerik:GridBoundColumn DataField="SystemName" HeaderText="Equipment/System Name" UniqueName="SystemName" ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        <HeaderStyle HorizontalAlign="Center" Width="200" />
                                        <ItemStyle HorizontalAlign="Center"/>
                                    </telerik:GridBoundColumn>
                                    ...
                                    <telerik:GridBoundColumn DataField="CauseGroup" HeaderText="Cause Group" UniqueName="CauseGroup" ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        <HeaderStyle HorizontalAlign="Center" Width="120" />
                                        <ItemStyle HorizontalAlign="Center"/>
                                    </telerik:GridBoundColumn>
                                    ...
                                    <telerik:GridBoundColumn DataField="FailureDuplication" HeaderText="Failure Duplication" UniqueName="FailureDuplication" ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        <HeaderStyle HorizontalAlign="Center" Width="120" />
                                        <ItemStyle HorizontalAlign="Center"/>
                                    </telerik:GridBoundColumn>
                                    ...
                                    <telerik:GridBoundColumn DataField="UnplannedWoNo" HeaderText="Unplanned WO Number" UniqueName="UnplannedWoNo" ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        <HeaderStyle HorizontalAlign="Center" Width="120" />
                                        <ItemStyle HorizontalAlign="Center"/>
                                    </telerik:GridBoundColumn>
                                    ...
                                    <telerik:GridBoundColumn DataField="PICStatus" HeaderText="Status" UniqueName="PICStatus" ColumnGroupName="PIC" ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        <HeaderStyle HorizontalAlign="Center" Width="80" />
                                        <ItemStyle HorizontalAlign="Center"/>
                                    </telerik:GridBoundColumn>
                                    ...
                                    <telerik:GridBoundColumn DataField="Status" HeaderText="Closed/Open" UniqueName="Status" ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        <HeaderStyle HorizontalAlign="Center" Width="100" />
                                        <ItemStyle HorizontalAlign="Center"/>
                                    </telerik:GridBoundColumn>
                                            
                                    <telerik:GridBoundColumn DataField="MRWRItem" HeaderText="MR & Item/ WR" UniqueName="MRWRItem" ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        <HeaderStyle HorizontalAlign="Center" Width="120" />
                                        <ItemStyle HorizontalAlign="Center"/>
                                    </telerik:GridBoundColumn>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Cost" UniqueName="Cost" FilterControlWidth="80%" CurrentFilterFunction="EqualTo" AutoPostBackOnFilter="True" DataField="Cost">
    ...
    <telerik:RadContextMenu ID="radMenu" runat="server"
        ...
        <Items>
            ...
            <telerik:RadMenuItem IsSeparator="True"/>
            <telerik:RadMenuItem Text="Cancel Breakdown Report" ImageUrl="~/Images/cancel1.png" Value="CancelBreakdownReport"/>
    ...
    <telerik:RadWindowManager ID="RadWindowManager1" runat="server" EnableShadow="true" >
        <Windows>
            <telerik:RadWindow ID="CustomerDialog" runat="server" Title="Breakdown Report Information"
                VisibleStatusbar="false" Height="700" Width="650" 
                Left="150px" ReloadOnShow="true" ShowContentDuringLoad="false" Modal="true">
            </telerik:RadWindow>
            
            <telerik:RadWindow ID="BreakdownReportDetailDialog" runat="server" Title="Breakdown Report Details"
                VisibleStatusbar="false" Height="700" Width="650" 
                Left="150px" ReloadOnShow="true" ShowContentDuringLoad="false" Modal="true">
            </telerik:RadWindow>
            ...
            <telerik:RadWindow ID="AttachWorkflow" runat="server" Title="Attach Breakdown Report to Workflow"
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
            ...
            function gridMenuClicking(sender, args) {
                ...
                else
                {
                    ...
                    case "MRDetail":
                        ...
                        owd.Show();
                        owd.setUrl("Controls/WMS/TrackingBreakdownReportDetail.aspx?objId=" + docId, "BreakdownReportDetailDialog");
                        break;
                        case "AttachWF":
                        var projId = document.getElementById("<%= lblProjectId.ClientID %>").value;
                        var owd = $find("<%=AttachWorkflow.ClientID %>");
                        owd.Show();
                        owd.setUrl("Controls/Workflow/AttachWorkflow.aspx?objId=" + docId + "&objType=BreakdownReport" + "&projId=" + projId, "AttachWorkflow");
                        break;
                    case "WFHistory":
                        var owd = $find("<%=WFProcessHistory.ClientID %>");
                        owd.Show();
                        owd.maximize();
                        owd.setUrl("Controls/Workflow/WorkflowProcessHistory.aspx?objId=" + docId + "&objType=BreakdownReport", "WFProcessHistory");
                        break;
                    case "AttachDocument":
                        ...
                        owd.setUrl("Controls/WMS/TrackingBreakdownReportAttach.aspx?objId=" + docId, "AttachDoc");
                        break;
                    case "CMS":
                        ...
                        case "EditProperties":
                            ...
                            owd.setSize(850, document.documentElement.offsetHeight);
                            owd.Show();
                            owd.setUrl("Controls/WMS/TrackingBreakdownReportEditForm.aspx?objId=" + docId + "&projId=" + projectId, "CustomerDialog");
                        break;
                    case "Transmittals":
                    ...
                    case "CommentResponse":
                        ...
                        case "CancelBreakdownReport":
                            if (confirm("Do you want to cancel Breakdown Report?") === false) return;
        ...
        <script type="text/javascript">
            ...
            function ShowEditForm(docId, projId) {
                ...
                owd.setSize(850, document.documentElement.offsetHeight);
                owd.Show();
                owd.setUrl("Controls/WMS/TrackingBreakdownReportEditForm.aspx?projId=" + projId + "&objId=" + docId, "CustomerDialog");
            }
            ...
            function OnClientButtonClicking(sender, args) {
                ...
                if (strText == "Breakdown Report") {
                    ...
                    owd.setSize(850, document.documentElement.offsetHeight);
                    owd.Show();
                    owd.setUrl("Controls/WMS/TrackingBreakdownReportEditForm.aspx?projId=" + projectId, "CustomerDialog");
                    //}
                }
