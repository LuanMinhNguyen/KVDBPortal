<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReassignWorkingPIC.aspx.cs" Inherits="EDMs.Web.Controls.Workflow.ReassignWorkingPIC" %>
        ...
        <div style="width: 100%" runat="server" ID="divContent">
            <ul style="list-style-type: none">
                ...
                <li style="width: 600px;">
                    <div>
                        <label style="width: 125px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
                            <span style="color: #2E5689; text-align: right; ">Assign To User
                            </span>
                        </label>
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
