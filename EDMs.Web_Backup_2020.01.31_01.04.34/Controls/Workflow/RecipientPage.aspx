...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RecipientPage.aspx.cs" Inherits="EDMs.Web.Controls.Workflow.RecipientPage" %>
        ...
        <div runat="server" ID="divContent">
         <dl class="accordion">
            ...
            <div style="width: 100%; display: inline-flex">
                <div style="margin-right: 3px;" runat="server" id="divApproveUser">
                    <div style="text-align: center;margin-bottom: 3px"><b>Assigned User (Approve)</b> </div>
                    <div style="float: left; padding-bottom: 5px;" class="qlcbFormItem">
                        <asp:Panel ID="panelSearchApproveUser" runat="server" DefaultButton="btnSearchApproveUser">
                            <telerik:RadTextBox runat="server" ID="txtSearchApproveUser" Width="246" CssClass="min25Percent" EmptyMessage="Search User" style="border-color: #8E8E8E #B8B8B8 #B8B8B8 #46A3D3 !important;" /> 
                            <asp:ImageButton ID="btnSearchApproveUser" runat="server" ImageUrl="../../Images/search.png" style="margin-bottom: -5px !important; margin-left: -2px !important;" OnClick="btnSearchApproveUser_OnClick"/>
                        </asp:Panel>
                    </div>
                    <telerik:RadTreeView RenderMode="Lightweight" ID="rtvApproveUser" runat="server"  CheckBoxes="True" TriStateCheckBoxes="true" CheckChildNodes="true" Width="250" Height="400" Skin="Windows7" OnNodeCheck="rtvApproveUser_OnNodeCheck"/>
                </div>
                <div style="margin-right: 3px;" runat="server" id="divReviewUser">
                    <div style="text-align: center;margin-bottom: 3px"><b>Assigned User (Review)</b></div>
                    <div style="float: left; padding-bottom: 5px;" class="qlcbFormItem">
                ...
                <div style="margin-right: 3px;" runat="server" id="divConsolidateUser">
                    <div style="text-align: center;margin-bottom: 3px"><b>Assigned User (Consolidate)</b></div>
                    <div style="float: left; padding-bottom: 5px;" class="qlcbFormItem">
                        <asp:Panel ID="panelSearchConsolidateUser" runat="server" DefaultButton="btnSearchConsolidateUser">
                            <telerik:RadTextBox runat="server" ID="txtSearchConsolidateUser" Width="246" CssClass="min25Percent" EmptyMessage="Search User" style="border-color: #8E8E8E #B8B8B8 #B8B8B8 #46A3D3 !important;" /> 
                            <asp:ImageButton ID="btnSearchConsolidateUser" runat="server" ImageUrl="../../Images/search.png" style="margin-bottom: -5px !important; margin-left: -2px !important;" OnClick="btnSearchConsolidateUser_OnClick"/>
                        </asp:Panel>
                    </div>

                    <telerik:RadTreeView RenderMode="Lightweight" ID="rtvConsolidateUser" runat="server"  CheckBoxes="True" TriStateCheckBoxes="true" CheckChildNodes="true" Width="250" Height="400" Skin="Windows7" OnNodeCheck="rtvConsolidateUser_OnNodeCheck"/>
                </div>
                <div style="margin-right: 3px;" runat="server" id="divInformationUser">
                    <div style="text-align: center;margin-bottom: 3px"><b>Informed User</b></div>
                    <div style="float: left; padding-bottom: 5px;" class="qlcbFormItem">
