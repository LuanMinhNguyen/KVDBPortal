<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompleteMoveNext.aspx.cs" Inherits="EDMs.Web.Controls.Workflow.CompleteMoveNext" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function AlterNCRSI() {
            alert("Please update Action Taken befor click 'Complete'!");
        }
        ...
        <div style="width: 100%" runat="server" ID="divContent">
            <ul style="list-style-type: none">
                ...
                <li style="width: 500px;">
                    <div>
                        <label style="width: 75px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
                            <span style="color: #2E5689; text-align: right; ">Next Step
                            </span>
                        </label>
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                            <asp:TextBox ID="txtNextStep" runat="server" Style="width: 390px;" CssClass="min25Percent" ReadOnly="True"/>
                        </div>
                    </div>
                    <div style="clear: both; font-size: 0;"></div>
                </li>
                
                <li style="width: 500px;" runat="server" ID="DurationControl" Visible="False">
                    <div>
                        <label style="width: 75px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
                        ...
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem"> 
                            <telerik:RadNumericTextBox Width="60" runat="server" ID="txtDuration" CssClass="min25Percent qlcbFormRequired" style="min-width: 60px !important;"/> Days.
                        </div>
                    </div>
                    <div style="clear: both; font-size: 0;"></div>
                </li>
                
                <li style="width: 600px;" runat="server" ID="DevCommentCode">
                    <div>
                        <label style="width: 75px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
                        ...
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem" runat="server" id="divDocCode">
                            <asp:DropDownList ID="ddlDocReviewStatus" runat="server" CssClass="min25Percent qlcbFormRequired" Width="406px"/>
                            ...
                            OnServerValidate="fileNameValidator_ServerValidate" Display="Dynamic" ControlToValidate="ddlDocReviewStatus"/>
                        </div>
                    </div>
                    <div style="clear: both; font-size: 0;"></div>
                </li>
                
                <li style="width: 600px;" runat="server" ID="divChangeRequestReviewResult" Visible="False">
                    <div>
                        <label style="width: 75px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
                            <span style="color: #2E5689; text-align: right; ">Review Status
                            </span>
                        ...
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                            <asp:DropDownList ID="ddlChangeRequestReviewCode" runat="server" CssClass="min25Percent qlcbFormRequired" Width="406px"/>
                        </div>
                    </div>
                    <div style="clear: both; font-size: 0;"></div>
                </li>
                
                <li style="width: 600px;" runat="server" ID="divNCRSICSReviewResult" Visible="False">
                    <div>
                        <label style="width: 75px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
                            <span style="color: #2E5689; text-align: right; ">Review Status
                            </span>
                        ...
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                            <asp:DropDownList ID="ddlNCRSICSReviewCode" runat="server" CssClass="min25Percent qlcbFormRequired" Width="406px">
                                <Items>
                                    <asp:ListItem Value="AGREED" Text="AGREED"></asp:ListItem>
                                    <asp:ListItem Value="DISAGREED" Text="DISAGREED"></asp:ListItem>
                                </Items>
                            </asp:DropDownList>
                        </div>
                    </div>
         ...
         <div style="width: 100%">
            <ul style="list-style-type: none">
                <li style="width: 500px; padding-top: 10px; padding-bottom: 3px; text-align: center">
                    <telerik:RadButton ID="btnSave" runat="server" Text="Save" OnClick="btnSave_Click" Width="100px" SingleClick="true" SingleClickText="Submitting..." style="text-align: center"
>
