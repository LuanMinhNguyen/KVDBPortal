<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ExportDataChanged.aspx.cs" Inherits="EDMs.Web.Controls.Security.ExportDataChanged" EnableViewState="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
            ...
            <telerik:RadToolBar ID="CustomerMenu" runat="server" Width="100%" OnClientButtonClicking="OnClientButtonClicking">
                <Items>
                    <telerik:RadToolBarDropDown runat="server" Text="Action" ImageUrl="~/Images/action.png" >
                        <Buttons>
                            <telerik:RadToolBarButton runat="server" Text="Export Data Changed File" Value="ExportDataChange" ImageUrl="~/Images/emdrreport.png"/>
                            <telerik:RadToolBarButton runat="server" Text="Import Data Changed File" Value="ImportDataChange" ImageUrl="~/Images/import.png"/>
                        </Buttons>
                                ...
                                <telerik:RadGrid ID="grdDocument" runat="server" AllowPaging="True"
                                    ...
                                    <MasterTableView ClientDataKeyNames="ID" DataKeyNames="ID" Width="100%" TableLayout="Auto" CssClass="rgMasterTable">
                                        ...
                                        <Columns>
                                            ...
                                            <%--3--%>
                                            <telerik:GridTemplateColumn UniqueName="ActionTypeName" HeaderText="Action">
                                                <HeaderStyle Width="20%" HorizontalAlign="Center" />
                                                <ItemStyle HorizontalAlign="Left"/>
                                                <ItemTemplate>
                                                    <asp:Label ID="Label1" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "ActionTypeName") %>'></asp:Label>
                                                </ItemTemplate>
                                            ...
                                            <telerik:GridBoundColumn DataField="ObjectID" HeaderText="ObjectID 1" UniqueName="ObjectID" >
                                                <HeaderStyle HorizontalAlign="Center" Width="15%" />
                                                <ItemStyle HorizontalAlign="Left"  />
                                            </telerik:GridBoundColumn>

                                            <telerik:GridBoundColumn DataField="ObjectID2" HeaderText="ObjectID 2" UniqueName="ObjectID2" >
                                                <HeaderStyle HorizontalAlign="Center" Width="15%" />
                                                <ItemStyle HorizontalAlign="Left"  />
                                            </telerik:GridBoundColumn>
                                            
                                            <telerik:GridDateTimeColumn HeaderText="Datetime" UniqueName="EffectDate" DataField="EffectDate"
                                         DataFormatString="{0:dd/MM/yyyy HH:mm:ss}">
                                        <HeaderStyle HorizontalAlign="Center" Width="280" />
                                        <ItemStyle HorizontalAlign="Center" Width="280"/>
                                    </telerik:GridDateTimeColumn>
                                            
                                            <telerik:GridTemplateColumn HeaderText="Exported" UniqueName="IsSynced" AllowFiltering="False">
                                                    <HeaderStyle Width="80" HorizontalAlign="Center" ></HeaderStyle>
                                                <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                <ItemTemplate>
                                                    <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/ok.png" Visible='<%# Convert.ToBoolean(Eval("IsSynced")) %>'/>
                                                </ItemTemplate>
                                            </telerik:GridTemplateColumn>
                                        </Columns>
                                    </MasterTableView>
    ...
    <telerik:RadWindowManager ID="RadWindowManager1" runat="server" EnableShadow="true" >
        <Windows>
            ...
            <telerik:RadWindow ID="ImportDataChanged" runat="server" Title="Import Data Changed File"
                VisibleStatusbar="false" Height="400" Width="700" 
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            ...
            function OnClientButtonClicking(sender, args) {
                ...
                if (strValue == "ImportDataChange") {
                    var owd = $find("<%=ImportDataChanged.ClientID %>");
                    owd.Show();
                    owd.setUrl("ImportDataChangedFile.aspx", "ImportDataChanged");
                }
            }
