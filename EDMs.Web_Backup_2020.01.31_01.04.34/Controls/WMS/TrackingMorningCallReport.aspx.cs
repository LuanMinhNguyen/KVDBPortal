...
namespace EDMs.Web.Controls.WMS
{
    ...
    /// The customer edit form.
    /// </summary>
    public partial class TrackingMorningCallReport : Page
    {
        protected const string ServiceName = "EDMSFolderWatcher";

        private readonly TrackingMorningCallService mcService;

        private readonly TrackingMorningCallAttachFileService mcAttachFileService;


        /// <summary>
        /// Initializes a new instance of the <see cref="TrackingMorningCallReport"/> class.
        /// </summary>
        public TrackingMorningCallReport()
        {
            this.mcAttachFileService = new TrackingMorningCallAttachFileService();
        ...
        protected void grdDocument_OnNeedDataSource(object source, GridNeedDataSourceEventArgs e)
        {
            if(Request.QueryString["stausName"] != null && Request.QueryString["projId"] != null)
            {
                ...
                var pmListFilter = new List<TrackingMorningCall>();
                var pmList = this.mcService.GetAllByProject(projId);
