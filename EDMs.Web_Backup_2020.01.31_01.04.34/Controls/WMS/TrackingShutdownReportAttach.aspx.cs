...
namespace EDMs.Web.Controls.WMS
{
    ...
    /// The customer edit form.
    /// </summary>
    public partial class TrackingShutdownReportAttach : Page
    {
        private readonly TrackingShutdownReportAttachFileService trackingShutdownReportAttachFileService;
        ...
        /// </summary>
        public TrackingShutdownReportAttach()
        {
        ...
        protected void btnSaveAttachFile_Click(object sender, EventArgs e)
        {
            ...
            foreach (UploadedFile docFile in docuploader.UploadedFiles)
            {
                ...
                this.trackingShutdownReportAttachFileService.Insert(attachFile);
            }
        ...
        protected void grdAttachFile_DeleteCommand(object sender, GridCommandEventArgs e)
        {
            ...
            this.trackingShutdownReportAttachFileService.Delete(objId);
            this.grdAttachFile.Rebind();
        }
        ...
        {
            var objId = new Guid(this.Request.QueryString["objId"]);
            var attachList = this.trackingShutdownReportAttachFileService.GetAllObjId(objId);
