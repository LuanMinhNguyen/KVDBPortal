...
namespace EDMs.Web.Controls.WMS
{
    ...
    /// The customer edit form.
    /// </summary>
    public partial class TrackingGeneralWorkingReport : Page
    {
        protected const string ServiceName = "EDMSFolderWatcher";

        private readonly TrackingGeneralWorkingService mcService;

        private readonly TrackingGeneralWorkingAttachFileService mcAttachFileService;


        /// <summary>
        /// Initializes a new instance of the <see cref="TrackingGeneralWorkingReport"/> class.
        /// </summary>
        public TrackingGeneralWorkingReport()
        {
            this.mcAttachFileService = new TrackingGeneralWorkingAttachFileService();
            this.mcService = new TrackingGeneralWorkingService();
        ...
        protected void grdDocument_OnNeedDataSource(object source, GridNeedDataSourceEventArgs e)
        {
            if(Request.QueryString["stausName"] != null && Request.QueryString["projId"] != null)
            {
                ...
                var pmListFilter = new List<TrackingGeneralWorking>();
                ...
                switch (statusName)
                {
                    ...
                    case "Open":
                        ...
                        break;
                    case "Routine":
                        pmListFilter = pmList.Where(t => t.Status == "Routine").ToList();
                        break;
                    case "Cancel":
