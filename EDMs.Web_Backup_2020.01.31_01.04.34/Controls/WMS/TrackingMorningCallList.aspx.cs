...
namespace EDMs.Web.Controls.WMS
{
    ...
    /// Class customer
    /// </summary>
    public partial class TrackingMorningCallList : Page
    {
        private readonly TrackingMorningCallService trackingMorningCallService = new TrackingMorningCallService();
        ...
        protected void grdDocument_OnNeedDataSource(object source, GridNeedDataSourceEventArgs e)
        {
            if (this.ddlProject.SelectedItem!= null)
            {
                if (this.IsView.Value == "True")
                {
                    ...
                    var projectId = Convert.ToInt32(this.ddlProject.SelectedValue);
                    var objList =
                        this.trackingMorningCallService.GetAllTrackingMorningCallOfProject(projectId,
                            txtSearchAllField.Text).OrderByDescending(t => t.DateRaised);
                    //var objList = new List<TrackingMorningCall>();
                    //switch (ddlStatus.SelectedValue)
                    //{
                    //    case "1":
                    //        objList = this.trackingMorningCallService.GetAllTrackingMorningCallOfProject(projectId, txtSearchAllField.Text)
                    ...
                    //        break;
                    //    case "3":
                    //        objList = this.trackingMorningCallService.GetAllComingDueTrackingMorningCallOfProject(projectId, txtSearchAllField.Text)
                    //                                    .Where(t => (txtDeadlineFrom.SelectedDate == null || t.Deadline >= txtDeadlineFrom.SelectedDate)
                    //                                            && (txtDeadlineTo.SelectedDate == null || t.Deadline < txtDeadlineTo.SelectedDate.Value.AddDays(1)))
                    //                                    .ToList();
                    //        break;
                    //    case "4":
                    //        objList = this.trackingMorningCallService.GetAllOverDueTrackingMorningCallOfProject(projectId, txtSearchAllField.Text)
                    //                                    .Where(t => (txtDeadlineFrom.SelectedDate == null || t.Deadline >= txtDeadlineFrom.SelectedDate)
                    //                                            && (txtDeadlineTo.SelectedDate == null || t.Deadline < txtDeadlineTo.SelectedDate.Value.AddDays(1)))
                    //                                    .ToList();
                    //        break;
                    //    case "5":
                    //        objList = this.trackingMorningCallService.GetAllCompleteTrackingMorningCallOfProject(projectId, txtSearchAllField.Text)
                    //                                    .Where(t => (txtDeadlineFrom.SelectedDate == null || t.Deadline >= txtDeadlineFrom.SelectedDate)
                    //                                            && (txtDeadlineTo.SelectedDate == null || t.Deadline < txtDeadlineTo.SelectedDate.Value.AddDays(1)))
                    //                                    .ToList();
                    //        break;
                    //    case "6":
                    //        objList = this.trackingMorningCallService.GetAllInCompleteTrackingMorningCallOfProject(projectId, txtSearchAllField.Text)
                    //                                    .Where(t => (txtDeadlineFrom.SelectedDate == null || t.Deadline >= txtDeadlineFrom.SelectedDate)
                    //                                            && (txtDeadlineTo.SelectedDate == null || t.Deadline < txtDeadlineTo.SelectedDate.Value.AddDays(1)))
                    //                                    .ToList();
                    //        break;
                ...
                {
                    this.grdDocument.DataSource = new List<TrackingMorningCall>();
                }
            }
            else
            {
        ...
        protected void grdDocument_DeleteCommand(object sender, GridCommandEventArgs e)
        {
            ...
            this.trackingMorningCallService.Delete(objId);
