...
namespace EDMs.Web.Controls.WMS
{
    ...
    /// Class customer
    /// </summary>
    public partial class TrackingProcedureList : Page
    {
        private readonly TrackingProcedureService trackingProcedureService = new TrackingProcedureService();
        ...
        protected void grdDocument_OnNeedDataSource(object source, GridNeedDataSourceEventArgs e)
        {
            if (this.ddlProject.SelectedItem!= null)
            {
                if (this.IsView.Value == "True")
                {
                    ...
                    var projectId = Convert.ToInt32(this.ddlProject.SelectedValue);
                    var objList =
                        this.trackingProcedureService.GetAllRevTrackingProcedureOfProject(projectId,
                            txtSearchAllField.Text).OrderByDescending(t => t.Code);
                    //var objList = new List<TrackingProcedure>();
                    //switch (ddlStatus.SelectedValue)
                    //{
                    //    case "1":
                    //        objList = this.trackingProcedureService.GetAllRevTrackingProcedureOfProject(projectId, txtSearchAllField.Text)
                    ...
                    //        break;
                    //    case "2":
                    //        objList = this.trackingProcedureService.GetAllTrackingProcedureOfProject(projectId, txtSearchAllField.Text)
                    //                                    .Where(t => (txtDeadlineFrom.SelectedDate == null || t.Deadline >= txtDeadlineFrom.SelectedDate)
                    //                                            && (txtDeadlineTo.SelectedDate == null || t.Deadline < txtDeadlineTo.SelectedDate.Value.AddDays(1)))
                    //                                    .ToList();
                    //        break;
                    //    case "3":
                    //        objList = this.trackingProcedureService.GetAllComingDueTrackingProcedureOfProject(projectId, txtSearchAllField.Text)
                    //                                    .Where(t => (txtDeadlineFrom.SelectedDate == null || t.Deadline >= txtDeadlineFrom.SelectedDate)
                    //                                            && (txtDeadlineTo.SelectedDate == null || t.Deadline < txtDeadlineTo.SelectedDate.Value.AddDays(1)))
                    //                                    .ToList();
                    //        break;
                    //    case "4":
                    //        objList = this.trackingProcedureService.GetAllOverDueTrackingProcedureOfProject(projectId, txtSearchAllField.Text)
                    //                                    .Where(t => (txtDeadlineFrom.SelectedDate == null || t.Deadline >= txtDeadlineFrom.SelectedDate)
                    //                                            && (txtDeadlineTo.SelectedDate == null || t.Deadline < txtDeadlineTo.SelectedDate.Value.AddDays(1)))
                    //                                    .ToList();
                    //        break;
                    //    case "5":
                    //        objList = this.trackingProcedureService.GetAllCompleteTrackingProcedureOfProject(projectId, txtSearchAllField.Text)
                    //                                    .Where(t => (txtDeadlineFrom.SelectedDate == null || t.Deadline >= txtDeadlineFrom.SelectedDate)
                    //                                            && (txtDeadlineTo.SelectedDate == null || t.Deadline < txtDeadlineTo.SelectedDate.Value.AddDays(1)))
                    //                                    .ToList();
                    //        break;
                    //    case "6":
                    //        objList = this.trackingProcedureService.GetAllInCompleteTrackingProcedureOfProject(projectId, txtSearchAllField.Text)
                    //                                    .Where(t => (txtDeadlineFrom.SelectedDate == null || t.Deadline >= txtDeadlineFrom.SelectedDate)
                    //                                            && (txtDeadlineTo.SelectedDate == null || t.Deadline < txtDeadlineTo.SelectedDate.Value.AddDays(1)))
                    //                                    .ToList();
                    //        break;
                ...
                {
                    this.grdDocument.DataSource = new List<TrackingProcedure>();
                }
            }
            else
            {
        ...
        protected void grdDocument_DeleteCommand(object sender, GridCommandEventArgs e)
        {
            ...
            this.trackingProcedureService.Delete(objId);
