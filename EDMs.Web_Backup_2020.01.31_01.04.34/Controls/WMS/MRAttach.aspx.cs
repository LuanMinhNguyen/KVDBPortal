...
namespace EDMs.Web.Controls.WMS
{
    ...
    /// The customer edit form.
    /// </summary>
    public partial class MRAttach : Page
    {
        private readonly MaterialRequisitionAttachFileService MaterialRequisitionAttachFileService;
        ...
        public MRAttach()
        {
            this.MaterialRequisitionAttachFileService = new MaterialRequisitionAttachFileService();
        ...
        protected void btnSaveAttachFile_Click(object sender, EventArgs e)
        {
            ...
            foreach (UploadedFile docFile in docuploader.UploadedFiles)
            {
                ...
                this.MaterialRequisitionAttachFileService.Insert(attachFile);
            }
            ...
            var obj = this.mrService.GetById(objId);
        ...
        protected void grdAttachFile_DeleteCommand(object sender, GridCommandEventArgs e)
        {
            ...
            this.MaterialRequisitionAttachFileService.Delete(objId);
            this.grdAttachFile.Rebind();
        }
        ...
        {
            var objId = new Guid(this.Request.QueryString["objId"]);
            var attachList = this.MaterialRequisitionAttachFileService.GetByMR(objId);
