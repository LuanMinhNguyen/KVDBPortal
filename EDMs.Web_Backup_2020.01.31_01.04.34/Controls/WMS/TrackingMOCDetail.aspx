<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TrackingMOCDetail.aspx.cs" Inherits="EDMs.Web.Controls.WMS.TrackingMOCDetail" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div style="width: 95%" runat="server" ID="divContent">
            <table style="height: 100%; border-collapse: collapse; border: 1px solid black; border-spacing: 5em; padding-bottom: 5px; padding-top: 5px; padding-left: 3px">
                <tr style="padding-bottom: 10px; border: 1px solid black; border-spacing: 5em; padding-bottom: 5px; padding-top: 5px; padding-left: 3px">
                    <td align="center" colspan="10" style="padding-bottom: 10px; border: 1px solid black; border-spacing: 5em; padding-bottom: 5px; padding-top: 5px; padding-left: 3px">
                        <b style="font-size: 25pt">MOC</b><br/>
                        <span style="font-size: 16pt">(Facility: <asp:Label runat="server" ID="lblProjectName" Text="FPSO PTSC LAM SON"/>)</span>
                        <div >
                            <telerik:RadButton ID="btnExportMOC" runat="server" Text="Export MOC Form" OnClick="btnExportMOC_Click" Width="120px" style="text-align: center" Skin="Windows7" AutoPostBack="True">
            ...
            SelectedIndex="0">
                            <Tabs>
                                <telerik:RadTab ImageUrl="~/Images/moc.png" Text="MOC Info">
                                </telerik:RadTab>
                            ...
                            <div style="width: 100%">
                                <ul style="list-style-type: none">
                                    ...
                                    <li style="width: 750px;">
                                        <div>
                                            <label style="width: 160px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
                                                <span style="color: #2E5689; text-align: right; ">Name of equiment /system
                                                </span>
                                            </label>
                                    ...
                                    <li style="width: 750px;">
                                        <div>
                                            <label style="width: 160px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
                                                <span style="color: #2E5689; text-align: right; ">Date issues
                                                </span>
                                            </label>
                                            <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                                                <telerik:RadDatePicker ID="txtDateIssue"  runat="server" 
                                    ...
                                    <li style="width: 750px;">
                                        <div>
                                            <label style="width: 160px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
                                                <span style="color: #2E5689; text-align: right; ">Reason of change
                                                </span>
                                            </label>
                                    ...
                                    <li style="width: 750px;">
                                        <div>
                                            <label style="width: 160px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
                                                <span style="color: #2E5689; text-align: right; ">Initial Risk Evaluation
                                                </span>
                                            </label>
                                            <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                                            ...
                                            <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                                                <asp:DropDownList ID="ddlInitRiskLvl" runat="server" CssClass="min25Percent" Width="516px" style="max-width: 316px">
                                                    <Items>
                                                        ...
                                                        <asp:ListItem Value="4" Text="Very low"></asp:ListItem>
                                                        <asp:ListItem Value="5" Text="Normal"></asp:ListItem>
                                                    </Items>
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                    ...
                                    <li style="width: 750px;">
                                        <div>
                                            <label style="width: 160px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
                                                <span style="color: #2E5689; text-align: right; ">Mitigation action
                                                </span>
                                            </label>
                                            <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                                                <asp:TextBox ID="txtMitigationAction" runat="server" Style="width: 500px;" CssClass="min25Percent" TextMode="MultiLine" Rows="3"/>
                                            </div>
                                        </div>
                                        <div style="clear: both; font-size: 0;"></div>
                                    </li>
                                    ...
                                    <li style="width: 750px;">
                                        <div>
                                            <label style="width: 160px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
                                                <span style="color: #2E5689; text-align: right; ">Risk Level after mitigation
                                                </span>
                                            </label>
                                            <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                                                <asp:DropDownList ID="ddlMitigationRiskLvl" runat="server" CssClass="min25Percent" Width="516px" style="max-width: 316px">
                                                    <Items>
                                                        <asp:ListItem Value="0" Text=""></asp:ListItem>
                                                        <asp:ListItem Value="1" Text="High"></asp:ListItem>
                                                        <asp:ListItem Value="2" Text="Low"></asp:ListItem>
                                    ...
                                    <li style="width: 750px;">
                                        <div>
                                            <label style="width: 160px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
                                                <span style="color: #2E5689; text-align: right; ">Latest Acceptable Date
                                                </span>
                                            </label>
                                            <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                                                <asp:TextBox ID="txtAcceptableDate" runat="server" Style="width: 500px;" CssClass="min25Percent"/>
                                            </div>
                                        </div>
                                        <div style="clear: both; font-size: 0;"></div>
                                    </li>
                                    ...
                                    <li style="width: 750px;">
                                        <div>
                                            <label style="width: 160px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
                                                <span style="color: #2E5689; text-align: right; ">Technical authority/Dept
                                                </span>
                                            </label>
                                            <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                                                <asp:TextBox ID="txtTechAuth" runat="server" Style="width: 500px;" CssClass="min25Percent"/>
                                            </div>
                                        </div>
                                        <div style="clear: both; font-size: 0;"></div>
                                    </li>
                                            ...
                                            <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                                                <asp:DropDownList ID="ddlStatus" runat="server" CssClass="min25Percent" Width="516px" style="max-width: 316px">
                                                    <Items>
                                                        ...
                                                        <asp:ListItem Value="4" Text="Hold"></asp:ListItem>
                                                        <asp:ListItem Value="5" Text="Implementing"></asp:ListItem>
                                    ...
                                    <li style="width: 750px;">
                                        <div>
                                            <label style="width: 160px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
                                                <span style="color: #2E5689; text-align: right; ">Closed Clarification
                                                </span>
                                            </label>
                                            <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                                                <asp:TextBox ID="txtClosedClari" runat="server" Style="width: 500px;" CssClass="min25Percent" TextMode="MultiLine" Rows="2"/>
                                            </div>
                                        </div>
                                        <div style="clear: both; font-size: 0;"></div>
                                    </li>
                        ...
                        <telerik:RadPageView runat="server" Height="100%" ID="RadPageView3">
                            <div style="width: 100%" runat="server" id="divMOCAttachFile">
                                <ul style="list-style-type: none">
                                    <li style="width: 800px;">
                                        <div>
                                            <label style="width: 110px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
