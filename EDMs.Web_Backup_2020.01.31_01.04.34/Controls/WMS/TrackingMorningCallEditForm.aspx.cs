...
namespace EDMs.Web.Controls.WMS
{
    ...
    /// The customer edit form.
    /// </summary>
    public partial class TrackingMorningCallEditForm : Page
    {
        private readonly TrackingMorningCallService trackingMorningCallService;
        ...
        /// </summary>
        public TrackingMorningCallEditForm()
        {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!this.IsPostBack)
            {
                ...
                if(!string.IsNullOrEmpty(this.Request.QueryString["objId"]))
                {
                    ...
                    var obj = this.trackingMorningCallService.GetById(new Guid(this.Request.QueryString["objId"]));
                    if(obj!=null)
                    {
                        ...
                        this.txtDeadlineHistory.Text = obj.DeadlineHistory;
                ...
                else
                {
                    ...
                    var index = this.numberManagementService.GetByName("TrackingMorningCall", projectId);
                    var objCode = "MC-" + index.NextCount.GetValueOrDefault();
        ...
        private void GetFuncPermissionConfig()
        {
            ...
            var fncPermission = this.fncPermissionService.GetOne(UserSession.Current.User.Id, 8);
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (this.Page.IsValid)
            {
                ...
                var obj = new TrackingMorningCall();
                obj.ID = Guid.NewGuid();
                ...
                obj.DeadlineHistory = this.txtDeadlineHistory.Text;
                ...
                if (!string.IsNullOrEmpty(this.Request.QueryString["objId"]))
                {
                    ...
                    var objOld = this.trackingMorningCallService.GetById(objId);
                    if (objOld != null)
                    {
                        objOld.IsLeaf = false;
                        this.trackingMorningCallService.Update(objOld);
                ...
                var objGUID = this.trackingMorningCallService.Insert(obj);
        ...
        private void SendNotification(TrackingMorningCall obj)
        {
            var configObj = configService.GetById(1);
            if (configObj != null)
            {
                ...
                message.Subject = "New Morning Call Update: " + obj.Code;

                // Generate email body
                var bodyContent = @"Dear All,<br/><br/>
                                    Please be informed that the new Morning Call Update with information:<br/>
                                    <table border='1' cellspacing='0'>
                                        ...
                                        <tr>
		                                    <td>Names of Equipment/System/Matter</td>
                                            <td>"+obj.EquipmentName + @"</td>
	                                    </tr>
                                        <tr>
		                                    <td>Description of issues</td>
                                            <td>" + obj.IssueDescription.Replace(Environment.NewLine, "<br/>") + @"</td>
	                                    </tr>
                                        <tr>
		                                    <td>Initial Risk Assessment</td>
                                            <td>" + obj.InitRiskAssessment.Replace(Environment.NewLine, "<br/>") + @"</td>
	                                    </tr>
                                        <tr>
                                        ...
                                        <tr>
		                                    <td>Description of Action Plan</td>
                                            <td>" + obj.ActionPlanDescription.Replace(Environment.NewLine, "<br/>") + @"</td>
	                                    </tr>
                                        <tr>
		                                    <td>Action Plan Risk level</td>
                                            <td>" + obj.ActionPlanRiskLvlName + @"</td>
	                                    </tr>
                                        <tr>
		                                    <td>PIC</td>
                                        ...
                                        <tr>
		                                    <td>Deadline History</td>
                                            <td>" + obj.DeadlineHistory.Replace(Environment.NewLine, "<br/>") + @"</td>
	                                    </tr>
                                        <tr>
		                                    <td>Relative Documents</td>
                                            <td>" + obj.RelativeDoc + @"</td>
	                                    </tr>
                                        <tr>
		                                    <td>Current Update</td>
                                            <td>" + obj.CurrentUpdate.Replace(Environment.NewLine, "<br/>") + @"</td>
	                                    </tr>
                                        <tr>
		                                    <td>Status</td>
                                        ...
                                        <tr>
		                                    <td>Offshore team comments/update</td>
                                            <td>" + obj.OffshoreComment.Replace(Environment.NewLine, "<br/>") + @"</td>
	                                    </tr>
                                    </table></br>
                ...
                foreach (var picId in obj.PICId.Split(';').Where(t => !string.IsNullOrEmpty(t)))
                {
                    ...
                    if (userObj != null)
                    {
                        var shareUserList = this.sharePermissionService.GetByFromUserAndObj(userObj.Id, "1");
