<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SendMail.aspx.cs" Inherits="EDMs.Web.Controls.WMS.SendMail" validateRequest="false" %>
            ...
            <tr>
                ...
                <td>
                    <telerik:RadComboBox ID="ddlEmail" runat="server" Width="903px" Height="140" Skin="Windows7"
                        AutoCompleteSeparator=";" MarkFirstMatch="True" AllowCustomText="True" 
                    DataTextField="FullNameWithEmail" DataValueField="Id">
                    </telerik:RadComboBox>
