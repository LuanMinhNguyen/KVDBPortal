...
namespace EDMs.Web.Controls.WMS
{
    ...
    /// The customer edit form.
    /// </summary>
    public partial class TrackingSailAttach : Page
    {
        private readonly TrackingSailAttachFileService trackingSailAttachFileService;
        ...
        protected void btnSaveAttachFile_Click(object sender, EventArgs e)
        {
            ...
            foreach (UploadedFile docFile in docuploader.UploadedFiles)
            {
                ...
                var attachFile = new TrackingSailAttachFile()
                {
                    ID = Guid.NewGuid(),
                    SailId = objId,
                ...
                this.trackingSailAttachFileService.Insert(attachFile);
            }
        ...
        protected void grdAttachFile_DeleteCommand(object sender, GridCommandEventArgs e)
        {
            ...
            this.trackingSailAttachFileService.Delete(objId);
            this.grdAttachFile.Rebind();
        }
        ...
        {
            var objId = new Guid(this.Request.QueryString["objId"]);
            var attachList = this.trackingSailAttachFileService.GetAllObjId(objId);
