...
namespace EDMs.Web.Controls.WMS
{
    ...
    /// The customer edit form.
    /// </summary>
    public partial class TrackingProductionMeetingRevisionHistory : Page
    {
        protected const string ServiceName = "EDMSFolderWatcher";

        private readonly TrackingProductionMeetingService mcService;

        private readonly TrackingProductionMeetingAttachFileService mcAttachFileService;


        /// <summary>
        /// Initializes a new instance of the <see cref="TrackingProductionMeetingRevisionHistory"/> class.
        /// </summary>
        public TrackingProductionMeetingRevisionHistory()
        {
            this.mcAttachFileService = new TrackingProductionMeetingAttachFileService();
            this.mcService = new TrackingProductionMeetingService();
        ...
        protected void grdDocument_OnNeedDataSource(object source, GridNeedDataSourceEventArgs e)
        {
            if(Request.QueryString["objId"] != null)
            {
                ...
                if (obj != null)
                {
                    var revList = this.mcService.GetAllProductionMeetingRev(obj.ParentId == null ? obj.ID : obj.ParentId.Value);
                    this.grdDocument.DataSource = revList;
                }
                else
                {
                    this.grdDocument.DataSource = new List<TrackingProductionMeeting>(); 
                }
            }
        }
