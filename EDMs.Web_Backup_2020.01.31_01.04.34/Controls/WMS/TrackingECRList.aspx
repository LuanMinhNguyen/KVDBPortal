<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TrackingECRList.aspx.cs" Inherits="EDMs.Web.Controls.WMS.TrackingECRList" EnableViewState="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
            ...
            <telerik:RadToolBar ID="CustomerMenu" runat="server" Width="100%" OnClientButtonClicking="OnClientButtonClicking">
                <Items>
                    <telerik:RadToolBarDropDown runat="server" Text="New" ImageUrl="~/Images/addNew.png" Visible="False">
                        <Buttons>
                            <telerik:RadToolBarButton runat="server" Text="ECR" Value="1" ImageUrl="~/Images/trackinglist.png"/>
                        </Buttons>
                    ...
                    <telerik:RadToolBarButton runat="server" Value="ShowAll">
                        <ItemTemplate>
                            ...
                            <asp:DropDownList ID="ddlStatus" runat="server" CssClass="min25Percent" Width="200px" style="max-width: 316px"
                                ...
                                <Items>
                                    <asp:ListItem Value="1" Text="All ECR"></asp:ListItem>
                                    <%--<asp:ListItem Value="2" Text="All Latest ECR" Selected="True"></asp:ListItem>--%>
                                    <%--<asp:ListItem Value="3" Text="Coming Due ECR" style="background-color: yellow"></asp:ListItem>
                                    <asp:ListItem Value="4" Text="Overdue ECR" style="background-color: red"></asp:ListItem>--%>
                                    <asp:ListItem Value="5" Text="Completed ECR" style="background-color: greenyellow"></asp:ListItem>
                                    <asp:ListItem Value="6" Text="Incompleted ECR" style="background-color: coral"></asp:ListItem>
                                </Items>
                            </asp:DropDownList>
                                ...
                                <telerik:RadGrid ID="grdDocument" runat="server" AllowPaging="True"
                                    ...
                                    <MasterTableView ClientDataKeyNames="ID" DataKeyNames="ID" Width="100%" TableLayout="Auto" CssClass="rgMasterTable">
                                        ...
                                        <Columns>
                                            ...
                                            <telerik:GridTemplateColumn UniqueName="Title" HeaderText="ECR Title">
                                            ...
                                            <telerik:GridBoundColumn DataField="PriorityName" HeaderText="Priority Level" UniqueName="PriorityName" ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                                <HeaderStyle HorizontalAlign="Center" Width="80"/>
                                                <ItemStyle HorizontalAlign="Center"/>
                                            </telerik:GridBoundColumn>
                                            
                                            <telerik:GridBoundColumn DataField="Section1Name" HeaderText="SECTION 1" UniqueName="Section1Name" ColumnGroupName="ApprovalStatus" >
                                                <HeaderStyle HorizontalAlign="Center" Width="80"/>
                                                <ItemStyle HorizontalAlign="Center"/>
                                            </telerik:GridBoundColumn>
                                            
                                            <telerik:GridBoundColumn DataField="Section2Name" HeaderText="SECTION 2" UniqueName="Section2Name" ColumnGroupName="ApprovalStatus" >
                                                <HeaderStyle HorizontalAlign="Center" Width="80"/>
                                                <ItemStyle HorizontalAlign="Center"/>
                                            </telerik:GridBoundColumn>
                                            
                                            <telerik:GridBoundColumn DataField="Section3Name" HeaderText="SECTION 3" UniqueName="Section3Name" ColumnGroupName="ApprovalStatus" >
                                                <HeaderStyle HorizontalAlign="Center" Width="80"/>
                                                <ItemStyle HorizontalAlign="Center"/>
                                            </telerik:GridBoundColumn>
                                            
                                            <telerik:GridBoundColumn DataField="Section4Name" HeaderText="SECTION 4" UniqueName="Section4Name" ColumnGroupName="ApprovalStatus" >
                                                <HeaderStyle HorizontalAlign="Center" Width="80"/>
                                                <ItemStyle HorizontalAlign="Center"/>
                                            </telerik:GridBoundColumn>
                                            
                                            <telerik:GridBoundColumn DataField="Section5Name" HeaderText="SECTION 5" UniqueName="Section5Name" ColumnGroupName="ApprovalStatus" >
                                                <HeaderStyle HorizontalAlign="Center" Width="80"/>
                                                <ItemStyle HorizontalAlign="Center"/>
                                            </telerik:GridBoundColumn>
                                            
                                            <telerik:GridBoundColumn DataField="ApSection3Name" HeaderText="SECTION 3" UniqueName="ApSection3Name" ColumnGroupName="AP" >
                                                <HeaderStyle HorizontalAlign="Center" Width="80"/>
                                                <ItemStyle HorizontalAlign="Center"/>
                                            </telerik:GridBoundColumn>
                                            
                                            <telerik:GridBoundColumn DataField="ApRequirementName" HeaderText="Requirements" UniqueName="ApRequirementName" ColumnGroupName="AP" >
                                            ...
                                            <telerik:GridBoundColumn DataField="StatusName" HeaderText="ECR Current Status" UniqueName="StatusName">
    ...
    <telerik:RadContextMenu ID="radMenu" runat="server"
        ...
        <Items>
            ...
            <telerik:RadMenuItem Text="Update ECR Info" ImageUrl="~/Images/edit.png" Value="EditProperties" DisabledImageUrl="~/Images/dis_edit.png"/>
            
            <telerik:RadMenuItem Text="ECR Detail" ImageUrl="~/Images/detail.png" Value="MRDetail" DisabledImageUrl="~/Images/dis_detail.png"/>
            <telerik:RadMenuItem IsSeparator="True"/>
            ...
            <telerik:RadMenuItem IsSeparator="True"/>
            <telerik:RadMenuItem Text="Cancel ECR" ImageUrl="~/Images/cancel1.png" Value="CancelECR"/>
    ...
    <telerik:RadWindowManager ID="RadWindowManager1" runat="server" EnableShadow="true" >
        <Windows>
            <telerik:RadWindow ID="CreateNewWD" runat="server" Title="Create New ECR"
            ...
            <telerik:RadWindow ID="UpdateWD" runat="server" Title="Update ECR"
                VisibleStatusbar="False" Height="700" Width="850" 
                Left="150px" ReloadOnShow="true" ShowContentDuringLoad="false" Modal="true">
            </telerik:RadWindow>
            ...
            <telerik:RadWindow ID="RevisionHistory" runat="server" Title="ECR Revision History"
                VisibleStatusbar="false" Height="550" Width="1250" MinHeight="550"  
                Left="150px" ReloadOnShow="true" ShowContentDuringLoad="false" Modal="true">
            </telerik:RadWindow>
                
            <telerik:RadWindow ID="ECRDetailDialog" runat="server" Title="ECR Details"
            ...
            <telerik:RadWindow ID="CustomerDialog" runat="server" Title="ECR Information"
                VisibleStatusbar="false" Height="700" Width="650" 
                Left="150px" ReloadOnShow="true" ShowContentDuringLoad="false" Modal="true">
            </telerik:RadWindow>
        </Windows>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            ...
            function ShowEditForm(id) {
                ...
                owd.Show();
                owd.setUrl("TrackingECREditForm.aspx?objId=" + id + "&projId=" + projectId, "UpdateWD");
            }
            ...
            function ShowAttachment(id) {
                ...
                owd.Show();
                owd.setUrl("TrackingECRAttach.aspx?objId=" + id, "AttachDoc");
            }
            ...
            function ShowHistory(id) {
                ...
                owd.Show();
                owd.maximize();
                owd.setUrl("TrackingECRRevisionHistory.aspx?objId=" + id, "RevisionHistory");
            }
            ...
            function OnClientButtonClicking(sender, args) {
                ...
                if (strText == "ECR") {
                    ...
                    owd.setSize(850, document.documentElement.offsetHeight);
                    owd.Show();
                    owd.setUrl("TrackingECREditForm.aspx?projId=" + projectId, "CreateNewWD");
                }
            }
            ...
            function gridMenuClicking(sender, args) {
                ...
                case "MRDetail":
                    ...
                    var owd = $find("<%=ECRDetailDialog.ClientID %>");
                    owd.setSize(850, document.documentElement.offsetHeight);
                    owd.Show();
                    owd.setUrl("TrackingECRDetail.aspx?objId=" + docId, "ECRDetailDialog");
                    break;
                case "WFHistory":
                    var owd = $find("<%=WFProcessHistory.ClientID %>");
                    owd.Show();
                    owd.maximize();
                    owd.setUrl("../../Controls/Workflow/WorkflowProcessHistory.aspx?objId=" + docId + "&objType=ECR",
                        "WFProcessHistory");
                    break;
                case "AttachDocument":
                    var owd = $find("<%=AttachDoc.ClientID %>");
                    ...
                    owd.setUrl("TrackingECRAttach.aspx?objId=" + docId, "AttachDoc");
                    break;
                case "EditProperties":
                    var projectId = document.getElementById("<%= lblProjectId.ClientID %>").value;
                    var owd = $find("<%=CustomerDialog.ClientID %>");
                    owd.setSize(850, document.documentElement.offsetHeight);
                    owd.Show();
                    owd.setUrl("TrackingECREditForm.aspx?objId=" + docId + "&projId=" + projectId,
                        "CustomerDialog");
                    break;
                    case "CancelECR":
                        if (confirm("Do you want to cancel ECR?") === false) return;
