<%@ Page Title="" Language="C#"  MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TrackingWCRList.aspx.cs" Inherits="EDMs.Web.Controls.WMS.TrackingWCRList" EnableViewState="true" %>
    ...
    <div style="width: 98%; padding-top: 10px; padding-left: 5px">
        ...
        <telerik:RadTreeView ID="rtvDiscipline" runat="server" 
            ...
            <Nodes>
                ...
                <telerik:RadTreeNode runat="server" Text="Tracking List Of WCR" ImageUrl="~/Images/trackinglist.png" Value="WCR" NavigateUrl="TrackingWCRList.aspx" Selected="True"/>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
            ...
            <telerik:RadToolBar ID="CustomerMenu" runat="server" Width="100%" OnClientButtonClicking="OnClientButtonClicking">
                <Items>
                    <telerik:RadToolBarDropDown runat="server" Text="New" ImageUrl="~/Images/addNew.png">
                        <Buttons>
                            <telerik:RadToolBarButton runat="server" Text="WCR" Value="1" ImageUrl="~/Images/trackinglist.png"/>
                        </Buttons>
                    ...
                    <telerik:RadToolBarButton runat="server" Value="ShowAll">
                        <ItemTemplate>
                            ...
                            <asp:DropDownList ID="ddlStatus" runat="server" CssClass="min25Percent" Width="200px" style="max-width: 316px"
                                ...
                                <Items>
                                    <asp:ListItem Value="1" Text="All WCR"></asp:ListItem>
                                    <asp:ListItem Value="2" Text="All Latest WCR" Selected="True"></asp:ListItem>
                                    <%--<asp:ListItem Value="3" Text="Coming Due WCR" style="background-color: yellow"></asp:ListItem>
                                    <asp:ListItem Value="4" Text="Overdue WCR" style="background-color: red"></asp:ListItem>
                                    <asp:ListItem Value="5" Text="Completed WCR" style="background-color: greenyellow"></asp:ListItem>
                                    <asp:ListItem Value="6" Text="Incompleted WCR" style="background-color: coral"></asp:ListItem>
                                </Items>
                            </asp:DropDownList>
                                ...
                                <telerik:RadGrid ID="grdDocument" runat="server" AllowPaging="True"
                                    ...
                                    <MasterTableView ClientDataKeyNames="ID" DataKeyNames="ID" Width="100%" TableLayout="Auto" CssClass="rgMasterTable" CommandItemDisplay="Top" EditMode="InPlace">
                                        ...
                                        <Columns>
                                            ...
                                            <telerik:GridBoundColumn DataField="Name" HeaderText="Name of Equipment" UniqueName="Name">
                                            ...
                                            <telerik:GridDateTimeColumn UniqueName="OpenDate" HeaderText="Opened Date" DataField="OpenDate">
                                                <HeaderStyle HorizontalAlign="Center" Width="80" />
                                                <ItemStyle HorizontalAlign="Center"/>
                                            </telerik:GridDateTimeColumn>
                                            
                                            <telerik:GridDateTimeColumn UniqueName="CloseDate" HeaderText="Closed Date" DataField="CloseDate">
                                                <HeaderStyle HorizontalAlign="Center" Width="80" />
                                                <ItemStyle HorizontalAlign="Center"/>
                                            </telerik:GridDateTimeColumn>
    ...
    <telerik:RadWindowManager ID="RadWindowManager1" runat="server" EnableShadow="true" >
        <Windows>
            <telerik:RadWindow ID="CreateNewWD" runat="server" Title="Create New WCR"
                VisibleStatusbar="False" Height="700" Width="850" 
                Left="150px" ReloadOnShow="true" ShowContentDuringLoad="false" Modal="true">
            </telerik:RadWindow>
            
            <telerik:RadWindow ID="UpdateWD" runat="server" Title="Update WCR"
                VisibleStatusbar="False" Height="700" Width="850" 
                Left="150px" ReloadOnShow="true" ShowContentDuringLoad="false" Modal="true">
            </telerik:RadWindow>
            ...
            <telerik:RadWindow ID="RevisionHistory" runat="server" Title="WCR Revision History"
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            ...
            function ShowEditForm(id) {
                ...
                owd.Show();
                owd.setUrl("TrackingWCREditForm.aspx?objId=" + id + "&projId=" + projectId, "UpdateWD");
            }
            ...
            function ShowAttachment(id) {
                ...
                owd.Show();
                owd.setUrl("TrackingWCRAttach.aspx?objId=" + id, "AttachDoc");
            }
            ...
            function ShowHistory(id) {
                ...
                owd.Show();
                owd.maximize();
                owd.setUrl("TrackingWCRRevisionHistory.aspx?objId=" + id, "RevisionHistory");
            }
            ...
            function OnClientButtonClicking(sender, args) {
                ...
                if (strText == "WCR") {
                    ...
                    owd.setSize(850, document.documentElement.offsetHeight);
                    owd.Show();
                    owd.setUrl("TrackingWCREditForm.aspx?projId=" + projectId, "CreateNewWD");
                }
            }
