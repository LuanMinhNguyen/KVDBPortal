...
namespace EDMs.Web.Controls.WMS
{
    ...
    /// The customer edit form.
    /// </summary>
    public partial class TrackingPunchRevisionHistory : Page
    {
        protected const string ServiceName = "EDMSFolderWatcher";

        private readonly TrackingPunchService mcService;

        private readonly TrackingPunchAttachFileService mcAttachFileService;


        /// <summary>
        /// Initializes a new instance of the <see cref="TrackingPunchRevisionHistory"/> class.
        /// </summary>
        public TrackingPunchRevisionHistory()
        {
            this.mcAttachFileService = new TrackingPunchAttachFileService();
            this.mcService = new TrackingPunchService();
        ...
        protected void grdDocument_OnNeedDataSource(object source, GridNeedDataSourceEventArgs e)
        {
            if(Request.QueryString["objId"] != null)
            {
                ...
                if (obj != null)
                {
                    var revList = this.mcService.GetAllPunchRev(obj.ParentId == null ? obj.ID : obj.ParentId.Value);
