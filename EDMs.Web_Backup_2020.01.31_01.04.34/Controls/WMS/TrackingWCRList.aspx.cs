...
namespace EDMs.Web.Controls.WMS
{
    ...
    /// Class customer
    /// </summary>
    public partial class TrackingWCRList : Page
    {
        private readonly TrackingWCRService trackingWCRService = new TrackingWCRService();
        ...
        protected void grdDocument_OnNeedDataSource(object source, GridNeedDataSourceEventArgs e)
        {
            if (this.ddlProject.SelectedItem!= null)
            {
                if (this.IsView.Value == "True")
                {
                    ...
                    var projectId = Convert.ToInt32(this.ddlProject.SelectedValue);
                    var objList = this.trackingWCRService.GetAllRevTrackingWCROfProject(projectId,
                        txtSearchAllField.Text);
                    //var objList = new List<TrackingWCR>();
                    //switch (ddlStatus.SelectedValue)
                    //{
                    //    case "1":
                    //        objList = this.trackingWCRService.GetAllRevTrackingWCROfProject(projectId, txtSearchAllField.Text)
                    //                                    .ToList();
                    //        break;
                    //    case "2":
                    //        objList = this.trackingWCRService.GetAllTrackingWCROfProject(projectId, txtSearchAllField.Text)
                    //                                    .ToList();
                    //        break;
                    //    case "3":
                    //        objList = this.trackingWCRService.GetAllComingDueTrackingWCROfProject(projectId, txtSearchAllField.Text)
                    //                                    .ToList();
                    //        break;
                    //    case "4":
                    //        objList = this.trackingWCRService.GetAllOverDueTrackingWCROfProject(projectId, txtSearchAllField.Text)
                    //                                    .ToList();
                    //        break;
                    //    case "5":
                    //        objList = this.trackingWCRService.GetAllCompleteTrackingWCROfProject(projectId, txtSearchAllField.Text)
                    //                                    .ToList();
                    //        break;
                    //    case "6":
                    //        objList = this.trackingWCRService.GetAllInCompleteTrackingWCROfProject(projectId, txtSearchAllField.Text)
                    //                                    .ToList();
                    //        break;
                    //}
                ...
                {
                    this.grdDocument.DataSource = new List<TrackingWCR>();
                }
            }
            else
            {
        ...
        protected void grdDocument_DeleteCommand(object sender, GridCommandEventArgs e)
        {
            ...
            this.trackingWCRService.Delete(objId);
