...
namespace EDMs.Web.Controls.WMS
{
    ...
    /// Class customer
    /// </summary>
    public partial class TrackingProductionMeetingList : Page
    {
        private readonly TrackingProductionMeetingService trackingProductionMeetingService = new TrackingProductionMeetingService();
        ...
        protected void grdDocument_OnNeedDataSource(object source, GridNeedDataSourceEventArgs e)
        {
            if (this.ddlProject.SelectedItem!= null)
            {
                if (this.IsView.Value == "True")
                {
                    ...
                    var projectId = Convert.ToInt32(this.ddlProject.SelectedValue);
                    var objList =
                        this.trackingProductionMeetingService.GetAllRevTrackingProductionMeetingOfProject(projectId,
                            txtSearchAllField.Text).OrderByDescending(t => t.CreatedDate);
        ...
        protected void grdDocument_DeleteCommand(object sender, GridCommandEventArgs e)
        {
            ...
            this.trackingProductionMeetingService.Delete(objId);
