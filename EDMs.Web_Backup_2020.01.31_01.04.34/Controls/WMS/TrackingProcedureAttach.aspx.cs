...
namespace EDMs.Web.Controls.WMS
{
    ...
    /// The customer edit form.
    /// </summary>
    public partial class TrackingProcedureAttach : Page
    {
        private readonly TrackingProcedureAttachFileService trackingProcedureAttachFileService;
        ...
        /// </summary>
        public TrackingProcedureAttach()
        {
        ...
        protected void btnSaveAttachFile_Click(object sender, EventArgs e)
        {
            ...
            foreach (UploadedFile docFile in docuploader.UploadedFiles)
            {
                ...
                var attachFile = new TrackingProcedureAttachFile()
                {
                    ID = Guid.NewGuid(),
                    ProcedureId = objId,
                ...
                this.trackingProcedureAttachFileService.Insert(attachFile);
            }
        ...
        protected void grdAttachFile_DeleteCommand(object sender, GridCommandEventArgs e)
        {
            ...
            this.trackingProcedureAttachFileService.Delete(objId);
            this.grdAttachFile.Rebind();
        }
        ...
        {
            var objId = new Guid(this.Request.QueryString["objId"]);
            var attachList = this.trackingProcedureAttachFileService.GetAllObjId(objId);
