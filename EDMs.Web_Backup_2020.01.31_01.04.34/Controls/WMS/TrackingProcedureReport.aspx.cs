...
namespace EDMs.Web.Controls.WMS
{
    ...
    /// The customer edit form.
    /// </summary>
    public partial class TrackingProcedureReport : Page
    {
        protected const string ServiceName = "EDMSFolderWatcher";

        private readonly TrackingProcedureService pmService;

        private readonly TrackingProcedureAttachFileService pmAttachFileService;


        /// <summary>
        /// Initializes a new instance of the <see cref="TrackingProcedureReport"/> class.
        /// </summary>
        public TrackingProcedureReport()
        {
            this.pmAttachFileService = new TrackingProcedureAttachFileService();
            this.pmService = new TrackingProcedureService();
        ...
        protected void grdDocument_OnNeedDataSource(object source, GridNeedDataSourceEventArgs e)
        {
            if(Request.QueryString["stausName"] != null && Request.QueryString["projId"] != null)
            {
                ...
                var pmListFilter = new List<TrackingProcedure>();
