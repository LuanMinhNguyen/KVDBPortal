<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TrackingMorningCallList.aspx.cs" Inherits="EDMs.Web.Controls.WMS.TrackingMorningCallList" EnableViewState="true" %>
    ...
    <div style="width: 98%; padding-top: 10px; padding-left: 5px">
        ...
        <telerik:RadTreeView ID="rtvDiscipline" runat="server" 
            ...
            <Nodes>
                ...
                <telerik:RadTreeNode runat="server" Text="Tracking List Of Morning Call" ImageUrl="~/Images/morning.png" Value="MorningCall" Selected="True" NavigateUrl="TrackingMorningCallList.aspx"/>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
            ...
            <telerik:RadToolBar ID="CustomerMenu" runat="server" Width="100%" OnClientButtonClicking="OnClientButtonClicking">
                <Items>
                    <telerik:RadToolBarDropDown runat="server" Text="New" ImageUrl="~/Images/addNew.png">
                        <Buttons>
                            <telerik:RadToolBarButton runat="server" Text="Morning Call" Value="1" ImageUrl="~/Images/morning.png"/>
                        </Buttons>
                        ...
                        <ItemTemplate>
                            ...
                            <asp:DropDownList ID="ddlStatus" runat="server" CssClass="min25Percent" Width="200px" style="max-width: 316px"
                                ...
                                <Items>
                                    ...
                                    <asp:ListItem Value="2" Text="All Latest Morning Call" Selected="True"></asp:ListItem>
                                    <asp:ListItem Value="3" Text="Coming Due Morning Call" style="background-color: yellow"></asp:ListItem>
                                ...
                                <telerik:RadGrid ID="grdDocument" runat="server" AllowPaging="True"
                                    ...
                                    <MasterTableView ClientDataKeyNames="ID" DataKeyNames="ID" Width="100%" TableLayout="Auto" CssClass="rgMasterTable" CommandItemDisplay="Top" EditMode="InPlace">
                                        ...
                                        <Columns>
                                            ...
                                            <telerik:GridTemplateColumn UniqueName="EquipmentName" HeaderText="Names of Equipment/System/Matter">
                                                <HeaderStyle Width="200" HorizontalAlign="Center" />
                                                <ItemStyle HorizontalAlign="Left"/>
                                                <ItemTemplate>
                                            ...
                                            <telerik:GridTemplateColumn  DataField="InitRiskAssessment" HeaderText="Risk Assessment" UniqueName="InitRiskAssessment" 
                                                AllowFiltering="false" ColumnGroupName="InitRisk">
                                                <HeaderStyle HorizontalAlign="Center" Width="300" />
                                                <ItemStyle HorizontalAlign="Left"  />
                                                <ItemTemplate>
                                            ...
                                            <telerik:GridBoundColumn DataField="InitRiskLvlName" HeaderText="Risk level" UniqueName="InitRiskLvlName" ColumnGroupName="InitRisk">
                                                <HeaderStyle HorizontalAlign="Center" Width="80"/>
                                                <ItemStyle HorizontalAlign="Center"/>
                                            </telerik:GridBoundColumn>
                                            ...
                                            <telerik:GridTemplateColumn  DataField="ActionPlanDescription" HeaderText="Description of Action Plan" UniqueName="ActionPlanDescription" 
                                                AllowFiltering="false" ColumnGroupName="ActionPlan">
                                            ...
                                            <telerik:GridBoundColumn DataField="ActionPlanRiskLvlName" HeaderText="Risk level" UniqueName="ActionPlanRiskLvlName" ColumnGroupName="ActionPlan">
                                                <HeaderStyle HorizontalAlign="Center" Width="80"/>
                                                <ItemStyle HorizontalAlign="Center"/>
                                            </telerik:GridBoundColumn>
                                            ...
                                            <telerik:GridBoundColumn DataField="RelativeDoc" HeaderText="Relative Documents" UniqueName="RelativeDoc">
                                                <HeaderStyle HorizontalAlign="Center" Width="80" />
                                                <ItemStyle HorizontalAlign="Center"/>
                                            </telerik:GridBoundColumn>
    ...
    <telerik:RadWindowManager ID="RadWindowManager1" runat="server" EnableShadow="true" >
        <Windows>
            <telerik:RadWindow ID="CreateNewWD" runat="server" Title="Create New Morning Call"
                VisibleStatusbar="False" Height="700" Width="850" 
                Left="150px" ReloadOnShow="true" ShowContentDuringLoad="false" Modal="true">
            </telerik:RadWindow>
            
            <telerik:RadWindow ID="UpdateWD" runat="server" Title="Update Morning Call"
                VisibleStatusbar="False" Height="700" Width="850" 
                Left="150px" ReloadOnShow="true" ShowContentDuringLoad="false" Modal="true">
            </telerik:RadWindow>
            ...
            <telerik:RadWindow ID="RevisionHistory" runat="server" Title="Morning Call Revision History"
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            ...
            function ShowEditForm(id) {
                ...
                owd.Show();
                owd.setUrl("TrackingMorningCallEditForm.aspx?objId=" + id + "&projId=" + projectId, "UpdateWD");
            }
            ...
            function ShowAttachment(id) {
                ...
                owd.Show();
                owd.setUrl("TrackingMorningCallAttach.aspx?objId=" + id, "AttachDoc");
            }
            ...
            function ShowHistory(id) {
                ...
                owd.Show();
                owd.maximize();
                owd.setUrl("TrackingMorningCallRevisionHistory.aspx?objId=" + id, "RevisionHistory");
            }
            ...
            function OnClientButtonClicking(sender, args) {
                ...
                if (strText == "Morning Call") {
                    ...
                    owd.setSize(850, document.documentElement.offsetHeight);
                    owd.Show();
                    owd.setUrl("TrackingMorningCallEditForm.aspx?projId=" + projectId, "CreateNewWD");
                }
            }
