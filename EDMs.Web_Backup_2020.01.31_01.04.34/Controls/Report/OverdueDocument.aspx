<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="OverdueDocument.aspx.cs" Inherits="EDMs.Web.Controls.Report.OverdueDocument" EnableViewState="true" %>
                                   ...
                                   <telerik:GridDateTimeColumn HeaderText="Date Issues" UniqueName="TransInDate" DataField="TransInDate"
                                    ...
                                    <telerik:GridDateTimeColumn HeaderText="Due Date" UniqueName="TrasInDueDate" DataField="TrasInDueDate"
                                        ...
                                        <ItemStyle HorizontalAlign="Center"/>
                                           ...
                                           <telerik:GridTemplateColumn HeaderText="Days Overdue" DataField="DaysOverDue" UniqueName="DaysOverDue"
                                        ShowFilterIcon="False" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        <HeaderStyle HorizontalAlign="Center" Width="80" />
                                        <ItemStyle HorizontalAlign="Left" Width="80" />
