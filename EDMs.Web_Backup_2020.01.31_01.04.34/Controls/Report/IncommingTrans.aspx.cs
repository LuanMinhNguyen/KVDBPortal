...
namespace EDMs.Web.Controls.Report
{
    ...
    //public class TaskProcessingIncom
    //{
    ...
    /// Class customer
    /// </summary>
    public partial class IncommingTrans : Page
    {
        ...
        protected void LoadDocuments()
        {
            ...
            overduretask = this.dqreDocumentSevice.GetAllIncomming().Select(t => new TaskProcessing
            {
                ID=t.ID,
        ...
        private void ExportCMDRDataFile()
        {
            ...
            var filename = "Incomming-Transmittal-Report_ " + DateTime.Now.ToString("ddmmyy") + ".xlsm";

            dataSheet.Cells["O4"].PutValue(DateTime.Now.ToString("dd/MM/yyyy"));
            dataSheet.Cells["E1"].PutValue("INCOMMING TRANSMITTAL REPORT");
            ...
            this.grdDocument.Rebind();
            var docList = this.dqreDocumentSevice.GetAllIncomming().Where(t=>ListId.Contains(t.ID)).Select(t => new {
                ID = t.ID,
                TransmittalNumber = t.IncomingTransNo,
                DocumentNumber = t.DocumentNo,
                DocRev = t.Revision,
        ...
        private void LoadReportPanel()
        {
            ...
            if (permissions.Any())
            {
                ...
                foreach (RadPanelItem item in this.radPbReport.Items[0].Items)
                {
                    ...
                    if (item.Text == "Incomming Transmittal")
                    {
                        item.Selected = true;
                    }
                }
