<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DocumentRelease.aspx.cs" Inherits="EDMs.Web.Controls.Report.DocumentRelease" EnableViewState="true" %>
                        ...
                        <telerik:RadPane ID="Radpane6" runat="server" Scrolling="None">
                            <telerik:RadGrid  ID="grdDocument" runat="server" AllowPaging="True"
                                ...
                                <telerik:GridTemplateColumn HeaderText="Document Description / Title" DataField="Title" UniqueName="Title"
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Revision" DataField="Revision" UniqueName="Revision"
                                        ShowFilterIcon="False" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        ...
                                        <ItemTemplate>
                                         ...
                                         <telerik:GridTemplateColumn HeaderText="Document Type" DataField="M_DocumentTypeName" UniqueName="M_DocumentTypeName"
                                        ShowFilterIcon="False" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        <HeaderStyle HorizontalAlign="Center" Width="80" />
                                        <ItemStyle HorizontalAlign="Left" Width="80" />
                                        <ItemTemplate>
                                            <%# Eval("M_DocumentTypeName") %>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                           <telerik:GridTemplateColumn HeaderText="CLass" DataField="DocumentClassName" UniqueName="DocumentClassName"
                                        ShowFilterIcon="False" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        <HeaderStyle HorizontalAlign="Center" Width="80" />
                                        <ItemStyle HorizontalAlign="Left" Width="80" />
                                        <ItemTemplate>
                                            <%# Eval("DocumentClassName") %>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                           <telerik:GridTemplateColumn HeaderText="Revision Status" DataField="RevisionStatusName" UniqueName="RevisionStatusName"
                                        ShowFilterIcon="False" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        <HeaderStyle HorizontalAlign="Center" Width="120" />
                                        <ItemStyle HorizontalAlign="Left" Width="120" />
                                        <ItemTemplate>
                                            <%# Eval("RevisionStatusName") %>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                         
                                           <telerik:GridTemplateColumn HeaderText="Unit" DataField="M_UnitName" UniqueName="M_UnitName"
                                        ShowFilterIcon="False" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        <HeaderStyle HorizontalAlign="Center" Width="80" />
                                        <ItemStyle HorizontalAlign="Left" Width="80" />
                                     ...
                                     <telerik:GridTemplateColumn HeaderText="Discipline" DataField="M_DisciplineName" UniqueName="M_DisciplineName"
                                        ShowFilterIcon="False" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        <HeaderStyle HorizontalAlign="Center" Width="80" />
                                        <ItemStyle HorizontalAlign="Center" Width="80" />
                                        <ItemTemplate>
                                            <%# Eval("M_DisciplineName") %>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                   
                                   <telerik:GridDateTimeColumn HeaderText="Date Issues" UniqueName="IsssuedDate" DataField="IsssuedDate"
                                            DataFormatString="{0:dd/MM/yyyy}" SortExpression="IsssuedDate"  PickerType="DatePicker" AutoPostBackOnFilter="true" 
