<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EMDRReport.aspx.cs" Inherits="EDMs.Web.Controls.Report.EMDRReport" EnableViewState="true" %>
                                ...
                                <MasterTableView AllowMultiColumnSorting="false"
                                    ...
                                    <Columns>
                                       ...
                                       <telerik:GridTemplateColumn HeaderText="UserName" UniqueName="UserName"
                                        DataField="UserName" ShowFilterIcon="True" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        <HeaderStyle HorizontalAlign="Center" Width="90" />
                                        <ItemStyle HorizontalAlign="Left" Width="90" />
                                        <ItemTemplate>
                                            <asp:Label ID="lblM_SystemDocumentNo" runat="server" Text='<%# Eval("UserName") %>' style="cursor: pointer"/> 
                                            
                                        </ItemTemplate></telerik:GridTemplateColumn>
     
                                    <telerik:GridTemplateColumn HeaderText="Description" DataField="FullName" UniqueName="FullName"
                                   ...
                                   <telerik:GridDateTimeColumn HeaderText="User Login Server Time" UniqueName="ServerTime" DataField="ServerTime"
                                            DataFormatString="{0:dd/MM/yyyy hh:mm:ss}" SortExpression="StartDate"  PickerType="DatePicker" AutoPostBackOnFilter="true" 
                                      ...
                                      <telerik:GridDateTimeColumn HeaderText="User Login Local Time" UniqueName="LocalTime" DataField="LocalTime"
                                            DataFormatString="{0:dd/MM/yyyy hh:mm:ss}" FilterControlWidth="80%" CurrentFilterFunction="EqualTo" AutoPostBackOnFilter="True">
                                        <HeaderStyle HorizontalAlign="Center" Width="120" />
                                        <ItemStyle HorizontalAlign="Center"/>
                                    </telerik:GridDateTimeColumn>   
                                     <telerik:GridTemplateColumn HeaderText="User Login Local Time Zone" UniqueName="LocalTimeZone" DataField="LocalTimeZone"
                                        ShowFilterIcon="False" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        ...
                                        <ItemTemplate>
                                          ...
                                          <telerik:GridDateTimeColumn HeaderText="User Logout Local Time" UniqueName="LogoutLocalTime" DataField="LogoutLocalTime"
                                            DataFormatString="{0:dd/MM/yyyy hh:mm:ss}" FilterControlWidth="80%" CurrentFilterFunction="EqualTo" AutoPostBackOnFilter="True">
                                        <HeaderStyle HorizontalAlign="Center" Width="120" />
                                        <ItemStyle HorizontalAlign="Center"/>
                                    </telerik:GridDateTimeColumn> 
                                          <telerik:GridTemplateColumn HeaderText="User Login Duration" UniqueName="DurationTimeLogin"
                                        ShowFilterIcon="False" FilterControlWidth="97%"  DataField="DurationTimeLogin"
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        <HeaderStyle HorizontalAlign="Center" Width="80" />
                                        <ItemStyle HorizontalAlign="Center"  />
                                        <ItemTemplate>
                                            <%# Eval("DurationTimeLogin") %>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn> 
                                         <telerik:GridTemplateColumn HeaderText="IP V4 Address" UniqueName="IpAddress"
                                        ShowFilterIcon="False" FilterControlWidth="97%"  DataField="IpAddress"
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        <HeaderStyle HorizontalAlign="Center" Width="80" />
                                        <ItemStyle HorizontalAlign="Center"  />
                                        <ItemTemplate>
                                            <%# Eval("IpAddress").ToString().Length >8 ? Eval("IpAddress").ToString().Substring(0,8): Eval("IpAddress").ToString() %>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn> 
                                  
                                         <telerik:GridTemplateColumn HeaderText="Windows Host Name" UniqueName="HostNameComputer"
                                        ShowFilterIcon="False" FilterControlWidth="97%"  DataField="HostNameComputer"
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        <HeaderStyle HorizontalAlign="Center" Width="120" />
                                        <ItemStyle HorizontalAlign="Center"  />
                                        <ItemTemplate>
                                            <%# Eval("HostNameComputer") %>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn> 
                                         
                                    <telerik:GridTemplateColumn HeaderText="Browser" UniqueName="Browser" DataField="Browser"
                                        ShowFilterIcon="False" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        <HeaderStyle HorizontalAlign="Center" Width="120" />
                                        <ItemStyle HorizontalAlign="Center"  />
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Windows OS Details" UniqueName="OSDetail" DataField="OSDetail"
                                        ShowFilterIcon="False" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        <HeaderStyle HorizontalAlign="Center" Width="120" />
                                        <ItemStyle HorizontalAlign="Center"  />
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Windows Language Format" UniqueName="LanguageFormat" DataField="LanguageFormat"
                                        ShowFilterIcon="False" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        <HeaderStyle HorizontalAlign="Center" Width="120" />
