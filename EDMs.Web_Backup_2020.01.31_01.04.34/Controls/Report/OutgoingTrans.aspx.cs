...
namespace EDMs.Web.Controls.Report
{
    ...
    /// Class customer
    /// </summary>
    public partial class OutgoingTrans : Page
    {
        ...
        protected void LoadDocuments()
        {
            ...
            overduretask = this.dqreDocumentSevice.GetAllOutGoing().Select(t => new TaskProcessing
            {
                ID=t.ID,
                TransmittalNumber=t.OutgoingTransNo,
                ...
                TransInDate = t.OutgoingTransId != null? this.dqreTransmittalService.GetById(t.OutgoingTransId.GetValueOrDefault()).IssuedDate.GetValueOrDefault(): datenull,
                TrasInDueDate= t.OutgoingTransId != null ? (this.dqreTransmittalService.GetById(t.OutgoingTransId.GetValueOrDefault()).DueDate!= null? this.dqreTransmittalService.GetById(t.OutgoingTransId.GetValueOrDefault()).DueDate.GetValueOrDefault():datenull) : datenull,
        ...
        private void ExportCMDRDataFile()
        {
            ...
            var filename = "Outgoing-Transmittal-Report_ " + DateTime.Now.ToString("ddmmyy") + ".xlsm";

            dataSheet.Cells["O4"].PutValue(DateTime.Now.ToString("dd/MM/yyyy"));
            dataSheet.Cells["E1"].PutValue("OUTGOING TRANSMITTAL REPORT");
            ...
            this.grdDocument.Rebind();
            var docList = this.dqreDocumentSevice.GetAllOutGoing().Where(t=>ListId.Contains(t.ID)).Select(t => new {
                ID = t.ID,
        ...
        private void LoadReportPanel()
        {
            ...
            if (permissions.Any())
            {
                ...
                foreach (RadPanelItem item in this.radPbReport.Items[0].Items)
                {
                    ...
                    if (item.Text == "Outgoing Transmittal")
                    {
                        item.Selected = true;
                    }
                }
