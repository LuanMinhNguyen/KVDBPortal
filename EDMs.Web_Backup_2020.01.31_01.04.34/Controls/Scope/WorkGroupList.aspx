<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="WorkGroupList.aspx.cs" Inherits="EDMs.Web.Controls.Scope.WorkGroupList" EnableViewState="true" %>
        ...
        <Items>
            <telerik:RadPanelItem Text="SCOPE" runat="server" Expanded="True" Width="100%">
                <Items>
                    ...
                    <telerik:RadPanelItem runat="server" Text="Workgroups" ImageUrl="~/Images/workgroup.png" NavigateUrl="~/Controls/Scope/WorkGroupList.aspx" Selected="True"/>
                </Items>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
            ...
            <telerik:RadToolBar ID="CustomerMenu" runat="server" Width="100%" OnClientButtonClicking="OnClientButtonClicking">
                <Items>
                    <telerik:RadToolBarDropDown runat="server" Text="New" ImageUrl="~/Images/addNew.png">
                        <Buttons>
                            <telerik:RadToolBarButton runat="server" Text="Workgroup" Value="1" ImageUrl="~/Images/workgroup.png"/>
                        </Buttons>
    ...
    <telerik:RadWindowManager ID="RadWindowManager1" runat="server" EnableShadow="true" >
        <Windows>
            <telerik:RadWindow ID="CustomerDialog" runat="server" Title="WorkGroup Information"
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            ...
            function OnClientButtonClicking(sender, args) {
                ...
                if (strText.toLowerCase() == "workgroup") {
                    var owd = $find("<%=CustomerDialog.ClientID %>");
                    owd.Show();
