<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MRTypeList.aspx.cs" Inherits="EDMs.Web.Controls.Library.MRTypeList" EnableViewState="true" %>
            ...
            <telerik:RadToolBar ID="CustomerMenu" runat="server" Width="100%" OnClientButtonClicking="OnClientButtonClicking">
                <Items>
                    <telerik:RadToolBarDropDown runat="server" Text="New" ImageUrl="~/Images/addNew.png">
                        <Buttons>
                            <telerik:RadToolBarButton runat="server" Text="Material Requisition Type" Value="1" ImageUrl="~/Images/material.png"/>
                        </Buttons>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            ...
            function OnClientButtonClicking(sender, args) {
                ...
                if (strText == "Material Requisition Type") {
                    var owd = $find("<%=CustomerDialog.ClientID %>");
                    owd.Show();
                    owd.setUrl("MRTypeEditForm.aspx", "CustomerDialog");
                }
            }
