<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SystemCodeEditForm.aspx.cs" Inherits="EDMs.Web.Controls.Library.SystemCodeEditForm" %>
        ...
        <div style="width: 100%" runat="server" ID="divContent">
            <ul style="list-style-type: none">
                    ...
                    <div>
                        ...
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem" runat="server" id="div3">
                            <telerik:RadComboBox ID="ddlParent" runat="server" Skin="Windows7" 
                                ...
                                <ItemTemplate>
                                    <div id="div1">
                                        <telerik:RadTreeView runat="server" ID="rtvSystemCode" Skin="Windows7" OnClientNodeClicking="nodeClicking">
                                            <DataBindings>
                ...
                <li style="width: 600px;">
                    <div>
                        <label style="width: 125px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
                            <span style="color: #2E5689; text-align: right; ">Package No.
                            </span>
                        </label>
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                            <asp:TextBox ID="txtPackageNo" runat="server" Style="width: 400px;" CssClass="min25Percent"/>
                        </div>
                    </div>
                    <div style="clear: both; font-size: 0;"></div>
                </li>
                ...
                <li style="width: 600px;">
                    <div>
                        <label style="width: 125px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
                            <span style="color: #2E5689; text-align: right; ">KKS
                            </span>
                        </label>
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                            <asp:DropDownList ID="ddlKKS" runat="server" CssClass="min25Percent qlcbFormRequired" Width="415px"/>
         ...
         <div style="width: 100%">
            <ul style="list-style-type: none">
                <li style="width: 600px; padding-top: 10px; padding-bottom: 3px; text-align: center">
                    <telerik:RadButton ID="btnSave" runat="server" Text="Save" OnClick="btnSave_Click" Width="125px" style="text-align: center"
>
                        <Icon PrimaryIconUrl="~/Images/save.png" PrimaryIconLeft="4" PrimaryIconTop="4" PrimaryIconWidth="16" PrimaryIconHeight="16"></Icon>
                    </telerik:RadButton>
                    <%--<telerik:RadButton ID="btncancel" runat="server" Text="Cancel" Width="125px" style="text-align: center"
        ...
        <telerik:RadAjaxManager runat="Server" ID="ajaxDocument">
            <AjaxSettings> 
                ...
                <telerik:AjaxSetting AjaxControlID="ddlPlant">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="rtvSystemCode"></telerik:AjaxUpdatedControl>
        ...
        <telerik:RadScriptBlock runat="server">
            <script type="text/javascript">
                ...
                function OnClientDropDownOpenedHandler(sender, eventArgs) {
                    var tree = sender.get_items().getItem(0).findControl("rtvSystemCode");
