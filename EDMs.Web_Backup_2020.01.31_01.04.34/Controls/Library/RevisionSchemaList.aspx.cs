...
namespace EDMs.Web.Controls.Library
{
    ...
    /// Class customer
    /// </summary>
    public partial class RevisionSchemaList : Page
    {
        private readonly PermissionService permissionService = new PermissionService();

        private readonly RevisionSchemaService revisionSchemaSrvice = new RevisionSchemaService();
        ...
        {
            this.grdDocument.DataSource = this.revisionSchemaSrvice.GetAll();
        ...
        protected void RadAjaxManager1_AjaxRequest(object sender, AjaxRequestEventArgs e)
        {
            ...
            }else if(e.Argument== "ExportTemplate")
            {
                ...
                workbook.Open(filePath + @"Template\TemplateRevisionScheme.xls");
                var sheets = workbook.Worksheets;
                var filename =  "RevisionSchema_MasterListTemplate"+ DateTime.Now.ToString("ddmmyyy")+".xls";
        ...
        protected void grdDocument_DeleteCommand(object sender, GridCommandEventArgs e)
        {
            ...
            this.revisionSchemaSrvice.Delete(disId);
