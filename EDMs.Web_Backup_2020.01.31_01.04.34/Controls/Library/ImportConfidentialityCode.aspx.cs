...
namespace EDMs.Web.Controls.Library
{
    ...
    /// The customer edit form.
    /// </summary>
    public partial class ImportConfidentialityCode : Page
    {
        ...
        /// </summary>
        public ImportConfidentialityCode()
        {
                ...
                foreach (UploadedFile docFile in this.docuploader.UploadedFiles)
                {
                    ...
                    if (extension == ".xls" || extension == ".xlsx" || extension == ".xlsm")
                    {
                        ...
                        foreach (DataRow prDetailRow in prDetailTable.Rows)
                        {
                            ...
                            var confidentialityCodeObj = this.confidentialityService.GetById(int.Parse(ID));
                            if (confidentialityCodeObj != null)
                            {
                                confidentialityCodeObj.Code = Code;
                                confidentialityCodeObj.Description = Description;
                                confidentialityCodeObj.LastUpdatedBy = UserSession.Current.User.Id;
                                confidentialityCodeObj.LastUpdatedDate = DateTime.Now;
                                confidentialityService.Update(confidentialityCodeObj);
                            }
                            else
                            {
                                confidentialityCodeObj = new Confidentiality();
                                confidentialityCodeObj.Code = Code;
                                confidentialityCodeObj.Description = Description;
                                confidentialityCodeObj.CreatedBy = UserSession.Current.User.Id;
                                confidentialityCodeObj.CreatedDate = DateTime.Now;
                                this.confidentialityService.Insert(confidentialityCodeObj);
                            }
                        }
