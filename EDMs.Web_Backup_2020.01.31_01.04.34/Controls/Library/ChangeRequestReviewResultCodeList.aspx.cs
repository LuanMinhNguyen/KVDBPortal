...
namespace EDMs.Web.Controls.Library
{
    ...
    /// Class customer
    /// </summary>
    public partial class ChangeRequestReviewResultCodeList : Page
    {
        private readonly PermissionService permissionService = new PermissionService();

        private readonly ChangeRequestReviewResultCodeService ChangeRequestReviewResultCodeCodeService = new ChangeRequestReviewResultCodeService();
        ...
        protected void RadAjaxManager1_AjaxRequest(object sender, AjaxRequestEventArgs e)
        {
            ...
            {
                this.ExportChangeRequestReviewResultCode();
            }
        }

        private void ExportChangeRequestReviewResultCode()
        {
            ...
            var ChangeRequestReviewResultCodeCodeList = this.ChangeRequestReviewResultCodeCodeService.GetAll().ToList();
            ...
            foreach (var ChangeRequestReviewResultCodeObj in ChangeRequestReviewResultCodeCodeList)
            {
                var dataRow = dtFull.NewRow();
                dataRow["ID"] = ChangeRequestReviewResultCodeObj.ID;
                dataRow["Code"] = ChangeRequestReviewResultCodeObj.Code;
                dataRow["Description"] = ChangeRequestReviewResultCodeObj.Description;
            ...
            dataSheet.Cells["C1"].PutValue("ChangeRequestReviewResultCodeCode CODE");
            var filename = "ChangeRequestReviewResultCode.xlsx";
        ...
        {
            var projectList = this.ChangeRequestReviewResultCodeCodeService.GetAll();
        ...
        protected void grdDocument_DeleteCommand(object sender, GridCommandEventArgs e)
        {
            ...
            this.ChangeRequestReviewResultCodeCodeService.Delete(disId);
        ...
        private void LoadScopePanel()
        {
            ...
            if (permissions.Any())
            {
                ...
                foreach (RadPanelItem item in this.radPbScope.Items[0].Items)
                {
                    item.ImageUrl = permissions.FirstOrDefault(t => t.Id == Convert.ToInt32(item.Value)).Menu.Icon;
                    item.NavigateUrl = permissions.FirstOrDefault(t => t.Id == Convert.ToInt32(item.Value)).Menu.Url;
                    if (item.Text == "Change Request Review Result Code")
                    {
                        item.Selected = true;
                    }
                }
