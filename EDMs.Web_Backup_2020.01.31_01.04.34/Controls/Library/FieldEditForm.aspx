<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FieldEditForm.aspx.cs" Inherits="EDMs.Web.Controls.Library.FieldEditForm" %>
            ...
            <ul style="list-style-type: none">
                ...
                <li style="width: 500px;">
                    <div>
                        ...
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                            <telerik:RadComboBox ID="ddlBlock" runat="server" Skin="Windows7"></telerik:RadComboBox>
                        </div>
                    </div>
                    <div style="clear: both; font-size: 0;"></div>
                </li>
        ...
        <telerik:RadAjaxManager runat="Server" ID="ajaxDocument">
            <AjaxSettings> 
                ...
                <telerik:AjaxSetting AjaxControlID="ddlDeparment">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="ddlBlock" LoadingPanelID="RadAjaxLoadingPanel2"></telerik:AjaxUpdatedControl>
                    </UpdatedControls>
                </telerik:AjaxSetting>
            </AjaxSettings>
