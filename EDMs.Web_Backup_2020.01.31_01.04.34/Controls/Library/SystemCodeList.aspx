<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SystemCodeList.aspx.cs" Inherits="EDMs.Web.Controls.Library.SystemCodeList" EnableViewState="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
            ...
            <telerik:RadToolBar ID="CustomerMenu" runat="server" Width="100%" OnClientButtonClicking="OnClientButtonClicking">
                <Items>
                    <telerik:RadToolBarDropDown runat="server" Text="New" ImageUrl="~/Images/addNew.png">
                        <Buttons>
                            <telerik:RadToolBarButton runat="server" Text="System - SubSystem" Value="1" ImageUrl="~/Images/system.png" Width="190"/>
                        </Buttons>
                                ...
                                <MasterTableView ClientDataKeyNames="ID" DataKeyNames="ID" Width="100%" TableLayout="Auto" CssClass="rgMasterTable">
                                    ...
                                    <HeaderStyle Font-Bold="True" HorizontalAlign="Center" VerticalAlign="Middle" />
                                      <Columns>
                                            ...
                                            <telerik:GridBoundColumn DataField="PackageNo" HeaderText="Package No." UniqueName="PackageNo" ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                                <HeaderStyle HorizontalAlign="Center" Width="150" />
                                                <ItemStyle HorizontalAlign="Left" />
                                            </telerik:GridBoundColumn>
                                          
                                          <telerik:GridBoundColumn DataField="KKSCode" HeaderText="KKS" UniqueName="KKSCode" ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
    ...
    <telerik:RadWindowManager ID="RadWindowManager1" runat="server" EnableShadow="true" >
        <Windows>
            <telerik:RadWindow ID="CustomerDialog" runat="server" Title="System - SubSystem Information"
                VisibleStatusbar="false" Height="350" Width="610"  IconUrl="~/Images/system.png"
        ...
        <script type="text/javascript">
            ...
            function pageLoad() {
             ...
             function ShowEditForm(id) {
                ...
                owd.Show();
                owd.setUrl("SystemCodeEditForm.aspx?objId=" + id, "CustomerDialog");
            }
            ...
            function OnClientButtonClicking(sender, args) {
                ...
                if (strText === "System - SubSystem") {
                    var owd = $find("<%=CustomerDialog.ClientID %>");
                    owd.setSize(730, document.documentElement.offsetHeight);
                    owd.Show();
                    owd.setUrl("SystemCodeEditForm.aspx", "CustomerDialog");
                ...
                if (strText.toLowerCase() == "import data file") {
                    ...
                    owd.setSize(730, document.documentElement.offsetHeight);
                    owd.Show();
                    owd.setUrl("SystemCodeImportFileTemplate.aspx", "ImportTemplate");
                }
            }
