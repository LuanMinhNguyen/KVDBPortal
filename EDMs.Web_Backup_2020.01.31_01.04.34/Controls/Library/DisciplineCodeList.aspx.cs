...
namespace EDMs.Web.Controls.Library
{
    ...
    /// Class customer
    /// </summary>
    public partial class DisciplineCodeList : Page
    {
        ...
        protected void RadAjaxManager1_AjaxRequest(object sender, AjaxRequestEventArgs e)
        {
            ...
            {
                this.ExportDisciplineCode();
            }
        }

        private void ExportDisciplineCode()
        {
            ...
            var disciplineList = this.disciplineService.GetAll().ToList();
            ...
            foreach (var disciplineObj in disciplineList)
            {
                var dataRow = dtFull.NewRow();
                dataRow["ID"] = disciplineObj.ID;
                dataRow["Code"] = disciplineObj.Code;
                dataRow["Description"] = disciplineObj.Description;
            ...
            dataSheet.Cells["C1"].PutValue("DISCIPLINE CODE");
            var filename = "DisciplineCode.xlsx";
        ...
        {
            var projectList = this.disciplineService.GetAll();
