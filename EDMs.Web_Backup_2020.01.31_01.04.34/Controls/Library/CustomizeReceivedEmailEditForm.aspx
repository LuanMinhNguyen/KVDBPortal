<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomizeReceivedEmailEditForm.aspx.cs" Inherits="EDMs.Web.Controls.Library.CustomizeReceivedEmailEditForm" %>
            ...
            <ul style="list-style-type: none">
                ...
                <li style="width: 500px;">
                    <div>
                        ...
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                            <asp:DropDownList ID="ddlfrom" runat="server" CssClass="min25Percent" Width="316px" style="max-width: 416px">
                                 <Items>
                                    <asp:ListItem Value="1" Text="PECC2"></asp:ListItem>
                                    <asp:ListItem Value="2" Text="CHEC"></asp:ListItem></Items>
                            </asp:DropDownList>
                        </div>
                    </div>
                    <div style="clear: both; font-size: 0;"></div>
                    ...
                    <div>
                        ...
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                            <asp:DropDownList ID="ddlObject" runat="server" CssClass="min25Percent qlcbFormRequired" Width="315px">
                                <Items>
                                    <asp:ListItem Value="1" Text="Document Transmittal"></asp:ListItem>
                                 <%--   <asp:ListItem Value="2" Text="Change Request"></asp:ListItem>
                                    <asp:ListItem Value="3" Text="NCR/SI/CS"></asp:ListItem>
                                    <asp:ListItem Value="4" Text="RFI"></asp:ListItem>
                                    <asp:ListItem Value="5" Text="Shipment"></asp:ListItem>--%>
                                </Items> 
                            </asp:DropDownList>
                        </div>
                    </div>
