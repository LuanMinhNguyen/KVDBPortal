...
namespace EDMs.Web.Controls.Library
{
    ...
    /// Class customer
    /// </summary>
    public partial class OrganizationCodeList : Page
    {
        ...
        {
            this.grdDocument.DataSource = this._OrganizationCodeService.GetAll();
        ...
        protected void RadAjaxManager1_AjaxRequest(object sender, AjaxRequestEventArgs e)
        {
            ...
            }else if(e.Argument== "ExportTemplate")
            {
                ...
                workbook.Open(filePath + @"Template\TemplateOrganizationCode.xls");
               // var sheets = workbook.Worksheets;
               // var readMeSheet = sheets[1];
               // var dataSheet = sheets[0];
                var filename =  "Organization_MasterListTemplate"+ DateTime.Now.ToString("ddmmyyy")+".xls";
        ...
        protected void grdDocument_DeleteCommand(object sender, GridCommandEventArgs e)
        {
            ...
            this._OrganizationCodeService.Delete(disId);
        ...
        private void LoadScopePanel()
        {
            ...
            if (permissions.Any())
            {
                ...
                foreach (RadPanelItem item in this.radPbScope.Items[0].Items)
                {
                    ...
                    if (item.Text == "Organization Code")
                    {
                        item.Selected = true;
                    }
                }
