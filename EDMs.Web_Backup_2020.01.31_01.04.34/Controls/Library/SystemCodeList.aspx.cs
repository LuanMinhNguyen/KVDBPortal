...
namespace EDMs.Web.Controls.Library
{
    ...
    /// Class customer
    /// </summary>
    public partial class SystemCodeList : Page
    {
        ...
        /// </summary>
        private readonly SystemCodeService _documenTypeService = new SystemCodeService();
        ...
        protected void RadAjaxManager1_AjaxRequest(object sender, AjaxRequestEventArgs e)
        {
            ...
            else if (e.Argument == "ExportTemplate")
            {
                ...
                workbook.Open(filePath + @"Template\TemplateSystemCode.xls");
                ...
                var filename = "SystemCode_MasterListTemplate" + DateTime.Now.ToString("ddmmyyyy") + ".xls";
