...
namespace EDMs.Web.Controls.Library
{
    ...
    /// </summary>
    public partial class AreaImportFileTemplate : Page
    {
            ...
            try
            {
                ...
                foreach (UploadedFile docFile in this.docuploader.UploadedFiles)
                {
                    ...
                    if (extension == ".xls" || extension == ".xlsx" || extension == ".xlsm")
                    {
                        ...
                        {
                            var PlantText = dataRow["Column1"].ToString();
                            var AreaCode = dataRow["column2"].ToString();
                            var description = dataRow["column3"].ToString();

                            var plantObj = this.plantService_.GetByName(PlantText);
                            if (plantObj != null && !string.IsNullOrEmpty(AreaCode))
                            {
                                ...
                                this.areaService_.Insert(areaobj);
                            }
                            else
                            {
                                error = "Have Error";
                ...
                if (error.Length != 0)
                {
                    ...
                    this.lblError.Text = "PlantCode does not exist</br>";
