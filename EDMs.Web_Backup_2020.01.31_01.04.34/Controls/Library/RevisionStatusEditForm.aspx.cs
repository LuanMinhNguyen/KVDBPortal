...
namespace EDMs.Web.Controls.Library
{
    ...
    /// The customer edit form.
    /// </summary>
    public partial class RevisionStatusEditForm : Page
    {
        /// <summary>
        /// The folder service.
        /// </summary>
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!this.IsPostBack)
            {
                if (!string.IsNullOrEmpty(this.Request.QueryString["disId"]))
                {
                    ...
                    var objArea = this._RevisionStatusService.GetById(Convert.ToInt32(this.Request.QueryString["disId"]));
                    if (objArea != null)
                    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            if (this.Page.IsValid)
            {
                if (!string.IsNullOrEmpty(this.Request.QueryString["disId"]))
                {
                    ...
                    var obj = this._RevisionStatusService.GetById(plantId);
                    if (obj != null)
                    {
                        ...
                        this._RevisionStatusService.Update(obj);
                    }
                }
                else
                {
                    var obj = new RevisionStatu()
                    {
                    ...
                    this._RevisionStatusService.Insert(obj);
                }
