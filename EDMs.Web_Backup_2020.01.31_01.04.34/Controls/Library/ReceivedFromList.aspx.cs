...
namespace EDMs.Web.Controls.Library
{
    ...
    /// Class customer
    /// </summary>
    public partial class ReceivedFromList : Page
    {
        ...
        {
            var categoryPermission = this.groupDataPermissionService.GetByRoleId(UserSession.Current.User.RoleId.GetValueOrDefault()).Select(t => Convert.ToInt32(t.CategoryIdList)).ToList();
            this.grdDocument.DataSource = this.ReceivedFromService.GetAllByCategory(categoryPermission);
        ...
        protected void grdDocument_DeleteCommand(object sender, GridCommandEventArgs e)
        {
            ...
            this.ReceivedFromService.Delete(disId);
