<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="NotificationRuleList.aspx.cs" Inherits="EDMs.Web.Controls.Document.NotificationRuleList" EnableViewState="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <telerik:RadPanelBar ID="radPbCategories" runat="server" Visible="False" Width="100%"></telerik:RadPanelBar>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
            ...
            <telerik:RadToolBar ID="CustomerMenu" runat="server" Width="100%" OnClientButtonClicking="OnClientButtonClicking">
                <Items>
                    <telerik:RadToolBarDropDown runat="server" Text="New" ImageUrl="~/Images/addNew.png">
                        <Buttons>
                            <telerik:RadToolBarButton runat="server" Text="Notification rule" Value="1" ImageUrl="~/Images/notification.png"/>
                        </Buttons>
                                ...
                                <telerik:RadGrid ID="grdDocument" runat="server" AllowPaging="True"
                                    ...
                                    <MasterTableView ClientDataKeyNames="ID" DataKeyNames="ID" Width="100%" TableLayout="Auto" CssClass="rgMasterTable">
                                        ...
                                        <Columns>
                                            ...
                                            <telerik:GridButtonColumn CommandName="Delete" ConfirmText="Do you want to delete Notification rule?" ButtonType="ImageButton" ImageUrl="~/Images/delete.png">
                                                <HeaderStyle Width="3%" />
                                                 <ItemStyle HorizontalAlign="Center" Width="3%"  />
                                            ...
                                            <%--5--%>
                                            <telerik:GridBoundColumn DataField="ReceiveGroup" HeaderText="Receive Group" UniqueName="ReceiveGroup">
                                                <HeaderStyle HorizontalAlign="Center" Width="37%" />
                                                <ItemStyle HorizontalAlign="Left" Width="37%" />
                                            </telerik:GridBoundColumn>
                                            <%--6--%>
                                            <telerik:GridBoundColumn DataField="ReceiverList" HeaderText="Receiver" UniqueName="ReceiverList">
                                                <HeaderStyle HorizontalAlign="Center" Width="37%" />
                                                <ItemStyle HorizontalAlign="Left" Width="37%" Wrap="True" />
                                            </telerik:GridBoundColumn>
                                            <%--7--%>
                                        </Columns>
                                    </MasterTableView>
    ...
    <telerik:RadWindowManager ID="RadWindowManager1" runat="server" EnableShadow="true" >
        <Windows>
            <telerik:RadWindow ID="CustomerDialog" runat="server" Title="Notification rule information"
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            ...
            function ShowEditForm(id) {
                ...
                owd.Show();
                owd.setUrl("NotificationRuleEditForm.aspx?notId=" + id, "CustomerDialog");
            }
            ...
            function OnClientButtonClicking(sender, args) {
                ...
                if (strText.toLowerCase() == "notification rule") {
                    var owd = $find("<%=CustomerDialog.ClientID %>");
                    owd.Show();
                    owd.setUrl("NotificationRuleEditForm.aspx", "CustomerDialog");
