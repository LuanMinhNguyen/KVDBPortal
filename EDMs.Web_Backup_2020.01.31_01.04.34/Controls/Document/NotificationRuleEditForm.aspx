<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NotificationRuleEditForm.aspx.cs" Inherits="EDMs.Web.Controls.Document.NotificationRuleEditForm" %>
        ...
        <div style="width: 100%" runat="server" ID="divContent">
            <ul style="list-style-type: none">
                ...
                <li style="width: 500px;">
                    <div>
                        ...
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                            <asp:DropDownList ID="ddlDiscipline" runat="server" CssClass="min25Percent" Width="150px"/>
                ...
                <li style="width: 500px;">
                    <div>
                        <label style="width: 125px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
                            <span style="color: #2E5689; text-align: right; ">Receive group
                            </span>
                        </label>
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                            <telerik:RadComboBox ID="ddlReceiveGroup" runat="server"  
                                DropDownWidth="300px" CheckBoxes="true" Height="200px"
                                EnableCheckAllItemsCheckBox="true"
                                EmptyMessage="Select receive group" /><br/>
                            <telerik:RadButton ID="btnGetUser" runat="server" Text="Get Users" OnClick="btnGetUser_Click" style="margin-top: 2px" />
                ...
                <li style="width: 500px;">
                    <div>
                        <label style="width: 125px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
                            <span style="color: #2E5689; text-align: right; ">Receiver
                            </span>
                        </label>
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                            <telerik:RadComboBox ID="ddlReceiver" runat="server"  DropDownWidth="300px"
                                Height="200px" EmptyMessage="Select receiver" 
                ...
                <li style="width: 500px;">
                    <div>
                        ...
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                            <asp:TextBox ID="txtDescription" runat="server" Style="width: 300px;" TextMode="MultiLine" Rows="3" CssClass="min25Percent"/>
                        </div>
                    </div>
                    <div style="clear: both; font-size: 0;"></div>
                </li>
...
>
        ...
        <telerik:RadAjaxManager runat="Server" ID="ajaxDocument">
            <AjaxSettings> 
                ...
                <telerik:AjaxSetting AjaxControlID="btnGetUser">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="ddlReceiver" LoadingPanelID="RadAjaxLoadingPanel2"></telerik:AjaxUpdatedControl>
                    </UpdatedControls>
                </telerik:AjaxSetting>
            </AjaxSettings>
