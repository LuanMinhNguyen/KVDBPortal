<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DocumentListProjectInfoEditForm_LMOM.aspx.cs" Inherits="EDMs.Web.Controls.Document.DocumentListProjectInfoEditForm_LMOM" %>
        ...
        <div style="width: 100%; height: 100%" runat="server" ID="divContent">
            ...
            <dl class="accordion">
                ...
                <li style="width: 600px;">
                    <div>
                        <label style="width: 130px; float: left; padding-top: 3px; padding-right: 10px; text-align: right;">
                            <span style="color: #2E5689; text-align: right; ">Response Required Date
                            </span>
                        </label>
                        <div style="float: left;  padding-top: 5px;"  class="qlcbFormItem">
                            <telerik:RadDatePicker ID="txtResponseRequiredDate"  runat="server" 
                                ShowPopupOnFocus="True" CssClass="qlcbFormNonRequired">
                                <DateInput runat="server" DateFormat="dd/MM/yyyy" cssclass="qlcbFormNonRequired" />
                            </telerik:RadDatePicker>
                        </div>
                ...
                <li style="width: 600px;">
                    <div>
                        <label style="width: 130px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
                            <span style="color: #2E5689; text-align: right; ">Response To
                            </span>
                        </label>
                            <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                           <asp:DropDownList ID="ddlResponseTo" runat="server" CssClass="min25Percent" Width="416px"/>
                        </div>
