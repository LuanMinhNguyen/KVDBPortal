...
namespace EDMs.Web.Controls.Document
{
    ...
    /// The customer edit form.
    /// </summary>
    public partial class DocumentListProjectInfoEditForm_LMOM : Page
    {
        ...
        /// </summary>
        public DocumentListProjectInfoEditForm_LMOM()
        {
        ...
        private void LoadComboData(ProjectCode projectObj)
        {
            ...
            this.ddlResponseTo.DataSource = organizationList.OrderBy(t => t.Code);
            this.ddlResponseTo.DataTextField = "FullName";
            this.ddlResponseTo.DataValueField = "ID";
            this.ddlResponseTo.DataBind();
        ...
        {
            obj.CategoryId = 3;
            obj.CategoryName = "3. Correspondence Document  (L, MOM)";
            ...
            obj.Date = this.txtDate.SelectedDate;
            obj.ResponseRequiredDate = this.txtResponseRequiredDate.SelectedDate;
            obj.ResponseToId = Convert.ToInt32(this.ddlResponseTo.SelectedValue);
            obj.ResponseToName = this.ddlResponseTo.SelectedItem.Text.Split(',')[0];
        ...
        private void LoadDocInfo(PECC2Documents obj, ProjectCode projectObj)
        {
            ...
            this.txtDate.SelectedDate = obj.Date;
            this.txtResponseRequiredDate.SelectedDate = obj.ResponseRequiredDate;
            this.ddlResponseTo.SelectedValue = obj.ResponseToId.ToString();
        }
    }
}