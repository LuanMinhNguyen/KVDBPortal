<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PECC2AttachDocument.aspx.cs" Inherits="EDMs.Web.Controls.Document.PECC2AttachDocument" %>
                        ...
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                            <asp:DropDownList ID="ddlType" runat="server" CssClass="min25Percent" Width="416px">
                                <Items>
                                    ...
                                    <asp:ListItem Value="4" Text="Comment Sheet"></asp:ListItem>
                                </Items>
                            </asp:DropDownList>
                        </div>
                    </div>
