...
namespace EDMs.Web.Controls.Document
{
    ...
    /// The customer edit form.
    /// </summary>
    public partial class ProjectDocumentRevisionHistory : Page
    {
        /// <summary>
        /// The document service.
        /// </summary>
        private readonly PECC2DocumentsService _documentService;

        private readonly PECC2DocumentAttachFileService attachFilePackageService;


        /// <summary>
        /// Initializes a new instance of the <see cref="RevisionHistory"/> class.
        /// </summary>
        public ProjectDocumentRevisionHistory()
        {
            this._documentService = new  PECC2DocumentsService();
            this.attachFilePackageService = new  PECC2DocumentAttachFileService();
        }
        ...
        protected void grdDocument_OnNeedDataSource(object source, GridNeedDataSourceEventArgs e)
        {
            if(Request.QueryString["docId"] != null)
            {
                ...
                var objDoc = this._documentService.GetById(docId);
                if (objDoc != null)
                {
                    var revList = this._documentService.GetAllRevDoc(objDoc.ParentId == null ? objDoc.ID : objDoc.ParentId.Value);
        ...
        protected void grdDocument_DeleteCommand(object sender, GridCommandEventArgs e)
        {
            ...
            var objDocDelete = this._documentService.GetById(docId);
           // var objDocDelete = this.documentService.GetById(documentId);
            ...
            if(objDocDelete != null)
            {
                if(!objDocDelete.IsLeaf.GetValueOrDefault())
                {
                    ...
                    this._documentService.Update(objDocDelete);
                    ////this.documentService.Delete(documentId);
                }
                else
                {
                    var objDoc = this._documentService.GetAllRevDoc(objDocDelete.ParentId.GetValueOrDefault())[1];
                    objDoc.IsLeaf = true;
                    ...
                    this._documentService.Update(objDocDelete);
                    this._documentService.Update(objDoc);
                }
            }
                ...
                case "DocDetail":
                    {
                        ...
                        e.DetailTableView.DataSource = this.attachFilePackageService.GetAllDocId(docId);
                        break;
                    }
            }
        }
