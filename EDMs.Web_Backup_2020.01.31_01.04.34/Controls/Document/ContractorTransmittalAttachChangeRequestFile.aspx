<%@ Page Language="C#" Debug="true" AutoEventWireup="true" CodeBehind="ContractorTransmittalAttachChangeRequestFile.aspx.cs" Inherits="EDMs.Web.Controls.Document.ContractorTransmittalAttachChangeRequestFile" %>
        ...
        <div style="width: 100%; height:100vh;" runat="server" ID="divContent" >
            ...
            <telerik:RadSplitter ID="RadSplitter4" runat="server" Orientation="Vertical" Width="100%" Height="100%" Skin="Windows7">
                <telerik:RadPane ID="RadPane2" runat="server" Scrollable="true" Scrolling="Y" Width="400" Height="100%">
                    ...
                    <dl class="accordion">
                        <dt style="width: 100%;">
                            <span>SELECT CHANGE REQUEST DOCUMENT FILES</span>
                        </dt>
                    </dl>
                    <div class="demo-container size-narrow">
