<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ObjectNumberingList.aspx.cs" Inherits="EDMs.Web.Controls.Document.ObjectNumberingList" EnableViewState="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
            ...
            <telerik:RadToolBar ID="CustomerMenu" runat="server" Width="100%" OnClientButtonClicking="OnClientButtonClicking">
                <Items>
                    <telerik:RadToolBarDropDown runat="server" Text="New" ImageUrl="~/Images/addNew.png">
                        <Buttons>
                            <telerik:RadToolBarButton runat="server" Text="Object Numbering" Value="1" ImageUrl="~/Images/documentNumbering_16.png" />
                        </Buttons>
                            ...
                            <telerik:RadGrid ID="grdDocument" runat="server" AllowPaging="True"
                                ...
                                <MasterTableView ClientDataKeyNames="ID" DataKeyNames="ID" Width="100%" TableLayout="Auto" CssClass="rgMasterTable">
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridBoundColumn DataField="DocumentTypeName" HeaderText="Document Type" UniqueName="DocumentTypeName" ShowFilterIcon="False" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                            <HeaderStyle HorizontalAlign="Center" Width="100" />
                                            <ItemStyle HorizontalAlign="Center" />
                                        </telerik:GridBoundColumn>
                                        
                                        <telerik:GridBoundColumn DataField="SegmentLenght" HeaderText="Segment Length" UniqueName="SegmentLenght" ShowFilterIcon="False" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                            <HeaderStyle HorizontalAlign="Center" Width="100" />
                                            <ItemStyle HorizontalAlign="Center" />
                                        </telerik:GridBoundColumn>
                                        
                                        <telerik:GridBoundColumn DataField="FullFormatName" HeaderText="Full Format" UniqueName="FullFormatName" ShowFilterIcon="False" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                            <HeaderStyle HorizontalAlign="Center" Width="300" />
                                            <ItemStyle HorizontalAlign="Left" />
                                        </telerik:GridBoundColumn>
                                        
                                        <telerik:GridBoundColumn DataField="RealFormatName" HeaderText="Short Format" UniqueName="RealFormatName" ShowFilterIcon="False" FilterControlWidth="97%" 
    ...
    <telerik:RadWindowManager ID="RadWindowManager1" runat="server" EnableShadow="true">
        <Windows>
            <telerik:RadWindow ID="CustomerDialog" runat="server" Title="Object Numbering Information"
                VisibleStatusbar="false" Height="500" Width="650" IconUrl="~/Images/documentNumbering_16.png"
                Left="150px" ReloadOnShow="true" ShowContentDuringLoad="false" Modal="true">
            </telerik:RadWindow>

            <telerik:RadWindow ID="NewDialog" runat="server" Title="Object Numbering Information"
                VisibleStatusbar="false" Height="610" Width="650" IconUrl="~/Images/documentNumbering_16.png"
                Left="150px" ReloadOnShow="true" ShowContentDuringLoad="false" Modal="true">
            </telerik:RadWindow>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            ...
            function ShowEditForm(id) {
                ...
                owd.Show();
                owd.setUrl("ObjectNumberingEditForm.aspx?objId=" + id, "CustomerDialog");
            }
            ...
            function OnClientButtonClicking(sender, args) {
                ...
                var owd;
                if (strText === "Object Numbering") {
                    owd = $find("<%=NewDialog.ClientID %>");
                    owd.setSize(730, document.documentElement.offsetHeight);
                    owd.Show();
                    owd.setUrl("ObjectNumberingEditForm.aspx", "NewDialog");
                }
                ...
                if (strText.toLowerCase() == "import data file") {
                    owd = $find("<%=ImportTemplate.ClientID %>");
                    owd.Show();
                    owd.setUrl("ImportDQREDocumentNumbering.aspx", "ImportTemplate");
                }
            }
