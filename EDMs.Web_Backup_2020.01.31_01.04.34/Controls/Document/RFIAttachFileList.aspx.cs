...
namespace EDMs.Web.Controls.Document
{
    ...
    /// The customer edit form.
    /// </summary>
    public partial class RFIAttachFileList : Page
    {

        /// <summary>
        /// The folder service.
        /// </summary>
        private readonly RFIAttachFileService rfiattachfileservice = new RFIAttachFileService();
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(Request.QueryString["docId"]))
            {
                ...
                var flag = false;
                const string targetFolder = "../../DocumentLibrary/RFI";
                var serverFolder = (HostingEnvironment.ApplicationVirtualPath == "/" ? string.Empty : HostingEnvironment.ApplicationVirtualPath) + "/DocumentLibrary/RFI";
                ...
                if (listUpload.Count > 0)
                {
                    foreach (UploadedFile docFile in listUpload)
                    {
                        ...
                        var attachFile = new RFIAttachFile()
                            {
                            ID=Guid.NewGuid(),
                                RFIId = docId,
                        ...
                        this.rfiattachfileservice.Insert(attachFile);                    
                    }
                }
            }
        ...
        protected void grdDocument_DeleteCommand(object sender, GridCommandEventArgs e)
        {
            ...
            this.rfiattachfileservice.Delete(docId);
            this.grdDocument.Rebind();
        }
        ...
        protected void grdDocument_OnNeedDataSource(object sender, GridNeedDataSourceEventArgs e)
        {
            if (!string.IsNullOrEmpty(Request.QueryString["docId"]))
            {
                ...
                var attachList = this.rfiattachfileservice.GetByRFI(docId);
