<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContractorTransmittalAttachDocFileList.aspx.cs" Inherits="EDMs.Web.Controls.Document.ContractorTransmittalAttachDocFileList" %>
            ...
            <telerik:RadSplitter ID="RadSplitter4" runat="server" Orientation="Vertical" Width="100%" Height="100%" Skin="Windows7">
                <telerik:RadPane ID="RadPane1" runat="server" Scrollable="false" Scrolling="None"  Height="100%" Skin="Windows7">
                    <asp:Panel ID="Panel1" runat="server" Width="100%" Height="100%">
                        <dl class="accordion">
                            <dt style="width: 100%;">
                                <span>Transmittal Attachments</span>
                            </dt>
                        </dl>
                        ...
                        <telerik:RadGrid Skin="Windows7" AllowCustomPaging="False" AllowPaging="False" AllowSorting="True" 
                            ...
                            Height="80%" ID="grdDocumentFile"  AllowFilteringByColumn="True" AllowMultiRowSelection="False"
                                ...
                                <MasterTableView AllowMultiColumnSorting="false"
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridTemplateColumn AllowFiltering="False" UniqueName="EditColumn">
                                            ...
                                            <ItemStyle HorizontalAlign="Center"/>
                                            <ItemTemplate>
                                                <a href='javascript:ShowEditForm("<%# DataBinder.Eval(Container.DataItem, "ID") %>", "<%# DataBinder.Eval(Container.DataItem, "TypeId") %>")' style="text-decoration: none; color:blue">
                                                    <asp:Image ID="EditLink" runat="server" ImageUrl="~/Images/edit.png" Style="cursor: pointer;" ToolTip="Edit properties" Visible='<%# Eval("PECC2ProjectDocId") == null %>'/>
                                                <a/>
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="Contractor Ref. No." UniqueName="ContractorRefNo" AllowFiltering="false" Display="False">
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="Train No." UniqueName="TrainNo" AllowFiltering="false" Display="False">
                                            <HeaderStyle HorizontalAlign="Center" Width="80" />
                                            <ItemStyle HorizontalAlign="Center"  />
                                            <ItemTemplate>
                                                <%# Eval("TrainNo") %>
    ...
    <telerik:RadWindowManager ID="RadWindowManager1" runat="server" EnableShadow="true" Skin="Windows7">
        ...
        <telerik:RadScriptBlock runat="server">
            <script type="text/javascript">
                ...
                function ShowEditForm(objId, typeId) {
                ...
                owd.Show();
                    if (typeId === "1" || typeId=="") {
                        ...
                        owd.setUrl("ContractorTransmittalChangeRequestEditForm.aspx?objId=" + objId, "CustomerDialog");
                    }
