...
namespace EDMs.Web.Controls.CostContract
{
    ...
    /// The customer edit form.
    /// </summary>
    public partial class AttachContractDocument : Page
    {
        ...
        private readonly AttachContractFileService attachFileService;

        /// <summary>
        /// Initializes a new instance of the <see cref="DocumentInfoEditForm"/> class.
        /// </summary>
        public AttachContractDocument()
        {
            this.contractService = new ContractService();
            this.attachFileService = new AttachContractFileService();
        }
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(Request.QueryString["contractId"]))
            {
                ...
                var flag = false;
                const string targetFolder = "../../DocumentLibrary/ContractDoc";
                ...
                if (listUpload.Count > 0)
                {
                    foreach (UploadedFile docFile in listUpload)
                    {
                        ...
                        var attachFile = new AttachContractFile()
                            {
        ...
        protected void grdDocument_OnNeedDataSource(object sender, GridNeedDataSourceEventArgs e)
        {
            if (!string.IsNullOrEmpty(Request.QueryString["contractId"]))
            {
                var contractId = Convert.ToInt32(Request.QueryString["contractId"]);
                var attachList = this.attachFileService.GetAllByContract(contractId);
        ...
        protected void rbtnDefaultDoc_CheckedChanged(object sender, EventArgs e)
        {
            ...
            //{
            //    var attachFiles = this.attachFileService.GetAllBycontractId(attachFileObj.DocumentId.GetValueOrDefault());
