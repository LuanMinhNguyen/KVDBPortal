<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ContractList.aspx.cs" Inherits="EDMs.Web.Controls.CostContract.ContractList" EnableViewState="true" %>
                            ...
                            <telerik:RadGrid AllowCustomPaging="False" AllowPaging="True" AllowSorting="True" 
                                ...
                                <MasterTableView AllowMultiColumnSorting="false"
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="PR Number" UniqueName="ProcurementRequirementNumber"
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lblDocNo" runat="server" Text='<%# Eval("ProcurementRequirementNumber") %>' style="cursor: pointer; color: green"/> 
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            ...
            function gridMenuClicking(sender, args) {
                ...
                case "PaymentHistory":
                    var owd = $find("<%=Payment.ClientID %>");
                    owd.Show();
                    owd.setUrl("PaymentHistoryPage.aspx?contractId=" + contractId, "Payment");
                    break;

                case "MaterialList":
                    var owd = $find("<%=MaterialList.ClientID %>");
                    owd.Show();
                    owd.setUrl("MaterialListByContract.aspx?contractId=" + contractId, "MaterialList");
                    break;
                ...
                case "EditProperties":
                    ...
                    owd.Show();
                    owd.setUrl("ContractEditForm.aspx?contractId=" + contractId + "&projId=" + projectId, "CustomerDialog");
                    break;
                    case "ShareControl":
                    var projectId = document.getElementById("<%= lblProjectId.ClientID %>").value;
        ...
        <script type="text/javascript">
            ...
            function ShowEditForm(docId, projId) {
                var owd = $find("<%=CustomerDialog.ClientID %>");
                owd.Show();
                owd.setUrl("ContractEditForm.aspx?projId=" + projId + "&docId=" + docId, "CustomerDialog");
            }
            ...
            function OnClientButtonClicking(sender, args) {
                ...
                if (strText.toLowerCase() == "contract") {
                    ...
                    var owd = $find("<%=CustomerDialog.ClientID %>");
                    owd.Show();
                    owd.setUrl("ContractEditForm.aspx?projId=" + projectId, "CustomerDialog");
                    //}
                }
