...
namespace EDMs.Web.Controls.CostContract
{
    ...
    /// The customer edit form.
    /// </summary>
    public partial class AttachPRDocument : Page
    {
        ...
        private readonly AttachPRFileService attachFileService;

        /// <summary>
        /// Initializes a new instance of the <see cref="DocumentInfoEditForm"/> class.
        /// </summary>
        public AttachPRDocument()
        {
            this.prService = new ProcurementRequirementService();
            this.attachFileService = new AttachPRFileService();
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!this.IsPostBack)
            {
                ...
                //{
                //    var objDoc = this.prService.GetById(Convert.ToInt32(this.Request.QueryString["prId"]));
                //    if (objDoc != null)
                //    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(Request.QueryString["prId"]))
            {
                ...
                var flag = false;
                const string targetFolder = "../../DocumentLibrary/PRDoc";
                ...
                if (listUpload.Count > 0)
                {
                    foreach (UploadedFile docFile in listUpload)
                    {
                        ...
                        var attachFile = new AttachPRFile()
                            {
                                PRId = prId,
        ...
        protected void grdDocument_DeleteCommand(object sender, GridCommandEventArgs e)
        {
            ...
            var prId = Convert.ToInt32(item.GetDataKeyValue("ID").ToString());

            this.attachFileService.Delete(prId);
            this.grdDocument.Rebind();
        }
        ...
        protected void grdDocument_OnNeedDataSource(object sender, GridNeedDataSourceEventArgs e)
        {
            if (!string.IsNullOrEmpty(Request.QueryString["prId"]))
            {
                var prId = Convert.ToInt32(Request.QueryString["prId"]);
                var attachList = this.attachFileService.GetAllByPR(prId);
        ...
        protected void rbtnDefaultDoc_CheckedChanged(object sender, EventArgs e)
        {
            ...
            //{
            //    var attachFiles = this.attachFileService.GetAllByprId(attachFileObj.DocumentId.GetValueOrDefault());
