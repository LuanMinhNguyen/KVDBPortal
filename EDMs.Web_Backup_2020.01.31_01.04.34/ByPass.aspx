<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ByPass.aspx.cs" Inherits="EDMs.Web.ByPass" EnableViewState="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <telerik:RadSplitter ID="RadSplitter4" runat="server" Orientation="Horizontal">
        <telerik:RadPane ID="RadPane3" runat="server" Height="30px" Scrollable="false" Scrolling="None">
            ...
            <telerik:RadToolBar ID="CustomerMenu" runat="server" Width="100%" OnClientButtonClicking="OnClientButtonClicking" Visible="false">
                <Items>
                                ...
                                <telerik:RadGrid AllowCustomPaging="False" AllowPaging="True" AllowSorting="True" 
                                    ...
                                    <MasterTableView AllowMultiColumnSorting="false"
                                        ...
                                        <Columns>
                                          ...
                                          <telerik:GridTemplateColumn AllowFiltering="False" Visible="false" UniqueName="ObjectStatus" HeaderText="Is Reject">
                                                <HeaderStyle Width="30"  />
                                                <ItemStyle HorizontalAlign="Center"/>
                                                <ItemTemplate>
                                       ...
                                       <telerik:GridTemplateColumn HeaderText="User" UniqueName="AssignUser"
    ...
    <telerik:RadContextMenu ID="radMenu" runat="server"
        ...
        <Items>
            ...
            <telerik:RadMenuItem Text="Reject" ImageUrl="~/Images/reject.png" Value="Reject" Visible="false"/>
            <telerik:RadMenuItem Text="Attach To Internal Workflow" ImageUrl="~/Images/attachwf.png" Value="AttachInternalWorkflow" Visible="false"/>
            ...
            <telerik:RadMenuItem Text="Document Properties" ImageUrl="~/Images/detail.png" Value="DocProperties" Visible="false"/>
