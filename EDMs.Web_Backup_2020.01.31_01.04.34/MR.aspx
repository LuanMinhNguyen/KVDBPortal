<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MR.aspx.cs" Inherits="EDMs.Web.MR" EnableViewState="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
            ...
            <telerik:RadToolBar ID="CustomerMenu" runat="server" Width="100%" OnClientButtonClicking="OnClientButtonClicking">
                <Items>
                    <telerik:RadToolBarDropDown runat="server" Text="Add" ImageUrl="~/Images/addNew.png">
                        <Buttons>
                            <telerik:RadToolBarButton runat="server" Text="Material Requisition" Value="1" ImageUrl="~/Images/material.png"></telerik:RadToolBarButton>
                    ...
                    <telerik:RadToolBarButton runat="server" Value="ShowAll">
                        <ItemTemplate>
                            ...
                            <asp:DropDownList ID="ddlStatus" runat="server" CssClass="rcbReadOnly" Width="230px" style="max-width: 316px"
                                ...
                                <Items>
                                    <asp:ListItem Value="1" Text="All MR"></asp:ListItem>
                                    ...
                                    <asp:ListItem Value="4" Text="Overdue MR" style="background-color: red"></asp:ListItem>
                                    <asp:ListItem Value="7" Text="MR complete Workflow Process" style="background-color: greenyellow"></asp:ListItem>
                                    <asp:ListItem Value="5" Text="Completed MR" style="background-color: greenyellow"></asp:ListItem>
                                    <asp:ListItem Value="6" Text="Incompleted MR" style="background-color: coral"></asp:ListItem>
                                </Items>
                            </asp:DropDownList>
                            ...
                            <telerik:RadGrid AllowCustomPaging="False" AllowPaging="True" AllowSorting="True" 
                                ...
                                <MasterTableView AllowMultiColumnSorting="false"
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridBoundColumn DataField="PriorityId" UniqueName="PriorityId" Display="False" />
                                    ...
                                    <telerik:GridButtonColumn UniqueName="DeleteColumn" CommandName="Delete" HeaderTooltip="Delete document"
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="Priority" UniqueName="PriorityName"
                                        DataField="PriorityName" ShowFilterIcon="False" FilterControlWidth="97%" 
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="AMOS Work Order No." UniqueName="AMOSWorkOrder"
                                        DataField="AMOSWorkOrder" ShowFilterIcon="False" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="MR No." UniqueName="MRNo"
                                        DataField="MRNo" ShowFilterIcon="False" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        <HeaderStyle HorizontalAlign="Center" Width="120" />
                                        <ItemStyle HorizontalAlign="Center"/>
                                        <ItemTemplate>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Department" UniqueName="DepartmentName"
                                        DataField="DepartmentName" ShowFilterIcon="False" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Justification For Requisition" UniqueName="Justification"
                                        DataField="Justification" ShowFilterIcon="False" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Type" UniqueName="MRTypeName"
                                        DataField="MRTypeName" ShowFilterIcon="False" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="Date Require" UniqueName="DateRequire"
                                        DataField="DateRequire" ShowFilterIcon="False" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        <HeaderStyle HorizontalAlign="Center" Width="150" />
                                        <ItemStyle HorizontalAlign="Center"  />
                                        <ItemTemplate>
    ...
    <telerik:RadContextMenu ID="radMenu" runat="server"
        ...
        <Items>
            <telerik:RadMenuItem Text="Attach Workflow" ImageUrl="~/Images/attachwf.png" DisabledImageUrl="~/Images/dis_attachwf.png" Value="AttachWF"/>
            ...
            <telerik:RadMenuItem Text="MR Detail" ImageUrl="~/Images/detail.png" Value="MRDetail" DisabledImageUrl="~/Images/dis_detail.png"/>
            <telerik:RadMenuItem IsSeparator="True"/>
            ...
            <telerik:RadMenuItem IsSeparator="True"/>
            <telerik:RadMenuItem Text="Cancel MR" ImageUrl="~/Images/cancel1.png" Value="CancelMR"/>
    ...
    <telerik:RadWindowManager ID="RadWindowManager1" runat="server" EnableShadow="true" >
        <Windows>
            <telerik:RadWindow ID="CustomerDialog" runat="server" Title="Material Requisition Information"
                VisibleStatusbar="false" Height="700" Width="650" 
                Left="150px" ReloadOnShow="true" ShowContentDuringLoad="false" Modal="true">
            </telerik:RadWindow>
            
            <telerik:RadWindow ID="MRDetailDialog" runat="server" Title="Material Requisition Details"
                VisibleStatusbar="false" Height="700" Width="650" 
                Left="150px" ReloadOnShow="true" ShowContentDuringLoad="false" Modal="true">
            </telerik:RadWindow>
            ...
            <telerik:RadWindow ID="AttachWorkflow" runat="server" Title="Attach MR to Workflow"
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            ...
            function gridMenuClicking(sender, args) {
                ...
                else
                {
                    ...
                    case "MRDetail":
                        var categoryId = document.getElementById("<%= lblCategoryId.ClientID %>").value;
                        var owd = $find("<%=MRDetailDialog.ClientID %>");
                        owd.Show();
                        owd.maximize();
                        owd.setUrl("Controls/WMS/MRDetail.aspx?mrId=" + docId, "MRDetailDialog");
                        break;
                        case "AttachWF":
                        var projId = document.getElementById("<%= lblProjectId.ClientID %>").value;
                        var owd = $find("<%=AttachWorkflow.ClientID %>");
                        owd.Show();
                        owd.setUrl("Controls/Workflow/AttachWorkflow.aspx?objId=" + docId + "&objType=MR" + "&projId=" + projId, "AttachWorkflow");
                        break;
                    case "WFHistory":
                        var owd = $find("<%=WFProcessHistory.ClientID %>");
                        owd.Show();
                        owd.maximize();
                        owd.setUrl("Controls/Workflow/WorkflowProcessHistory.aspx?objId=" + docId + "&objType=MR", "WFProcessHistory");
                        break;
                    case "AttachDocument":
                        ...
                        owd.setUrl("Controls/WMS/MRAttach.aspx?objId=" + docId, "AttachDoc");
                        break;
                    case "CMS":
                        ...
                        case "EditProperties":
                            ...
                            owd.Show();
                            owd.setUrl("Controls/WMS/MREditForm.aspx?mrId=" + docId + "&projId=" + projectId, "CustomerDialog");
                        break;
                    case "Transmittals":
                    ...
                    case "CommentResponse":
                        ...
                        break;
                        case "CancelMR":
                            if (confirm("Do you want to cancel MR?") === false) return;
        ...
        <script type="text/javascript">
            ...
            function ShowEditForm(docId, projId) {
                var owd = $find("<%=CustomerDialog.ClientID %>");
                owd.Show();
                owd.setUrl("Controls/WMS/MREditForm.aspx?projId=" + projId + "&mrId=" + docId, "CustomerDialog");
            }
            ...
            function OnClientButtonClicking(sender, args) {
                ...
                if (strText == "Material Requisition") {
                    ...
                    var owd = $find("<%=CustomerDialog.ClientID %>");
                    owd.Show();
                    owd.setUrl("Controls/WMS/MREditForm.aspx?projId=" + projectId, "CustomerDialog");
                    //}
                }
