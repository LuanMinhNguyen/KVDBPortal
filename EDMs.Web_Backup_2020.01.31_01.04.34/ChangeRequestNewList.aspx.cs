...
namespace EDMs.Web
{
    ...
    /// Class customer
    /// </summary>
    public partial class ChangeRequestNewList : Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                this.LoadComboData();
                if(!string.IsNullOrEmpty(this.Request.QueryString["FCRDCNNo"]))
                {
                    var txtSearch = (TextBox)this.radMenuOutgoing.Items[2].FindControl("txtSearch");
                    txtSearch.Text= this.Request.QueryString["FCRDCNNo"];
                }
            }
        }
        ...
        private void LoadComboData()
        {
            ...
            if (UserSession.Current.User.IsEngineer.GetValueOrDefault() || UserSession.Current.User.IsLeader.GetValueOrDefault() || !UserSession.Current.User.Role.IsInternal.GetValueOrDefault())
            {
                ...
                this.grdChangeRequest.MasterTableView.GetColumn("EditColumn").Visible = false;
            }
            ...
            //    this.grdChangeRequest.MasterTableView.GetColumn("DeleteColumn").Visible = false;
            //    this.grdChangeRequest.MasterTableView.GetColumn("CreateOutgoingTrans").Visible = false;
            ...
            //    this.grdChangeRequest.MasterTableView.GetColumn("CreateOutgoingTrans").Visible = true;
