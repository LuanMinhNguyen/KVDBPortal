<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ChangeRequestList.aspx.cs" Inherits="EDMs.Web.ChangeRequestList" EnableViewState="true" %>
            ...
            <telerik:RadToolBar ID="CustomerMenu" runat="server" Width="100%" OnClientButtonClicking="OnClientButtonClicking">
                <Items>
                    <telerik:RadToolBarDropDown runat="server" Text="Add" ImageUrl="~/Images/addNew.png">
                        <Buttons>
                            <telerik:RadToolBarButton runat="server" Text="Change Request" Value="1" ImageUrl="~/Images/index.png"></telerik:RadToolBarButton>
                                  ...
                                  <%--  <GroupByExpressions>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Confidentiality" UniqueName="ConfidentialityName"
                                     ...
                                     <telerik:GridTemplateColumn HeaderText="Code" UniqueName="ChangeGradeCodeName" DataField="ChangeGradeCodeName"
                                        ...
                                        <telerik:GridTemplateColumn Display="false" HeaderText="PECC2 Review Result" UniqueName="PECC2ReviewResultName" DataField="PECC2ReviewResultName"
                                        ShowFilterIcon="False" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" >
                                        <HeaderStyle HorizontalAlign="Center" Width="100" />
                                        <ItemStyle HorizontalAlign="Center" />
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            ...
            function ShowEditForm(objId) {
                ...
                window.Show();
                window.setUrl("Controls/Document/ChangeRequestEditForm.aspx?projectId=" + projectId + "&objId=" + objId, "CustomerDialog");
            ...
            function OnClientButtonClicking(sender, args) {
                ...
                if (strText === "Change Request") {
                    ...
                    window.setSize(730, document.documentElement.offsetHeight);
                    window.Show();
                    window.setUrl("Controls/Document/ChangeRequestEditForm.aspx?projectId=" + projectId, "CustomerDialog");
