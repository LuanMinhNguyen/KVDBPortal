<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MorningCall.aspx.cs" Inherits="EDMs.Web.MorningCall" EnableViewState="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
            ...
            <telerik:RadToolBar ID="CustomerMenu" runat="server" Width="100%" OnClientButtonClicking="OnClientButtonClicking">
                <Items>
                    <telerik:RadToolBarDropDown runat="server" Text="Add" ImageUrl="~/Images/addNew.png">
                        <Buttons>
                            <telerik:RadToolBarButton runat="server" Text="Morning Call" Value="1" ImageUrl="~/Images/morning.png"></telerik:RadToolBarButton>
                    ...
                    <telerik:RadToolBarButton runat="server" Value="ShowAll">
                        <ItemTemplate>
                            ...
                            <asp:DropDownList ID="ddlStatus" runat="server" CssClass="min25Percent" Width="230px" style="max-width: 316px"
                                OnSelectedIndexChanged="ddlStatus_OnSelectedIndexChanged" AutoPostBack="True">
                                <Items>
                                    <asp:ListItem Value="1" Text="All Morning Call"></asp:ListItem>
                                    ...
                                    <asp:ListItem Value="4" Text="Overdue Morning Call" style="background-color: red"></asp:ListItem>
                                    <asp:ListItem Value="7" Text="Morning Call complete Workflow Process" style="background-color: greenyellow"></asp:ListItem>
                                    <asp:ListItem Value="5" Text="Completed Morning Call" style="background-color: greenyellow"></asp:ListItem>
                                    <asp:ListItem Value="6" Text="Incompleted Morning Call" style="background-color: coral"></asp:ListItem>
                                </Items>
                            </asp:DropDownList>
            ...
            <div>
                <table>
                    <tr>
                        ...
                        <td valign="middle"> Canceled MorningCall.</td>
                    </tr>
                </table>
            </div>
        </telerik:RadPane>
                        ...
                        <telerik:RadPane ID="Radpane6" runat="server" Scrolling="None">
                            <telerik:RadGrid AllowCustomPaging="False" AllowPaging="True" AllowSorting="True" 
                                ...
                                <MasterTableView AllowMultiColumnSorting="false"
                                    ...
                                    <telerik:GridTemplateColumn DataField="EquipmentName" UniqueName="EquipmentName" HeaderText="Names of Equipment/System/Matter" ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                    ...
                                    <telerik:GridTemplateColumn  DataField="IssueDescription" HeaderText="Description of issues" UniqueName="IssueDescription" 
                                        ...
                                        <ItemStyle HorizontalAlign="Left"  />
                                        <ItemTemplate>
                                            <%# Eval("IssueDescription").ToString().Replace(Environment.NewLine, "<br/>") %>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                            
                                            
                                            
                                    <telerik:GridTemplateColumn  DataField="InitRiskAssessment" HeaderText="Risk Assessment" UniqueName="InitRiskAssessment" 
                                        ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" ColumnGroupName="InitRisk">
                                        <HeaderStyle HorizontalAlign="Center" Width="300" />
                                        <ItemStyle HorizontalAlign="Left"  />
                                        <ItemTemplate>
                                            <%# Eval("InitRiskAssessment").ToString().Replace(Environment.NewLine, "<br/>") %>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                            
                                    <telerik:GridBoundColumn DataField="InitRiskLvlName" HeaderText="Risk level" UniqueName="InitRiskLvlName" ColumnGroupName="InitRisk" ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        <HeaderStyle HorizontalAlign="Center" Width="80"/>
                                        <ItemStyle HorizontalAlign="Center"/>
                                    </telerik:GridBoundColumn>

                                    <telerik:GridTemplateColumn  DataField="ActionPlanDescription" HeaderText="Description of Action Plan" UniqueName="ActionPlanDescription" 
                                        ColumnGroupName="ActionPlan" ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        <HeaderStyle HorizontalAlign="Center" Width="600" />
                                        <ItemStyle HorizontalAlign="Left"  />
                                        <ItemTemplate>
                                            <%# Eval("ActionPlanDescription").ToString().Replace(Environment.NewLine, "<br/>") %>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                            
                                    <telerik:GridBoundColumn DataField="ActionPlanRiskLvlName" HeaderText="Risk level" UniqueName="ActionPlanRiskLvlName" ColumnGroupName="ActionPlan" ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        <HeaderStyle HorizontalAlign="Center" Width="80"/>
                                        <ItemStyle HorizontalAlign="Center"/>
                                    </telerik:GridBoundColumn>
                                    ...
                                    <telerik:GridTemplateColumn  DataField="PICName" HeaderText="PIC" UniqueName="PICName" 
                                        ...
                                        <telerik:GridDateTimeColumn HeaderText="Deadline" UniqueName="Deadline" DataField="Deadline"
                                            DataFormatString="{0:dd/MM/yyyy}" FilterControlWidth="80%" CurrentFilterFunction="EqualTo" AutoPostBackOnFilter="True">
                                        <HeaderStyle HorizontalAlign="Center" Width="120" />
                                        <ItemStyle HorizontalAlign="Center"/>
                                    </telerik:GridDateTimeColumn>
                                            
                                        <telerik:GridDateTimeColumn HeaderText="Deadline History" UniqueName="DeadlineHistory" DataField="DeadlineHistory"
                                            DataFormatString="{0:dd/MM/yyyy}" FilterControlWidth="80%" CurrentFilterFunction="EqualTo" AutoPostBackOnFilter="True">
                                        <HeaderStyle HorizontalAlign="Center" Width="120" />
                                        <ItemStyle HorizontalAlign="Center"/>
                                    </telerik:GridDateTimeColumn>
                                            
                                    <telerik:GridBoundColumn DataField="RelativeDoc" HeaderText="Relative Documents" UniqueName="RelativeDoc" ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        <HeaderStyle HorizontalAlign="Center" Width="80" />
                                        <ItemStyle HorizontalAlign="Center"/>
                                    </telerik:GridBoundColumn>

                                    <telerik:GridTemplateColumn  DataField="CurrentUpdate" HeaderText="Current Update" UniqueName="CurrentUpdate" 
                                        ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        <HeaderStyle HorizontalAlign="Center" Width="600" />
                                        <ItemStyle HorizontalAlign="Left"  />
                                        <ItemTemplate>
                                            <%# Eval("CurrentUpdate").ToString().Replace(Environment.NewLine, "<br/>") %>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                            
                                    <telerik:GridBoundColumn DataField="StatusName" HeaderText="Status" UniqueName="StatusName" ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        <HeaderStyle HorizontalAlign="Center" Width="80" />
                                        <ItemStyle HorizontalAlign="Center"/>
                                    </telerik:GridBoundColumn>
                                            
                                    <telerik:GridTemplateColumn  DataField="OffshoreComment" HeaderText="Offshore team comments/update" UniqueName="OffshoreComment" 
                                        ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        <HeaderStyle HorizontalAlign="Center" Width="300" />
                                        <ItemStyle HorizontalAlign="Left"  />
                                        <ItemTemplate>
    ...
    <telerik:RadContextMenu ID="radMenu" runat="server"
        ...
        <Items>
            ...
            <telerik:RadMenuItem Text="Update MorningCall Info" ImageUrl="~/Images/edit.png" Value="EditProperties" DisabledImageUrl="~/Images/dis_edit.png"/>
            
            <telerik:RadMenuItem Text="MorningCall Detail" ImageUrl="~/Images/detail.png" Value="MRDetail" DisabledImageUrl="~/Images/dis_detail.png"/>
            <telerik:RadMenuItem IsSeparator="True"/>
            ...
            <telerik:RadMenuItem IsSeparator="True"/>
            <telerik:RadMenuItem Text="Cancel MorningCall" ImageUrl="~/Images/cancel1.png" Value="CancelMorningCall"/>
    ...
    <telerik:RadWindowManager ID="RadWindowManager1" runat="server" EnableShadow="true" >
        <Windows>
            <telerik:RadWindow ID="CustomerDialog" runat="server" Title="Morning Call Information"
                VisibleStatusbar="false" Height="700" Width="650" 
                Left="150px" ReloadOnShow="true" ShowContentDuringLoad="false" Modal="true">
            </telerik:RadWindow>
            
            <telerik:RadWindow ID="MorningCallDetailDialog" runat="server" Title="Morning Call Details"
                VisibleStatusbar="false" Height="700" Width="650" 
                Left="150px" ReloadOnShow="true" ShowContentDuringLoad="false" Modal="true">
            </telerik:RadWindow>
            ...
            <telerik:RadWindow ID="AttachWorkflow" runat="server" Title="Attach Morning Call to Workflow"
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            ...
            function gridMenuClicking(sender, args) {
                ...
                else
                {
                    ...
                    case "MRDetail":
                        var categoryId = document.getElementById("<%= lblCategoryId.ClientID %>").value;
                        var owd = $find("<%=MorningCallDetailDialog.ClientID %>");
                        owd.setSize(850, document.documentElement.offsetHeight);
                        owd.Show();
                        owd.setUrl("Controls/WMS/TrackingMorningCallDetail.aspx?objId=" + docId, "MorningCallDetailDialog");
                        break;
                        case "AttachWF":
                        var projId = document.getElementById("<%= lblProjectId.ClientID %>").value;
                        var owd = $find("<%=AttachWorkflow.ClientID %>");
                        owd.Show();
                        owd.setUrl("Controls/Workflow/AttachWorkflow.aspx?objId=" + docId + "&objType=MorningCall" + "&projId=" + projId, "AttachWorkflow");
                        break;
                    case "WFHistory":
                        var owd = $find("<%=WFProcessHistory.ClientID %>");
                        owd.Show();
                        owd.maximize();
                        owd.setUrl("Controls/Workflow/WorkflowProcessHistory.aspx?objId=" + docId + "&objType=MorningCall", "WFProcessHistory");
                        break;
                    case "AttachDocument":
                        ...
                        owd.setUrl("Controls/WMS/TrackingMorningCallAttach.aspx?objId=" + docId, "AttachDoc");
                        break;
                    case "CMS":
                        ...
                        case "EditProperties":
                            ...
                            owd.setSize(850, document.documentElement.offsetHeight);
                            owd.Show();
                            owd.setUrl("Controls/WMS/TrackingMorningCallEditForm.aspx?objId=" + docId + "&projId=" + projectId, "CustomerDialog");
                        break;
                    case "Transmittals":
                    ...
                    case "CommentResponse":
                        ...
                        owd.setUrl("Controls/WMS/TransmittalListByDoc.aspx?docId=" + docId, "TransmittalList");
                        break;
                    case "CancelMorningCall":
                        if (confirm("Do you want to cancel MorningCall?") === false) return;
        ...
        <script type="text/javascript">
            ...
            function ShowEditForm(docId, projId) {
                ...
                owd.setSize(850, document.documentElement.offsetHeight);
                owd.Show();
                owd.setUrl("Controls/WMS/TrackingMorningCallEditForm.aspx?projId=" + projId + "&objId=" + docId, "CustomerDialog");
            }
            ...
            function OnClientButtonClicking(sender, args) {
                ...
                if (strText == "Morning Call") {
                    ...
                    owd.setSize(850, document.documentElement.offsetHeight);
                    owd.Show();
                    owd.setUrl("Controls/WMS/TrackingMorningCallEditForm.aspx?projId=" + projectId, "CustomerDialog");
                    //}
                }
