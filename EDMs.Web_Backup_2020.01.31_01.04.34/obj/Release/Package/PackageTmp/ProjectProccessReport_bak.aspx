<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ProjectProccessReport_bak.aspx.cs" Inherits="EDMs.Web.ProjectProccessReport_bak" EnableViewState="true" %>
            ...
            <telerik:RadPane ID="RadPane3" runat="server" Height="30px" Scrollable="false" Scrolling="None">
                <telerik:RadToolBar ID="CustomerMenu" Width="100%" runat="server" OnClientButtonClicking="OnClientButtonClicking">
                    <Items>
                        ...
                        <telerik:RadToolBarButton runat="server" IsSeparator="true"/>
                        <telerik:RadToolBarButton runat="server" Value="RecoveryPlan">
                            <ItemTemplate>
                                <div style="display: inline-block">
                        ...
                        <td align="center">
                            <telerik:RadHtmlChart runat="server" ID="LineChart" Width="1024" Height="600" Transitions="true">
                                ...
                                <PlotArea>
                                        ...
                                        <XAxis  Color="Black" BaseUnit="days" Type="Date" DataLabelsField="WeekDate">
                                        ...
                                        <Series>
                                            <telerik:LineSeries Name="Planed" DataFieldY="Planed" >
                                                ...
                                                <MarkersAppearance MarkersType="Circle" BackgroundColor="White" Size="5" BorderColor="Green" BorderWidth="2"/>
                                                <TooltipsAppearance >
                                                    <ClientTemplate>
                                            ...
                                            <telerik:LineSeries Name="Actual" MissingValues="Interpolate" DataFieldY="Actual">
                                                <Appearance>
                                            ...
                                            <telerik:LineSeries Name="Recovery Plan" MissingValues="Interpolate" DataFieldY="RecoveryPlan">
                                                <Appearance>
                                                    <FillStyle BackgroundColor="dodgerblue"></FillStyle>
                                                </Appearance>
                                                <LabelsAppearance DataFormatString="{0}" Position="Above" Visible="false">
                                                </LabelsAppearance>
                                                <LineAppearance Width="2" />
                                                <MarkersAppearance MarkersType="Circle" BackgroundColor="White" Size="5" BorderColor="dodgerblue"
                                                    BorderWidth="2"></MarkersAppearance>
                                                <TooltipsAppearance>
                                                    <ClientTemplate>
                                                        Recovery Plan of  #= kendo.format(\'{0:d}\', category) #: #= value #%
                                                    </ClientTemplate>
                                                </TooltipsAppearance>
                                            </telerik:LineSeries>
                                        </Series>
            ...
            <AjaxSettings>
                ...
                <telerik:AjaxSetting AjaxControlID="ddlProject">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="rtvWorkgroup" LoadingPanelID="RadAjaxLoadingPanel2"/>
                        <telerik:AjaxUpdatedControl ControlID="LineChart" LoadingPanelID="RadAjaxLoadingPanel2"/>
                        <telerik:AjaxUpdatedControl ControlID="ddlRecoveryPlan"/>

                    </UpdatedControls>
                </telerik:AjaxSetting>
                <telerik:AjaxSetting AjaxControlID="ddlRecoveryPlan">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="rtvWorkgroup" LoadingPanelID="RadAjaxLoadingPanel2"/>
                        <telerik:AjaxUpdatedControl ControlID="LineChart" LoadingPanelID="RadAjaxLoadingPanel2"/>
                    </UpdatedControls>
