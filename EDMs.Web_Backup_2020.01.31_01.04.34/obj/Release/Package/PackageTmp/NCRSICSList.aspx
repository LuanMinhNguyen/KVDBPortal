<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="NCRSICSList.aspx.cs" Inherits="EDMs.Web.NCRSICSList" EnableViewState="true" %>
    ...
    <telerik:RadSplitter ID="RadSplitter4" runat="server" Orientation="Horizontal">
        ...
        <telerik:RadPane ID="RadPane1" runat="server" Scrollable="false" Scrolling="None">
            <telerik:RadGrid AllowCustomPaging="False" AllowPaging="true" AllowSorting="True" 
                            ...
                            Height="100%" ID="grdChangeRequest"  AllowFilteringByColumn="False" AllowMultiRowSelection="False"
                            ...
                            <MasterTableView AllowMultiColumnSorting="false"
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridTemplateColumn AllowFiltering="False" UniqueName="AllAttachFile">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:Image ID="imgAllAttach" runat="server" ImageUrl="~/Images/excelfileattach.png" Style="cursor: pointer;" ToolTip="Attach Change Request Form" Visible='<%# Eval("IsValid")%>'/>
                                            <a/>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                    
                                    <telerik:GridTemplateColumn AllowFiltering="False" UniqueName="SendChange">
                                        <HeaderStyle Width="30"  />
                                        <ItemStyle HorizontalAlign="Center"/>
                                        <ItemTemplate>
                                ...
                                <telerik:GridTemplateColumn AllowFiltering="False" UniqueName="CreateResponseChangeRequest">
                                        <HeaderStyle Width="30"  />
                                        <ItemStyle HorizontalAlign="Center"/>
                                        <ItemTemplate>
...
<telerik:RadAjaxManager runat="Server" ID="ajaxCustomer" OnAjaxRequest="RadAjaxManager1_AjaxRequest">
    ...
    <telerik:RadWindowManager ID="RadWindowManager1" runat="server" EnableShadow="true" >
        <Windows>
            ...
            <telerik:RadWindow ID="CreateOutgoingTrans" runat="server" Title="Create Change Request"
