<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PdfControllToolbox.ascx.cs" Inherits="WebAppPdf.WebViewer.lib.html5.PdfControllToolbox" %>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
		 ...
		 var list = document.getElementsByClassName("staticNoteContents");
		...
		function ConfirmConsolidate()
		 {
		    return confirm('Bạn có chắc chắn thực hiện chức năng này không. Sẽ gộp lại tất cả thao tác của những người dùng');
		 }
    ...
    <style>
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
         <button type="button" class="btn btn-default" data-dismiss="modal" onclick="return ConfirmConsolidate();">Consolidate</button> <button type="button" class="btn btn-default" data-dismiss="modal">Đóng</button>
        </div>
      </div>
            ...
            <div class="right-content">
                ...
                <div id="control" class="ui-widget-header toolbar">
                    ...
                    <div class="right-aligned">
                        <div class="group">
							<span id="prevPage" data-toggle="modal" data-target="#myModal" class="glyphicons package"   title="Consolidate"></span>
