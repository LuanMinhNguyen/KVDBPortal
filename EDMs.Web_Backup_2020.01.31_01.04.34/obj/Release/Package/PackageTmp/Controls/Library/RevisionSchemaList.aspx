<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RevisionSchemaList.aspx.cs" Inherits="EDMs.Web.Controls.Library.RevisionSchemaList" EnableViewState="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <style type="text/css">
        ...
        #RadWindowWrapper_ctl00_ContentPlaceHolder2_CustomerDialog {
            top: 0px !important;
        }
    </style>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
            ...
            <telerik:RadToolBar ID="CustomerMenu" runat="server" Width="100%" OnClientButtonClicking="OnClientButtonClicking">
                <Items>
                    <telerik:RadToolBarDropDown runat="server" Text="New" ImageUrl="~/Images/addNew.png">
                        <Buttons>
                            <telerik:RadToolBarButton Width="200px" runat="server" Text="Revision Schema" Value="1" ImageUrl="~/Images/revSchema1.png"/>
                        </Buttons>
                         ...
                         <telerik:RadPane ID="Radpane6" runat="server" Scrolling="None">
                                ...
                                <MasterTableView ClientDataKeyNames="ID" DataKeyNames="ID" Width="100%" TableLayout="Auto" CssClass="rgMasterTable">
                                  ...
                                  <Columns>
                                            ...
                                            <%--3--%>
                                            <telerik:GridTemplateColumn UniqueName="Code" DataField="Code" HeaderText="Code" ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                       ...
                                       <telerik:GridBoundColumn DataField="Define" HeaderText="Define" UniqueName="Define" ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                                <HeaderStyle HorizontalAlign="Center" Width="42%" />
                                                <ItemStyle HorizontalAlign="Left" />
                                            </telerik:GridBoundColumn>
    ...
    <telerik:RadWindowManager ID="RadWindowManager1" runat="server" EnableShadow="true" >
        <Windows>
            <telerik:RadWindow ID="CustomerDialog" runat="server" Title="Revision Schema Information"
                VisibleStatusbar="false" Height="500" Width="650" IconUrl="~/Images/revSchema1.png"
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            ...
            function ShowEditForm(id) {
                ...
                owd.setUrl("RevisionSchemaEditForm.aspx?disId=" + id, "CustomerDialog");
            }
            ...
            function OnClientButtonClicking(sender, args) {
                ...
                var customerId = null;
                var customerName = "";
                if (strText == "Revision Schema") {
                    var owd = $find("<%=CustomerDialog.ClientID %>");
                    owd.setSize(730, document.documentElement.offsetHeight);
                    owd.Show();
                    owd.setUrl("RevisionSchemaEditForm.aspx", "CustomerDialog");
                }
                ...
                if (strText.toLowerCase() == "import data file") {
                    ...
                    owd.setSize(730, document.documentElement.offsetHeight);
                    owd.Show();
                    owd.setUrl("RevisionSchemEImportFileTemplate.aspx", "ImportTemplate");
                }
            }
