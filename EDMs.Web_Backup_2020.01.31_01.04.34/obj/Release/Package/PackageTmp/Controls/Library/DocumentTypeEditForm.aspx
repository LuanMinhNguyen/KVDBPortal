<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DocumentTypeEditForm.aspx.cs" Inherits="EDMs.Web.Controls.Library.DocumentTypeEditForm" %>
        ...
        <div style="width: 100%" runat="server" ID="divContent">
            <ul style="list-style-type: none">
                    ...
                    <div>
                        ...
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem" runat="server" id="div3">
                            <telerik:RadComboBox ID="ddlParent" runat="server" Skin="Windows7" 
                                ...
                                <ItemTemplate>
                                    <div id="div1">
                                        <telerik:RadTreeView runat="server" ID="rtvDocumentType" Skin="Windows7" OnClientNodeClicking="nodeClicking">
                                            <DataBindings>
                ...
                <li style="width: 600px;">
                    <div>
                        <label style="width: 125px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
                            <span style="color: #2E5689; text-align: right; ">Apply For Categories
                            </span>
                        </label>
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                           <asp:DropDownList ID="ddlCategory" runat="server" CssClass="min25Percent" Width="416px">
                               <Items>
