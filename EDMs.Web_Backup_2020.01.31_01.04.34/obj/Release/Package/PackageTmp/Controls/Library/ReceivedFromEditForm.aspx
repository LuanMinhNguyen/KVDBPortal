<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReceivedFromEditForm.aspx.cs" Inherits="EDMs.Web.Controls.Library.ReceivedFromEditForm" %>
                ...
                <li style="width: 500px;">
                    <div>
                        ...
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem" runat="server" id="div1">
                            <asp:DropDownList ID="ddlCategory" runat="server" CssClass="min25Percent" Width="316px" style="max-width: 316px"/>
                        </div>
                    </div>
                    <div style="clear: both; font-size: 0;"></div>
                </li>
