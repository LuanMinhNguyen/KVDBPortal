<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DocumentClassList.aspx.cs" Inherits="EDMs.Web.Controls.Library.DocumentClassList" EnableViewState="true" %>
            ...
            <telerik:RadToolBar ID="CustomerMenu" runat="server" Width="100%" OnClientButtonClicking="OnClientButtonClicking">
                <Items>
                    <telerik:RadToolBarDropDown runat="server" Text="New" ImageUrl="~/Images/addNew.png">
                        <Buttons>
                            <telerik:RadToolBarButton Width="200px" runat="server" Text="Document Class" Value="1" ImageUrl="~/Images/docClass.png"/>
                        </Buttons>
    ...
    <telerik:RadWindowManager ID="RadWindowManager1" runat="server" EnableShadow="true" >
        <Windows>
            <telerik:RadWindow ID="CustomerDialog" runat="server" Title="Area Information"
                VisibleStatusbar="false" Height="350" Width="610"  IconUrl="~/Images/docClass.png"
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            ...
            function ShowEditForm(id) {
                ...
                owd.Show();
                owd.setUrl("DocumentClassEditForm.aspx?disId=" + id, "CustomerDialog");
            }
            ...
            function OnClientButtonClicking(sender, args) {
                ...
                var customerId = null;
                var customerName = "";
                if (strText.toLowerCase() == "document class") {
                    var owd = $find("<%=CustomerDialog.ClientID %>");
                    owd.setSize(730, document.documentElement.offsetHeight);
                    owd.Show();
                    owd.setUrl("DocumentClassEditForm.aspx", "CustomerDialog");
                }
                ...
                if (strText.toLowerCase() == "import data file") {
                    ...
                    owd.setSize(730, document.documentElement.offsetHeight);
                    owd.Show();
                    owd.setUrl("DocumentClassImportFileTemplate.aspx", "ImportTemplate");
                }
            }
