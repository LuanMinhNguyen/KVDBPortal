<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrganizationCodeEditForm.aspx.cs" Inherits="EDMs.Web.Controls.Library.OrganizationCodeEditForm" %>
            ...
            <ul style="list-style-type: none">
                ...
                <li style="width: 600px;">
                    ...
                    <div>
                        ...
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                            <asp:DropDownList ID="ddlRole" runat="server" CssClass="min25Percent" Width="315px">
                                <Items>
                                    <asp:ListItem Text="Owner" Value="Owner"/>
                                    <asp:ListItem Text="PMC" Value="Owner"/>
                                    <asp:ListItem Text="EPC Contractor" Value="EPC Contractor"/>
                                </Items>
                            </asp:DropDownList>
               ...
               <li style="width: 600px;">
                    <div>
                        <label style="width: 125px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
                            <span style="color: #2E5689; text-align: right; ">Head Office
                            </span>
                        </label>
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                            <asp:TextBox ID="txtHeadOffice" runat="server" Style="width: 300px;" CssClass="min25Percent" TextMode="MultiLine" Rows="4"/>
                        </div>
                    </div>
                    <div style="clear: both; font-size: 0;"></div>
                </li>
                ...
                <li style="width: 600px;">
                    <div>
                        ...
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                            <asp:TextBox ID="txtPhone" runat="server" Style="width: 300px;" CssClass="min25Percent"/>
                        </div>
                    </div>
                    <div style="clear: both; font-size: 0;"></div>
                </li>
                ...
                <li style="width: 600px;">
                    <div>
                        <label style="width: 125px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
                            <span style="color: #2E5689; text-align: right; ">Fax
                            </span>
                        </label>
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                            <asp:TextBox ID="txtFax" runat="server" Style="width: 300px;" CssClass="min25Percent"/>
                        </div>
                    </div>
                    <div style="clear: both; font-size: 0;"></div>
                </li>                 
                <li style="width: 600px;">
                    <div>
                        ...
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                            <asp:CheckBox ID="ckbIsDefault" runat="server" Checked="True" Text="Default Receiving Organisation in Contractor Outgoing Transmittal"/>
                        </div>
                    </div>
                    <div style="clear: both; font-size: 0;"></div>
                </li>
