<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CustomizeReceivedEmailList.aspx.cs" Inherits="EDMs.Web.Controls.Library.CustomizeReceivedEmailList" EnableViewState="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
            ...
            <telerik:RadToolBar ID="CustomerMenu" runat="server" Width="100%" OnClientButtonClicking="OnClientButtonClicking">
                <Items>
                    <telerik:RadToolBarDropDown runat="server" Text="New" ImageUrl="~/Images/addNew.png">
                        <Buttons>
                            <telerik:RadToolBarButton runat="server" Text="Received Email" Value="1" ImageUrl="~/Images/email1.png" />
                        </Buttons>
                    </telerik:RadToolBarDropDown>
                  <%--  <telerik:RadToolBarDropDown runat="server" Text="Action" ImageUrl="~/Images/action.png">
                        <Buttons>
                            <telerik:RadToolBarButton runat="server" Text="Export Data File" ImageUrl="~/Images/export.png"/>
                        </Buttons>
                        <Buttons>
                            <telerik:RadToolBarButton runat="server" Text="Import Data File" ImageUrl="~/Images/import.png"/>
                        </Buttons>
                    </telerik:RadToolBarDropDown>--%>
                            ...
                            <telerik:RadGrid ID="grdDocument" runat="server" AllowPaging="True"
                                ...
                                <MasterTableView ClientDataKeyNames="ID" DataKeyNames="ID" Width="100%" TableLayout="Auto" CssClass="rgMasterTable">
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridBoundColumn DataField="Name" HeaderText="Name" UniqueName="Name" ShowFilterIcon="False" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                            <HeaderStyle HorizontalAlign="Center" Width="90" />
                                            <ItemStyle HorizontalAlign="Left" />
                                        </telerik:GridBoundColumn>
                                         <telerik:GridBoundColumn DataField="TypeName" HeaderText="Type" UniqueName="TypeName" ShowFilterIcon="False" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                            <HeaderStyle HorizontalAlign="Center" Width="100" />
                                            <ItemStyle HorizontalAlign="Left" />
                                        </telerik:GridBoundColumn>
                                          <telerik:GridTemplateColumn  HeaderText="From" UniqueName="Pecc2SendReceived"  AllowFiltering="false">
                                <HeaderStyle HorizontalAlign="Center" Width="80" />
                                <ItemStyle HorizontalAlign="Center" />
                                <ItemTemplate>
                                   <%# Convert.ToInt32( Eval("Pecc2SendReceived"))==1 ?"PECC2" :"CHEC" %>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                                        <telerik:GridTemplateColumn DataField="RecipientsTo" HeaderText="To" UniqueName="RecipientsTo" ShowFilterIcon="False" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                            <HeaderStyle HorizontalAlign="Center" Width="300" />
                                            <ItemStyle HorizontalAlign="Left" />
                                             <ItemTemplate>
                            <%# Eval("RecipientsTo") %>
                            <a href='javascript:ShowRecipientsFormTo(<%# DataBinder.Eval(Container.DataItem, "ID") %>)' style="text-decoration: none; color:blue">
                                <asp:Image ID="imageRecipientsto" runat="server" ImageUrl="~/Images/group.png" Style="cursor: pointer;" AlternateText="Recipients" />
                            <a/>
                        </ItemTemplate>
                                        </telerik:GridTemplateColumn>
                                         <telerik:GridTemplateColumn DataField="RecipientsCC" HeaderText="CC" UniqueName="RecipientsCC" ShowFilterIcon="False" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                            <HeaderStyle HorizontalAlign="Center" Width="300" />
                                            <ItemStyle HorizontalAlign="Left" />
                                              <ItemTemplate>
                            <%# Eval("RecipientsCC") %>
                            <a href='javascript:ShowRecipientsFormCC(<%# DataBinder.Eval(Container.DataItem, "ID") %>)' style="text-decoration: none; color:blue">
                                <asp:Image ID="imageRecipientscc" runat="server" ImageUrl="~/Images/group.png" Style="cursor: pointer;" AlternateText="Recipients" />
                            <a/>
                        </ItemTemplate>
                                        </telerik:GridTemplateColumn>
                                    </Columns>
    ...
    <telerik:RadWindowManager ID="RadWindowManager1" runat="server" EnableShadow="true">
        <Windows>
            <telerik:RadWindow ID="CustomerDialog" runat="server" Title="Customize Information"
                VisibleStatusbar="false" Height="100%" Width="650" IconUrl="~/Images/group2.png"
                Left="150px" ReloadOnShow="true" ShowContentDuringLoad="false" Modal="true">
            </telerik:RadWindow>

            <telerik:RadWindow ID="NewDialog" runat="server" Title="Customize Information"
                VisibleStatusbar="false" Height="100%" Width="650" IconUrl="~/Images/group2.png"
                Left="150px" ReloadOnShow="true" ShowContentDuringLoad="false" Modal="true">
            </telerik:RadWindow>

            <telerik:RadWindow runat="server" ID="ImportTemplate" Title="Import Data File" VisibleStatusbar="false" Height="300" Width="520" Left="50px" ReloadOnShow="true" OnClientClose="refreshGrid" ShowContentDuringLoad="false" Modal="true"></telerik:RadWindow>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            ...
            function GetGridObject(sender, eventArgs) {
              ...
              function ShowRecipientsFormTo(wfDetailId) {
                    var owd = $find("<%=Recipients.ClientID %>");
                    owd.SetTitle("Recipients Information for To Email");
                    owd.setSize(850, document.documentElement.offsetHeight);
                    owd.Show();
                    //owd.maximize(true);
                    owd.setUrl("RecipientPageEmail.aspx?type=To&wfdId=" + wfDetailId, "Recipients");
              }
            function ShowRecipientsFormCC(wfDetailId) {
                    var owd = $find("<%=Recipients.ClientID %>");
                    owd.SetTitle("Recipients Information for CC Email");
                    owd.setSize(850, document.documentElement.offsetHeight);
                    owd.Show();
                    //owd.maximize(true);
                    owd.setUrl("RecipientPageEmail.aspx?type=CC&wfdId=" + wfDetailId, "Recipients");
                }
        ...
        <script type="text/javascript">
            ...
            function ShowEditForm(id) {
                ...
                owd.setSize(650, document.documentElement.offsetHeight);
                owd.Show();
                owd.setUrl("CustomizeReceivedEmailEditForm.aspx?objId=" + id, "CustomerDialog");
            }
            ...
            function OnClientButtonClicking(sender, args) {
                ...
                if (strText == "Received Email") {
                    var owd = $find("<%=NewDialog.ClientID %>");
                    owd.setSize(650, document.documentElement.offsetHeight);
                    owd.Show();
                    owd.setUrl("CustomizeReceivedEmailEditForm.aspx", "NewDialog");
                }
                ...
                if (strText.toLowerCase() == "import data file") {
                    ...
                    owd.Show();
                    owd.setUrl("ImportGroup.aspx", "ImportTemplate");
                }
            }
