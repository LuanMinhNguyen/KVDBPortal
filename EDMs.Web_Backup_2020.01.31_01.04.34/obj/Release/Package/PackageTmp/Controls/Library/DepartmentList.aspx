                                    ...
                                    <MasterTableView ClientDataKeyNames="ID" DataKeyNames="ID" Width="100%" TableLayout="Auto" CssClass="rgMasterTable">
                                        <GroupByExpressions>
                                            <telerik:GridGroupByExpression>
                                                <SelectFields>
                                                    <telerik:GridGroupByField FieldAlias="Location" FieldName="TypeName" FormatString="{0:D}"
                                        ...
                                        <Columns>
                                            ...
                                            <telerik:GridBoundColumn DataField="TypeName" HeaderText="Location" UniqueName="TypeName">
