<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TrackingSailList.aspx.cs" Inherits="EDMs.Web.Controls.WMS.TrackingSailList" EnableViewState="true" %>
    ...
    <div style="width: 98%; padding-top: 10px; padding-left: 5px">
        ...
        <telerik:RadTreeView ID="rtvDiscipline" runat="server" 
            ...
            <Nodes>
                ...
                <telerik:RadTreeNode runat="server" Text="Tracking List Of Sail List" ImageUrl="~/Images/trackinglist.png" Value="Sail" NavigateUrl="TrackingSailList.aspx" Selected="True"/>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
            ...
            <telerik:RadToolBar ID="CustomerMenu" runat="server" Width="100%" OnClientButtonClicking="OnClientButtonClicking">
                <Items>
                    <telerik:RadToolBarDropDown runat="server" Text="New" ImageUrl="~/Images/addNew.png">
                        <Buttons>
                            <telerik:RadToolBarButton runat="server" Text="Sail" Value="1" ImageUrl="~/Images/trackinglist.png"/>
                        </Buttons>
                    ...
                    <telerik:RadToolBarButton runat="server" Value="ShowAll">
                        <ItemTemplate>
                            ...
                            <asp:DropDownList ID="ddlStatus" runat="server" CssClass="min25Percent" Width="200px" style="max-width: 316px"
                                ...
                                <Items>
                                    <asp:ListItem Value="1" Text="All Sail"></asp:ListItem>
                                    <asp:ListItem Value="2" Text="All Latest Sail" Selected="True"></asp:ListItem>
                                    <%--<asp:ListItem Value="3" Text="Coming Due Sail" style="background-color: yellow"></asp:ListItem>
                                    <asp:ListItem Value="4" Text="Overdue Sail" style="background-color: red"></asp:ListItem>
                                    <asp:ListItem Value="5" Text="Completed Sail" style="background-color: greenyellow"></asp:ListItem>
                                    <asp:ListItem Value="6" Text="Incompleted Sail" style="background-color: coral"></asp:ListItem>
                                </Items>
                            </asp:DropDownList>
    ...
    <telerik:RadWindowManager ID="RadWindowManager1" runat="server" EnableShadow="true" >
        <Windows>
            <telerik:RadWindow ID="CreateNewWD" runat="server" Title="Create New Sail"
                VisibleStatusbar="False" Height="700" Width="850" 
                Left="150px" ReloadOnShow="true" ShowContentDuringLoad="false" Modal="true">
            </telerik:RadWindow>
            
            <telerik:RadWindow ID="UpdateWD" runat="server" Title="Update Sail"
                VisibleStatusbar="False" Height="700" Width="850" 
                Left="150px" ReloadOnShow="true" ShowContentDuringLoad="false" Modal="true">
            </telerik:RadWindow>
            ...
            <telerik:RadWindow ID="RevisionHistory" runat="server" Title="Sail Revision History"
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            ...
            function ShowEditForm(id) {
                ...
                owd.Show();
                owd.setUrl("TrackingSailEditForm.aspx?objId=" + id + "&projId=" + projectId, "UpdateWD");
            }
            ...
            function ShowAttachment(id) {
                ...
                owd.Show();
                owd.setUrl("TrackingSailAttach.aspx?objId=" + id, "AttachDoc");
            }
            ...
            function ShowHistory(id) {
                ...
                owd.Show();
                owd.maximize();
                owd.setUrl("TrackingSailRevisionHistory.aspx?objId=" + id, "RevisionHistory");
            }
            ...
            function OnClientButtonClicking(sender, args) {
                ...
                if (strText == "Sail") {
                    ...
                    owd.setSize(850, document.documentElement.offsetHeight);
                    owd.Show();
                    owd.setUrl("TrackingSailEditForm.aspx?projId=" + projectId, "CreateNewWD");
                }
            }
