<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TrackingProcedureAttach.aspx.cs" Inherits="EDMs.Web.Controls.WMS.TrackingProcedureAttach" %>
            ...
            <ul style="list-style-type: none">
                ...
                <li style="width: 650px;" Runat="server" ID="UploadControl">
                    <div>
                        ...
                        <div style="float: left; padding-top: 5px; " class="qlcbFormItem">
                            <span style="color: red">Limited file size < 5mb</span>
