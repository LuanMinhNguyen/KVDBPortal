<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MRDetail.aspx.cs" Inherits="EDMs.Web.Controls.WMS.MRDetail" %>
    ...
    <telerik:RadScriptManager ID="RadScriptManager2" runat="server"/>
            ...
            <telerik:RadPane ID="Radpane6" runat="server" Scrolling="Both" Width="25%">
                ...
                <table class="borderTable">
                        <tr class="borderTable">
                            <td>
                                <b>AMOS Work Order No.</b> (if applicable) (1): <asp:Label runat="server" ID="lblAMOSNo" Text="FPSO PTSC LAM SON"/>
                            </td>
                        </tr>
                        <tr class="borderTable">
                            <td>
                                <b>MR No.</b> (2): <asp:Label runat="server" ID="lblMRNo" Text="FPSO PTSC LAM SON"/> 
                        ...
                        <tr class="borderTable">
                            <td>
                                <b>Department</b> (3): <asp:Label runat="server" ID="lblDepartment" Text="FPSO PTSC LAM SON"/>
                            </td>
                        </tr>
                                        
                        <tr class="borderTable">
                            <td>
                                <b>JUSTIFICATION FOR REQUISITION</b> (4): <br/><asp:Label runat="server" ID="lblJustification" Text="FPSO PTSC LAM SON"/>
                            </td>
                        </tr>
                        <tr class="borderTable">
                            <td><b>Please obtain the following</b> - (tick applicable box): <br/><telerik:RadListBox RenderMode="Lightweight" ID="lbMRType" runat="server" CheckBoxes="true" ShowCheckAll="False"  Skin="Windows7"/></td>
                        </tr>
                        <tr class="borderTable">
                            <td><b>Date Required </b>(18): <asp:Label runat="server" ID="lblDateRequire" Text="FPSO PTSC LAM SON"/></td>
                        </tr>
                        <tr class="borderTable">
                            <td><b>Priority Level </b>(19): <br/><telerik:RadListBox RenderMode="Lightweight" ID="lbPriority" runat="server" CheckBoxes="true" ShowCheckAll="False" Skin="Windows7"/></td>
                        </tr>
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td><div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                                                <asp:TextBox ID="txtOriginator" runat="server" Style="width: 250px;min-width: 150px !important" CssClass="min25Percent"/>
                                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                                                <asp:TextBox ID="txtOriginatorDate" runat="server" Style="width: 250px;min-width: 150px !important" CssClass="min25Percent"/>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td ><b>Storeman</b></td>
                                        <td><div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                                                <asp:TextBox ID="txtStoremanName" runat="server" Style="width: 250px;min-width: 150px !important" CssClass="min25Percent"/>
                                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                                                <asp:TextBox ID="txtStoremanDate" runat="server" Style="width: 250px;min-width: 150px !important" CssClass="min25Percent"/>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                                                <asp:TextBox ID="txtSupervisorName" runat="server" Style="width: 250px;min-width: 150px !important" CssClass="min25Percent"/>
                                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                                                <asp:TextBox ID="txtSupervisorDate" runat="server" Style="width: 250px;min-width: 150px !important" CssClass="min25Percent"/>
                                            </div>
                                    ...
                                    <tr>
                                        <td ><b>OIM/FM</b></td>
                                        <td><div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                                                <asp:TextBox ID="txtOIMName" runat="server" Style="width: 250px;min-width: 150px !important" CssClass="min25Percent"/>
                                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td> 
                                            <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                                                <asp:TextBox ID="txtOIMDate" runat="server" Style="width: 250px;min-width: 150px !important" CssClass="min25Percent"/>
                                            </div>
                            ...
                            <ul style="list-style-type: none">
                                ...
                                <li style="width: 600px;" Runat="server" ID="UploadControl">
                                    <div>
                                        ...
                                        <div style="float: left; padding-top: 5px; " class="qlcbFormItem">
                                            <span style="color: red"><b>Limited file size < 1.5mb</b></span>
                            ...
                            <ul style="list-style-type: none">
                                        ...
                                        <div style="float: left; padding-top: 5px; " class="qlcbFormItem">
                                            <div style="float: left; padding-top: 5px;" class="qlcbFormItem" runat="server" id="div3">
                                                <asp:DropDownList ID="ddlCommentFrom" runat="server" CssClass="min25Percent qlcbFormRequired" Width="516px" style="max-width: 5006px"
                                                    OnSelectedIndexChanged="ddlCommentFrom_OnSelectedIndexChanged" AutoPostBack="True">
                                                    <Items>
                                ...
                                <li style="width: 800px;">
                                    <div>
                                        ...
                                        <div style="float: left; padding-top: 5px; " class="qlcbFormItem">
                                            <asp:TextBox runat="server" ID="txtComment" style="width: 500px; max-width: 500px" CssClass="min25Percent qlcbFormRequired" TextMode="MultiLine" Rows="8"/>
                                        </div>
                                    </div>
                                    <div style="clear: both; font-size: 0;"></div>
                                </li>
                    ...
                    <div runat="server" ID="divMRDetailTracking">
                        <fieldset>
                            ...
                            <table>
                                <tr>
                                    <td>SFI Code</td>
                                    <td><asp:Label runat="server" ID="lblSFICode"/></td>
                                    
                                    <td>Material Name & Specification Descriptions</td>
                                    <td><asp:Label runat="server" ID="lblMRDetailDescription"/></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                                            <asp:TextBox runat="server" ID="txtUnitPrice"  Style="width: 200px; min-width: 50px" CssClass="min25Percent"></asp:TextBox>
                                        </div>
                                    </td>
                                </tr>
                                    ...
                                    <td colspan="2" valign="top">
                                        <table>
                                                ...
                                                <td>
                                                    <div style="float: left; padding-top: 5px; " class="qlcbFormItem">
                                                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem" runat="server" id="div11">
                                                            <telerik:RadDatePicker ID="txtRequestQuotationDate"  runat="server" 
                                                                ShowPopupOnFocus="True" CssClass="qlcbFormNonRequired">
                                                                <DateInput runat="server" DateFormat="dd/MM/yyyy" cssclass="qlcbFormNonRequired" />
                                                            </telerik:RadDatePicker>
                                                        </div>
                                                ...
                                                <td>
                                                    <div style="float: left; padding-top: 5px; " class="qlcbFormItem">
                                                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem" runat="server" id="div15">
                                                            <telerik:RadDatePicker ID="txtDeliveryDateRevisedSupplier"  runat="server" 
                                                                ShowPopupOnFocus="True" CssClass="qlcbFormNonRequired">
                                                                <DateInput runat="server" DateFormat="dd/MM/yyyy" cssclass="qlcbFormNonRequired" />
                                                            </telerik:RadDatePicker>
                                                        </div>
                                                ...
                                                <td>
                                                    <div style="float: left; padding-top: 5px; " class="qlcbFormItem">
                                                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem" runat="server" id="div12">
                                                            <telerik:RadDatePicker ID="txtReceiveQuotationDate"  runat="server" 
                                                                ShowPopupOnFocus="True" CssClass="qlcbFormNonRequired">
                                                                <DateInput runat="server" DateFormat="dd/MM/yyyy" cssclass="qlcbFormNonRequired" />
                                                            </telerik:RadDatePicker>
                                                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                                                        <asp:TextBox runat="server" ID="txtPONumber"  Style="width: 200px; min-width: 50px" CssClass="min25Percent"></asp:TextBox>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div style="float: left; padding-top: 5px; " class="qlcbFormItem">
                                                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem" runat="server" id="div13">
                                                            <telerik:RadDatePicker ID="txtPOIssueDate"  runat="server" 
                                                                ShowPopupOnFocus="True" CssClass="qlcbFormNonRequired">
                                                                <DateInput runat="server" DateFormat="dd/MM/yyyy" cssclass="qlcbFormNonRequired" />
                                                            </telerik:RadDatePicker>
                                                        </div>
                                    ...
                                    <td colspan="2" valign="top">
                                        <table>
                                            <tr>
                                                ...
                                                <td>
                                                    <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                                                        <asp:TextBox runat="server" ID="txtTotalPrice"  Style="width: 200px; min-width: 50px" CssClass="min25Percent"></asp:TextBox>
                                                    </div>
                                                </td>
                                            </tr>
                                                ...
                                                <td>
                                                    <div style="float: left; padding-top: 5px; " class="qlcbFormItem">
                                                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem" runat="server" id="div14">
                                                            <telerik:RadDatePicker ID="txtExpectedDeliveryDate"  runat="server" 
                                                                ShowPopupOnFocus="True" CssClass="qlcbFormNonRequired">
                                                                <DateInput runat="server" DateFormat="dd/MM/yyyy" cssclass="qlcbFormNonRequired" />
                                                            </telerik:RadDatePicker>
                                                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div style="float: left; padding-top: 5px;" class="qlcbFormItem" runat="server" id="div16">
                                                        <telerik:RadDatePicker ID="txtActualDeliveryDate"  runat="server" 
                                                            ShowPopupOnFocus="True" CssClass="qlcbFormNonRequired">
                                                            <DateInput runat="server" DateFormat="dd/MM/yyyy" cssclass="qlcbFormNonRequired" />
                                                        </telerik:RadDatePicker>
                                                    </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                                                        <asp:TextBox runat="server" ID="txtSupplier"  Style="width: 200px; min-width: 50px" CssClass="min25Percent"></asp:TextBox>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                                                        <asp:DropDownList ID="ddlMSRPurchasingStatus" runat="server" CssClass="min25Percent" Width="134" style="max-width: 5006px">
                                                            <Items>
                                                                <asp:ListItem Value="" Text=""></asp:ListItem>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                                                        <asp:DropDownList ID="ddlMSRItemPurchasingStatus" runat="server" CssClass="min25Percent" Width="134" style="max-width: 5006px">
                                                            <Items>
                                                                <asp:ListItem Value="" Text=""></asp:ListItem>
                                                                <asp:ListItem Value="Cancel" Text="Cancel"></asp:ListItem>
                                                                <asp:ListItem Value="Complete" Text="Complete"></asp:ListItem>
                                ...
                                <tr>
                                    <td colspan="6" align="center">
                                        <telerik:RadButton ID="btnMRDetailTrackingSave" runat="server" Text="Save" OnClick="btnMRDetailTrackingSave_OnClick" Width="70px" style="text-align: center">
                                            <Icon PrimaryIconUrl="../../Images/save.png" PrimaryIconLeft="4" PrimaryIconTop="4" PrimaryIconWidth="16" PrimaryIconHeight="16"></Icon>
                                        </telerik:RadButton>
                                        
                                        <telerik:RadButton ID="btnMRDetailTrackingClear" runat="server" Text="Clear" OnClick="btnMRDetailTrackingClear_OnClick" Width="70px" style="text-align: center">
                                            <Icon PrimaryIconUrl="../../Images/clear.png" PrimaryIconLeft="4" PrimaryIconTop="4" PrimaryIconWidth="16" PrimaryIconHeight="16"></Icon>
                                        </telerik:RadButton>
                                    </td>
                                </tr>
                        ...
                        <telerik:RadGrid ID="grdMRDetailTracking" runat="server" AllowPaging="False"
                            ...
                            <MasterTableView ClientDataKeyNames="ID" DataKeyNames="ID" >
                                ...
                                <%-- **********************************Comment********************************* --%>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="No." Groupable="False" AllowFiltering="false" Display="False">
                                        ...
                                        <ItemStyle HorizontalAlign="Center" Width="30"></ItemStyle>
                                        <ItemTemplate>
                                            <asp:Label ID="lblSoTT" runat="server" Text='<%# grdMRDetailTracking.CurrentPageIndex * grdMRDetailTracking.PageSize + grdMRDetailTracking.Items.Count+1 %>'>
                                            </asp:Label>
                            ...
                            <ClientSettings Selecting-AllowRowSelect="true" AllowColumnHide="True">
                                <Resizing EnableRealTimeResize="True" ResizeGridOnColumnResize="True" ClipCellContentOnResize="false"></Resizing>
                                <Scrolling AllowScroll="True" SaveScrollPosition="True" UseStaticHeaders="True" FrozenColumnsCount="5"/>
                            </ClientSettings>
                        </telerik:RadGrid>
                    </telerik:RadPageView>
        ...
        <telerik:RadAjaxManager runat="Server" ID="ajaxDocument" >
            ...
            <AjaxSettings> 
                ...
                <telerik:AjaxSetting AjaxControlID="grdMRDetailTracking">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="lblMRDetailDescription"/>
                        <telerik:AjaxUpdatedControl ControlID="lblSFICode"/>
                        <telerik:AjaxUpdatedControl ControlID="txtMRTrackingRecieveDate"/>
                        <telerik:AjaxUpdatedControl ControlID="txtContractNo"/>
                        <telerik:AjaxUpdatedControl ControlID="txtUnitPrice"/>
                        <telerik:AjaxUpdatedControl ControlID="rtvPIC"/>
                        <telerik:AjaxUpdatedControl ControlID="txtRequestQuotationDate"/>
                        <telerik:AjaxUpdatedControl ControlID="txtDeliveryDateRevisedSupplier"/>
                        <telerik:AjaxUpdatedControl ControlID="txtReceiveQuotationDate"/>
                        <telerik:AjaxUpdatedControl ControlID="txtPONumber"/>
                        <telerik:AjaxUpdatedControl ControlID="txtPOIssueDate"/>
                        <telerik:AjaxUpdatedControl ControlID="txtTotalPrice"/>
                        <telerik:AjaxUpdatedControl ControlID="txtExpectedDeliveryDate"/>
                        <telerik:AjaxUpdatedControl ControlID="txtActualDeliveryDate"/>
                        <telerik:AjaxUpdatedControl ControlID="txtSupplier"/>
                        <telerik:AjaxUpdatedControl ControlID="ddlMSRPurchasingStatus"/>
                        <telerik:AjaxUpdatedControl ControlID="ddlMSRItemPurchasingStatus"/>
                        <telerik:AjaxUpdatedControl ControlID="grdMRDetailTracking"/>
                    </UpdatedControls>
                </telerik:AjaxSetting>
                
                <telerik:AjaxSetting AjaxControlID="btnMRDetailTrackingSave">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="lblMRDetailDescription"/>
                        <telerik:AjaxUpdatedControl ControlID="lblSFICode"/>
                        <telerik:AjaxUpdatedControl ControlID="grdMRDetailTracking"/>
                ...
                <telerik:AjaxSetting AjaxControlID="btnMRDetailTrackingClear">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="lblMRDetailDescription"/>
                        <telerik:AjaxUpdatedControl ControlID="lblSFICode"/>
                        <telerik:AjaxUpdatedControl ControlID="txtMRTrackingRecieveDate"/>
                ...
                <telerik:AjaxSetting AjaxControlID="ddlCommentFrom">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="txtComment"/>
                    </UpdatedControls>
                </telerik:AjaxSetting>
