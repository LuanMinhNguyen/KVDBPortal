<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DistributionMatrixEditForm.aspx.cs" Inherits="EDMs.Web.Controls.Document.DistributionMatrixEditForm" %>
            ...
            <ul style="list-style-type: none">
                ...
                <li style="width: 600px; display: none">
                    <div>
                        ...
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                            <asp:DropDownList ID="ddlReAssignUser" runat="server" CssClass="min25Percent qlcbFormRequired" Width="416px" style="max-width: 416px"/>
                        </div>
                    </div>
                    <div style="clear: both; font-size: 0;"></div>
                </li>
