<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DocumentListProjectInfoEditForm_VEN.aspx.cs" Inherits="EDMs.Web.Controls.Document.DocumentListProjectInfoEditForm_VEN" %>
                ...
                <li style="width: 600px;">
                    <div>
                        <label style="width: 130px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
                            ...
                            <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                           <asp:DropDownList ID="ddlReceivingOrganisation" runat="server" CssClass="min25Percent" Width="416px"/>
                        </div>
