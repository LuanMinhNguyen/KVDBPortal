<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CSAttachDocument.aspx.cs" Inherits="EDMs.Web.Controls.Document.CSAttachDocument" %>
                    ...
                    <div>
                        ...
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                            <asp:DropDownList ID="ddlType" runat="server" CssClass="min25Percent" Width="416px">
                                <Items>
                                    <asp:ListItem Value="1" Text="CS Form"></asp:ListItem>
