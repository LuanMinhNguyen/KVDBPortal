    ...
    <form id="form1" runat="server">
        ...
        <table style="width: 90%">
            <tr class="qlcbFormItem">
                ...
                <td width="*"><asp:DropDownList ID="ddlDiscipline" runat="server" CssClass="min25Percent" Width="316"/>
                </td>
            </tr>
            <tr><td height="3px" colspan="4"></td></tr>
            <tr class="qlcbFormItem">
                <td class="qlcbTooltip">  <span id="Span6">Document Number:</span></td>
                <td><asp:TextBox ID="txtDocNumber" runat="server" CssClass="min25Percent" Width="300px"/></td>
            ...
            <tr class="qlcbFormItem">
                ...
                <td><asp:DropDownList ID="ddlIncomingTransmittal" runat="server" CssClass="min25Percent" Width="316"/></td>
            </tr>
        </table>
            ...
            <telerik:RadGrid ID="grdDocument" runat="server" AllowPaging="True" Height="405px"
                ...
                <MasterTableView ClientDataKeyNames="ID" DataKeyNames="ID" Width="100%">
                    ...
                    <Columns>
                        ...
                        <%--<telerik:GridTemplateColumn HeaderText="Sys Doc No" UniqueName="SystemDocumentNo">
                            <HeaderStyle HorizontalAlign="Center" Width="10%" />
                            <ItemStyle HorizontalAlign="Left" Width="10%" />
                            <ItemTemplate>
                                <%# Eval("M_SystemDocumentNo") %>
                            </ItemTemplate>
                            <EditItemTemplate>
                                <asp:HiddenField ID="SystemDocumentNo" runat="server" Value='<%# Eval("M_SystemDocumentNo") %>'/>
