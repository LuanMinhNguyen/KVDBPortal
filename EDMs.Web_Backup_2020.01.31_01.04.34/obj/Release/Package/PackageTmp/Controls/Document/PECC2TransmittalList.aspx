<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PECC2TransmittalList.aspx.cs" Inherits="EDMs.Web.Controls.Document.PECC2TransmittalList" EnableViewState="true" %>
       ...
       #ctl00_ContentPlaceHolder2_IncomingTransView{
        ...
        } #ctl00_ContentPlaceHolder2_ctl00_ContentPlaceHolder2_grdOutgoingTransPanel
        {
          ...
          #ctl00_ContentPlaceHolder2_radMenuIncoming_i1_btnSearchIncoming {
            ...
            #ctl00_ContentPlaceHolder2_radMenuIncoming_i1_btnSearchOutgoing {
              margin-top: -3px;
          }
            ...
            <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" Height="100%" Width="100%">
                <telerik:RadPageView runat="server" ID="IncomingTransView">
                            ...
                            <telerik:RadToolBarButton runat="server" Value="ShowAll">
                                <ItemTemplate>
                                  &nbsp;&nbsp; <%-- <img src="../../Images/filter.png"/>&nbsp;&nbsp;<b style="color: red">Filter: </b> &nbsp;&nbsp;--%>
                                    ...
                                    <b>Show</b>  
                                    <asp:DropDownList ID="ddlStatusIncoming" runat="server" CssClass="rcbReadOnly" Width="200px" style="max-width: 200px"
                                        OnSelectedIndexChanged="ddlStatusIncoming_OnSelectedIndexChanged" AutoPostBack="True">
                                        <Items>
                                            <asp:ListItem Value="All" Text="All Transmittals"></asp:ListItem>
                                            <asp:ListItem Value="WaitingValidate" Text="Transmittals Waiting To Validate" style="background-color: coral"></asp:ListItem>
                                            <asp:ListItem Value="Rejected" Text="Transmittals Rejected" style="background-color: coral"></asp:ListItem>
                                            <asp:ListItem Value="Validated" Text="Transmittals Validated" style="background-color: greenyellow"></asp:ListItem>
                                             <asp:ListItem Value="Processing" Text="Transmittals Processing" style="background-color: powderblue"></asp:ListItem>
                                            <asp:ListItem Value="Processed" Text="Transmittals Waiting To Respond" style="background-color: powderblue"></asp:ListItem>
                    ...
                    <telerik:RadGrid AllowCustomPaging="False" AllowPaging="True" AllowSorting="True" 
                            ...
                            Height="100%" ID="grdIncomingTrans"  AllowFilteringByColumn="true" AllowMultiRowSelection="False"
                            ...
                            <MasterTableView AllowMultiColumnSorting="false"
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridTemplateColumn AllowFiltering="False" UniqueName="EditColumn">
                                        ...
                                        <ItemStyle HorizontalAlign="Center"/>
                                        <ItemTemplate>
                                            <a href='javascript:ShowEditForm("<%# DataBinder.Eval(Container.DataItem, "ID") %>","In")' style="text-decoration: none; color:blue">
                                            <asp:Image ID="EditLink" runat="server" ImageUrl="~/Images/edit.png" Style="cursor: pointer;" ToolTip="Edit properties" Visible='<%# !Convert.ToBoolean(Eval("IsAttachWorkflow"))%>' />
                                                <a/>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                    ...
                                    <telerik:GridTemplateColumn AllowFiltering="False" UniqueName="AttachDocFile">
                                        ...
                                        <ItemStyle HorizontalAlign="Center"/>
                                        <ItemTemplate>
                                            <a href='javascript:ShowContractorAttachDocFile("<%# DataBinder.Eval(Container.DataItem, "ContractorTransId") %>","<%# DataBinder.Eval(Container.DataItem, "ID") %>", "<%# DataBinder.Eval(Container.DataItem, "ForSentId") %>")' style="text-decoration: none; color:blue">
                                            <asp:Image ID="AttachDoc" runat="server" ImageUrl="~/Images/attach.png" Style="cursor: pointer;" ToolTip="Transmittal Attachment" />
                                                <a/>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                    ...
                                    <telerik:GridTemplateColumn AllowFiltering="False" UniqueName="ETRM" Display="False">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:Image ID="imgExcel" runat="server" ImageUrl="~/Images/excelfile1.png" Style="cursor: pointer;" ToolTip="Export eTRM" Visible='<%# Eval("ForSentId").ToString() =="1"%>' />
                                                <a/>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                    ...
                                    <telerik:GridTemplateColumn AllowFiltering="False" UniqueName="ETRMAtach" Display="false">
                                        ...
                                        <ItemStyle HorizontalAlign="Center"/>
                                        <ItemTemplate>
                                            <a href='javascript:ShowIncomingTransAttachFile("<%# DataBinder.Eval(Container.DataItem, "ID") %>")' style="text-decoration: none; color:blue">
                                            <asp:Image ID="imgExcelAttach" runat="server" ImageUrl="~/Images/excelfileattach.png" Style="cursor: pointer;" ToolTip="Transmittal Attach Files" />
                                                <a/>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                    
                                    <telerik:GridTemplateColumn AllowFiltering="False" UniqueName="RejectColumn">
                                            <HeaderStyle Width="30"  />
                                            <ItemStyle HorizontalAlign="Center"/>
                                            <ItemTemplate>
                                                <a href='javascript:ShowRejectForm("<%# DataBinder.Eval(Container.DataItem, "ID") %>")' style="text-decoration: none; color:blue">
                                                    <asp:Image ID="imgReject" runat="server" ImageUrl="~/Images/reject2.png" Style="cursor: pointer;" ToolTip="Reject Transmittal" Visible='<%# !Convert.ToBoolean(Eval("IsImport")) && !Convert.ToBoolean(Eval("IsReject"))%>'/>
                                                <a/>
                                                ...
                                                Text='<%# "Reject Reason:<br/>" + Eval("CurrentRejectReason").ToString().Replace(Environment.NewLine, "<br/>") %>' Visible='<%# Eval("IsReject") %>'/>
                                    ...
                                    <telerik:GridTemplateColumn AllowFiltering="False" UniqueName="ImportTrans">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:Image ID="imgImportDocument" runat="server" ImageUrl="~/Images/importDoc.png" Style="cursor: pointer;" ToolTip="Import Transmittal" Visible='<%# !Convert.ToBoolean(Eval("IsImport")) && !Convert.ToBoolean(Eval("IsReject"))%>'/>
                                            <a/>
                                    ...
                                    <telerik:GridTemplateColumn AllowFiltering="False" UniqueName="AttachWorkflow">
                                        ...
                                        <ItemStyle HorizontalAlign="Center"/>
                                        <ItemTemplate>
                                            <a href='javascript:AttachWorkflow("<%# DataBinder.Eval(Container.DataItem, "ID") %>", "<%# DataBinder.Eval(Container.DataItem, "ForSentId") %>")' style="text-decoration: none; color:blue">
                                            <asp:Image ID="imgAttachWorkflow" runat="server" ImageUrl="~/Images/attachwf.png" Style="cursor: pointer;" ToolTip="Attach Transmittal To Workflow" Visible='<%# Convert.ToBoolean(Eval("IsImport")) && !Convert.ToBoolean(Eval("IsAttachWorkflow"))%>'/>
                                                <a/>
                                     ...
                                     <telerik:GridTemplateColumn AllowFiltering="False" UniqueName="WorkflowProcessHistory">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:Image ID="imgWorkflowProcessHistory" runat="server" ImageUrl="~/Images/history.png" Style="cursor: pointer;" ToolTip="Workflow Details Report" Visible='<%# Convert.ToBoolean(Eval("IsAttachWorkflow"))%>'/>
                                                <a/>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                    ...
                                    <telerik:GridTemplateColumn AllowFiltering="False" UniqueName="CreateOutgoingTrans">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:Image ID="imgCreateOutTrans" runat="server" ImageUrl="~/Images/outgoingTrans.png" Style="cursor: pointer;" ToolTip="Create Outgoing Transmittal" Visible='<%# Convert.ToBoolean(Eval("IsWFComplete")) && !Convert.ToBoolean(Eval("IsCreateOutGoingTrans"))%>'/>
                                                <a/>
                                                
                                                <asp:Image ID="imgCreateOutTransOk" runat="server" ImageUrl="~/Images/outgoingTransOk.png" ToolTip="Create Outgoing Transmittal Completed" Visible='<%# Convert.ToBoolean(Eval("IsCreateOutGoingTrans"))%>'/>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                      <telerik:GridTemplateColumn AllowFiltering="False" UniqueName="CopyFile">
                                        ...
                                        <ItemStyle HorizontalAlign="Center"/>
                                        <ItemTemplate>
                                            <a href='javascript:ShowExplorer("<%# DataBinder.Eval(Container.DataItem, "StoreFolderPathContractor") %>")' style="text-decoration: none; color:blue">
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Project" UniqueName="ProjectCodeName" AllowFiltering="false" Display="false">
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Transmittal Number" UniqueName="TransmittalNo" ShowFilterIcon="False" FilterControlWidth="97%"  DataField="TransmittalNo"
                                    AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Other Transmittal Number" UniqueName="OtherTransNo" AllowFiltering="false" Display="False">
                                ...
                                <telerik:GridTemplateColumn HeaderText="CC Organization" UniqueName="CCOrganizationName"
                                    ...
                                    <telerik:GridTemplateColumn  DataField="FromValue" HeaderText="From" UniqueName="FromValue" 
                                        ...
                                        <ItemStyle HorizontalAlign="Left"  />
                                        <ItemTemplate>
                                            <%# Eval("FromValue") != null ?Eval("FromValue").ToString().Replace(Environment.NewLine, "<br/>") : string.Empty %>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                    ...
                                    <telerik:GridTemplateColumn  DataField="ToValue" HeaderText="To" UniqueName="ToValue" 
                                        ...
                                        <ItemStyle HorizontalAlign="Left"  />
                                        <ItemTemplate>
                                            <%#Eval("ToValue") != null ?Eval("ToValue").ToString().Replace(Environment.NewLine, "<br/>") : string.Empty%>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                    ...
                                    <telerik:GridTemplateColumn  DataField="CCValue" HeaderText="CC" UniqueName="CCValue" 
                                        ...
                                        <ItemStyle HorizontalAlign="Left"  />
                                        <ItemTemplate>
                                            <%# Eval("CCValue") != null ?Eval("CCValue").ToString().Replace(Environment.NewLine, "<br/>") : string.Empty%>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                ...
                <telerik:RadPageView runat="server" Height="100%" ID="OutgoingTransView" Width="100%">
                                ...
                                <ItemTemplate>
                                   &nbsp;&nbsp; <%--<img src="../../Images/filter.png"/>&nbsp;&nbsp;<b style="color: red">Filter: </b> &nbsp;&nbsp;--%>
                                    ...
                                    <asp:DropDownList ID="ddlStatusOutgoing" runat="server" CssClass="rcbReadOnly" Width="200px" style="max-width: 200px"
                                        ...
                                        <Items>
                                            <asp:ListItem Value="All" Text="All Transmittals"></asp:ListItem>
                                            <asp:ListItem Value="Invalid" Text="Invalid Transmittals" style="background-color: red"></asp:ListItem>
                                            <asp:ListItem Value="Waiting" Text="Transmittals Waiting to Send" style="background-color: coral"></asp:ListItem>
                                            <%--<asp:ListItem Value="Waiting&Invalid"   Text="Transmittals Not Yet Sent" style="background-color: gold"></asp:ListItem>--%>
                                            <asp:ListItem Value="Sent" Text="Transmittals Sent" style="background-color: greenyellow"></asp:ListItem>
                    ...
                    <telerik:RadGrid AllowCustomPaging="False" AllowPaging="true" AllowSorting="True" 
                            AutoGenerateColumns="False" CellPadding="0" CellSpacing="0" GridLines="None" 
                            Height="100%" ID="grdOutgoingTrans"  AllowFilteringByColumn="true" AllowMultiRowSelection="False"
                            ...
                            <MasterTableView AllowMultiColumnSorting="false"
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridTemplateColumn AllowFiltering="False" UniqueName="EditColumn">
                                        ...
                                        <ItemStyle HorizontalAlign="Center"/>
                                        <ItemTemplate>
                                            <a href='javascript:ShowEditForm("<%# DataBinder.Eval(Container.DataItem, "ID") %>","Out")' style="text-decoration: none; color:blue">
                                    ...
                                    <telerik:GridTemplateColumn AllowFiltering="False" UniqueName="AttachDocFile" Display="false">
                                        <HeaderStyle Width="30"  />
                                        <ItemStyle HorizontalAlign="Center"/>
                                        <ItemTemplate>
                                            <a href='javascript:ShowAttachDocFile("<%# DataBinder.Eval(Container.DataItem, "ID") %>", "<%# DataBinder.Eval(Container.DataItem, "ForSentId") %>")' style="text-decoration: none; color:blue">
                                    ...
                                    <telerik:GridTemplateColumn AllowFiltering="False" UniqueName="DocumentList"  Display="false">
                                        ...
                                        <ItemStyle HorizontalAlign="Center"/>
                                        <ItemTemplate>
                                            <a href='javascript:ShowDocumentList("<%# DataBinder.Eval(Container.DataItem, "ID") %>", "<%# DataBinder.Eval(Container.DataItem, "ForSentId") %>")' style="text-decoration: none; color:blue">
                                            <asp:Image ID="DocList" runat="server" ImageUrl="~/Images/documents.png" Style="cursor: pointer;" ToolTip="Already Attach Document List" Visible='<%#  Eval("IsValid") != null && Convert.ToBoolean(Eval("IsValid"))%>'/>
                                                <a/>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:Image ID="AttachDoctrans" runat="server" ImageUrl="~/Images/attach.png" Style="cursor: pointer;" ToolTip="Transmittal Files Attachment" Visible='<%# Eval("IsValid") != null && Convert.ToBoolean(Eval("IsValid"))%>' />
                                                <a/>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>

                                       <telerik:GridTemplateColumn AllowFiltering="False"  Display="true" UniqueName="ETRMAL">
                                        <HeaderStyle Width="30"  />
                                        <ItemStyle HorizontalAlign="Center"/>
                                        <ItemTemplate>
                                            <a href='javascript:ExportApproveLetter("<%# DataBinder.Eval(Container.DataItem, "ID") %>", "<%# DataBinder.Eval(Container.DataItem, "ForSentId") %>")' style="text-decoration: none; color:blue">
                                            <asp:Image ID="imgExcelAL" runat="server" ImageUrl="~/Images/export.png" Style="cursor: pointer;" ToolTip="Export Approve Letter" Visible='<%# Eval("IsValid") != null && Convert.ToBoolean(Eval("IsValid")) %>'/>
                                                <a/>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                    ...
                                    <telerik:GridTemplateColumn AllowFiltering="False" UniqueName="ETRM">
                                        ...
                                        <ItemStyle HorizontalAlign="Center"/>
                                        <ItemTemplate>
                                            <a href='javascript:ExportETRM("<%# DataBinder.Eval(Container.DataItem, "ID") %>", "<%# DataBinder.Eval(Container.DataItem, "ForSentId") %>")' style="text-decoration: none; color:blue">
                                            <asp:Image ID="imgExcel" runat="server" ImageUrl="~/Images/excelfile1.png" Style="cursor: pointer;" ToolTip="Export Transmittal Cover Sheet" Visible='<%# Eval("IsValid") != null && Convert.ToBoolean(Eval("IsValid"))%>'/>
                                                <a/>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                    ...
                                    <telerik:GridTemplateColumn AllowFiltering="False" UniqueName="ETRMAtach">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:Image ID="imgExcelAttach" runat="server" ImageUrl="~/Images/excelfileattach.png" Style="cursor: pointer;" ToolTip="Attach Transmittal Files" Visible='<%# Eval("IsValid") != null && Convert.ToBoolean(Eval("IsValid"))%>'/>
                                                <a/>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                    ...
                                    <telerik:GridTemplateColumn AllowFiltering="False" UniqueName="SendTrans">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:Image ID="imgSendTrans" runat="server" ImageUrl="~/Images/sendTrans.png" Style="cursor: pointer;" ToolTip="Waiting to send transmittal" Visible='<%# Eval("IsValid") != null &&Convert.ToBoolean(Eval("IsValid")) && !Convert.ToBoolean(Eval("IsSend"))%>'/>
                                            <a/>
                                       ...
                                       <telerik:GridTemplateColumn AllowFiltering="False" UniqueName="UndoSendTrans">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:Image ID="imgUndoSendTrans" runat="server" ImageUrl="~/Images/undo_16.png" Style="cursor: pointer;" ToolTip="Undo transmittal sended" Visible='<%# Convert.ToBoolean(Eval("IsSend")) &&  !Convert.ToBoolean(Eval("IsOpen")) &&(DateTime.Now - Convert.ToDateTime(DataBinder.Eval(Container.DataItem, "ReceivedDate"))).TotalHours < 24%>'/>
                                            <a/>                       
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                    
                                    <telerik:GridTemplateColumn HeaderText="Project" UniqueName="ProjectCodeName" DataField="ProjectCodeName"  Display="false" ShowFilterIcon="False" FilterControlWidth="97%" 
                                    AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        <HeaderStyle HorizontalAlign="Center" Width="100" />
                                        <ItemStyle HorizontalAlign="Center"  />
                                        <ItemTemplate>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Group" UniqueName="GroupCode" DataField="GroupCode" ShowFilterIcon="False" FilterControlWidth="97%" 
                                    AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" >
                                        <HeaderStyle HorizontalAlign="Center" Width="100" />
                                        <ItemStyle HorizontalAlign="Center"  />
                                        <ItemTemplate>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Ref Incoming Trans" UniqueName="RefTransNo" AllowFiltering="false" Display="true">
                                        <HeaderStyle HorizontalAlign="Center" Width="150" />
                                        <ItemStyle HorizontalAlign="Center"  />
                                        <ItemTemplate>
                                            <%# Eval("RefTransNo") %>
...
<telerik:RadAjaxManager runat="Server" ID="ajaxCustomer" OnAjaxRequest="RadAjaxManager1_AjaxRequest">
    ...
    <AjaxSettings>
        ...
        <telerik:AjaxSetting AjaxControlID="txtSearchOutgoing">
            <UpdatedControls>
                <telerik:AjaxUpdatedControl ControlID="grdOutgoingTrans" LoadingPanelID="RadAjaxLoadingPanel1"/>
            </UpdatedControls>
        </telerik:AjaxSetting>
        <telerik:AjaxSetting AjaxControlID ="IncomingTransView">
            <UpdatedControls>
                  <telerik:AjaxUpdatedControl ControlID="grdIncomingTrans" LoadingPanelID="RadAjaxLoadingPanel1"/>
            </UpdatedControls>
        </telerik:AjaxSetting>
        <telerik:AjaxSetting AjaxControlID="OutgoingTransView">
            <UpdatedControls>
                 <telerik:AjaxUpdatedControl ControlID="grdOutgoingTrans" LoadingPanelID="RadAjaxLoadingPanel1"/>
            </UpdatedControls>
        </telerik:AjaxSetting>
    ...
    <telerik:RadWindowManager ID="RadWindowManager1" runat="server" EnableShadow="true" >
        <Windows>
            ...
            <telerik:RadWindow ID="AttachDocFile" runat="server" Title="Transmittal Attachments"
            ...
            <telerik:RadWindow ID="AttachWorkflow" runat="server" Title="Attach Transmittal To Workflow"
                VisibleStatusbar="False" Height="250" Width="610" IconUrl="~/Images/attachwf.png"
                Left="150px" ReloadOnShow="true" ShowContentDuringLoad="false" Modal="true">
            </telerik:RadWindow>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            ...
            function ShowExplorer(StorePath) {
                if (StorePath != null) {
                   // ajaxManager.ajaxRequest("OpenFolder_" + ID);
                   // window.open("file:///" + Servername + StorePath.replace("/DocumentLibrary/", "").replace("/", "\\"),"Explorer");
        ...
        <script type="text/javascript">
            ...
            function ShowEditForm(objId,type) {
                var owd = $find("<%=CustomerDialog.ClientID %>");
                owd.setSize(730, document.documentElement.offsetHeight);
                owd.Show();
                owd.setUrl("PECC2TransmittalEditForm.aspx?objId=" + objId+"&Type="+type, "CustomerDialog");
            }
            ...
            function ShowAttachDocFile(objId, forSendId) {
                var owd = $find("<%=AttachDocFile.ClientID %>");
                owd.Show();
                owd.maximize();
                ...
                if (forSendId === "1") {
                    ...
                    //alert(forSendId);
                    owd.setUrl("TransmittalAttaccChangeRequest.aspx?objId=" + objId, "AttachDocFile");
                }
            ...
            function ExportETRM(objId, forsend) {
                ajaxManager.ajaxRequest("ExportPECC2ETRM_" + objId + "_" + forsend);
            }

            function ExportApproveLetter(objId, forsend) {
                ajaxManager.ajaxRequest("ExportPECC2ApproveLetter_" + objId + "_" + forsend);
                }
            ...
            function AttachWorkflow(docId, forSentId) {
                var owd = $find("<%=AttachWorkflow.ClientID %>");
                 var projId = document.getElementById("<%= lblProjectIncomingId.ClientID %>").value;
                 owd.setSize(700, 300);
                 owd.Show();
                 ...
                 if (forSentId == "1") {
                     ...
                     owd.setUrl("../../Controls/Workflow/AttachWorkflow.aspx?objId=" + docId + "&projId=" + projId + "&type=4" + "&attachFrom=AttachByTrans&customizeWfFrom=Trans", "AttachWorkflow");
                 } else if (forSentId == "2"){
                    owd.setUrl("../../Controls/Workflow/AttachWorkflow.aspx?objId=" + docId + "&projId=" + projId + "&type=2" + "&attachFrom=AttachByTrans&customizeWfFrom=Trans", "AttachWorkflow");
                }

                 
            }

            function CreateOutgoingTrans(objId, forSentId) {
                var owd = $find("<%=CreateOutgoingTrans.ClientID %>");
                 var projId = document.getElementById("<%= lblProjectIncomingId.ClientID %>").value;
                 owd.setSize(850, document.documentElement.offsetHeight);
                 owd.Show();
                owd.setUrl("PECC2TransmittalFromToDoList.aspx?objId=" + objId + "&forSend=" + forSentId, "CreateOutgoingTrans");
            }

            function SendTrans(objId, forSendId) {
                if (confirm("Do you want to send this transmittal to contractor?") == false) return;
                ajaxManager.ajaxRequest("SendTrans_" + objId + "_" + forSendId);
            }
            ...
            function refreshAllGrid() {
                ...
                var masterTable1 = $find("<%=grdIncomingTrans.ClientID%>").get_masterTableView();
                    masterTable1.rebind();
            }
            ...
            function radMenuOutgoing_OnClientButtonClicking(sender, args) {
                ...
                if (strText === "Outgoing Transmittal") {
                    ...
                    owd.setSize(730, document.documentElement.offsetHeight);
                    owd.Show();
                    owd.setUrl("PECC2TransmittalEditForm.aspx?objId=" + objId + "&projId=" + projectId, "CustomerDialog");
                }
            }
