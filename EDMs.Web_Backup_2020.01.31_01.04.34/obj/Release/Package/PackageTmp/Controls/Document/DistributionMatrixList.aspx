<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DistributionMatrixList.aspx.cs" Inherits="EDMs.Web.Controls.Document.DistributionMatrixList" EnableViewState="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
            ...
            <telerik:RadToolBar ID="CustomerMenu" runat="server" Width="100%" OnClientButtonClicking="OnClientButtonClicking">
                <Items>
                    <telerik:RadToolBarDropDown runat="server" Text="New" ImageUrl="~/Images/addNew.png">
                        <Buttons>
                            <telerik:RadToolBarButton runat="server" Text="Distribution Matrix" Value="1" ImageUrl="~/Images/distribution.png"/>
                        </Buttons>
                                    ...
                                    <MasterTableView ClientDataKeyNames="ID" DataKeyNames="ID" Width="100%" TableLayout="Auto" CssClass="rgMasterTable">
                                        ...
                                        <Columns>
                                            ...
                                            <telerik:GridTemplateColumn>
                                                ...
                                                <ItemTemplate>
                                                    <asp:Image ID="EditLink" runat="server" ImageUrl="~/Images/edit.png" Style="cursor: pointer;" ToolTip="Edit Information of Matrix" AlternateText="Edit properties" />
                                                </ItemTemplate>
                                            </telerik:GridTemplateColumn>
                                            ...
                                            <telerik:GridTemplateColumn AllowFiltering="False" UniqueName="DetailColumn">
                                                <HeaderStyle Width="30"  />
                                                <ItemStyle HorizontalAlign="Center"/>
                                                <ItemTemplate>
                                                    <a href='javascript:ShowDetailForm(<%# DataBinder.Eval(Container.DataItem, "ID") %>, <%# DataBinder.Eval(Container.DataItem, "ProjectId") %>)' style="text-decoration: none; color:blue">
                                                    <asp:Image ID="DetailLink" runat="server" ImageUrl="~/Images/matrix.png" Style="cursor: pointer;" ToolTip="View Matrix" AlternateText="Distribution Matrix Detail" />
                                                        <a/>
                                                </ItemTemplate>
                                            </telerik:GridTemplateColumn>
                                            
                                            <telerik:GridTemplateColumn AllowFiltering="False" UniqueName="ExportColumn">
                                                <HeaderStyle Width="30"  />
                                                <ItemStyle HorizontalAlign="Center"/>
                                                <ItemTemplate>
                                                    <a href='javascript:ExportDmDetail(<%# DataBinder.Eval(Container.DataItem, "ID") %>, <%# DataBinder.Eval(Container.DataItem, "TypeId") %>)' style="text-decoration: none; color:blue">
                                                    <asp:Image ID="ExportLink" runat="server" ImageUrl="~/Images/export.png" Style="cursor: pointer;" ToolTip="Export Matrix to file" AlternateText="Export Distribution Matrix Detail" />
                                                        <a/>
                                                </ItemTemplate>
                                            </telerik:GridTemplateColumn>
                                            
                                            <telerik:GridTemplateColumn AllowFiltering="False" UniqueName="ImportColumn">
                                                <HeaderStyle Width="30"  />
                                                <ItemStyle HorizontalAlign="Center"/>
                                                <ItemTemplate>
                                                    <a href='javascript:ShowImportForm(<%# DataBinder.Eval(Container.DataItem, "ID") %>, <%# DataBinder.Eval(Container.DataItem, "TypeId") %>)' style="text-decoration: none; color:blue">
                                                    <asp:Image ID="ImportLink" runat="server" ImageUrl="~/Images/import.png" Style="cursor: pointer;" ToolTip="Import Matrix from file" AlternateText="Import Distribution Matrix Detail" />
                                                        <a/>
                                                </ItemTemplate>
                                            </telerik:GridTemplateColumn>
                                            <%--3--%>
                                            <telerik:GridTemplateColumn UniqueName="Name" HeaderText="Name"
                                                ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" DataField="Name">
                                            ...
                                            <telerik:GridBoundColumn DataField="TypeName" HeaderText="Type Name" UniqueName="TypeName" Display="False">
    ...
    <telerik:RadWindowManager ID="RadWindowManager1" runat="server" EnableShadow="true" >
        <Windows>
            <telerik:RadWindow ID="CustomerDialog" runat="server" Title="Distribution Matrix Information"
                VisibleStatusbar="False" Height="350" Width="610" IconUrl="~/Images/distribution.png"
                Left="150px" ReloadOnShow="true" ShowContentDuringLoad="false" Modal="true">
            </telerik:RadWindow>
            <telerik:RadWindow ID="DisMatrixDetail" runat="server" Title="Distribution Matrix Detail"
                VisibleStatusbar="False" Height="700" Width="800" IconUrl="~/Images/matrix.png"
                Left="150px" ReloadOnShow="true" ShowContentDuringLoad="false" Modal="true">
            </telerik:RadWindow>
            <telerik:RadWindow ID="ImportDMDetail" runat="server" Title="Import Distribution Matrix Detail"
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            ...
            function ShowDetailForm(disMatrixId, projectId) {
                var owd = $find("<%=DisMatrixDetail.ClientID %>");
                owd.Show();
                owd.maximize();
                owd.setUrl("DistributionMatrixDetailForm.aspx?disMatrixId=" + disMatrixId + "&projectId=" + projectId, "DisMatrixDetail");
            }
        ...
        <script type="text/javascript">
            ...
            function ExportDmDetail(disMatrixId, typeId) {
                ajaxManager.ajaxRequest("ExportDMDetail_" + disMatrixId + "_" + typeId);
            }
            ...
            function ShowEditForm(id) {
                ...
                owd.Show();
                owd.setUrl("DistributionMatrixEditForm.aspx?objId=" + id, "CustomerDialog");
            }

            function ShowImportForm(id) {
                var owd = $find("<%=ImportDMDetail.ClientID %>");
                owd.Show();
                owd.setUrl("ImportDistributionMatrix.aspx?dmId=" + id, "ImportDMDetail");
            }
            ...
            function OnClientButtonClicking(sender, args) {
                ...
                if (strText.toLowerCase() == "distribution matrix") {
                    var owd = $find("<%=CustomerDialog.ClientID %>");
                    owd.setSize(730, document.documentElement.offsetHeight);
                    owd.Show();
                    owd.setUrl("DistributionMatrixEditForm.aspx", "CustomerDialog");
                }
            }
