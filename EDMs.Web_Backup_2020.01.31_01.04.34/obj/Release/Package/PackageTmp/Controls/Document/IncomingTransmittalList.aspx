<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="IncomingTransmittalList.aspx.cs" Inherits="EDMs.Web.Controls.Document.IncomingTransmittalList" EnableViewState="true" %>
     ...
     <telerik:RadPanelBar ID="RadPanelBarTransmittal" runat="server" Width="100%" >
        <Items>
            <telerik:RadPanelItem Text="TRANSMITTAL" runat="server" Expanded="True" Width="100%">
                <Items>
                    <telerik:RadPanelItem runat="server" Text="InComing Transmittal" ImageUrl="~/Images/in.png" NavigateUrl="~/Controls/Document/IncomingTransmittalList.aspx" Selected="True" />
            ...
            <telerik:RadToolBar ID="CustomerMenu" runat="server" Width="100%" OnClientButtonClicking="OnClientButtonClicking">
                <Items>
                    <telerik:RadToolBarDropDown runat="server" Text="New" ImageUrl="~/Images/addNew.png">
                        <Buttons>
                            <telerik:RadToolBarButton runat="server" Text="Incoming Transmittal" Value="1" ImageUrl="~/Images/in.png"/>
                        </Buttons>
                                ...
                                <telerik:RadGrid ID="grdDocument" runat="server" AllowPaging="True"
                                    ...
                                    <MasterTableView ClientDataKeyNames="ID" DataKeyNames="ID" Width="100%" TableLayout="Auto" CssClass="rgMasterTable">
                                        ...
                                        <Columns>
                                            ...
                                            <telerik:GridTemplateColumn UniqueName="IsGenerate">
                                                <HeaderStyle Width="2%"/>
                                                <ItemStyle HorizontalAlign="Center" Width="2%" />
                                                <ItemTemplate>
                                                    <a download='<%# DataBinder.Eval(Container.DataItem, "AttachFileName") %>' 
                                                        href='<%# DataBinder.Eval(Container.DataItem, "AttachFilePath") %>' target="_blank">
                                                    <asp:Image ID="GenTrans" runat="server" ImageUrl='~/Images/generate.png' 
                                                        Visible='<%# !string.IsNullOrEmpty(DataBinder.Eval(Container.DataItem, "AttachFileName").ToString()) %>' Style="cursor: pointer;" /> 
                                                    </a>
                                                </ItemTemplate>
                                            </telerik:GridTemplateColumn>
                                            <%--3--%>
                                            ...
                                            <telerik:GridBoundColumn DataField="TransNumber" HeaderText="Transmittal No." UniqueName="TransNumber">
                                            ...
                                            <%--6--%>
                                            <telerik:GridBoundColumn DataField="FromName" HeaderText="From" UniqueName="FromName">
                                                <HeaderStyle HorizontalAlign="Center" Width="10%" />
                                                <ItemStyle HorizontalAlign="Center" Width="10%" />
                                            </telerik:GridBoundColumn>
                                            <%--7--%>
                                            <telerik:GridBoundColumn DataField="ToName" HeaderText="To" UniqueName="ToName">
                                                <HeaderStyle HorizontalAlign="Center" Width="10%" />
                                                <ItemStyle HorizontalAlign="Left" Width="10%" />
                                            </telerik:GridBoundColumn>
                                            <%--8--%>
                                            <telerik:GridBoundColumn DataField="AttentionName" HeaderText="Attentions" UniqueName="AttentionName">
                                                <HeaderStyle HorizontalAlign="Center" Width="10%" />
                                                <ItemStyle HorizontalAlign="Left" Width="10%" />
                                            </telerik:GridBoundColumn>

                                            <telerik:GridBoundColumn DataField="ReceivedDate" HeaderText="Received Date" UniqueName="ReceivedDate" DataFormatString="{0:dd/MM/yyyy}" >
                                                <HeaderStyle HorizontalAlign="Center" Width="10%" />
                                                <ItemStyle HorizontalAlign="Center" Width="10%" />
                                            </telerik:GridBoundColumn>
                                        </Columns>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
            ...
            function gridMenuClicking(sender, args) {
                ...
                switch (itemValue) {
                    case "AttachDocument":
                        ...
                        owd.Show();
                        owd.setUrl("Controls/Document/TransmittalAttachDocument.aspx?tranId=" + tranId, "AttachDoc");
                        break;
                    case "DocumentList":
                        var owd = $find("<%=DocList.ClientID %>");
                        owd.Show();
                        owd.setUrl("Controls/Document/TransmittalDocumentList.aspx?tranId=" + tranId, "DocList");
                        break;
                }
            }
        ...
        <script type="text/javascript">
            ...
            function ShowEditForm(id) {
                ...
                owd.Show();
                owd.setUrl("IncomingTransmittalEditForm.aspx?tranId=" + id, "CustomerDialog");
            }
            ...
            function OnClientButtonClicking(sender, args) {
                ...
                if (strText.toLowerCase() == "incoming transmittal") {
                    var owd = $find("<%=CustomerDialog.ClientID %>");
                    owd.Show();
                    owd.setUrl("IncomingTransmittalEditForm.aspx", "CustomerDialog");
