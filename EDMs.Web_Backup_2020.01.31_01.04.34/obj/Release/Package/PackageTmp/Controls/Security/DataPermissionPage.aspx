<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DataPermissionPage.aspx.cs" Inherits="EDMs.Web.Controls.Security.DataPermissionPage" EnableViewState="true" %>
                     ...
                     <telerik:RadSplitter ID="Radsplitter10" runat="server" Orientation="Vertical">
                         <telerik:RadPane ID="Radpane6" runat="server" Scrolling="Both" Width="30%">
                             <div style="padding-top: 4px; padding-left: 10px; width: 97%">
                                 ...
                                 <br/>
                                 Workgroups:
                                 <telerik:RadTreeView ID="rtvWorkgroup" runat="server" style="padding-top: 10px;" 
                                     Width="100%" Height="100%" ShowLineImages="False" 
                                     OnNodeClick="rtvWorkgroup_NodeClick"
                                     OnNodeDataBound="rtvWorkgroup_OnNodeDataBound">
                                    <DataBindings>
