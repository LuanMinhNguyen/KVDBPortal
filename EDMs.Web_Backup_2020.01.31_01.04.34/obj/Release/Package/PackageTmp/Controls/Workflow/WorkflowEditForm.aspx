<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorkflowEditForm.aspx.cs" Inherits="EDMs.Web.Controls.Workflow.WorkflowEditForm" %>
        ...
        <div style="width: 100%" runat="server" ID="divContent">
            <ul style="list-style-type: none">
                ...
                <li style="width: 500px;">
                    <div>
                        <label style="width: 125px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
                            <span style="color: #2E5689; text-align: right; ">Re-Assign User
                            </span>
                        </label>
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                            <asp:DropDownList ID="ddlReAssignUser" runat="server" CssClass="min25Percent" Width="316px" style="max-width: 416px"/>
                        </div>
                    </div>
                    <div style="clear: both; font-size: 0;"></div>
                </li>
                ...
                <li style="width: 500px;">
                    <div>
                        <label style="width: 125px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
                            <span style="color: #2E5689; text-align: right; ">Object
                            </span>
                        </label>
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                            <asp:DropDownList ID="ddlObject" runat="server" CssClass="min25Percent qlcbFormRequired" Width="315px">
                                <Items>
                                    <asp:ListItem Value="4" Text="Document Transmittal"></asp:ListItem>
                                    <asp:ListItem Value="2" Text="Change Request"></asp:ListItem>
                                    <asp:ListItem Value="3" Text="NCR/SI/CS"></asp:ListItem>
                                    <asp:ListItem Value="5" Text="RFI"></asp:ListItem>
                                    <asp:ListItem Value="6" Text="Shipment"></asp:ListItem>
                                </Items> 
                            </asp:DropDownList>
                        </div>
                    </div>
                ...
                <li style="width: 500px;display: none">
                    <div>
                        ...
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                            <asp:CheckBox runat="server" Text="Internal Workflow" ID="cbInternalWorkflow"/>
                        </div>
                    </div>
                    <div style="clear: both; font-size: 0;"></div>
                </li>
