<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AttachWorkflow_bak.aspx.cs" Inherits="EDMs.Web.Controls.Workflow.AttachWorkflow_bak" %>
            ...
            <ul style="list-style-type: none">
                <li style="width: 500px;">
                    <div>
                        ...
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                            <asp:DropDownList ID="ddlWorkflow" runat="server" CssClass="min25Percent qlcbFormRequired" Width="315px"
                ...
                <li style="width: 500px;">
                    <div>
                        ...
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                            <asp:TextBox ID="txtDescription" runat="server" Style="width: 300px;" CssClass="min25Percent" TextMode="MultiLine" Rows="3" ReadOnly="True"/>
                        </div>
                    </div>
                    <div style="clear: both; font-size: 0;"></div>
                </li>
