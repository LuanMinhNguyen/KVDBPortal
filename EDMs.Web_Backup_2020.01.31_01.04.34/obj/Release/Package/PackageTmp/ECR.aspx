<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ECR.aspx.cs" Inherits="EDMs.Web.ECR" EnableViewState="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
            ...
            <telerik:RadToolBar ID="CustomerMenu" runat="server" Width="100%" OnClientButtonClicking="OnClientButtonClicking">
                <Items>
                    <telerik:RadToolBarDropDown runat="server" Text="Add" ImageUrl="~/Images/addNew.png">
                        <Buttons>
                            <telerik:RadToolBarButton runat="server" Text="ECR" Value="1" ImageUrl="~/Images/trackinglist.png"></telerik:RadToolBarButton>
                        ...
                        <ItemTemplate>
                            ...
                            <asp:DropDownList ID="ddlStatus" runat="server" CssClass="rcbReadOnly" Width="230px" style="max-width: 316px"
                                ...
                                <Items>
                                    ...
                                    <asp:ListItem Value="7" Text="ECR complete Workflow Process" style="background-color: greenyellow"></asp:ListItem>
            ...
            <div style="padding-top: 5px;">
                <table>
                    <tr>
                        ...
                        <td valign="middle">New ECR.&nbsp;&nbsp; | &nbsp;&nbsp;</td>
                        <td valign="middle"><asp:Image runat="server" ImageUrl="~/Images/ball_inwf.png"/></td>
                        <td valign="middle"> ECR being in workflow process.&nbsp;&nbsp; | &nbsp;&nbsp;</td>
                        <td valign="middle"><asp:Image runat="server" ImageUrl="~/Images/ball_completewf.png"/></td>
                        <td valign="middle"> ECR completed workflow process.&nbsp;&nbsp; | &nbsp;&nbsp;</td>
                        <td valign="middle"><asp:Image runat="server" ImageUrl="~/Images/ball_completefinal.png"/></td>
                        <td valign="middle"> ECR completed attach ECR form.&nbsp;&nbsp; | &nbsp;&nbsp;</td>
                        <td valign="middle"><asp:Image runat="server" ImageUrl="~/Images/ball_cancel.png"/></td>
                        <td valign="middle"> Canceled ECR.</td>
                    </tr>
                </table>
            </div>
        </telerik:RadPane>
    ...
    <telerik:RadWindowManager ID="RadWindowManager1" runat="server" EnableShadow="true" >
        <Windows>
            ...
            <telerik:RadWindow ID="AttachWorkflow" runat="server" Title="Attach ECR to Workflow"
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
            ...
            function gridMenuClicking(sender, args) {
                ...
                else
                {
                    ...
                    case "MRDetail":
                        ...
                        owd.Show();
                        owd.setUrl("Controls/WMS/TrackingECRDetail.aspx?objId=" + docId, "ECRDetailDialog");
                        break;
                        case "AttachWF":
                        var projId = document.getElementById("<%= lblProjectId.ClientID %>").value;
                        var owd = $find("<%=AttachWorkflow.ClientID %>");
                        owd.Show();
                        owd.setUrl("Controls/Workflow/AttachWorkflow.aspx?objId=" + docId + "&objType=ECR" + "&projId=" + projId, "AttachWorkflow");
                        break;
                    case "WFHistory":
                        var owd = $find("<%=WFProcessHistory.ClientID %>");
                        owd.Show();
                        owd.maximize();
                        owd.setUrl("Controls/Workflow/WorkflowProcessHistory.aspx?objId=" + docId + "&objType=ECR", "WFProcessHistory");
                        break;
                    case "AttachDocument":
                        ...
                        owd.setUrl("Controls/WMS/TrackingECRAttach.aspx?objId=" + docId, "AttachDoc");
                        break;
                    case "CMS":
                        ...
                        case "EditProperties":
                            ...
                            owd.setSize(850, document.documentElement.offsetHeight);
                            owd.Show();
                            owd.setUrl("Controls/WMS/TrackingECREditForm.aspx?objId=" + docId + "&projId=" + projectId, "CustomerDialog");
                        break;
                    case "Transmittals":
        ...
        <script type="text/javascript">
            ...
            function ShowEditForm(docId, projId) {
                ...
                owd.setSize(850, document.documentElement.offsetHeight);
                owd.Show();
                owd.setUrl("Controls/WMS/TrackingECREditForm.aspx?projId=" + projId + "&objId=" + docId, "CustomerDialog");
            }
            ...
            function OnClientButtonClicking(sender, args) {
                ...
                if (strText == "ECR") {
                    ...
                    owd.setSize(850, document.documentElement.offsetHeight);
                    owd.Show();
                    owd.setUrl("Controls/WMS/TrackingECREditForm.aspx?projId=" + projectId, "CustomerDialog");
                    //}
                }
