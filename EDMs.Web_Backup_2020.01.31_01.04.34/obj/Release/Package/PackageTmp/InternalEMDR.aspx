<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="InternalEMDR.aspx.cs" Inherits="EDMs.Web.InternalEMDR" EnableViewState="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
                ...
                <Items>
                    ...
                    <telerik:RadToolBarDropDown runat="server" Text="Action" ImageUrl="~/Images/action.png">
                        <Buttons>
                            ...
                            <telerik:RadToolBarButton runat="server" Text="Export Master document register template" Value="Adminfunc" ImageUrl="~/Images/export.png" Visible="False"/>
                            <telerik:RadToolBarButton runat="server" Text="Import Master document register" Value="Adminfunc" ImageUrl="~/Images/import.png" Visible="False"/>
                        ...
                        <telerik:RadPane ID="Radpane6" runat="server" Scrolling="None">
                            <telerik:RadGrid AllowCustomPaging="False" AllowPaging="True" AllowSorting="True" 
                                ...
                                <MasterTableView AllowMultiColumnSorting="false"
                                    ...
                                    <ColumnGroups>
                                        <telerik:GridColumnGroup HeaderText="Contractor Issue Info" Name="RevisionDetails"
    ...
    <telerik:RadContextMenu ID="radMenu" runat="server"
        ...
        <Items>
            ...
            <telerik:RadMenuItem Text="Attach comment/response" ImageUrl="~/Images/comment.png" Value="AttachComment" Visible="False"/>
    ...
    <telerik:RadWindowManager ID="RadWindowManager1" runat="server" EnableShadow="true" >
        <Windows>
            <telerik:RadWindow ID="CustomerDialog" runat="server" Title="Internal Document Information"
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
            ...
            function gridMenuClicking(sender, args) {
                ...
                else
                {
                    ...
                    case "RevisionHistory":
                        ...
                        owd.Show();
                        owd.setUrl("Controls/Document/InternalDocumentRevisionHistory.aspx?docId=" + docId + "&categoryId=" + categoryId, "RevisionDialog");
                        break;
                    case "AttachDocument":
                    ...
                    case "AttachComment":
                        ...
                        case "EditProperties":
                            ...
                            owd.Show();
                            owd.setUrl("Controls/Document/InternalDocumentInfoEditForm.aspx?docId=" + docId + "&projId=" + projectId, "CustomerDialog");
                        break;
                    case "Transmittals":
        ...
        <script type="text/javascript">
            ...
            function ShowEditForm(docId, projId) {
                var owd = $find("<%=CustomerDialog.ClientID %>");
                owd.Show();
                owd.setUrl("Controls/Document/InternalDocumentInfoEditForm.aspx?projId=" + projId + "&docId=" + docId, "CustomerDialog");
            }
            ...
            function OnClientButtonClicking(sender, args) {
                ...
                if (strText.toLowerCase() == "document") {
                    ...
                    var owd = $find("<%=CustomerDialog.ClientID %>");
                    owd.Show();
                    owd.setUrl("Controls/Document/InternalDocumentInfoEditForm.aspx?projId=" + projectId, "CustomerDialog");
                    //}
                }
