<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ChangeRequestNewList.aspx.cs" Inherits="EDMs.Web.ChangeRequestNewList" EnableViewState="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <style type="text/css">
        ...
        #ctl00_ContentPlaceHolder2_grdChangeRequest_GridData {
            height: 100% !important;
        }
       ...
       #ctl00_ContentPlaceHolder2_IncomingTransView{
        ...
        #ctl00_ContentPlaceHolder2_OutgoingTransView {
         ...
         #ctl00_ContentPlaceHolder2_ctl00_ContentPlaceHolder2_grdIncomingTransPanel{
            height: 100% !important;
        } #ctl00_ContentPlaceHolder2_ctl00_ContentPlaceHolder2_grdChangeRequestPanel
        {
            height: 100% !important;
        }
    ...
    <telerik:RadSplitter ID="RadSplitter4" runat="server" Orientation="Horizontal">
            ...
            <telerik:RadToolBar ID="radMenuOutgoing" runat="server" Width="100%" OnClientButtonClicking="radMenuOutgoing_OnClientButtonClicking">
                <Items>
                    <telerik:RadToolBarDropDown runat="server" Text="New" ImageUrl="~/Images/addNew.png" Visible="False">
                        <Buttons>
                            <telerik:RadToolBarButton runat="server" Text="Change Request" Value="1" ImageUrl="~/Images/index.png" />
                        </Buttons>
                    ...
                    <telerik:RadToolBarButton runat="server" Value="ShowAll">
                        <ItemTemplate>
                            ...
                            <asp:DropDownList ID="ddlStatus" runat="server" CssClass="rcbReadOnly" Width="200px" style="max-width: 200px"
                                ...
                                <Items>
                                    <asp:ListItem Value="All" Text="All Change Request"></asp:ListItem>
                                    <asp:ListItem Value="Invalid" Text="Invalid Change Request" style="background-color: red"></asp:ListItem>
                                    <asp:ListItem Value="Waiting" Text="Change Request Waiting For Send" style="background-color: coral"></asp:ListItem>
                                    <asp:ListItem Value="Sent" Text="Change Request Sent" style="background-color: greenyellow"></asp:ListItem>
        ...
        <telerik:RadPane ID="RadPane1" runat="server" Scrollable="false" Scrolling="None">
            <telerik:RadGrid AllowCustomPaging="False" AllowPaging="true" AllowSorting="True" 
                    ...
                    Height="100%" ID="grdChangeRequest"  AllowFilteringByColumn="true" AllowMultiRowSelection="False"
                    OnNeedDataSource="grdChangeRequest_OnNeedDataSource" 
                    OnDeleteCommand="grdChangeRequest_OnDeleteCommand"
                        OnItemDataBound="grdChangeRequest_OnItemDataBound"
                    ...
                    <MasterTableView AllowMultiColumnSorting="false"
                        ...
                        <Columns>
                            ...
                            <telerik:GridTemplateColumn HeaderText="No." Groupable="False" AllowFiltering="false">
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="lblSoTT" runat="server" Text='<%# grdChangeRequest.CurrentPageIndex * grdChangeRequest.PageSize + grdChangeRequest.Items.Count+1 %>'>
                                    </asp:Label>
                                      
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                                    
                            <telerik:GridTemplateColumn  UniqueName="ProcessStatus" AllowFiltering="false">
                                <HeaderStyle HorizontalAlign="Center" Width="30" />
                                <ItemStyle HorizontalAlign="Center"  />
                                <ItemTemplate>
                                    <asp:Image ID="imgStatus" runat="server" ImageUrl='<%# 
                                        !Convert.ToBoolean(Eval("IsValid")) || Convert.ToBoolean(Eval("IsReject"))
                                            ? "~/Images/warning.png" 
                            ...
                            Text='<%# "Error Message:<br/>" + Eval("ErrorMessage").ToString().Replace(Environment.NewLine, "<br/>") %>' Visible='<%# !Convert.ToBoolean(Eval("IsValid")) || Convert.ToBoolean(Eval("IsReject"))%>'/>
                        ...
                        <telerik:GridTemplateColumn AllowFiltering="False" UniqueName="DocumentRevison">
                            ...
                            <ItemStyle HorizontalAlign="Center"/>
                            <ItemTemplate>
                                <a href='javascript:ShowDocumentRevision("<%# DataBinder.Eval(Container.DataItem, "ID") %>")' style="text-decoration: none; color:blue">
                            ...
                            <telerik:GridTemplateColumn AllowFiltering="False" UniqueName="ETRMAtach" Display="False">
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:Image ID="imgExcelAttach" runat="server" ImageUrl="~/Images/excelfileattach.png" Style="cursor: pointer;" ToolTip="Attach Change Request Form" Visible='<%# Eval("IsValid")%>'/>
                                        <a/>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            ...
                            <telerik:GridTemplateColumn AllowFiltering="False" UniqueName="AllAttachFile" >
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:Image ID="imgAllAttach" runat="server" ImageUrl="~/Images/attach.png" Style="cursor: pointer;" ToolTip="Attach Change Request Form" Visible='<%# Eval("IsValid")%>'/>
                                    <a/>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                                    
                            <telerik:GridTemplateColumn AllowFiltering="False" UniqueName="SendChange" Display="False" >
                                <HeaderStyle Width="30"  />
                                <ItemStyle HorizontalAlign="Center"/>
                                <ItemTemplate>
                                    ...
                                    <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/sendTransOk1.png" ToolTip="Change Request sent" Visible='<%# Convert.ToBoolean(Eval("IsSend"))%>'/>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                                 
                        <telerik:GridTemplateColumn AllowFiltering="False" UniqueName="CreateOutgoingTrans" Display="False">
                            <HeaderStyle Width="30"  />
                            <ItemStyle HorizontalAlign="Center"/>
                            <ItemTemplate>
                                <a href='javascript:CreateOutgoingTrans("<%# DataBinder.Eval(Container.DataItem, "ID") %>", "2")' style="text-decoration: none; color:blue">
                                <asp:Image ID="imgCreateOutTrans" runat="server" ImageUrl="~/Images/outgoingTrans.png" Style="cursor: pointer;" ToolTip="Create Outgoing Transmittal" Visible='<%# Convert.ToBoolean(Eval("IsValid")) && !Convert.ToBoolean(Eval("IsCreateOutgoingTrans"))%>'/>
                                <a/>
                            ...
                            <telerik:GridTemplateColumn AllowFiltering="False" UniqueName="AttachWorkflow" Display="False">
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:Image ID="imgAttachWorkflow" runat="server" ImageUrl="~/Images/attachwf.png" Style="cursor: pointer;" ToolTip="Attach Change Request To Workflow" Visible='<%# Convert.ToBoolean(Eval("IsSend")) && !Convert.ToBoolean(Eval("IsAttachWorkflow"))%>'/>
                                        <a/>
                                                
                                        <asp:Image ID="imgAttachWorkflowOk" runat="server" ImageUrl="~/Images/attachwfOk.png" ToolTip="Change Request Attached To Workflow" Visible='<%# Convert.ToBoolean(Eval("IsAttachWorkflow"))%>'/>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                        ...
                        <telerik:GridTemplateColumn AllowFiltering="False" UniqueName="CreateResponseChangeRequest" Display="False">
                                <HeaderStyle Width="30"  />
                                <ItemStyle HorizontalAlign="Center"/>
                                <ItemTemplate>
                                    <a href='javascript:ShowAddNew("<%# DataBinder.Eval(Container.DataItem, "ID") %>")' style="text-decoration: none; color:blue">
                                    <asp:Image ID="imgCreateNew" runat="server" ImageUrl="~/Images/addNew.png" Style="cursor: pointer;" ToolTip="Create new Change Request reference this Change Request" Visible='<%# Convert.ToBoolean(Eval("IsReject"))%>'/>
                                        <a/>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                        ...
                        <telerik:GridTemplateColumn HeaderText="PECC2 Review Result" UniqueName="PECC2ReviewResultName" DataField="PECC2ReviewResultName"
                            ...
                            <telerik:GridTemplateColumn Display="False" HeaderText="Confidentiality" UniqueName="ConfidentialityName"
                                ...
                                <telerik:GridTemplateColumn Display="False" HeaderText="Reason For Change" UniqueName="ReasonForChange"
                                ...
                                <telerik:GridTemplateColumn Display="False" HeaderText="Existing Condition" UniqueName="ExistingCondition"
                                ...
                                <telerik:GridDateTimeColumn HeaderText="Issued Date" UniqueName="IssuedDate" DataField="IssuedDate" AllowFiltering="false"
                                    DataFormatString="{0:dd/MM/yyyy}" FilterControlWidth="80%" CurrentFilterFunction="EqualTo" AutoPostBackOnFilter="True" >
                                <HeaderStyle HorizontalAlign="Center" Width="80" />
                                <ItemStyle HorizontalAlign="Center"/>
                            </telerik:GridDateTimeColumn> 
                                        
                                    <telerik:GridDateTimeColumn HeaderText="Closed Date" UniqueName="ClosedDate" DataField="ClosedDate" AllowFiltering="false"
                                    DataFormatString="{0:dd/MM/yyyy}" FilterControlWidth="80%" CurrentFilterFunction="EqualTo" AutoPostBackOnFilter="True" >
                                <HeaderStyle HorizontalAlign="Center" Width="80" />
                                <ItemStyle HorizontalAlign="Center"/>
                            </telerik:GridDateTimeColumn> 

                                <telerik:GridTemplateColumn HeaderText="Grade Code" UniqueName="ChangeGradeCodeName" DataField="ChangeGradeCodeName"
                                ShowFilterIcon="False" FilterControlWidth="97%" 
                                AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" >
                                <HeaderStyle HorizontalAlign="Center" Width="50" />
                                <ItemStyle HorizontalAlign="Center" />
                           ...
                           <telerik:GridTemplateColumn AllowFiltering="true" UniqueName="RefDocNo" HeaderText="Referenced Document Number"  DataField="RefDocNo"  ShowFilterIcon="False" FilterControlWidth="97%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        <HeaderStyle Width="150"  />
                                        <ItemStyle HorizontalAlign="Center"/>
                                        <ItemTemplate>
                                            <a href='javascript:ShowRefDocNo("<%# DataBinder.Eval(Container.DataItem, "ID") %>")' style="text-decoration: none; color: black;">
                                                <asp:Label ID="lblName1" runat="server" Text='<%# Eval("RefDocNo") != null ? Eval("RefDocNo").ToString().Replace(Environment.NewLine, "<br/>") : string.Empty%>'></asp:Label>
                                                <a/>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
    ...
    <AjaxSettings>
        <telerik:AjaxSetting AjaxControlID="ajaxCustomer">
            <UpdatedControls>
                ...
                <telerik:AjaxUpdatedControl ControlID="grdChangeRequest" LoadingPanelID="RadAjaxLoadingPanel1"/>
            </UpdatedControls>
        </telerik:AjaxSetting>
        ...
        <telerik:AjaxSetting AjaxControlID="grdChangeRequest">
            <UpdatedControls>
                <telerik:AjaxUpdatedControl ControlID="grdChangeRequest" LoadingPanelID="RadAjaxLoadingPanel1"/>
            </UpdatedControls>
        </telerik:AjaxSetting>
    ...
    <telerik:RadWindowManager ID="RadWindowManager1" runat="server" EnableShadow="true" >
        <Windows>
            <telerik:RadWindow ID="CustomerDialog" runat="server" Title="Change Request Information"
                VisibleStatusbar="false" Height="600" Width="650" IconUrl="~/Images/index.png"
                Left="150px" ReloadOnShow="true" ShowContentDuringLoad="false" Modal="true">
            </telerik:RadWindow>
            
            <telerik:RadWindow ID="AttachDocFile" runat="server" Title="Change Request Attach Referenced Document Files"
            ...
            <telerik:RadWindow ID="ETRMAttachFile" runat="server" Title="Change Request Attach Files"
            ...
            <telerik:RadWindow ID="AttachWorkflow" runat="server" Title="Attach Change Request to Workflow"
            ...
            <telerik:RadWindow ID="CreateOutgoingTrans" runat="server" Title="Create Outgoing Transmittal"
              ...
              <telerik:RadWindow ID="ReviseDoc" runat="server" Title="Documents"
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            ...
            function refreshGrid() {
                var masterTable = $find("<%=grdChangeRequest.ClientID%>").get_masterTableView();
                masterTable.rebind();
            }
            function ShowRefDocNo(id) {
                var owd = $find("<%=ReviseDoc.ClientID %>");
                owd.Show();
                owd.maximize();
                owd.setUrl("Controls/Document/TransmittalDocumentList.aspx?RefDocNo=" + id, "ContractorAttachDocFile");
            }
            ...
            function ShowAddNew(refChangeRequest) {
                ...
                owd.setSize(730, document.documentElement.offsetHeight);
                owd.Show();
                owd.setUrl("Controls/Document/ChangeRequestEditForm.aspx?projectId=" + projectId + "&ref=" + refChangeRequest, "CustomerDialog");
            }
        ...
        <script type="text/javascript">
            ...
            function ShowAllAttachFile(objId) {
                ...
                owd.setSize(800, document.documentElement.offsetHeight);
                owd.Show();
                owd.setUrl("Controls/Document/ChangeRequestAllAttachFile.aspx?objId=" + objId, "ETRMAttachFile");
            }
            ...
            function AttachWorkflow(objId) {
                var owd = $find("<%=AttachWorkflow.ClientID %>");
                 ...
                 owd.Show();
                 owd.setUrl("../../Controls/Workflow/AttachWorkflow.aspx?objId=" + objId + "&projId=" + projId + "&type=2", "AttachWorkflow");
            }
            ...
            function SendTrans(objId) {
                if (confirm("Do you want to send this Change Request to PECC2?") === false) return;
            ...
            function radMenuOutgoing_OnClientButtonClicking(sender, args) {
                ...
                if (strText === "Change Request") {
                    var projectId = document.getElementById("<%= lblProjectId.ClientID %>").value;
                    var owd = $find("<%=CustomerDialog.ClientID %>");
                    owd.setSize(730, document.documentElement.offsetHeight);
                    owd.Show();
                    owd.setUrl("Controls/Document/ChangeRequestEditForm.aspx?projectId=" + projectId, "CustomerDialog");
                }
            }
