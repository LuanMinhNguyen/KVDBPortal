                    ...
                    <div>
                        ...
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                            <asp:DropDownList ID="ddlType" runat="server" CssClass="min25Percent qlcbFormRequired" Width="315px">
                                <Items>
                                    <asp:ListItem Value="1" Text="Design"></asp:ListItem>
                                    <asp:ListItem Value="2" Text="Review"></asp:ListItem>
                                    <asp:ListItem Value="3" Text="International Certification"></asp:ListItem>
                                </Items>
                            </asp:DropDownList>
                        </div>
                    </div>
