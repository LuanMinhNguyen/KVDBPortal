...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CommentResponseForm.aspx.cs" Inherits="EDMs.Web.Controls.Document.CommentResponseForm" %>
        ...
        <div style="width: 100%" runat="server" ID="EditContent">
            <ul style="list-style-type: none">
                <li style="width: 650px;">
                    <div>
                        <label style="width: 125px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
                            <span style="color: #2E5689; text-align: right; ">SPMB send date
                            </span>
                        </label>
                ...
                <li style="width: 650px;">
                    <div>
                        <label style="width: 125px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
                            <span style="color: #2E5689; text-align: right; ">SPMB send Trans No.
                            </span>
                        </label>
                    ...
                    <div>
                        <label style="width: 125px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
                            <span style="color: #2E5689; text-align: right; ">
                                <asp:Label runat="server" ID="lblPlanResCom"></asp:Label>
                            </span>
                        </label>
                ...
                <li style="width: 650px;">
                    <div>
                        <label style="width: 125px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
                            <span style="color: #2E5689; text-align: right; ">
                                <asp:Label runat="server" ID="lblActualResCom"></asp:Label>
                            </span>
                        </label>
                ...
                <li style="width: 500px;" runat="server" ID="divCode">
                    <div>
                        <label style="width: 125px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
                ...
                <li style="width: 650px;"  runat="server" ID="divCMS">
                    <div>
                        <label style="width: 125px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
                ...
                <li style="width: 500px;display: none">
                    <div>
                        ...
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                            <telerik:radnumerictextbox type="Percent" id="txtPlannextMonth" runat="server" Style=" min-width: 0px !important; border-color: #8E8E8E #B8B8B8 #B8B8B8 #46A3D3;" Width="70px" CssClass="min25Percent" MaxValue="100">
        ...
        <telerik:RadGrid ID="grdDocument" runat="server" AllowPaging="True"
            ...
            <MasterTableView ClientDataKeyNames="ID" DataKeyNames="ID" Width="100%">
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="SendDate" HeaderText="SPMB Send Date" UniqueName="SendDate"
                        DataFormatString="{0:dd/MM/yyyy}" >
                        <HeaderStyle HorizontalAlign="Center" Width="11%" />
                        <ItemStyle HorizontalAlign="Left" />
                    </telerik:GridBoundColumn>
                    
                    <telerik:GridBoundColumn DataField="SendTransNumber" HeaderText="SPMB Send Trans No." UniqueName="SendTransNumber" >
                        <HeaderStyle HorizontalAlign="Center" Width="11%" />
                        <ItemStyle HorizontalAlign="Left" />
                    </telerik:GridBoundColumn>
                    ...
                    <telerik:GridBoundColumn DataField="ActualReceiveDate" HeaderText="Actual Comment" UniqueName="ActualReceiveDate" DataFormatString="{0:dd/MM/yyyy}">
                        <HeaderStyle HorizontalAlign="Center" Width="11%" />
                        <ItemStyle HorizontalAlign="Left" />
                    </telerik:GridBoundColumn>
                    
                    <telerik:GridBoundColumn DataField="ReceiveCodeName" HeaderText="Code" UniqueName="ReceiveCodeName" >
                        <HeaderStyle HorizontalAlign="Center" Width="11%" />
                        <ItemStyle HorizontalAlign="Left" />
                    </telerik:GridBoundColumn>
                    
                    <telerik:GridBoundColumn DataField="CommentSheetNumber" HeaderText="CMS" UniqueName="CommentSheetNumber" >
                        <HeaderStyle HorizontalAlign="Center" Width="11%" />
                        <ItemStyle HorizontalAlign="Left" />
                    </telerik:GridBoundColumn>
                    
                    <telerik:GridBoundColumn DataField="ReceiveTransNumber" HeaderText="Trans No." UniqueName="ReceiveTransNumber" >
                        <HeaderStyle HorizontalAlign="Center" Width="11%" />
                        <ItemStyle HorizontalAlign="Left" />
                    </telerik:GridBoundColumn>
                </Columns>
