<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ImportEMDR.aspx.cs" Inherits="EDMs.Web.Controls.Document.ImportEMDR" %>
            ...
            <ul style="list-style-type: none">
                ...
                <li style="width: 400px;">
                    <div>
                        ...
                        <div style="float: left; padding-top: 5px; " class="qlcbFormItem">
                            <asp:CheckBox ID="cbCheckValidFile" runat="server" Checked="true" Text="Check EMDR report is valid?"/>
                        </div>
                    </div>
                    <div style="clear: both; font-size: 0;"></div>
                </li>
