<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DocListByTag.aspx.cs" Inherits="EDMs.Web.Controls.Document.DocListByTag" %>
            ...
            <telerik:RadGrid ID="grdDocument" runat="server" AllowPaging="True"
                ...
                <MasterTableView ClientDataKeyNames="ID" DataKeyNames="ID" Width="100%" EditMode="InPlace" Font-Size="8pt">
                    ...
                    <Columns>
                        ...
                        <telerik:GridButtonColumn UniqueName="DeleteColumn" CommandName="Delete"  HeaderTooltip="Delete document" Visible="False"
                        ...
                        <telerik:GridBoundColumn DataField="TagTypeName" HeaderText="Tags" UniqueName="Index11">
                            <HeaderStyle HorizontalAlign="Center" Width="8%" />
                            <ItemStyle HorizontalAlign="Left" Width="8%" />
                        </telerik:GridBoundColumn>
