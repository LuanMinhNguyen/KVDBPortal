        ...
        <Items>
            <telerik:RadPanelItem Text="TRANSMITTAL" runat="server" Expanded="True" Width="100%">
                <Items>
                    ...
                    <telerik:RadPanelItem runat="server" Text="Transmittals" ImageUrl="~/Images/out.png" NavigateUrl="~/Controls/Document/TransmittalList.aspx" Selected="True" />
                </Items>
            </telerik:RadPanelItem>
        </Items>
    </telerik:RadPanelBar>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
                            ...
                            <telerik:RadGrid ID="grdDocument" runat="server" AllowPaging="True"
                                    ...
                                    <MasterTableView ClientDataKeyNames="ID" DataKeyNames="ID" Width="100%" TableLayout="Auto" CssClass="rgMasterTable">
                                        ...
                                        <Columns>
                                            ...
                                            <telerik:GridBoundColumn DataField="TransmittalNumber" HeaderText="Record No." UniqueName="TransmittalNumber"
    ...
    <telerik:RadContextMenu ID="radMenu" runat="server"
        ...
        <Items>
            ...
            <telerik:RadMenuItem Text="Import transmittal file" ImageUrl="~/Images/import.png" Value="ImportTransFile"/>
        </Items>
    ...
    <telerik:RadWindowManager ID="RadWindowManager1" runat="server" EnableShadow="true" >
        <Windows>
            ...
            <telerik:RadWindow ID="ImportData" runat="server" Title="Import transmittal file"
                VisibleStatusbar="false" Height="100" Width="420" OnClientClose="refreshGrid"
                Left="150px" ReloadOnShow="true" ShowContentDuringLoad="false" Modal="true">
            </telerik:RadWindow>
        </Windows>
                ...
                switch (itemValue) {
                    ...
                    case "ImportTransFile":
                        var owd = $find("<%=ImportData.ClientID %>");
                            owd.Show();
                            owd.setUrl("ImportData.aspx?tranId=" + tranId, "ImportData");
                            break;
                }
            }
