<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DisciplineIdentifier.aspx.cs" Inherits="EDMs.Web.Controls.Library.DisciplineIdentifier" EnableViewState="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <style type="text/css">
     ...
     <telerik:RadPanelBar ID="RadPanelBar1" runat="server" Width="100%">
        <Items>
            <telerik:RadPanelItem Text="SCOPE OF WORK" runat="server" Expanded="True" Width="100%">
                <Items>
                    ...
                    <telerik:RadPanelItem runat="server" Text="Contractors" ImageUrl="~/Images/contractor.png" NavigateUrl="~/Controls/Scope/ContractorList.aspx" />
                    <telerik:RadPanelItem runat="server" Text="Document Status" ImageUrl="~/Images/status1.png" NavigateUrl="~/Controls/Scope/DocumentStatusList.aspx"/>
                    <telerik:RadPanelItem runat="server" Text="Document Code" ImageUrl="~/Images/code.png" NavigateUrl="~/Controls/Scope/DocumentCodeList.aspx"/>
                    <telerik:RadPanelItem runat="server" Text="Discipline" ImageUrl="~/Images/discipline.png" NavigateUrl="~/Controls/Library/DisciplineIdentifier.aspx" Selected="True"/>
                    <telerik:RadPanelItem runat="server" Text="Document Type" ImageUrl="~/Images/type1.png" NavigateUrl="~/Controls/Library/DocumentTypeList.aspx"/>
                    <telerik:RadPanelItem runat="server" Text="Document Revision" ImageUrl="~/Images/revision.png" NavigateUrl="~/Controls/Library/RevisionList.aspx"/>
                </Items>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
            ...
            <telerik:RadToolBar ID="CustomerMenu" runat="server" Width="100%" OnClientButtonClicking="OnClientButtonClicking">
                <Items>
                    <telerik:RadToolBarDropDown runat="server" Text="New" ImageUrl="~/Images/addNew.png">
                        <Buttons>
                            <telerik:RadToolBarButton runat="server" Text="Discipline" Value="1" ImageUrl="~/Images/discipline.png"/>
                        </Buttons>
                                ...
                                <telerik:RadGrid ID="grdDocument" runat="server" AllowPaging="True"
                                    ...
                                    <MasterTableView ClientDataKeyNames="ID" DataKeyNames="ID" Width="100%" TableLayout="Auto" CssClass="rgMasterTable">
                                        ...
                                        <Columns>
                                            ...
                                            <telerik:GridButtonColumn CommandName="Delete" ConfirmText="Do you want to delete Discipline?" ButtonType="ImageButton" ImageUrl="~/Images/delete.png">
                                                <HeaderStyle Width="3%" />
                                                 <ItemStyle HorizontalAlign="Center" Width="3%"  />
                                        ...
                                        <ItemTemplate>
                                            <%# Eval("Weight") != null ? Eval("Weight") + "%" : string.Empty%>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                            ...
                                            <telerik:GridTemplateColumn HeaderText="Auto Calculate" UniqueName="IsAuto" AllowFiltering="false">
                                        <HeaderStyle HorizontalAlign="Center" Width="10%" />
                                        <ItemStyle HorizontalAlign="Center"  />
                                        <ItemTemplate>
                                            <asp:Image ID="imgIsAuto" runat="server" ImageUrl="~/Images/ok.png" Visible='<%# Eval("IsAutoCalculate")%>'/>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                        </Columns>
                                    </MasterTableView>
    ...
    <telerik:RadWindowManager ID="RadWindowManager1" runat="server" EnableShadow="true" >
        <Windows>
            <telerik:RadWindow ID="CustomerDialog" runat="server" Title="Discipline Information"
                VisibleStatusbar="false" Height="400" Width="610" 
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            ...
            function ShowEditForm(id) {
                ...
                owd.Show();
                owd.setUrl("DisciplineEditForm.aspx?disId=" + id, "CustomerDialog");
            }
            ...
            function OnClientButtonClicking(sender, args) {
                ...
                if (strText.toLowerCase() == "discipline") {
                    var owd = $find("<%=CustomerDialog.ClientID %>");
                    owd.Show();
                    owd.setUrl("DisciplineEditForm.aspx", "CustomerDialog");
