<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DocumentTypeList.aspx.cs" Inherits="EDMs.Web.Controls.Library.DocumentTypeList" EnableViewState="true" %>
        ...
        <Items>
            <telerik:RadPanelItem Text="SCOPE OF WORK" runat="server" Expanded="True" Width="100%">
                <Items>
                    ...
                    <telerik:RadPanelItem runat="server" Text="Document Type" ImageUrl="~/Images/type1.png" NavigateUrl="~/Controls/Library/DocumentTypeList.aspx" Selected="True"/>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
            ...
            <telerik:RadToolBar ID="CustomerMenu" runat="server" Width="100%" OnClientButtonClicking="OnClientButtonClicking">
                <Items>
                    <telerik:RadToolBarDropDown runat="server" Text="New" ImageUrl="~/Images/addNew.png">
                        <Buttons>
                            <telerik:RadToolBarButton runat="server" Text="Document type" Value="1" ImageUrl="~/Images/discipline.png"/>
                        </Buttons>
                                ...
                                <telerik:RadGrid ID="grdDocument" runat="server" AllowPaging="True"
                                    ...
                                    <MasterTableView ClientDataKeyNames="ID" DataKeyNames="ID" Width="100%" TableLayout="Auto" CssClass="rgMasterTable">
                                        ...
                                        <Columns>
                                            ...
                                            <telerik:GridButtonColumn CommandName="Delete" ConfirmText="Do you want to delete Document type?" ButtonType="ImageButton" ImageUrl="~/Images/delete.png">
                                                <HeaderStyle Width="3%" />
                                                 <ItemStyle HorizontalAlign="Center" Width="3%"/>
    ...
    <telerik:RadWindowManager ID="RadWindowManager1" runat="server" EnableShadow="true" >
        <Windows>
            <telerik:RadWindow ID="CustomerDialog" runat="server" Title="Document type Information"
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            ...
            function ShowEditForm(id) {
                ...
                owd.Show();
                owd.setUrl("DocumentTypeEditForm.aspx?doctypeId=" + id, "CustomerDialog");
            }
            ...
            function OnClientButtonClicking(sender, args) {
                ...
                if (strText.toLowerCase() == "document type") {
                    var owd = $find("<%=CustomerDialog.ClientID %>");
                    owd.Show();
                    owd.setUrl("DocumentTypeEditForm.aspx", "CustomerDialog");
