<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RevisionList.aspx.cs" Inherits="EDMs.Web.Controls.Library.RevisionList" EnableViewState="true" %>
        ...
        <Items>
            <telerik:RadPanelItem Text="SCOPE OF WORK" runat="server" Expanded="True" Width="100%">
                <Items>
                    ...
                    <telerik:RadPanelItem runat="server" Text="Document Revision" ImageUrl="~/Images/revision.png" NavigateUrl="~/Controls/Library/RevisionList.aspx" Selected="True"/>
                </Items>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
            ...
            <telerik:RadToolBar ID="CustomerMenu" runat="server" Width="100%" OnClientButtonClicking="OnClientButtonClicking">
                <Items>
                    <telerik:RadToolBarDropDown runat="server" Text="New" ImageUrl="~/Images/addNew.png">
                        <Buttons>
                            <telerik:RadToolBarButton runat="server" Text="Revision" Value="1" ImageUrl="~/Images/revision.png"/>
                        </Buttons>
    ...
    <telerik:RadWindowManager ID="RadWindowManager1" runat="server" EnableShadow="true" >
        <Windows>
            <telerik:RadWindow ID="CustomerDialog" runat="server" Title="Revision Information"
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            ...
            function ShowEditForm(id) {
                ...
                owd.Show();
                owd.setUrl("RevisionEditForm.aspx?doctypeId=" + id, "CustomerDialog");
            }
            ...
            function OnClientButtonClicking(sender, args) {
                ...
                if (strText.toLowerCase() == "revision") {
                    var owd = $find("<%=CustomerDialog.ClientID %>");
                    owd.Show();
                    owd.setUrl("RevisionEditForm.aspx", "CustomerDialog");
