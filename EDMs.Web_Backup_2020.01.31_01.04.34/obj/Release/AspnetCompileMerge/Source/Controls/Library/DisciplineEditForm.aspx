<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DisciplineEditForm.aspx.cs" Inherits="EDMs.Web.Controls.Library.DisciplineEditForm" %>
            ...
            <ul style="list-style-type: none">
                ...
                <li style="width: 500px;">
                    <div>
                        ...
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem" runat="server" id="div1">
                            <asp:DropDownList ID="ddlProject" runat="server" CssClass="min25Percent qlcbFormRequired" Width="316px" style="max-width: 316px"/>
                        </div>
                    </div>
                    <div style="clear: both; font-size: 0;"></div>
                </li>
                ...
                <li style="width: 500px;">
                    <div>
                        ...
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                            <telerik:radnumerictextbox type="Percent" id="txtWeight" runat="server" Style=" min-width: 0px !important; border-color: #8E8E8E #B8B8B8 #B8B8B8 #46A3D3;" Width="80px" CssClass="min25Percent qlcbFormRequired">
                ...
                <li style="width: 500px;">
                    <div>
                        ...
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                            <asp:CheckBox runat="server" ID="cbIsAutoCalculate" Text="Auto calculate compelte percent."/>
                        </div>
                    </div>
                    <div style="clear: both; font-size: 0;"></div>
                </li>
