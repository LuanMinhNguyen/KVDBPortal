<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoleEditForm.aspx.cs" Inherits="EDMs.Web.RoleEditForm" %>
                ...
                <li style="width: 500px;">
                    <div>
                        ...
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem" runat="server" id="div2">
                            <asp:RadioButton ID="rbtnAdmin" runat="server" Text="Admin" GroupName="RolePermission"/>
                            <asp:RadioButton ID="rbtnUpdate" runat="server" Text="Update" GroupName="RolePermission"/>
                            <asp:RadioButton ID="rbtnView" runat="server" Text="View only" GroupName="RolePermission" Checked="True"/>
                        </div>
                    </div>
                    <div style="clear: both; font-size: 0;"></div>
                </li>
