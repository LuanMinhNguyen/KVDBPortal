<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UserListControl.ascx.cs" Inherits="EDMs.Web.UserListControl" %>
...
<telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
    <script type="text/javascript">
        ...
        function ShowUserEditForm(id, userId, rowIndex) {
            var oWindow = window.radopen("Controls/System/UserEditForm.aspx?Id=" + id + "&userId=" + userId, "UserDialog");
        ...
        function ShowUserInsertForm() {
            var oWindow = window.radopen("Controls/System/UserEditForm.aspx", "UserDialog");
            oWindow.setSize(500, 360);
            oWindow.SetTitle("User Information");
            oWindow.set_visibleStatusbar(false);
            return false;
