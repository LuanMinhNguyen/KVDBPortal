<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" 
    CodeBehind="GroupsList.aspx.cs" Inherits="EDMs.Web.GroupsList" EnableViewState="true" %>
        ...
        <Items>
            <telerik:RadPanelItem Text="SCOPE OF WORK" runat="server" Expanded="True" Width="100%">
                <Items>
                    ...
                    <telerik:RadPanelItem runat="server" Text="Discipline" ImageUrl="~/Images/discipline.png" NavigateUrl="~/Controls/Library/DisciplineIdentifier.aspx"/>
                         ...
                         <telerik:RadPane ID="Radpane6" runat="server" Scrolling="None">
                                ...
                                <MasterTableView DataKeyNames="Id" ClientDataKeyNames="Id" Width="100%" >
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridBoundColumn DataField="Categories" HeaderText="Category" UniqueName="colCategories" Display="False" >
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="Role admin" UniqueName="RoleAdmin">
                                                <HeaderStyle Width="10%" HorizontalAlign="Center"></HeaderStyle>
                                            <ItemStyle Width="10%" HorizontalAlign="Center"></ItemStyle>
                                            <ItemTemplate>
                                                <asp:Image ID="Image1" runat="server" ImageUrl='<%# Convert.ToBoolean(DataBinder.Eval(Container.DataItem, "IsAdmin")) ? "~/Images/ok.png" : "" %>'/>
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
            
                                        <telerik:GridTemplateColumn HeaderText="Role update" UniqueName="RoleUpdate">
                                                <HeaderStyle Width="10%" HorizontalAlign="Center"></HeaderStyle>
                                            <ItemStyle Width="10%" HorizontalAlign="Center"></ItemStyle>
                                            <ItemTemplate>
                                                <asp:Image ID="Image2" runat="server" ImageUrl='<%# Convert.ToBoolean(DataBinder.Eval(Container.DataItem, "IsUpdate")) ? "~/Images/ok.png" : "" %>'/>
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
            
                                        <telerik:GridTemplateColumn HeaderText="Role view" UniqueName="RoleView">
                                                <HeaderStyle Width="10%" HorizontalAlign="Center"></HeaderStyle>
                                            <ItemStyle Width="10%" HorizontalAlign="Center"></ItemStyle>
                                            <ItemTemplate>
                                                <asp:Image ID="Image3" runat="server" ImageUrl='<%# !Convert.ToBoolean(DataBinder.Eval(Container.DataItem, "IsAdmin")) && !Convert.ToBoolean(DataBinder.Eval(Container.DataItem, "IsUpdate")) ? "~/Images/ok.png" : "" %>'/>
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
                                    </Columns>
