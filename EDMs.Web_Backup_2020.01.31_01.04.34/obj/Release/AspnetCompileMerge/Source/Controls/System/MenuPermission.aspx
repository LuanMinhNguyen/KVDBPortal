<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" 
    CodeBehind="MenuPermission.aspx.cs" Inherits="EDMs.Web.MenuPermission" EnableViewState="true" %>
            ...
            <telerik:RadSplitter ID="Radsplitter3" runat="server" Orientation="Horizontal">
                <telerik:RadPane ID="Radpane4" runat="server" Scrolling="None" >
                     <telerik:RadSplitter ID="Radsplitter10" runat="server" Orientation="Vertical" Width="">
                         <telerik:RadPane ID="Radpane6" runat="server" Scrolling="Both" Width="360">
                                <telerik:RadPanelBar ID="radPbGroup" runat="server" OnItemClick="radPbGroup_ItemClick" Width="360" style="min-width: 360px" />
                        </telerik:RadPane>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            ...
            function ShowUserEditForm(id, userId) {
                ...
                owd.Show();
                owd.setUrl("Controls/System/UserEditForm.aspx?Id=" + id + "&userId=" + userId, "CustomerDialog");
            }
