...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
                                ...
                                <MasterTableView AllowMultiColumnSorting="false"
                                    ...
                                    <GroupByExpressions>
                                            <telerik:GridGroupByExpression>
                                                <SelectFields>
                                                    <telerik:GridGroupByField FieldAlias="-" FieldName="DisciplineName" FormatString="{0:D}"
                                                        HeaderValueSeparator=""></telerik:GridGroupByField>
                                                </SelectFields>
                                                <GroupByFields>
                                                    <telerik:GridGroupByField FieldName="DisciplineName" SortOrder="Ascending" ></telerik:GridGroupByField>
                                                </GroupByFields>
                                            </telerik:GridGroupByExpression>
                                        </GroupByExpressions>    
    ...
    <telerik:RadWindowManager ID="RadWindowManager1" runat="server" EnableShadow="true" >
        <Windows>
            ...
            <telerik:RadWindow ID="CommentResponse" runat="server" 
                VisibleStatusbar="false" Height="650" Width="750" 
                Left="150px" ReloadOnShow="true" ShowContentDuringLoad="false" Modal="true">
            </telerik:RadWindow>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            ...
            function gridMenuClicking(sender, args) {
                ...
                if (itemValue.indexOf("CommentResponse") > -1)
                {
                    var contractorId = itemValue.split("_")[1];
                    var owd = $find("<%=CommentResponse.ClientID %>");
                    owd.Show();
                    owd.setUrl("Controls/Document/CommentResponseForm.aspx?docId=" + docId + "&contId=" + contractorId, "CommentResponse");
                ...
                } else
                {
                    ...
                    case "EditProperties":
                        ...
                        owd.Show();
                        owd.setUrl("Controls/Document/DocumentPackageInfoEditForm.aspx?docId=" + docId + "&wgId=" + packageId, "CustomerDialog");
                        break;
                    case "Transmittals":
