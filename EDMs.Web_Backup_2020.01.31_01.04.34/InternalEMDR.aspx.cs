...
namespace EDMs.Web
{
    ...
    /// Class customer
    /// </summary>
    public partial class InternalEMDR : Page
    {
        ...
        protected void LoadDocuments(bool isbind = false, bool isListAll = false)
        {
            ...
            else
            {
                var listDisciplineInPermission = UserSession.Current.User.Id == 1
                       ? this.disciplineService.GetAllDisciplineOfProject(Convert.ToInt32(this.ddlProject.SelectedValue)).OrderBy(t => t.ID).ToList()
                ...
                var listDisciplineId = listDisciplineInPermission.Select(t => t.ID).ToList();

                docList = this.documentPackageService.GetAllByDisciplineInPermission(listDisciplineId, cbShowAll.Checked)
                    .OrderBy(t => t.DocNo)
                        .ToList();
            ...
            this.grdDocument.DataSource = docList.Where(t => t.IsInternalDocument.GetValueOrDefault());
        }
        ...
        protected void RadAjaxManager1_AjaxRequest(object sender, AjaxRequestEventArgs e)
        {
            ...
            else if (e.Argument == "ExportMasterList")
            {
                ...
                if (listDisciplineInPermission.Count > 0)
                {
                    ...
                    workbook.Open(filePath + @"Template\MasterListTemplate_New.xlsm");
                    ...
                    for (int i = 0; i < listDisciplineInPermission.Count; i++)
                    {
                        ...
                        this.CreateValidation(rangeRevisionList.Name, validations, 2, 3000, 10, 10);
                    }
