<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CSList.aspx.cs" Inherits="EDMs.Web.CSList" EnableViewState="true" %>
            ...
            <telerik:RadToolBar ID="CustomerMenu" runat="server" Width="100%" OnClientButtonClicking="OnClientButtonClicking">
                <Items>
                    <telerik:RadToolBarDropDown runat="server" Text="Add" ImageUrl="~/Images/addNew.png">
                        <Buttons>
                            <telerik:RadToolBarButton runat="server" Text="Communication Sheet" Value="1" ImageUrl="~/Images/index.png"></telerik:RadToolBarButton>
                            ...
                            <telerik:RadGrid AllowCustomPaging="False" AllowPaging="True" AllowSorting="True" 
                                ...
                                <MasterTableView AllowMultiColumnSorting="false"
                                  ...
                                  <%--  <GroupByExpressions>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Number" UniqueName="Number" DataField="Number"
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            ...
            function ShowEditForm(objId) {
                ...
                window.Show();
                window.setUrl("Controls/Document/NCRSIEditForm.aspx?projectId=" + projectId + "&objId=" + objId +"&type=3", "CustomerDialog");
            ...
            function OnClientButtonClicking(sender, args) {
                ...
                if (strText === "Communication Sheet") {
                    var projectId = document.getElementById("<%= lblProjectId.ClientID %>").value;
                    var window = $find("<%=CustomerDialog.ClientID %>");
                    //alert(projectId);
                    window.setSize(730, document.documentElement.offsetHeight);
                    window.Show();
                    window.setUrl("Controls/Document/NCRSIEditForm.aspx?projectId=" + projectId + "&type=3", "CustomerDialog");
