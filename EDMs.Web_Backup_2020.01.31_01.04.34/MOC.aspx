<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MOC.aspx.cs" Inherits="EDMs.Web.MOC" EnableViewState="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
            ...
            <telerik:RadToolBar ID="CustomerMenu" runat="server" Width="100%" OnClientButtonClicking="OnClientButtonClicking">
                <Items>
                    <telerik:RadToolBarDropDown runat="server" Text="Add" ImageUrl="~/Images/addNew.png">
                        <Buttons>
                            <telerik:RadToolBarButton runat="server" Text="MOC" Value="1" ImageUrl="~/Images/moc.png"></telerik:RadToolBarButton>
                        ...
                        <ItemTemplate>
                            ...
                            <asp:DropDownList ID="ddlStatus" runat="server" CssClass="rcbReadOnly" Width="230px" style="max-width: 316px"
                                ...
                                <Items>
                                    ...
                                    <asp:ListItem Value="7" Text="MOC complete Workflow Process" style="background-color: greenyellow"></asp:ListItem>
    ...
    <telerik:RadWindowManager ID="RadWindowManager1" runat="server" EnableShadow="true" >
        <Windows>
            ...
            <telerik:RadWindow ID="AttachWorkflow" runat="server" Title="Attach MOC to Workflow"
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
            ...
            function gridMenuClicking(sender, args) {
                ...
                else
                {
                    ...
                    case "MRDetail":
                        ...
                        owd.Show();
                        owd.setUrl("Controls/WMS/TrackingMOCDetail.aspx?objId=" + docId, "MOCDetailDialog");
                        break;
                        case "AttachWF":
                        var projId = document.getElementById("<%= lblProjectId.ClientID %>").value;
                        var owd = $find("<%=AttachWorkflow.ClientID %>");
                        owd.Show();
                        owd.setUrl("Controls/Workflow/AttachWorkflow.aspx?objId=" + docId + "&objType=MOC" + "&projId=" + projId, "AttachWorkflow");
                        break;
                    case "WFHistory":
                        var owd = $find("<%=WFProcessHistory.ClientID %>");
                        owd.Show();
                        owd.maximize();
                        owd.setUrl("Controls/Workflow/WorkflowProcessHistory.aspx?objId=" + docId + "&objType=MOC", "WFProcessHistory");
                        break;
                    case "AttachDocument":
                        ...
                        owd.setUrl("Controls/WMS/TrackingMOCAttach.aspx?objId=" + docId, "AttachDoc");
                        break;
                    case "CMS":
                        ...
                        case "EditProperties":
                            ...
                            owd.setSize(850, document.documentElement.offsetHeight);
                            owd.Show();
                            owd.setUrl("Controls/WMS/TrackingMOCEditForm.aspx?objId=" + docId + "&projId=" + projectId, "CustomerDialog");
                        break;
                    case "Transmittals":
        ...
        <script type="text/javascript">
            ...
            function ShowEditForm(docId, projId) {
                ...
                owd.setSize(850, document.documentElement.offsetHeight);
                owd.Show();
                owd.setUrl("Controls/WMS/TrackingMOCEditForm.aspx?projId=" + projId + "&objId=" + docId, "CustomerDialog");
            }
            ...
            function OnClientButtonClicking(sender, args) {
                ...
                if (strText == "MOC") {
                    ...
                    owd.setSize(850, document.documentElement.offsetHeight);
                    owd.Show();
                    owd.setUrl("Controls/WMS/TrackingMOCEditForm.aspx?projId=" + projectId, "CustomerDialog");
                    //}
                }
