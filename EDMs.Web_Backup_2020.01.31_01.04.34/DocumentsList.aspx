<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DocumentsList.aspx.cs" Inherits="EDMs.Web.DocumentsList" EnableViewState="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="width: 98%; padding-top: 10px; padding-left: 5px">
        <%--<asp:Image ID="Image1" runat="server" ImageUrl="Images/project.png" /> Selected Plant:<br />
        
        <telerik:RadComboBox ID="ddlPlant" runat="server" 
            Skin="Windows7" Width="100%" AutoPostBack="True" 
            OnItemDataBound="ddlPlant_ItemDataBound"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
                            ...
                            <telerik:RadGrid  ID="grdDocument" runat="server" AllowPaging="True"
                                ...
                                <MasterTableView AllowMultiColumnSorting="false"
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridTemplateColumn AllowFiltering="False" UniqueName="EditColumn">
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <asp:Image ID="EditLink" runat="server" ImageUrl="~/Images/edit.png" Style="cursor: pointer;" AlternateText="Edit properties"  ToolTip="Edit properties"/>
                                                        <a/>
                                                </ItemTemplate>
                                            </telerik:GridTemplateColumn>
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:Image ID="DocList" runat="server" ImageUrl="~/Images/revision.png" Style="cursor: pointer;" AlternateText="Revision Detail Of Master" ToolTip="Revision Detail Of Master"/>
                                               <a/>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                    <telerik:GridButtonColumn UniqueName="DeleteColumn" CommandName="Delete" HeaderTooltip="Delete document"
                                       ...
                                       <telerik:GridTemplateColumn HeaderText="System Number" UniqueName="System"
                                        DataField="SystemDocumentNo" ShowFilterIcon="True" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        <HeaderStyle HorizontalAlign="Center" Width="110" />
                                        <ItemStyle HorizontalAlign="Left" Width="110" />
                                        <ItemTemplate>
                                            <asp:Label ID="lblM_SystemDocumentNo" runat="server" Text='<%# Eval("SystemDocumentNo") %>' style="cursor: pointer"/> 
                                            
                                        </ItemTemplate></telerik:GridTemplateColumn>
     
                                    <telerik:GridTemplateColumn HeaderText="Title" DataField="Title" UniqueName="Title"
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Equipment Tag" UniqueName="EquipmentTagName" DataField="EquipmentTagName"
                                        ShowFilterIcon="TRue" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        <HeaderStyle HorizontalAlign="Center" Width="80" />
                                        <ItemStyle HorizontalAlign="Left" Width="80" />
                                        <ItemTemplate>
                                            <%# Eval("EquipmentTagName") %>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                    <telerik:GridTemplateColumn HeaderText="Document Sequence" UniqueName="DocumentSequenceNo" DataField="DocumentSequenceNo"
                                        ShowFilterIcon="False" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        <HeaderStyle HorizontalAlign="Center" Width="80" />
                                        <ItemStyle HorizontalAlign="Left" Width="80" />
                                        <ItemTemplate>
                                            <%# Eval("DocumentSequenceNo") %>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                      <telerik:GridTemplateColumn HeaderText="Sheet.No" UniqueName="SheetNo"
                                        ShowFilterIcon="False" FilterControlWidth="97%"  DataField="SheetNo"
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        <HeaderStyle HorizontalAlign="Center" Width="80" />
                                        <ItemStyle HorizontalAlign="Left" Width="80" />
                                        <ItemTemplate>
                                     ...
                                     <telerik:GridTemplateColumn HeaderText="Department Code" UniqueName="DepartmentCode" DataField="DepartmentCode"
                                        ShowFilterIcon="False" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        <HeaderStyle HorizontalAlign="Center" Width="80" />
                                        ...
                                        <ItemTemplate>
                                         ...
                                         <telerik:GridTemplateColumn HeaderText="Plant" UniqueName="PlantName"
                                        ShowFilterIcon="False" FilterControlWidth="97%"  DataField="PlantName"
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        <HeaderStyle HorizontalAlign="Center" Width="80" />
                                        <ItemStyle HorizontalAlign="Center"  />
                                        <ItemTemplate>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Area" UniqueName="AreaName"
                                        ShowFilterIcon="False" FilterControlWidth="97%"  DataField="AreaName"
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        <HeaderStyle HorizontalAlign="Center" Width="80" />
                                        <ItemStyle HorizontalAlign="Center"  />
                                        <ItemTemplate>
                                         ...
                                         <telerik:GridTemplateColumn HeaderText="Unit" UniqueName="UnitName"
                                        ShowFilterIcon="False" FilterControlWidth="97%"  DataField="UnitName"
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        <HeaderStyle HorizontalAlign="Center" Width="80" />
                                        <ItemStyle HorizontalAlign="Center"  />
                                        <ItemTemplate>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Document Type" UniqueName="DocumentType" DataField="DocumentTypeName"
                                        ShowFilterIcon="False" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Originator" UniqueName="OriginatorName" DataField="OriginatorName"
                                        ShowFilterIcon="False" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        ...
                                        <ItemTemplate>
                                          ...
                                          <telerik:GridTemplateColumn HeaderText="Material Code" UniqueName="MaterialCodeName" DataField="MaterialCodeName"
                                        ShowFilterIcon="False" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        <HeaderStyle HorizontalAlign="Center" Width="80" />
                                        <ItemStyle HorizontalAlign="Left" Width="120" />
                                        <ItemTemplate>
                                            <%# Eval("MaterialCodeName") %>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                          <telerik:GridTemplateColumn HeaderText="Work Code" UniqueName="WorkCodeName" DataField="WorkCodeName"
                                        ShowFilterIcon="False" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        <HeaderStyle HorizontalAlign="Center" Width="120" />
                                        <ItemStyle HorizontalAlign="Left" Width="120" />
                                        <ItemTemplate>
                                         ...
                                         <telerik:GridTemplateColumn HeaderText="Drawing Code" UniqueName="DrawingCodeName" DataField="DrawingCodeName"
                                        ShowFilterIcon="False" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        <HeaderStyle HorizontalAlign="Center" Width="120" />
                                        <ItemStyle HorizontalAlign="Left" Width="120" />
                                        <ItemTemplate>
                                            <%# Eval("DrawingCodeName") %>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                             </Columns>   
                            </MasterTableView>
  ...
  <%--  <telerik:RadContextMenu ID="radMenu" runat="server" Visible="false"
    ...
    <telerik:RadWindowManager ID="RadWindowManager1" runat="server" EnableShadow="true" >
        <Windows>
            <telerik:RadWindow ID="CustomerDialog" runat="server" Title="Master Document Information"
            ...
            <telerik:RadWindow ID="SendMail" runat="server" Title="Send mail"
                VisibleStatusbar="false" Height="560" Width="992"
                Left="150px" ReloadOnShow="true" ShowContentDuringLoad="false" Modal="true">
            </telerik:RadWindow>
                ...
                else
                {
                    ...
                    case "CMS":
                        ...
                        case "EditProperties":
                            ...
                            owd.Show();
                            owd.setUrl("Controls/Document/DocumentListInfoEditForm.aspx?docId=" + docId , "CustomerDialog");
                        break;
                    case "Transmittals":
        ...
        <script type="text/javascript">
            ...
            function ShowDocumentRevision(docId) {
               var owd = $find("<%=RevisionDialog.ClientID %>");
                owd.Show();
                owd.maximize(true);
                owd.setUrl("Controls/Document/ProjectDocumentRevisionHistory.aspx?MasterId=" + docId, "RevisionDialog");
            }
            ...
            function OnClientButtonClicking(sender, args) {
                ...
                if (strText.toLowerCase() == "document") {
                    ...
                    owd.setSize(730, document.documentElement.offsetHeight);
                    owd.Show();
                    owd.setUrl("Controls/Document/DocumentListInfoEditForm.aspx?", "CustomerDialog");
                    //}
                }
