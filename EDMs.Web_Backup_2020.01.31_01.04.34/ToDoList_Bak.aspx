<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ToDoList_Bak.aspx.cs" Inherits="EDMs.Web.ToDoList_Bak" EnableViewState="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <telerik:RadSplitter ID="RadSplitter4" runat="server" Orientation="Horizontal">
        <telerik:RadPane ID="RadPane3" runat="server" Height="30px" Scrollable="false" Scrolling="None">
            ...
            <telerik:RadToolBar ID="CustomerMenu" runat="server" Width="100%" OnClientButtonClicking="OnClientButtonClicking">
                <Items>
                    <telerik:RadToolBarDropDown runat="server" Text="Add" ImageUrl="~/Images/addNew.png" Visible="False">
                        <Buttons>
                    ...
                    <telerik:RadToolBarDropDown runat="server" Text="Action" ImageUrl="~/Images/action.png">
                        <Buttons>
                            <telerik:RadToolBarButton runat="server" Text="Complete All Selected Task" Value="3" ImageUrl="~/Images/ok.png"/>
                        </Buttons>
                    </telerik:RadToolBarDropDown>
                    ...
                    <telerik:RadToolBarButton runat="server" Value="ShowAll" >
                        <ItemTemplate>
                            <asp:CheckBox ID="ckbShowAll" runat="server" Text="Show all Task" AutoPostBack="True" OnCheckedChanged="ckbShowAll_CheckedChange"/>
                        </ItemTemplate>
                            ...
                            <telerik:RadGrid AllowCustomPaging="False" AllowPaging="True" AllowSorting="True" 
                                ...
                                <MasterTableView AllowMultiColumnSorting="false"
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridBoundColumn DataField="DocId" UniqueName="DocId" Display="False"/>
                                        ...
                                        <telerik:GridTemplateColumn AllowFiltering="False" UniqueName="AttachColumn">
                                                ...
                                                <ItemTemplate>
                                                    <a href='javascript:ShowAttachForm(<%# DataBinder.Eval(Container.DataItem, "DocId") %>)' style="text-decoration: none; color:blue">
                                                    <asp:Image ID="AttachLink" runat="server" ImageUrl="~/Images/attach.png" Style="cursor: pointer;" AlternateText="Attach Document" />
                                                        <a/>
                                                </ItemTemplate>
                                            </telerik:GridTemplateColumn>
                                        ...
                                        <telerik:GridTemplateColumn AllowFiltering="False" UniqueName="EmailColumn">
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <asp:Image ID="EmailLink" runat="server" ImageUrl="~/Images/email1.png" Style="cursor: pointer;" AlternateText="Attach Document" />
                                                        <a/>
                                                </ItemTemplate>
                                            </telerik:GridTemplateColumn>
                                        
                                        <telerik:GridTemplateColumn AllowFiltering="False" UniqueName="CommentColumn">
                                                <HeaderStyle Width="30"  />
                                                <ItemStyle HorizontalAlign="Center"/>
                                                <ItemTemplate>
                                                    <a href='javascript:ShowCommentForm(<%# DataBinder.Eval(Container.DataItem, "DocId") %>, <%# DataBinder.Eval(Container.DataItem, "ID") %>)' style="text-decoration: none; color:blue">
                                                    <asp:Image ID="CommentLink" runat="server" ImageUrl="~/Images/comment.png" Style="cursor: pointer;" AlternateText="Add Comment" />
                                                        <a/>
                                                </ItemTemplate>
                                            </telerik:GridTemplateColumn>
                                            
                                    <telerik:GridButtonColumn UniqueName="CompleteTaskColumn" CommandName="CompleteTask" HeaderTooltip="Complete task"
                                            ConfirmText="Do you want to Complete this task?" ButtonType="ImageButton" ImageUrl="~/Images/ok.png">
                                            <HeaderStyle Width="25" />
                                            <ItemStyle HorizontalAlign="Center" Width="25"  />
                                        </telerik:GridButtonColumn>
                                        
                                    <telerik:GridTemplateColumn HeaderText="Received Date" UniqueName="DocReceivedDate"
                                        AllowFiltering="false">
                                        <HeaderStyle HorizontalAlign="Center" Width="80" />
                                        <ItemStyle HorizontalAlign="Center" Width="80"/>
                                        <ItemTemplate>
                                            <%# Eval("DocReceivedDate","{0:dd/MM/yyyy}") %>
                                            
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                        
                                    <telerik:GridTemplateColumn HeaderText="Deadline" UniqueName="DeadlineDate"
                                        AllowFiltering="false">
                                        <HeaderStyle HorizontalAlign="Center" Width="80" />
                                        <ItemStyle HorizontalAlign="Center" Width="80"/>
                                        <ItemTemplate>
                                            <%# Eval("DeadlineDate","{0:dd/MM/yyyy}") %>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                            
                                         <telerik:GridTemplateColumn HeaderText="Action" UniqueName="ActionName"
                                        AllowFiltering="false">
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="DOC. No." UniqueName="DocNumber"
                                        DataField="DocNumber" ShowFilterIcon="False" FilterControlWidth="97%" 
                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                        <HeaderStyle HorizontalAlign="Center" Width="160" />
                                        <ItemStyle HorizontalAlign="Left" Width="160" />
                                        <ItemTemplate>
                                            <asp:Label ID="lblDocNo" runat="server" Text='<%# Eval("DocNumber") %>' style="cursor: pointer"/> 
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Rev." UniqueName="DocRevName"
                                        AllowFiltering="false">
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Trans No." UniqueName="DocReceivedTransNo"
                                        AllowFiltering="false">
                                        <HeaderStyle HorizontalAlign="Center" Width="150" />
                                        <ItemStyle HorizontalAlign="Center"  />
                                        <ItemTemplate>
                                            <%# Eval("DocReceivedTransNo") %>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                        
                                    <telerik:GridTemplateColumn HeaderText="Complete Taks" UniqueName="IsComplete" AllowFiltering="False">
                                            <HeaderStyle Width="70" HorizontalAlign="Center"></HeaderStyle>
                                        <ItemStyle  HorizontalAlign="Center"></ItemStyle>
                                        <ItemTemplate>
                                            <asp:Image ID="Image3" runat="server" ImageUrl="~/Images/ok.png" Visible='<%# Convert.ToBoolean(DataBinder.Eval(Container.DataItem, "IsComplete"))%>'/>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                </Columns>
                            </MasterTableView>
    ...
    <telerik:RadWindowManager ID="RadWindowManager1" runat="server" EnableShadow="true" >
        <Windows>
            ...
            <telerik:RadWindow ID="CommentWnd" runat="server" Title="Attach Comment Sheet"
                VisibleStatusbar="false" Height="510" Width="800" 
                Left="150px" ReloadOnShow="true" ShowContentDuringLoad="false" Modal="true">
            </telerik:RadWindow>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            ...
            function SendMail(taskid) {
                var owd = $find("<%=SendMail.ClientID %>");
                        owd.Show();
                        owd.setUrl("Controls/Document/SendMail.aspx?taskId=" + taskid, "SendMail");
            }

            function ShowCommentForm(docId, taskId) {
                var owd = $find("<%=CommentWnd.ClientID %>");
                owd.Show();
                owd.setUrl("Controls/Document/AttachComment.aspx?docId=" + docId +"&taskId=" + taskId, "CommentWnd");
            }

            function CompleteTask(taskId) {
                ajaxManager.ajaxRequest("CompleteTask_" + taskId);
            }
