<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CSNewList.aspx.cs" Inherits="EDMs.Web.CSNewList" EnableViewState="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<style type="text/css">
		...
		#ctl00_ContentPlaceHolder2_grdCS_GridData {
			height: 100% !important;
		}
	   ...
	   #ctl00_ContentPlaceHolder2_IncomingTransView{
		...
		#ctl00_ContentPlaceHolder2_OutgoingTransView {
		 ...
		 #ctl00_ContentPlaceHolder2_ctl00_ContentPlaceHolder2_grdIncomingTransPanel{
			height: 100% !important;
		} #ctl00_ContentPlaceHolder2_ctl00_ContentPlaceHolder2_grdCSPanel
		{
			height: 100% !important;
		}
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
	<telerik:RadSplitter ID="RadSplitter4" runat="server" Orientation="Horizontal">
			...
			<telerik:RadToolBar ID="radMenuOutgoing" runat="server" Width="100%" OnClientButtonClicking="radMenuOutgoing_OnClientButtonClicking">
				<Items>
					<telerik:RadToolBarDropDown runat="server" Text="New" ImageUrl="~/Images/addNew.png" >
						<Buttons>
							<telerik:RadToolBarButton runat="server" Text="CS" Value="1" ImageUrl="~/Images/index.png" />
						</Buttons>
					...
					<telerik:RadToolBarButton runat="server" Value="ShowAll">
						<ItemTemplate>
							...
							<asp:DropDownList ID="ddlStatus" runat="server" CssClass="rcbReadOnly" Width="200px" style="max-width: 200px"
								...
								<Items>
									<asp:ListItem Value="All" Text="All CS"></asp:ListItem>
									<asp:ListItem Value="Invalid" Text="Invalid CS" style="background-color: red"></asp:ListItem>
									<asp:ListItem Value="Waiting" Text="CS Waiting For Send" style="background-color: coral"></asp:ListItem>
									<asp:ListItem Value="Sent" Text="CS Sent" style="background-color: greenyellow"></asp:ListItem>
		...
		<telerik:RadPane ID="RadPane1" runat="server" Scrollable="false" Scrolling="None">
			<telerik:RadGrid AllowCustomPaging="False" AllowPaging="true" AllowSorting="True" 
					...
					Height="100%" ID="grdCS"  AllowFilteringByColumn="true" AllowMultiRowSelection="False"
					OnNeedDataSource="grdCS_OnNeedDataSource" 
					OnDeleteCommand="grdCS_OnDeleteCommand"
					...
					<MasterTableView AllowMultiColumnSorting="false"
						...
						<PagerStyle AlwaysVisible="True" FirstPageToolTip="First page" LastPageToolTip="Last page" NextPagesToolTip="Next page" NextPageToolTip="Next page" PagerTextFormat="Change page: {4} &amp;nbsp;Page &lt;strong&gt;{0}&lt;/strong&gt; / &lt;strong&gt;{1}&lt;/strong&gt;, Total:  &lt;strong&gt;{5}&lt;/strong&gt; CS." PageSizeLabelText="Row/page: " PrevPagesToolTip="Previous page" PrevPageToolTip="Previous page" />
						...
						<Columns>
							...
							<telerik:GridTemplateColumn HeaderText="No." Groupable="False" AllowFiltering="false" Display="False">
								...
								<ItemTemplate>
									<asp:Label ID="lblSoTT" runat="server" Text='<%# grdCS.CurrentPageIndex * grdCS.PageSize + grdCS.Items.Count+1 %>'>
									</asp:Label>
							...
							<telerik:GridTemplateColumn AllowFiltering="False" UniqueName="DeleteColumn">
								...
								<ItemTemplate>
									...
									<a href='javascript:DeleteCS("<%# DataBinder.Eval(Container.DataItem, "ID") %>")' style="text-decoration: none; color:blue">
									<asp:Image ID="delete" runat="server" ImageUrl="~/Images/delete.png" Style="cursor: pointer;" ToolTip="Delete CS" />
										<a/></div>
								</ItemTemplate>
							</telerik:GridTemplateColumn>
							...
							<telerik:GridTemplateColumn AllowFiltering="False" UniqueName="ExportExcelForm">
								...
								<ItemTemplate>
									...
									<asp:Image ID="imgExcel" runat="server" ImageUrl="~/Images/excelfile1.png" Style="cursor: pointer;" ToolTip="Export CS Form"  visible='<%# !Convert.ToBoolean(Eval("IsAttachWorkflow"))%>' />
									<a/>
								</ItemTemplate>
							</telerik:GridTemplateColumn>
							...
							<telerik:GridTemplateColumn AllowFiltering="False" UniqueName="AttachWorkflow" >
								...
								<ItemTemplate>
									...
									<asp:Image ID="imgAttachWorkflow" runat="server" ImageUrl="~/Images/attachwf.png" Style="cursor: pointer;" ToolTip="Attach CS To Workflow" Visible='<%# !Convert.ToBoolean(Eval("IsAttachWorkflow"))%>'/>
										<a/>
												
										<asp:Image ID="imgAttachWorkflowOk" runat="server" ImageUrl="~/Images/attachwfOk.png" ToolTip="CS Attached To Workflow" Visible='<%# Convert.ToBoolean(Eval("IsAttachWorkflow"))%>'/>
								</ItemTemplate>
							</telerik:GridTemplateColumn>
						   ...
						   <telerik:GridTemplateColumn HeaderText="Review Result" UniqueName="ReviewResult" DataField="ReviewResult"
							...
							<telerik:GridTemplateColumn HeaderText="CS" UniqueName="Number" DataField="Number"
							...
							<telerik:GridTemplateColumn HeaderText="Subject" UniqueName="Subject" DataField="Subject"
								...
								<telerik:GridTemplateColumn  HeaderText="Related CS/Letter No." UniqueName="RelatedCSNo" DataField="RelatedCSNo"
								ShowFilterIcon="False" FilterControlWidth="97%" 
								AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" >
						...
						<telerik:GridTemplateColumn  HeaderText="Need Reply" UniqueName="NeedReply" DataField="NeedReply"
								ShowFilterIcon="False" FilterControlWidth="97%" 
								AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" >
								<HeaderStyle HorizontalAlign="Center" Width="100" />
								<ItemStyle HorizontalAlign="Center" />
	...
	<telerik:RadContextMenu ID="radMenu" runat="server"
		...
		<Items>
			<telerik:RadMenuItem Text="Related" ImageUrl="~/Images/reassign.png" Value="Related"/>
...
<telerik:RadAjaxManager runat="Server" ID="ajaxCustomer" OnAjaxRequest="RadAjaxManager1_AjaxRequest">
	...
	<AjaxSettings>
		<telerik:AjaxSetting AjaxControlID="ajaxCustomer">
			<UpdatedControls>
				...
				<telerik:AjaxUpdatedControl ControlID="grdCS" LoadingPanelID="RadAjaxLoadingPanel1"/>
			</UpdatedControls>
		</telerik:AjaxSetting>
		...
		<telerik:AjaxSetting AjaxControlID="grdCS">
			<UpdatedControls>
				<telerik:AjaxUpdatedControl ControlID="grdCS" LoadingPanelID="RadAjaxLoadingPanel1"/>
			</UpdatedControls>
		</telerik:AjaxSetting>
	...
	<telerik:RadWindowManager ID="RadWindowManager1" runat="server" EnableShadow="true" >
		<Windows>
			<telerik:RadWindow ID="CustomerDialog" runat="server" Title="CS Information"
			...
			<telerik:RadWindow ID="AttachDocFile" runat="server" Title="CS Attach Referenced Document Files"
			...
			<telerik:RadWindow ID="ETRMAttachFile" runat="server" Title="CS Attach Files"
			...
			<telerik:RadWindow ID="AttachWorkflow" runat="server" Title="Attach CS to Workflow"
	...
	<telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
		...
		<script type="text/javascript">
			...
			function refreshGrid() {
				var masterTable = $find("<%=grdCS.ClientID%>").get_masterTableView();
				masterTable.rebind();
			}
			...
			function ShowAddNew(refChangeRequest) {
				...
				owd.setSize(730, document.documentElement.offsetHeight);
				owd.Show();
				owd.setUrl("Controls/Document/CSEditForm.aspx?projectId=" + projectId + "&ref=" + refChangeRequest, "CustomerDialog");
			}
				...
				else
				{
					switch (itemValue) {
						case "Related":
							...
							owd.Show();
							owd.setUrl("Controls/Document/CSEditForm.aspx?Replate=true&projectId=" + projectId + "&ReobjId=" + docId, "CustomerDialog");
							break;
		...
		<script type="text/javascript">
			...
			function ShowEditForm(objId) {
				...
				owd.setSize(900, document.documentElement.offsetHeight);
				owd.Show();
				owd.setUrl("Controls/Document/CSEditForm.aspx?projectId=" + projectId + "&objId=" + objId, "CustomerDialog");
			}
			...
			function ExportExcelForm(objId) {
				ajaxManager.ajaxRequest("ExportCSForm_" + objId);
			}
			...
			function ShowAllAttachFile(objId) {
				...
				owd.setSize(800, document.documentElement.offsetHeight);
				owd.Show();
				owd.setUrl("Controls/Document/CSAttachDocument.aspx?objId=" + objId, "ETRMAttachFile");
			}
			...
			function AttachWorkflow(objId) {
				var owd = $find("<%=AttachWorkflow.ClientID %>");
				 ...
				 owd.Show();
				 owd.setUrl("../../Controls/Workflow/AttachWorkflow.aspx?objId=" + objId + "&projId=" + projId + "&type=3&typename=CS", "AttachWorkflow");
			}
			...
			function SendTrans(objId) {
				if (confirm("Do you want to send this CS to PECC2?") === false) return;
			...
			function radMenuOutgoing_OnClientButtonClicking(sender, args) {
				...
				if (strText === "CS") {
					...
					owd.setSize(900, document.documentElement.offsetHeight);
					owd.Show();
					owd.setUrl("Controls/Document/CSEditForm.aspx?projectId=" + projectId, "CustomerDialog");
				}
			}
